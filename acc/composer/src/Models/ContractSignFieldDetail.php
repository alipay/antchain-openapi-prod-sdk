...
class ContractSignFieldDetail extends Model
{
    ...
    {
        Model::validateRequired('actorIndentityType', $this->actorIndentityType, true);
        Model::validateRequired('addTime', $this->addTime, true);
        Model::validateRequired('assignedPosbean', $this->assignedPosbean, true);
        Model::validateRequired('assignedSeal', $this->assignedSeal, true);
        ...
        Model::validateRequired('executeFailedReason', $this->executeFailedReason, true);
        ...
        Model::validateRequired('sealFileKey', $this->sealFileKey, true);
