...
PACKAGE = "antchain_sdk_acc"
NAME = "antchain_acc" or "alibabacloud-package"
DESCRIPTION = "Ant Chain ACC SDK Library for Python"
AUTHOR = "Ant Chain SDK"
