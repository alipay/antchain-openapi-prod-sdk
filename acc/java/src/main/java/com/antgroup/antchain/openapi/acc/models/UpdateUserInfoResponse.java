...
public class UpdateUserInfoResponse extends TeaModel {
    ...
    public UpdateUserInfoResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateUserInfoResponse setResultCode(String resultCode) {
    ...
    public UpdateUserInfoResponse setResultMsg(String resultMsg) {
