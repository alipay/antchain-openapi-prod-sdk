...
public class CreateContractSignflowRequest extends TeaModel {
    ...
    @Validation(required = true)
    public java.util.List<ContractPaymentOrderInfo> repaymentOrderInfo;
    ...
    public CreateContractSignflowRequest setRepaymentOrderInfo(java.util.List<ContractPaymentOrderInfo> repaymentOrderInfo) {
        this.repaymentOrderInfo = repaymentOrderInfo;
        return this;
    }
    public java.util.List<ContractPaymentOrderInfo> getRepaymentOrderInfo() {
