...
class ExecAntcloudBxptnewDataproductRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class ExecAntcloudBxptnewDataproductResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class ExecAntcloudBxptnewDataproductAsyncRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_code: str = None,
...
class ExecAntcloudBxptnewDataproductAsyncResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryAntcloudBxptnewDataproductAsyncRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_code: str = None,
...
class QueryAntcloudBxptnewDataproductAsyncResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
