...
type OperateAisProxyRequest struct {
	// OAuth模式下的授权token
...
func (s OperateAisProxyRequest) GoString() string {
	return s.String()
}

func (s *OperateAisProxyRequest) SetAuthToken(v string) *OperateAisProxyRequest {
	s.AuthToken = &v
	return s
}

func (s *OperateAisProxyRequest) SetProductInstanceId(v string) *OperateAisProxyRequest {
...
type OperateAisProxyResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
...
func (s OperateAisProxyResponse) GoString() string {
	return s.String()
}

func (s *OperateAisProxyResponse) SetReqMsgId(v string) *OperateAisProxyResponse {
	s.ReqMsgId = &v
	return s
}

func (s *OperateAisProxyResponse) SetResultCode(v string) *OperateAisProxyResponse {
	s.ResultCode = &v
	return s
}
 ...
 * Summary: ais代理
 */
func (client *Client) OperateAisProxy(request *OperateAisProxyRequest) (_result *OperateAisProxyResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &OperateAisProxyResponse{}
	_body, _err := client.OperateAisProxyEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: ais代理
 */
func (client *Client) OperateAisProxyEx(request *OperateAisProxyRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *OperateAisProxyResponse, _err error) {
