...
class Client
{
     ...
     * Summary: ais代理.
     *
     * @param OperateAisProxyRequest $request
     *
     * @return OperateAisProxyResponse
     */
    public function operateAisProxy($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];

        return $this->operateAisProxyEx($request, $headers, $runtime);
    }
     ...
     * @return OperateAisProxyResponse
     */
    public function operateAisProxyEx($request, $headers, $runtime)
    {
