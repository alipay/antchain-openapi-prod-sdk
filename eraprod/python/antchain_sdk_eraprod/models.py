...
class OperateAisProxyRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class OperateAisProxyResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class OperateAgentProxyRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class OperateAgentProxyResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
