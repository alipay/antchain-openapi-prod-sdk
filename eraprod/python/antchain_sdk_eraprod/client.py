...
from antchain_sdk_eraprod import models as eraprod_models
...
class Client:
    ...
    def operate_ais_proxy(
        self,
        request: eraprod_models.OperateAisProxyRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.operate_ais_proxy_ex(request, headers, runtime)

    async def operate_ais_proxy_async(
        self,
        request: eraprod_models.OperateAisProxyRequest,
    ) -> eraprod_models.OperateAisProxyResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.operate_ais_proxy_ex_async(request, headers, runtime)

    def operate_ais_proxy_ex(
        self,
        request: eraprod_models.OperateAisProxyRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            eraprod_models.OperateAisProxyResponse(),
            self.do_request('1.0', 'antdigital.eraprod.ais.proxy.operate', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def operate_ais_proxy_ex_async(
        self,
        request: eraprod_models.OperateAisProxyRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
