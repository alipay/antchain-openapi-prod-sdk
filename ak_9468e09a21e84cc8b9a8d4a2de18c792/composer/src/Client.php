...
namespace AntChain\Ak_9468e09a21e84cc8b9a8d4a2de18c792;
...
class Client
{
     ...
     * Summary: 单据上链状态查询.
     *
     * @param QueryBlockchainAppexAsynformStatusRequest $request
     *
     * @return QueryBlockchainAppexAsynformStatusResponse
     */
    public function queryBlockchainAppexAsynformStatus($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryBlockchainAppexAsynformStatusResponse
     */
    public function queryBlockchainAppexAsynformStatusEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);
