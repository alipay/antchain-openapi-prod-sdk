...
func (s QueryBlockchainAppexAsynformStatusRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryBlockchainAppexAsynformStatusRequest) GoString() string {
	return s.String()
}

func (s *QueryBlockchainAppexAsynformStatusRequest) SetAuthToken(v string) *QueryBlockchainAppexAsynformStatusRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusRequest) SetProductInstanceId(v string) *QueryBlockchainAppexAsynformStatusRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusRequest) SetUserDid(v string) *QueryBlockchainAppexAsynformStatusRequest {
	s.UserDid = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusRequest) SetUnionId(v int64) *QueryBlockchainAppexAsynformStatusRequest {
	s.UnionId = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusRequest) SetFormId(v string) *QueryBlockchainAppexAsynformStatusRequest {
	s.FormId = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusRequest) SetFormType(v string) *QueryBlockchainAppexAsynformStatusRequest {
	s.FormType = &v
	return s
}

type QueryBlockchainAppexAsynformStatusResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
...
func (s QueryBlockchainAppexAsynformStatusResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryBlockchainAppexAsynformStatusResponse) GoString() string {
	return s.String()
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetReqMsgId(v string) *QueryBlockchainAppexAsynformStatusResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetResultCode(v string) *QueryBlockchainAppexAsynformStatusResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetResultMsg(v string) *QueryBlockchainAppexAsynformStatusResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetBlockHeight(v int64) *QueryBlockchainAppexAsynformStatusResponse {
	s.BlockHeight = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetTxHash(v string) *QueryBlockchainAppexAsynformStatusResponse {
	s.TxHash = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetCreateTime(v string) *QueryBlockchainAppexAsynformStatusResponse {
	s.CreateTime = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetStatus(v string) *QueryBlockchainAppexAsynformStatusResponse {
	s.Status = &v
	return s
}

func (s *QueryBlockchainAppexAsynformStatusResponse) SetTxTimestamp(v string) *QueryBlockchainAppexAsynformStatusResponse {
	s.TxTimestamp = &v
	return s
}
 ...
 * Summary: 单据上链状态查询
 */
func (client *Client) QueryBlockchainAppexAsynformStatus(request *QueryBlockchainAppexAsynformStatusRequest) (_result *QueryBlockchainAppexAsynformStatusResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryBlockchainAppexAsynformStatusResponse{}
	_body, _err := client.QueryBlockchainAppexAsynformStatusEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 单据上链状态查询
 */
func (client *Client) QueryBlockchainAppexAsynformStatusEx(request *QueryBlockchainAppexAsynformStatusRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryBlockchainAppexAsynformStatusResponse, _err error) {
