...
using AntChain.SDK.Ak_9468e09a21e84cc8b9a8d4a2de18c792.Models;

namespace AntChain.SDK.Ak_9468e09a21e84cc8b9a8d4a2de18c792
{
    public class Client 
    {
         ...
         * Summary: 单据上链状态查询
         */
        public QueryBlockchainAppexAsynformStatusResponse QueryBlockchainAppexAsynformStatus(QueryBlockchainAppexAsynformStatusRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return QueryBlockchainAppexAsynformStatusEx(request, headers, runtime);
        }
         ...
         * Summary: 单据上链状态查询
         */
        public async Task<QueryBlockchainAppexAsynformStatusResponse> QueryBlockchainAppexAsynformStatusAsync(QueryBlockchainAppexAsynformStatusRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryBlockchainAppexAsynformStatusExAsync(request, headers, runtime);
        }
         ...
         * Summary: 单据上链状态查询
         */
        public QueryBlockchainAppexAsynformStatusResponse QueryBlockchainAppexAsynformStatusEx(QueryBlockchainAppexAsynformStatusRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryBlockchainAppexAsynformStatusResponse>(DoRequest("1.0", "blockchain.appex.asynform.status.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 单据上链状态查询
         */
        public async Task<QueryBlockchainAppexAsynformStatusResponse> QueryBlockchainAppexAsynformStatusExAsync(QueryBlockchainAppexAsynformStatusRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
