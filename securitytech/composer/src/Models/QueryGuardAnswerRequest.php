...
class QueryGuardAnswerRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateMaxLength('serviceCode', $this->serviceCode, 128);
        Model::validateMaxLength('answer', $this->answer, 10000);
        Model::validateMaxLength('question', $this->question, 800);
        Model::validateMaxLength('questionFormat', $this->questionFormat, 32);
        Model::validateMaxLength('answerFormat', $this->answerFormat, 32);
        Model::validateMaxLength('sceneCode', $this->sceneCode, 128);
        Model::validateMinLength('sessionId', $this->sessionId, 0);
        Model::validateMinLength('requestId', $this->requestId, 0);
        Model::validateMinLength('serviceCode', $this->serviceCode, 0);
        Model::validateMinLength('answer', $this->answer, 1);
        Model::validateMinLength('question', $this->question, 1);
        Model::validateMinLength('questionFormat', $this->questionFormat, 0);
        Model::validateMinLength('answerFormat', $this->answerFormat, 0);
        Model::validateMinLength('sceneCode', $this->sceneCode, 1);
    }
     ...
     * @param array $map
     *
     * @return QueryGuardAnswerRequest
     */
