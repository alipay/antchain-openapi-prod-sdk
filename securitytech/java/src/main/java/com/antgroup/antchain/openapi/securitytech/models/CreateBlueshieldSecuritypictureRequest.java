...
public class CreateBlueshieldSecuritypictureRequest extends TeaModel {
    ...
    public CreateBlueshieldSecuritypictureRequest setRaasProducts(String raasProducts) {
    ...
    public CreateBlueshieldSecuritypictureRequest setRaasSecondTenant(String raasSecondTenant) {
