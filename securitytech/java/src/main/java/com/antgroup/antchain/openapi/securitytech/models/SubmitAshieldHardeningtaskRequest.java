...
public class SubmitAshieldHardeningtaskRequest extends TeaModel {
    ...
    public SubmitAshieldHardeningtaskRequest setSoProtect(String soProtect) {
    ...
    public SubmitAshieldHardeningtaskRequest setSoProtectConfig(String soProtectConfig) {
    ...
    public SubmitAshieldHardeningtaskRequest setAssetsProtect(String assetsProtect) {
    ...
    public SubmitAshieldHardeningtaskRequest setAssetsProtectConfing(String assetsProtectConfing) {
    ...
    public SubmitAshieldHardeningtaskRequest setRuntimeProtectConfig(RuntimeProtectConfig runtimeProtectConfig) {
    ...
    public SubmitAshieldHardeningtaskRequest setEnableLifeFunc(String enableLifeFunc) {
    ...
    public SubmitAshieldHardeningtaskRequest setExtInfo(String extInfo) {
