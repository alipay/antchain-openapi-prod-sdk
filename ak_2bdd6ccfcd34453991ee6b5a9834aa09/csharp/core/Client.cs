...
using AntChain.SDK.Ak_2bdd6ccfcd34453991ee6b5a9834aa09.Models;

namespace AntChain.SDK.Ak_2bdd6ccfcd34453991ee6b5a9834aa09
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_2bdd6ccfcd34453991ee6b5a9834aa09"},
                        {"_prod_channel", "saas"},
                    };
