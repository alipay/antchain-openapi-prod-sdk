...
using AntChain.SDK.Ak_bb3e5638866e4c77aa9ae8ac5c14e933.Models;

namespace AntChain.SDK.Ak_bb3e5638866e4c77aa9ae8ac5c14e933
{
    public class Client 
    {
         ...
         * Summary: 测试使用
         */
        public QueryDemoAaaaFffDdResponse QueryDemoAaaaFffDd(QueryDemoAaaaFffDdRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
         ...
         * Summary: 测试使用
         */
        public async Task<QueryDemoAaaaFffDdResponse> QueryDemoAaaaFffDdAsync(QueryDemoAaaaFffDdRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryDemoAaaaFffDdExAsync(request, headers, runtime);
        }
         ...
         * Summary: 测试使用
         */
        public QueryDemoAaaaFffDdResponse QueryDemoAaaaFffDdEx(QueryDemoAaaaFffDdRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryDemoAaaaFffDdResponse>(DoRequest("1.0", "demo.aaaa.fff.dd.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 测试使用
         */
        public async Task<QueryDemoAaaaFffDdResponse> QueryDemoAaaaFffDdExAsync(QueryDemoAaaaFffDdRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryDemoAaaaFffDdResponse>(await DoRequestAsync("1.0", "demo.aaaa.fff.dd.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 共享能力六期回归验证
         */
        public BindDemoGongxaingTestResponse BindDemoGongxaingTest(BindDemoGongxaingTestRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return BindDemoGongxaingTestEx(request, headers, runtime);
        }
         ...
         * Summary: 共享能力六期回归验证
         */
        public async Task<BindDemoGongxaingTestResponse> BindDemoGongxaingTestAsync(BindDemoGongxaingTestRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await BindDemoGongxaingTestExAsync(request, headers, runtime);
        }
         ...
         * Summary: 共享能力六期回归验证
         */
        public BindDemoGongxaingTestResponse BindDemoGongxaingTestEx(BindDemoGongxaingTestRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<BindDemoGongxaingTestResponse>(DoRequest("1.0", "demo.gongxaing.test.bind", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 共享能力六期回归验证
         */
        public async Task<BindDemoGongxaingTestResponse> BindDemoGongxaingTestExAsync(BindDemoGongxaingTestRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<BindDemoGongxaingTestResponse>(await DoRequestAsync("1.0", "demo.gongxaing.test.bind", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
