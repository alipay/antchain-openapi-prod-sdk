...
package com.antgroup.antchain.openapi.ak_c3cc551641bc4a1e948f7b80bb2180f4;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.ak_c3cc551641bc4a1e948f7b80bb2180f4.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("_prod_code", "ak_c3cc551641bc4a1e948f7b80bb2180f4"),
     ...
     * Summary: 测试001
     */
    public QueryDemoGatewayTestResponse queryDemoGatewayTest(QueryDemoGatewayTestRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 测试001
     */
    public QueryDemoGatewayTestResponse queryDemoGatewayTestEx(QueryDemoGatewayTestRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "demo.gateway.test.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDemoGatewayTestResponse());
    }
