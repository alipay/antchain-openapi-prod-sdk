...
using AntChain.SDK.Ak_c3cc551641bc4a1e948f7b80bb2180f4.Models;

namespace AntChain.SDK.Ak_c3cc551641bc4a1e948f7b80bb2180f4
{
    public class Client 
    {
         ...
         * Summary: 测试001
         */
        public QueryDemoGatewayTestResponse QueryDemoGatewayTest(QueryDemoGatewayTestRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return QueryDemoGatewayTestEx(request, headers, runtime);
        }
         ...
         * Summary: 测试001
         */
        public async Task<QueryDemoGatewayTestResponse> QueryDemoGatewayTestAsync(QueryDemoGatewayTestRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryDemoGatewayTestExAsync(request, headers, runtime);
        }
         ...
         * Summary: 测试001
         */
        public QueryDemoGatewayTestResponse QueryDemoGatewayTestEx(QueryDemoGatewayTestRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryDemoGatewayTestResponse>(DoRequest("1.0", "demo.gateway.test.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 测试001
         */
        public async Task<QueryDemoGatewayTestResponse> QueryDemoGatewayTestExAsync(QueryDemoGatewayTestRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryDemoGatewayTestResponse>(await DoRequestAsync("1.0", "demo.gateway.test.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
