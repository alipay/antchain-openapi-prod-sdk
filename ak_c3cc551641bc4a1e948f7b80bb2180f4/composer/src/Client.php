...
namespace AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4;
...
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\BindDemoCenterAbilityRequest;
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\BindDemoCenterAbilityResponse;
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\QueryDemoGatewayCheckRequest;
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\QueryDemoGatewayCheckResponse;
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\QueryDemoGatewayTestRequest;
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\QueryDemoGatewayTestResponse;
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\StatusDemoGatewayCheckRequest;
use AntChain\Ak_c3cc551641bc4a1e948f7b80bb2180f4\Models\StatusDemoGatewayCheckResponse;
...
class Client
{
     ...
     * Summary: 测试001.
     *
     * @param QueryDemoGatewayTestRequest $request
     *
     * @return QueryDemoGatewayTestResponse
     */
    public function queryDemoGatewayTest($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];

        return $this->queryDemoGatewayTestEx($request, $headers, $runtime);
    }
     ...
     * @return QueryDemoGatewayTestResponse
     */
    public function queryDemoGatewayTestEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return QueryDemoGatewayTestResponse::fromMap($this->doRequest('1.0', 'demo.gateway.test.query', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
