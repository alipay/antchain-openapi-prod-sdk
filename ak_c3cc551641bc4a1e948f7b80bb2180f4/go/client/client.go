...
type QueryDemoGatewayTestRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
}

func (s QueryDemoGatewayTestRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryDemoGatewayTestRequest) GoString() string {
	return s.String()
}

func (s *QueryDemoGatewayTestRequest) SetAuthToken(v string) *QueryDemoGatewayTestRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryDemoGatewayTestRequest) SetProductInstanceId(v string) *QueryDemoGatewayTestRequest {
	s.ProductInstanceId = &v
	return s
}

type QueryDemoGatewayTestResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryDemoGatewayTestResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryDemoGatewayTestResponse) GoString() string {
	return s.String()
}

func (s *QueryDemoGatewayTestResponse) SetReqMsgId(v string) *QueryDemoGatewayTestResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryDemoGatewayTestResponse) SetResultCode(v string) *QueryDemoGatewayTestResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryDemoGatewayTestResponse) SetResultMsg(v string) *QueryDemoGatewayTestResponse {
	s.ResultMsg = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("ak_c3cc551641bc4a1e948f7b80bb2180f4"),
 ...
 * Summary: 测试001
 */
func (client *Client) QueryDemoGatewayTest(request *QueryDemoGatewayTestRequest) (_result *QueryDemoGatewayTestResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryDemoGatewayTestResponse{}
	_body, _err := client.QueryDemoGatewayTestEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 测试001
 */
func (client *Client) QueryDemoGatewayTestEx(request *QueryDemoGatewayTestRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryDemoGatewayTestResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
