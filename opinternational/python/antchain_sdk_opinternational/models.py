...
class PushAcopmDataRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
    ...
    def validate(self):
        self.validate_required(self.executor_type, 'executor_type')
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('executor_type') is not None:
            self.executor_type = m.get('executor_type')
...
class PushAcopmDataResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
