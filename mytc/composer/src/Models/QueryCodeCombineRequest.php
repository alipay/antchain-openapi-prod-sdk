...
class QueryCodeCombineRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->recursionFlag) {
            $res['recursion_flag'] = $this->recursionFlag;
        }
     ...
     * @param array $map
     *
     * @return QueryCodeCombineRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['recursion_flag'])) {
            $model->recursionFlag = $map['recursion_flag'];
        }
