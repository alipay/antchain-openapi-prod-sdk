...
public class AddCodeRegistrationRequest extends TeaModel {
    // OAuth模式下的授权token
    ...
    public static AddCodeRegistrationRequest build(java.util.Map<String, ?> map) throws Exception {
        AddCodeRegistrationRequest self = new AddCodeRegistrationRequest();
        return TeaModel.build(map, self);
    }

    public AddCodeRegistrationRequest setAuthToken(String authToken) {
    ...
    public AddCodeRegistrationRequest setProductInstanceId(String productInstanceId) {
    ...
    public AddCodeRegistrationRequest setBizType(String bizType) {
    ...
    public AddCodeRegistrationRequest setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AddCodeRegistrationRequest setStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public AddCodeRegistrationRequest setBizLabels(java.util.List<String> bizLabels) {
    ...
    public AddCodeRegistrationRequest setContent(String content) {
    ...
    public AddCodeRegistrationRequest setRelationCodes(java.util.List<String> relationCodes) {
    ...
    public AddCodeRegistrationRequest setRecursionType(String recursionType) {
    ...
    public AddCodeRegistrationRequest setUpChainFlag(Boolean upChainFlag) {
