...
class Client
{
     ...
     */
    public function getuserscore($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];

        return $this->getuserscoreEx($request, $headers, $runtime);
    }
     ...
     * @return GetuserscoreResponse
     */
    public function getuserscoreEx($request, $headers, $runtime)
    {
