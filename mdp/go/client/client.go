...
func (s GetuserscoreRequest) String() string {
	return tea.Prettify(s)
}

func (s GetuserscoreRequest) GoString() string {
	return s.String()
}

func (s *GetuserscoreRequest) SetAuthToken(v string) *GetuserscoreRequest {
	s.AuthToken = &v
	return s
}

func (s *GetuserscoreRequest) SetProductInstanceId(v string) *GetuserscoreRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *GetuserscoreRequest) SetModelId(v string) *GetuserscoreRequest {
	s.ModelId = &v
	return s
}

func (s *GetuserscoreRequest) SetMobileMd5(v string) *GetuserscoreRequest {
	s.MobileMd5 = &v
	return s
}
...
func (s GetuserscoreResponse) String() string {
	return tea.Prettify(s)
}

func (s GetuserscoreResponse) GoString() string {
	return s.String()
}

func (s *GetuserscoreResponse) SetReqMsgId(v string) *GetuserscoreResponse {
	s.ReqMsgId = &v
	return s
}

func (s *GetuserscoreResponse) SetResultCode(v string) *GetuserscoreResponse {
	s.ResultCode = &v
	return s
}

func (s *GetuserscoreResponse) SetResultMsg(v string) *GetuserscoreResponse {
	s.ResultMsg = &v
	return s
}
...
func (client *Client) Getuserscore(request *GetuserscoreRequest) (_result *GetuserscoreResponse, _err error) {
	...
	_body, _err := client.GetuserscoreEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
