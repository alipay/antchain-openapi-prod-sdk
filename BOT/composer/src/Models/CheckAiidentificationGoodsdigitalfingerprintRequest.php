...
use AntChain\BOT\Models\GoodsDigitalFingerprintInfo;
use AntChain\BOT\Models\GoodsDigitalFingerprintUserInfo;

class CheckAiidentificationGoodsdigitalfingerprintRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return CheckAiidentificationGoodsdigitalfingerprintRequest
     */
