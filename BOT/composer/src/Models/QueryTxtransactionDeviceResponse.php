...
use AntChain\BOT\Models\QueryDeviceTransactionResultData;

class QueryTxtransactionDeviceResponse extends Model {
    protected $_name = [
        'reqMsgId' => 'req_msg_id',
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['data'])){
            $model->data = QueryDeviceTransactionResultData::fromMap($map['data']);
        }
        return $model;
    }
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    // 交易返回的数据
    /**
     * @var QueryDeviceTransactionResultData
     */
    public $data;
