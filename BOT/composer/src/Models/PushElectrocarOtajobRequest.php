...
class PushElectrocarOtajobRequest extends Model {
    protected $_name = [
    ...
    public function toMap() {
        ...
        if (null !== $this->targetTrustDeviceIds) {
            $res['target_trust_device_ids'] = $this->targetTrustDeviceIds;
        }
        if (null !== $this->dnListFileUrl) {
            $res['dn_list_file_url'] = $this->dnListFileUrl;
        }
        if (null !== $this->targetDeviceNames) {
            $res['target_device_names'] = $this->targetDeviceNames;
        }
    ...
    /**
     * @param array $map
     * @return PushElectrocarOtajobRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['target_trust_device_ids'])){
            if(!empty($map['target_trust_device_ids'])){
                $model->targetTrustDeviceIds = $map['target_trust_device_ids'];
            }
        }
        if(isset($map['dn_list_file_url'])){
            $model->dnListFileUrl = $map['dn_list_file_url'];
        }
        if(isset($map['target_device_names'])){
            if(!empty($map['target_device_names'])){
                $model->targetDeviceNames = $map['target_device_names'];
            }
        }
