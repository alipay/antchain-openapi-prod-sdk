...
use AntChain\BOT\Models\QueryIoaAgentRequest;
use AntChain\BOT\Models\QueryIoaAgentResponse;
use AntChain\BOT\Models\SaveIoaAgentRequest;
use AntChain\BOT\Models\SaveIoaAgentResponse;
use AntChain\BOT\Models\QueryIoaTemplatesRequest;
use AntChain\BOT\Models\QueryIoaTemplatesResponse;
use AntChain\BOT\Models\QueryAgentchatHistoryRequest;
...
use AntChain\BOT\Models\QueryElectrocarOtaupgradecheckRequest;
use AntChain\BOT\Models\QueryElectrocarOtaupgradecheckResponse;
use AntChain\BOT\Models\ExecElectrocarOtataskcancelRequest;
use AntChain\BOT\Models\ExecElectrocarOtataskcancelResponse;
use AntChain\BOT\Models\ExecElectrocarOtataskretryRequest;
use AntChain\BOT\Models\ExecElectrocarOtataskretryResponse;
use AntChain\BOT\Models\ExecElectrocarOtataskconfirmRequest;
use AntChain\BOT\Models\ExecElectrocarOtataskconfirmResponse;
use AntChain\BOT\Models\ExecElectrocarOtataskpermanentcancelRequest;
use AntChain\BOT\Models\ExecElectrocarOtataskpermanentcancelResponse;
use AntChain\BOT\Models\PublishElectrocarModuleversionRequest;
use AntChain\BOT\Models\PublishElectrocarModuleversionResponse;
use AntChain\BOT\Models\QueryElectrocarTaskstatusRequest;
use AntChain\BOT\Models\QueryElectrocarTaskstatusResponse;
use AntChain\BOT\Models\QueryElectrocarProductcustomerpageRequest;
use AntChain\BOT\Models\QueryElectrocarProductcustomerpageResponse;
use AntChain\BOT\Models\PushElectrocarOtajobRequest;
use AntChain\BOT\Models\PushElectrocarOtajobResponse;
use AntChain\BOT\Models\QueryElectrocarOtamodulepageRequest;
use AntChain\BOT\Models\QueryElectrocarOtamodulepageResponse;
use AntChain\BOT\Models\QueryElectrocarOtafirmwarepageRequest;
use AntChain\BOT\Models\QueryElectrocarOtafirmwarepageResponse;
use AntChain\BOT\Models\QueryElectrocarOtafirmwaredetailRequest;
use AntChain\BOT\Models\QueryElectrocarOtafirmwaredetailResponse;
use AntChain\BOT\Models\QueryElectrocarOtajobpageRequest;
use AntChain\BOT\Models\QueryElectrocarOtajobpageResponse;
use AntChain\BOT\Models\QueryElectrocarOtajobdetailRequest;
use AntChain\BOT\Models\QueryElectrocarOtajobdetailResponse;
use AntChain\BOT\Models\QueryElectrocarOtataskpageRequest;
use AntChain\BOT\Models\QueryElectrocarOtataskpageResponse;
use AntChain\BOT\Models\QueryElectrocarDevicepageRequest;
...
use AntChain\BOT\Models\GetIdsquaredOtpRequest;
...
class Client {
    ...
    public function queryAiidentificationQrcodeEx($request, $headers, $runtime){
        if (!Utils::isUnset($request->fileObject)) {
            ...
            if (!UtilClient::isSuccess($uploadResp->resultCode, "ok")) {
                $queryAiidentificationQrcodeResponse = new QueryAiidentificationQrcodeResponse([
     ...
     * Description: 获取智能体信息
     * Summary: 获取智能体信息
     * @param QueryIoaAgentRequest $request
     * @return QueryIoaAgentResponse
     */
    public function queryIoaAgent($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryIoaAgentEx($request, $headers, $runtime);
    }
     ...
     * @return QueryIoaAgentResponse
     */
    public function queryIoaAgentEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryIoaAgentResponse::fromMap($this->doRequest("1.0", "blockchain.bot.ioa.agent.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 更新智能体信息
     * Summary: 更新智能体信息
     * @param SaveIoaAgentRequest $request
     * @return SaveIoaAgentResponse
     */
    public function saveIoaAgent($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->saveIoaAgentEx($request, $headers, $runtime);
    }
     ...
     * @return SaveIoaAgentResponse
     */
    public function saveIoaAgentEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return SaveIoaAgentResponse::fromMap($this->doRequest("1.0", "blockchain.bot.ioa.agent.save", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询用户可选的模板列表详情
     * Summary: 查询用户可选的模板列表详情
     * @param QueryIoaTemplatesRequest $request
     * @return QueryIoaTemplatesResponse
     */
    public function queryIoaTemplates($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryIoaTemplatesEx($request, $headers, $runtime);
    }
     ...
     * @return QueryIoaTemplatesResponse
     */
    public function queryIoaTemplatesEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryIoaTemplatesResponse::fromMap($this->doRequest("1.0", "blockchain.bot.ioa.templates.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询聊天记录
     * Summary: 查询聊天记录
     * @param QueryAgentchatHistoryRequest $request
     * @return QueryAgentchatHistoryResponse
     */
    public function queryAgentchatHistory($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryAgentchatHistoryEx($request, $headers, $runtime);
    }
     ...
     * @return QueryAgentchatHistoryResponse
     */
    public function queryAgentchatHistoryEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryAgentchatHistoryResponse::fromMap($this->doRequest("1.0", "blockchain.bot.agentchat.history.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询 Session 列表
     * Summary: 查询 Session 列表
     * @param QueryAgentSessionsRequest $request
     * @return QueryAgentSessionsResponse
     */
    public function queryAgentSessions($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryAgentSessionsEx($request, $headers, $runtime);
    }
    ...
    public function createIotlinkAppmanagerEx($request, $headers, $runtime){
        if (!Utils::isUnset($request->fileObject)) {
            ...
            $uploadResp = $this->createAntcloudGatewayxFileUploadEx($uploadReq, $headers, $runtime);
            if (!UtilClient::isSuccess($uploadResp->resultCode, "ok")) {
                $createIotlinkAppmanagerResponse = new CreateIotlinkAppmanagerResponse([
                    "reqMsgId" => $uploadResp->reqMsgId,
                    "resultCode" => $uploadResp->resultCode,
                    "resultMsg" => $uploadResp->resultMsg
                ]);
    ...
    /**
     * Description: OTA上报版本并查询升级状态
     * Summary: OTA上报版本并查询升级状态
     * @param QueryElectrocarOtaupgradecheckRequest $request
     * @return QueryElectrocarOtaupgradecheckResponse
     */
    public function queryElectrocarOtaupgradecheck($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryElectrocarOtaupgradecheckEx($request, $headers, $runtime);
    }
     ...
     * @return QueryElectrocarOtaupgradecheckResponse
     */
    public function queryElectrocarOtaupgradecheckEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarOtaupgradecheckResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otaupgradecheck.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 取消OTA任务
     * Summary: 取消OTA任务
     * @param ExecElectrocarOtataskcancelRequest $request
     * @return ExecElectrocarOtataskcancelResponse
     */
    public function execElectrocarOtataskcancel($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->execElectrocarOtataskcancelEx($request, $headers, $runtime);
    }
     ...
     * @return ExecElectrocarOtataskcancelResponse
     */
    public function execElectrocarOtataskcancelEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return ExecElectrocarOtataskcancelResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otataskcancel.exec", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 重试OTA任务
     * Summary: 重试OTA任务
     * @param ExecElectrocarOtataskretryRequest $request
     * @return ExecElectrocarOtataskretryResponse
     */
    public function execElectrocarOtataskretry($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->execElectrocarOtataskretryEx($request, $headers, $runtime);
    }
     ...
     * @return ExecElectrocarOtataskretryResponse
     */
    public function execElectrocarOtataskretryEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return ExecElectrocarOtataskretryResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otataskretry.exec", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 确认OTA升级任务
     * Summary: 确认OTA升级任务
     * @param ExecElectrocarOtataskconfirmRequest $request
     * @return ExecElectrocarOtataskconfirmResponse
     */
    public function execElectrocarOtataskconfirm($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->execElectrocarOtataskconfirmEx($request, $headers, $runtime);
    }
     ...
     * @return ExecElectrocarOtataskconfirmResponse
     */
    public function execElectrocarOtataskconfirmEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return ExecElectrocarOtataskconfirmResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otataskconfirm.exec", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 永久取消OTA任务
     * Summary: 永久取消OTA任务
     * @param ExecElectrocarOtataskpermanentcancelRequest $request
     * @return ExecElectrocarOtataskpermanentcancelResponse
     */
    public function execElectrocarOtataskpermanentcancel($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->execElectrocarOtataskpermanentcancelEx($request, $headers, $runtime);
    }
     ...
     * @return ExecElectrocarOtataskpermanentcancelResponse
     */
    public function execElectrocarOtataskpermanentcancelEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return ExecElectrocarOtataskpermanentcancelResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otataskpermanentcancel.exec", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: OTA模块版本上报
     * Summary: OTA模块版本上报
     * @param PublishElectrocarModuleversionRequest $request
     * @return PublishElectrocarModuleversionResponse
     */
    public function publishElectrocarModuleversion($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->publishElectrocarModuleversionEx($request, $headers, $runtime);
    }
     ...
     * @return PublishElectrocarModuleversionResponse
     */
    public function publishElectrocarModuleversionEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return PublishElectrocarModuleversionResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.moduleversion.publish", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询OTA任务状态
     * Summary: 查询OTA任务状态
     * @param QueryElectrocarTaskstatusRequest $request
     * @return QueryElectrocarTaskstatusResponse
     */
    public function queryElectrocarTaskstatus($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryElectrocarTaskstatusEx($request, $headers, $runtime);
    }
     ...
     * @return QueryElectrocarTaskstatusResponse
     */
    public function queryElectrocarTaskstatusEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarTaskstatusResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.taskstatus.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询客户的产品分页列表
     * Summary: 查询客户的产品分页列表
     * @param QueryElectrocarProductcustomerpageRequest $request
     * @return QueryElectrocarProductcustomerpageResponse
     */
    public function queryElectrocarProductcustomerpage($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryElectrocarProductcustomerpageResponse
     */
    public function queryElectrocarProductcustomerpageEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarProductcustomerpageResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.productcustomerpage.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 创建OTA升级任务
     * Summary: 创建OTA升级任务
     * @param PushElectrocarOtajobRequest $request
     * @return PushElectrocarOtajobResponse
     */
    public function pushElectrocarOtajob($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return PushElectrocarOtajobResponse
     */
    public function pushElectrocarOtajobEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return PushElectrocarOtajobResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otajob.push", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询OTA模块分页列表
     * Summary: 查询OTA模块分页列表
     * @param QueryElectrocarOtamodulepageRequest $request
     * @return QueryElectrocarOtamodulepageResponse
     */
    public function queryElectrocarOtamodulepage($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryElectrocarOtamodulepageResponse
     */
    public function queryElectrocarOtamodulepageEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarOtamodulepageResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otamodulepage.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询固件升级包分页列表
     * Summary: 查询固件升级包分页列表
     * @param QueryElectrocarOtafirmwarepageRequest $request
     * @return QueryElectrocarOtafirmwarepageResponse
     */
    public function queryElectrocarOtafirmwarepage($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryElectrocarOtafirmwarepageResponse
     */
    public function queryElectrocarOtafirmwarepageEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarOtafirmwarepageResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otafirmwarepage.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询固件包详情
     * Summary: 查询固件包详情
     * @param QueryElectrocarOtafirmwaredetailRequest $request
     * @return QueryElectrocarOtafirmwaredetailResponse
     */
    public function queryElectrocarOtafirmwaredetail($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryElectrocarOtafirmwaredetailResponse
     */
    public function queryElectrocarOtafirmwaredetailEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarOtafirmwaredetailResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otafirmwaredetail.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询OTA固件升级批次分页列表
     * Summary: 查询OTA固件升级批次分页列表
     * @param QueryElectrocarOtajobpageRequest $request
     * @return QueryElectrocarOtajobpageResponse
     */
    public function queryElectrocarOtajobpage($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryElectrocarOtajobpageResponse
     */
    public function queryElectrocarOtajobpageEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarOtajobpageResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otajobpage.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: OTA升级批次详情查询
     * Summary: OTA升级批次详情查询
     * @param QueryElectrocarOtajobdetailRequest $request
     * @return QueryElectrocarOtajobdetailResponse
     */
    public function queryElectrocarOtajobdetail($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryElectrocarOtajobdetailResponse
     */
    public function queryElectrocarOtajobdetailEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarOtajobdetailResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otajobdetail.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 查询OTA升级任务分页列表
     * Summary: 查询OTA升级任务分页列表
     * @param QueryElectrocarOtataskpageRequest $request
     * @return QueryElectrocarOtataskpageResponse
     */
    public function queryElectrocarOtataskpage($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryElectrocarOtataskpageResponse
     */
    public function queryElectrocarOtataskpageEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarOtataskpageResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.otataskpage.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 统一物联设备分页列表查询
     * Summary: 统一物联设备分页列表查询
     * @param QueryElectrocarDevicepageRequest $request
     * @return QueryElectrocarDevicepageResponse
     */
    public function queryElectrocarDevicepage($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->queryElectrocarDevicepageEx($request, $headers, $runtime);
    }
     ...
     * @return QueryElectrocarDevicepageResponse
     */
    public function queryElectrocarDevicepageEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryElectrocarDevicepageResponse::fromMap($this->doRequest("1.0", "blockchain.bot.electrocar.devicepage.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 根据设备模块创建定向OTA批次
     * Summary: 根据设备模块创建定向OTA批次
     * @param PushElectrocarOtajobbymoduleRequest $request
     * @return PushElectrocarOtajobbymoduleResponse
     */
    public function pushElectrocarOtajobbymodule($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
    ...
    /**
     * Description: 获取id2 provision信息
     * Summary: 获取id2 provision信息
     * @param GetIdsquaredOtpRequest $request
     * @return GetIdsquaredOtpResponse
     */
    public function getIdsquaredOtp($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->getIdsquaredOtpEx($request, $headers, $runtime);
    }
     ...
     * @return GetIdsquaredOtpResponse
     */
    public function getIdsquaredOtpEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return GetIdsquaredOtpResponse::fromMap($this->doRequest("1.0", "blockchain.bot.idsquared.otp.get", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: id2鉴权加密服务
     * Summary: id2鉴权加密服务
     * @param EncryptIdsquaredAuthRequest $request
     * @return EncryptIdsquaredAuthResponse
     */
    public function encryptIdsquaredAuth($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
        return $this->encryptIdsquaredAuthEx($request, $headers, $runtime);
    }
