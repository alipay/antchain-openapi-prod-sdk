...
public class CreateThingmodelResponse extends TeaModel {
    ...
    public CreateThingmodelResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateThingmodelResponse setResultCode(String resultCode) {
    ...
    public CreateThingmodelResponse setResultMsg(String resultMsg) {
