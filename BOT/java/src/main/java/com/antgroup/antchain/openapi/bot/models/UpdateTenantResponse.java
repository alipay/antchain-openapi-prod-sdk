...
public class UpdateTenantResponse extends TeaModel {
    ...
    public UpdateTenantResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateTenantResponse setResultCode(String resultCode) {
    ...
    public UpdateTenantResponse setResultMsg(String resultMsg) {
