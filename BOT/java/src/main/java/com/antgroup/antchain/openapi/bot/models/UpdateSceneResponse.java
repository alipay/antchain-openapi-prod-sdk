...
public class UpdateSceneResponse extends TeaModel {
    ...
    public UpdateSceneResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateSceneResponse setResultCode(String resultCode) {
    ...
    public UpdateSceneResponse setResultMsg(String resultMsg) {
