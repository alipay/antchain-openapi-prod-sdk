...
public class CreateTaskResponse extends TeaModel {
    ...
    public CreateTaskResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateTaskResponse setResultCode(String resultCode) {
    ...
    public CreateTaskResponse setResultMsg(String resultMsg) {
