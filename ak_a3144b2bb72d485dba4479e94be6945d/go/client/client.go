...
type QueryDemoAaaAaaRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
}

func (s QueryDemoAaaAaaRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryDemoAaaAaaRequest) GoString() string {
	return s.String()
}

func (s *QueryDemoAaaAaaRequest) SetAuthToken(v string) *QueryDemoAaaAaaRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryDemoAaaAaaRequest) SetProductInstanceId(v string) *QueryDemoAaaAaaRequest {
	s.ProductInstanceId = &v
	return s
}

type QueryDemoAaaAaaResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryDemoAaaAaaResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryDemoAaaAaaResponse) GoString() string {
	return s.String()
}

func (s *QueryDemoAaaAaaResponse) SetReqMsgId(v string) *QueryDemoAaaAaaResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryDemoAaaAaaResponse) SetResultCode(v string) *QueryDemoAaaAaaResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryDemoAaaAaaResponse) SetResultMsg(v string) *QueryDemoAaaAaaResponse {
	s.ResultMsg = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("ak_a3144b2bb72d485dba4479e94be6945d"),
 ...
 * Summary: test
 */
func (client *Client) QueryDemoAaaAaa(request *QueryDemoAaaAaaRequest) (_result *QueryDemoAaaAaaResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryDemoAaaAaaResponse{}
	_body, _err := client.QueryDemoAaaAaaEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: test
 */
func (client *Client) QueryDemoAaaAaaEx(request *QueryDemoAaaAaaRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryDemoAaaAaaResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	_result = &QueryDemoAaaAaaResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("demo.aaa.aaa.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
