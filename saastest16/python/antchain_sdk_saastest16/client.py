...
from antchain_sdk_saastest16 import models as saas_test_16_models
...
class Client:
    ...
    def __init__(
        self, 
        config: saas_test_16_models.Config,
    ):
        """
    ...
    def service_antcloud_openapi_gateway_check(
        self,
        request: saas_test_16_models.ServiceAntcloudOpenapiGatewayCheckRequest,
    ) -> saas_test_16_models.ServiceAntcloudOpenapiGatewayCheckResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.service_antcloud_openapi_gateway_check_ex(request, headers, runtime)

    async def service_antcloud_openapi_gateway_check_async(
        self,
        request: saas_test_16_models.ServiceAntcloudOpenapiGatewayCheckRequest,
    ) -> saas_test_16_models.ServiceAntcloudOpenapiGatewayCheckResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.service_antcloud_openapi_gateway_check_ex_async(request, headers, runtime)

    def service_antcloud_openapi_gateway_check_ex(
        self,
        request: saas_test_16_models.ServiceAntcloudOpenapiGatewayCheckRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def service_antcloud_openapi_gateway_check_ex_async(
        self,
        request: saas_test_16_models.ServiceAntcloudOpenapiGatewayCheckRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def init_demo_bbp_insurance_user(
        self,
        request: saas_test_16_models.InitDemoBbpInsuranceUserRequest,
    ) -> saas_test_16_models.InitDemoBbpInsuranceUserResponse:
        """
    ...
    def query_demo_gateway_check(
        self,
        request: saas_test_16_models.QueryDemoGatewayCheckRequest,
    ) -> saas_test_16_models.QueryDemoGatewayCheckResponse:
        """
        Description: ceshi
        Summary: ss
        """
