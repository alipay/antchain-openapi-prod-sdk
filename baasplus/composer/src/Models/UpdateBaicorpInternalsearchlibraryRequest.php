...
class UpdateBaicorpInternalsearchlibraryRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('entityData', $this->entityData, true);
        Model::validateRequired('entityDesc', $this->entityDesc, true);
     ...
     * @param array $map
     *
     * @return UpdateBaicorpInternalsearchlibraryRequest
     */
