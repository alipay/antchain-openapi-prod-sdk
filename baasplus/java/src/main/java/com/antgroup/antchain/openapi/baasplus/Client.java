...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "1.2.8"),
                    new TeaPair("_prod_code", "BAASPLUS"),
     ...
     * Summary: 企业基础信息查询
     */
    public QueryEnterpriseBaseinfoResponse queryEnterpriseBaseinfo(QueryEnterpriseBaseinfoRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 企业基础信息查询
     */
    public QueryEnterpriseBaseinfoResponse queryEnterpriseBaseinfoEx(QueryEnterpriseBaseinfoRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "baas.plus.enterprise.baseinfo.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryEnterpriseBaseinfoResponse());
    }
     ...
     * Summary: 企业工商信息查询能力
     */
    public QueryEnterpriseBusinessinfomationResponse queryEnterpriseBusinessinfomation(QueryEnterpriseBusinessinfomationRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryEnterpriseBusinessinfomationEx(request, headers, runtime);
    }
     ...
     * Summary: 企业工商信息查询能力
     */
    public QueryEnterpriseBusinessinfomationResponse queryEnterpriseBusinessinfomationEx(QueryEnterpriseBusinessinfomationRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "baas.plus.enterprise.businessinfomation.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryEnterpriseBusinessinfomationResponse());
    }
}
