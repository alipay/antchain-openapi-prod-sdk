...
package com.antgroup.antchain.openapi.ak_039036ceaf344eae826f7a5f2e0c0a1a;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.ak_039036ceaf344eae826f7a5f2e0c0a1a.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("_prod_code", "ak_039036ceaf344eae826f7a5f2e0c0a1a"),
     ...
     * Summary: api评审测试
     */
    public QueryDemoApprovalTestResponse queryDemoApprovalTest(QueryDemoApprovalTestRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: api评审测试
     */
    public QueryDemoApprovalTestResponse queryDemoApprovalTestEx(QueryDemoApprovalTestRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "demo.approval.test.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDemoApprovalTestResponse());
    }
}
