...
using AntChain.SDK.Ak_b0bf8e7efff240d69678028eeb721a2f.Models;

namespace AntChain.SDK.Ak_b0bf8e7efff240d69678028eeb721a2f
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_b0bf8e7efff240d69678028eeb721a2f"},
                        {"_prod_channel", "saas"},
                    };
