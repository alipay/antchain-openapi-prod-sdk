...
class UploadMaxCopilotKnowledgeRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class UploadMaxCopilotKnowledgeResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('knowledge_id') is not None:
            self.knowledge_id = m.get('knowledge_id')
        return self


class QueryMaxCopilotFinRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryMaxCopilotFinResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryMaxCopilotFileRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryMaxCopilotFileResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class GetMaxCopilotFinRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class GetMaxCopilotFinResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class GetMaxCopilotFileRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class GetMaxCopilotFileResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
