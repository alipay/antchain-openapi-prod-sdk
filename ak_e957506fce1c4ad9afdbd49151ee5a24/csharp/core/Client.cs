...
using AntChain.SDK.Ak_e957506fce1c4ad9afdbd49151ee5a24.Models;

namespace AntChain.SDK.Ak_e957506fce1c4ad9afdbd49151ee5a24
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_e957506fce1c4ad9afdbd49151ee5a24"},
                        {"_prod_channel", "saas"},
                    };
