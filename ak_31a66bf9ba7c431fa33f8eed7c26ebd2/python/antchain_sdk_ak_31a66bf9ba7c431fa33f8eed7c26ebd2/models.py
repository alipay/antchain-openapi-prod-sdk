...
class QueryAntcloudSmartaccountPaymentRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class QueryAntcloudSmartaccountPaymentResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class SubmitAntcloudSmartaccountPaymentRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        sys_param: SystemParam = None,
...
class SubmitAntcloudSmartaccountPaymentResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
