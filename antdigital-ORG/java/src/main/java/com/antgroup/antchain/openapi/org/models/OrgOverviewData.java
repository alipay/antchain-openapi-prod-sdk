...
public class OrgOverviewData extends TeaModel {
     ...
     * <p>2.1</p>
     */
    @NameInMap("huabei_roi")
    @Validation(required = true)
    public String huabeiRoi;
     ...
     * <p>2.1</p>
     */
    @NameInMap("jiebei_roi")
    @Validation(required = true)
    public String jiebeiRoi;
     ...
     * <p>2.1</p>
     */
    @NameInMap("xiaowei_roi")
    @Validation(required = true)
    public String xiaoweiRoi;
    ...
    public OrgOverviewData setHuabeiRoi(String huabeiRoi) {
        this.huabeiRoi = huabeiRoi;
        return this;
    }
    public String getHuabeiRoi() {
        return this.huabeiRoi;
    }

    public OrgOverviewData setJiebeiRoi(String jiebeiRoi) {
        this.jiebeiRoi = jiebeiRoi;
        return this;
    }
    public String getJiebeiRoi() {
        return this.jiebeiRoi;
    }

    public OrgOverviewData setXiaoweiRoi(String xiaoweiRoi) {
        this.xiaoweiRoi = xiaoweiRoi;
        return this;
    }
    public String getXiaoweiRoi() {
        return this.xiaoweiRoi;
    }
