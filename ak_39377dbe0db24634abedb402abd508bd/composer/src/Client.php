...
namespace AntChain\Ak_39377dbe0db24634abedb402abd508bd;
...
use AntChain\Ak_39377dbe0db24634abedb402abd508bd\Models\ConfirmAntchainBbpContractReconciliationRequest;
use AntChain\Ak_39377dbe0db24634abedb402abd508bd\Models\ConfirmAntchainBbpContractReconciliationResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_39377dbe0db24634abedb402abd508bd',
                    '_prod_channel'    => 'saas',
                ];
