...
public class DeleteDepartmentResponse extends TeaModel {
    ...
    public DeleteDepartmentResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteDepartmentResponse setResultCode(String resultCode) {
    ...
    public DeleteDepartmentResponse setResultMsg(String resultMsg) {
