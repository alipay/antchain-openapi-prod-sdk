...
public class CreateDepartmentResponse extends TeaModel {
    ...
    public CreateDepartmentResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateDepartmentResponse setResultCode(String resultCode) {
    ...
    public CreateDepartmentResponse setResultMsg(String resultMsg) {
