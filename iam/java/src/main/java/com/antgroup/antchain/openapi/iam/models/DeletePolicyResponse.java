...
public class DeletePolicyResponse extends TeaModel {
    ...
    public DeletePolicyResponse setReqMsgId(String reqMsgId) {
    ...
    public DeletePolicyResponse setResultCode(String resultCode) {
    ...
    public DeletePolicyResponse setResultMsg(String resultMsg) {
