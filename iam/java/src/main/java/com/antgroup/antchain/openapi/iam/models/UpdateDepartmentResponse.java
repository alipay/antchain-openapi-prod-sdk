...
public class UpdateDepartmentResponse extends TeaModel {
    ...
    public UpdateDepartmentResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateDepartmentResponse setResultCode(String resultCode) {
    ...
    public UpdateDepartmentResponse setResultMsg(String resultMsg) {
