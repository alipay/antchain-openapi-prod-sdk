...
type QuerySaasSecurityPolicyRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 风控事件咨询查询入参
...
func (s QuerySaasSecurityPolicyRequest) String() string {
	return tea.Prettify(s)
}

func (s QuerySaasSecurityPolicyRequest) GoString() string {
	return s.String()
}

func (s *QuerySaasSecurityPolicyRequest) SetAuthToken(v string) *QuerySaasSecurityPolicyRequest {
	s.AuthToken = &v
	return s
}

func (s *QuerySaasSecurityPolicyRequest) SetProductInstanceId(v string) *QuerySaasSecurityPolicyRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QuerySaasSecurityPolicyRequest) SetEventInfo(v *EventInfo) *QuerySaasSecurityPolicyRequest {
	s.EventInfo = v
	return s
}

func (s *QuerySaasSecurityPolicyRequest) SetRiskType(v string) *QuerySaasSecurityPolicyRequest {
	s.RiskType = &v
	return s
}

type QuerySaasSecurityPolicyResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QuerySaasSecurityPolicyResponse) String() string {
	return tea.Prettify(s)
}

func (s QuerySaasSecurityPolicyResponse) GoString() string {
	return s.String()
}

func (s *QuerySaasSecurityPolicyResponse) SetReqMsgId(v string) *QuerySaasSecurityPolicyResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QuerySaasSecurityPolicyResponse) SetResultCode(v string) *QuerySaasSecurityPolicyResponse {
	s.ResultCode = &v
	return s
}

func (s *QuerySaasSecurityPolicyResponse) SetResultMsg(v string) *QuerySaasSecurityPolicyResponse {
	s.ResultMsg = &v
	return s
}

func (s *QuerySaasSecurityPolicyResponse) SetModelDetails(v []*ModelDetails) *QuerySaasSecurityPolicyResponse {
	s.ModelDetails = v
	return s
}

func (s *QuerySaasSecurityPolicyResponse) SetSecurityId(v string) *QuerySaasSecurityPolicyResponse {
	s.SecurityId = &v
	return s
}

func (s *QuerySaasSecurityPolicyResponse) SetSecurityResult(v string) *QuerySaasSecurityPolicyResponse {
	s.SecurityResult = &v
	return s
}

func (s *QuerySaasSecurityPolicyResponse) SetStrategyDetails(v []*StrategyDetails) *QuerySaasSecurityPolicyResponse {
	s.StrategyDetails = v
	return s
}
...
func (s *UploadDubbridgeFileRequest) SetFileType(v string) *UploadDubbridgeFileRequest {
	s.FileType = &v
	return s
}
...
func (s *BindDubbridgeCustomerBankcardRequest) SetCustomerNo(v string) *BindDubbridgeCustomerBankcardRequest {
	s.CustomerNo = &v
	return s
}
...
func (s *BindDubbridgeCustomerBankcardRequest) SetCustomName(v string) *BindDubbridgeCustomerBankcardRequest {
	s.CustomName = &v
	return s
}

func (s *BindDubbridgeCustomerBankcardRequest) SetOpenId(v string) *BindDubbridgeCustomerBankcardRequest {
	s.OpenId = &v
	return s
}

func (s *BindDubbridgeCustomerBankcardRequest) SetCardNo(v string) *BindDubbridgeCustomerBankcardRequest {
	s.CardNo = &v
	return s
}
...
func (s *BindDubbridgeCustomerBankcardResponse) SetCustomerNo(v string) *BindDubbridgeCustomerBankcardResponse {
	s.CustomerNo = &v
	return s
}
...
type VerifyDubbridgeCustomerBankcardRequest struct {
	...
	// 绑卡验证码
	BindValidCode *string `json:"bind_valid_code,omitempty" xml:"bind_valid_code,omitempty" require:"true"`
	// 银行卡号
	BankCardNo *string `json:"bank_card_no,omitempty" xml:"bank_card_no,omitempty" require:"true"`
	// 渠道号
	ChannelCode *string `json:"channel_code,omitempty" xml:"channel_code,omitempty" require:"true"`
...
func (s *VerifyDubbridgeCustomerBankcardRequest) SetOrderNo(v string) *VerifyDubbridgeCustomerBankcardRequest {
	s.OrderNo = &v
	return s
}
...
func (s *VerifyDubbridgeCustomerBankcardRequest) SetBindSerialNo(v string) *VerifyDubbridgeCustomerBankcardRequest {
	s.BindSerialNo = &v
	return s
}

func (s *VerifyDubbridgeCustomerBankcardRequest) SetBindValidCode(v string) *VerifyDubbridgeCustomerBankcardRequest {
	s.BindValidCode = &v
	return s
}

func (s *VerifyDubbridgeCustomerBankcardRequest) SetBankCardNo(v string) *VerifyDubbridgeCustomerBankcardRequest {
	s.BankCardNo = &v
	return s
}

func (s *VerifyDubbridgeCustomerBankcardRequest) SetChannelCode(v string) *VerifyDubbridgeCustomerBankcardRequest {
	s.ChannelCode = &v
	return s
}
...
func (s *VerifyDubbridgeCustomerBankcardResponse) SetBindSerialNo(v string) *VerifyDubbridgeCustomerBankcardResponse {
	s.BindSerialNo = &v
	return s
}

func (s *VerifyDubbridgeCustomerBankcardResponse) SetSignResult(v string) *VerifyDubbridgeCustomerBankcardResponse {
	s.SignResult = &v
	return s
}
...
func (s *QueryDubbridgeCreditStatusResponse) SetFundCode(v string) *QueryDubbridgeCreditStatusResponse {
	s.FundCode = &v
	return s
}
...
type UpdateDubbridgeInstitutionCreditRequest struct {
	...
	CreditExpireDate *string `json:"credit_expire_date,omitempty" xml:"credit_expire_date,omitempty"`
}
...
func (s *UpdateDubbridgeInstitutionCreditRequest) SetCreditExpireDate(v string) *UpdateDubbridgeInstitutionCreditRequest {
	s.CreditExpireDate = &v
	return s
}
...
func (s *ApplyDubbridgeCustomerAgreementsignRequest) SetChannelCode(v string) *ApplyDubbridgeCustomerAgreementsignRequest {
	s.ChannelCode = &v
	return s
}

func (s *ApplyDubbridgeCustomerAgreementsignRequest) SetProjectCode(v string) *ApplyDubbridgeCustomerAgreementsignRequest {
	s.ProjectCode = &v
	return s
}

func (s *ApplyDubbridgeCustomerAgreementsignRequest) SetOrgCode(v string) *ApplyDubbridgeCustomerAgreementsignRequest {
	s.OrgCode = &v
	return s
}
...
func (s *QueryDubbridgeAccountStatusRequest) SetBizType(v string) *QueryDubbridgeAccountStatusRequest {
	s.BizType = &v
	return s
}

func (s *QueryDubbridgeAccountStatusRequest) SetChannelCode(v string) *QueryDubbridgeAccountStatusRequest {
	s.ChannelCode = &v
	return s
}

func (s *QueryDubbridgeAccountStatusRequest) SetOrgCode(v string) *QueryDubbridgeAccountStatusRequest {
	s.OrgCode = &v
	return s
}
...
type QueryDubbridgeAccountStatusResponse struct {
	...
	// 支付账户签约结果
	PayMethodLockResult *PayMethodLockResult `json:"pay_method_lock_result,omitempty" xml:"pay_method_lock_result,omitempty"`
	// 支付账户锁定结果
	FundChainLockResult []*FundChainLockResult `json:"fund_chain_lock_result,omitempty" xml:"fund_chain_lock_result,omitempty" type:"Repeated"`
}
...
func (s *QueryDubbridgeAccountStatusResponse) SetPayMethodLockResult(v *PayMethodLockResult) *QueryDubbridgeAccountStatusResponse {
	s.PayMethodLockResult = v
	return s
}

func (s *QueryDubbridgeAccountStatusResponse) SetFundChainLockResult(v []*FundChainLockResult) *QueryDubbridgeAccountStatusResponse {
	s.FundChainLockResult = v
	return s
}
...
func (s *QueryDubbridgeCustomerAgreementsignResponse) SetCustomName(v string) *QueryDubbridgeCustomerAgreementsignResponse {
	s.CustomName = &v
	return s
}

func (s *QueryDubbridgeCustomerAgreementsignResponse) SetAlipayUserId(v string) *QueryDubbridgeCustomerAgreementsignResponse {
	s.AlipayUserId = &v
	return s
}

func (s *QueryDubbridgeCustomerAgreementsignResponse) SetProtocolNo(v string) *QueryDubbridgeCustomerAgreementsignResponse {
	s.ProtocolNo = &v
	return s
}
...
func (s *CountDubbridgeRepayReftrialRequest) SetRepayDate(v string) *CountDubbridgeRepayReftrialRequest {
	s.RepayDate = &v
	return s
}
...
type CountDubbridgeRepayReftrialResponse struct {
	...
	RepayAccount *string `json:"repay_account,omitempty" xml:"repay_account,omitempty"`
	// 总利息
	TotalInterest *int64 `json:"total_interest,omitempty" xml:"total_interest,omitempty"`
	// 授信信息
...
func (s *CountDubbridgeRepayReftrialResponse) SetRepayDate(v string) *CountDubbridgeRepayReftrialResponse {
	s.RepayDate = &v
	return s
}

func (s *CountDubbridgeRepayReftrialResponse) SetRepayAccount(v string) *CountDubbridgeRepayReftrialResponse {
	s.RepayAccount = &v
	return s
}

func (s *CountDubbridgeRepayReftrialResponse) SetTotalInterest(v int64) *CountDubbridgeRepayReftrialResponse {
	s.TotalInterest = &v
	return s
}

func (s *CountDubbridgeRepayReftrialResponse) SetApplyInfo(v *ApplyInfo) *CountDubbridgeRepayReftrialResponse {
	s.ApplyInfo = v
	return s
}
...
func (s *ApplyDubbridgeUsecreditRequest) SetChannelType(v string) *ApplyDubbridgeUsecreditRequest {
	s.ChannelType = &v
	return s
}
...
type QueryDubbridgeCustomerCommonagreementsignRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 订单号
...
func (s QueryDubbridgeCustomerCommonagreementsignRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryDubbridgeCustomerCommonagreementsignRequest) GoString() string {
	return s.String()
}

func (s *QueryDubbridgeCustomerCommonagreementsignRequest) SetAuthToken(v string) *QueryDubbridgeCustomerCommonagreementsignRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignRequest) SetProductInstanceId(v string) *QueryDubbridgeCustomerCommonagreementsignRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignRequest) SetOrderNo(v string) *QueryDubbridgeCustomerCommonagreementsignRequest {
	s.OrderNo = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignRequest) SetCustomNo(v string) *QueryDubbridgeCustomerCommonagreementsignRequest {
	s.CustomNo = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignRequest) SetFundCode(v string) *QueryDubbridgeCustomerCommonagreementsignRequest {
	s.FundCode = &v
	return s
}

type QueryDubbridgeCustomerCommonagreementsignResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	Status *string `json:"status,omitempty" xml:"status,omitempty"`
	// 签约用户唯一标识
	AccountUserId *string `json:"account_user_id,omitempty" xml:"account_user_id,omitempty"`
	// 脱敏的签约账号
...
func (s QueryDubbridgeCustomerCommonagreementsignResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryDubbridgeCustomerCommonagreementsignResponse) GoString() string {
	return s.String()
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetReqMsgId(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetResultCode(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetResultMsg(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetCustomNo(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.CustomNo = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetCustomName(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.CustomName = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetTransSerials(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.TransSerials = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetStatus(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.Status = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetAccountUserId(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.AccountUserId = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetAccountNo(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.AccountNo = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetProtocolNo(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.ProtocolNo = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetSignTime(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.SignTime = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetValidTime(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.ValidTime = &v
	return s
}

func (s *QueryDubbridgeCustomerCommonagreementsignResponse) SetInvalidTime(v string) *QueryDubbridgeCustomerCommonagreementsignResponse {
	s.InvalidTime = &v
	return s
}
...
type UpdateDubbridgeFileRequest struct {
	...
	CustomNo *string `json:"custom_no,omitempty" xml:"custom_no,omitempty" require:"true"`
	// 资料文件
	Materials []*Material `json:"materials,omitempty" xml:"materials,omitempty" require:"true" type:"Repeated"`
}

func (s UpdateDubbridgeFileRequest) String() string {
	return tea.Prettify(s)
}

func (s UpdateDubbridgeFileRequest) GoString() string {
	return s.String()
}

func (s *UpdateDubbridgeFileRequest) SetAuthToken(v string) *UpdateDubbridgeFileRequest {
	s.AuthToken = &v
	return s
}

func (s *UpdateDubbridgeFileRequest) SetProductInstanceId(v string) *UpdateDubbridgeFileRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *UpdateDubbridgeFileRequest) SetOrderNo(v string) *UpdateDubbridgeFileRequest {
	s.OrderNo = &v
	return s
}

func (s *UpdateDubbridgeFileRequest) SetOriginalOrderNo(v string) *UpdateDubbridgeFileRequest {
	s.OriginalOrderNo = &v
	return s
}

func (s *UpdateDubbridgeFileRequest) SetCustomNo(v string) *UpdateDubbridgeFileRequest {
	s.CustomNo = &v
	return s
}

func (s *UpdateDubbridgeFileRequest) SetMaterials(v []*Material) *UpdateDubbridgeFileRequest {
	s.Materials = v
	return s
}

type UpdateDubbridgeFileResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s UpdateDubbridgeFileResponse) String() string {
	return tea.Prettify(s)
}

func (s UpdateDubbridgeFileResponse) GoString() string {
	return s.String()
}

func (s *UpdateDubbridgeFileResponse) SetReqMsgId(v string) *UpdateDubbridgeFileResponse {
	s.ReqMsgId = &v
	return s
}

func (s *UpdateDubbridgeFileResponse) SetResultCode(v string) *UpdateDubbridgeFileResponse {
	s.ResultCode = &v
	return s
}
...
type NotifyDubbridgeCallbackRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 租户id
...
func (s NotifyDubbridgeCallbackRequest) GoString() string {
	return s.String()
}

func (s *NotifyDubbridgeCallbackRequest) SetAuthToken(v string) *NotifyDubbridgeCallbackRequest {
	s.AuthToken = &v
	return s
}

func (s *NotifyDubbridgeCallbackRequest) SetProductInstanceId(v string) *NotifyDubbridgeCallbackRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *NotifyDubbridgeCallbackRequest) SetChannelCode(v string) *NotifyDubbridgeCallbackRequest {
	s.ChannelCode = &v
	return s
}

func (s *NotifyDubbridgeCallbackRequest) SetBizParam(v string) *NotifyDubbridgeCallbackRequest {
	s.BizParam = &v
	return s
}
...
type NotifyDubbridgeCallbackResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	//
	// 处理结果
	Data *CommonNotyfyResult `json:"data,omitempty" xml:"data,omitempty"`
}

func (s NotifyDubbridgeCallbackResponse) String() string {
	return tea.Prettify(s)
}

func (s NotifyDubbridgeCallbackResponse) GoString() string {
	return s.String()
}

func (s *NotifyDubbridgeCallbackResponse) SetReqMsgId(v string) *NotifyDubbridgeCallbackResponse {
	s.ReqMsgId = &v
	return s
}

func (s *NotifyDubbridgeCallbackResponse) SetResultCode(v string) *NotifyDubbridgeCallbackResponse {
	s.ResultCode = &v
	return s
}

func (s *NotifyDubbridgeCallbackResponse) SetResultMsg(v string) *NotifyDubbridgeCallbackResponse {
	s.ResultMsg = &v
	return s
}

func (s *NotifyDubbridgeCallbackResponse) SetData(v *CommonNotyfyResult) *NotifyDubbridgeCallbackResponse {
	s.Data = v
	return s
}

type QueryDubbridgeRepayResultRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 订单号
...
func (s QueryDubbridgeRepayResultRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryDubbridgeRepayResultRequest) GoString() string {
	return s.String()
}

func (s *QueryDubbridgeRepayResultRequest) SetAuthToken(v string) *QueryDubbridgeRepayResultRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryDubbridgeRepayResultRequest) SetProductInstanceId(v string) *QueryDubbridgeRepayResultRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryDubbridgeRepayResultRequest) SetOrderNo(v string) *QueryDubbridgeRepayResultRequest {
	s.OrderNo = &v
	return s
}

func (s *QueryDubbridgeRepayResultRequest) SetOriginalOrderNo(v string) *QueryDubbridgeRepayResultRequest {
	s.OriginalOrderNo = &v
	return s
}

type QueryDubbridgeRepayResultResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryDubbridgeRepayResultResponse) GoString() string {
	return s.String()
}

func (s *QueryDubbridgeRepayResultResponse) SetReqMsgId(v string) *QueryDubbridgeRepayResultResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetResultCode(v string) *QueryDubbridgeRepayResultResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetResultMsg(v string) *QueryDubbridgeRepayResultResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetRepayNo(v string) *QueryDubbridgeRepayResultResponse {
	s.RepayNo = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetReceiptNo(v string) *QueryDubbridgeRepayResultResponse {
	s.ReceiptNo = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetCustomNo(v string) *QueryDubbridgeRepayResultResponse {
	s.CustomNo = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetRepayType(v string) *QueryDubbridgeRepayResultResponse {
	s.RepayType = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetRepaySign(v string) *QueryDubbridgeRepayResultResponse {
	s.RepaySign = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetRepayAccount(v string) *QueryDubbridgeRepayResultResponse {
	s.RepayAccount = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetRepayStatus(v string) *QueryDubbridgeRepayResultResponse {
	s.RepayStatus = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetFailReason(v string) *QueryDubbridgeRepayResultResponse {
	s.FailReason = &v
	return s
}

func (s *QueryDubbridgeRepayResultResponse) SetRepayInfos(v []*RepayInfos) *QueryDubbridgeRepayResultResponse {
	s.RepayInfos = v
	return s
}
...
type ReceiveMdipParamsFileResponse struct {
	...
	ResultMsg *string `json:"result_msg,omitempty" xml:"result_msg,omitempty"`
	// 文件上传结果
	Content *RuntimeResult `json:"content,omitempty" xml:"content,omitempty"`
}
...
type SendQmpDigitalsmsBatchRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// cpassAccessKey
	...
	TemplateCode *string `json:"template_code,omitempty" xml:"template_code,omitempty" require:"true"`
	// 短信模板参数
	TemplateParam *string `json:"template_param,omitempty" xml:"template_param,omitempty" require:"true"`
	// 透传字段
	OutId *string `json:"out_id,omitempty" xml:"out_id,omitempty"`
}

func (s SendQmpDigitalsmsBatchRequest) String() string {
	return tea.Prettify(s)
}

func (s SendQmpDigitalsmsBatchRequest) GoString() string {
	return s.String()
}

func (s *SendQmpDigitalsmsBatchRequest) SetAuthToken(v string) *SendQmpDigitalsmsBatchRequest {
	s.AuthToken = &v
	return s
}

func (s *SendQmpDigitalsmsBatchRequest) SetProductInstanceId(v string) *SendQmpDigitalsmsBatchRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *SendQmpDigitalsmsBatchRequest) SetCpassAk(v string) *SendQmpDigitalsmsBatchRequest {
	s.CpassAk = &v
	return s
}

func (s *SendQmpDigitalsmsBatchRequest) SetIndustryTag(v string) *SendQmpDigitalsmsBatchRequest {
	s.IndustryTag = &v
	return s
}

func (s *SendQmpDigitalsmsBatchRequest) SetPhoneNumbers(v string) *SendQmpDigitalsmsBatchRequest {
	s.PhoneNumbers = &v
	return s
}

func (s *SendQmpDigitalsmsBatchRequest) SetTemplateCode(v string) *SendQmpDigitalsmsBatchRequest {
	s.TemplateCode = &v
	return s
}

func (s *SendQmpDigitalsmsBatchRequest) SetTemplateParam(v string) *SendQmpDigitalsmsBatchRequest {
	s.TemplateParam = &v
	return s
}

func (s *SendQmpDigitalsmsBatchRequest) SetOutId(v string) *SendQmpDigitalsmsBatchRequest {
	s.OutId = &v
	return s
}

type SendQmpDigitalsmsBatchResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s SendQmpDigitalsmsBatchResponse) String() string {
	return tea.Prettify(s)
}

func (s SendQmpDigitalsmsBatchResponse) GoString() string {
	return s.String()
}

func (s *SendQmpDigitalsmsBatchResponse) SetReqMsgId(v string) *SendQmpDigitalsmsBatchResponse {
	s.ReqMsgId = &v
	return s
}

func (s *SendQmpDigitalsmsBatchResponse) SetResultCode(v string) *SendQmpDigitalsmsBatchResponse {
	s.ResultCode = &v
	return s
}

func (s *SendQmpDigitalsmsBatchResponse) SetResultMsg(v string) *SendQmpDigitalsmsBatchResponse {
	s.ResultMsg = &v
	return s
}

func (s *SendQmpDigitalsmsBatchResponse) SetBizId(v string) *SendQmpDigitalsmsBatchResponse {
	s.BizId = &v
	return s
}

type CallbackQmpRobotcallRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 外呼号码，支持密文
...
func (s CallbackQmpRobotcallRequest) String() string {
	return tea.Prettify(s)
}

func (s CallbackQmpRobotcallRequest) GoString() string {
	return s.String()
}

func (s *CallbackQmpRobotcallRequest) SetAuthToken(v string) *CallbackQmpRobotcallRequest {
	s.AuthToken = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetProductInstanceId(v string) *CallbackQmpRobotcallRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetCustomerKey(v string) *CallbackQmpRobotcallRequest {
	s.CustomerKey = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetCurrentCallTimes(v int64) *CallbackQmpRobotcallRequest {
	s.CurrentCallTimes = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetKeyTemplate(v string) *CallbackQmpRobotcallRequest {
	s.KeyTemplate = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetBatchId(v string) *CallbackQmpRobotcallRequest {
	s.BatchId = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetCallType(v int64) *CallbackQmpRobotcallRequest {
	s.CallType = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetTag(v string) *CallbackQmpRobotcallRequest {
	s.Tag = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetCallId(v string) *CallbackQmpRobotcallRequest {
	s.CallId = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetTaskId(v int64) *CallbackQmpRobotcallRequest {
	s.TaskId = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetTaskName(v string) *CallbackQmpRobotcallRequest {
	s.TaskName = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetTemplateId(v int64) *CallbackQmpRobotcallRequest {
	s.TemplateId = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetStatusCode(v int64) *CallbackQmpRobotcallRequest {
	s.StatusCode = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetStatusDescription(v string) *CallbackQmpRobotcallRequest {
	s.StatusDescription = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetTransferStatusCode(v string) *CallbackQmpRobotcallRequest {
	s.TransferStatusCode = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetTransferStatus(v string) *CallbackQmpRobotcallRequest {
	s.TransferStatus = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAgentId(v int64) *CallbackQmpRobotcallRequest {
	s.AgentId = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAgentTag(v string) *CallbackQmpRobotcallRequest {
	s.AgentTag = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAgentExtension(v string) *CallbackQmpRobotcallRequest {
	s.AgentExtension = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetImportTime(v string) *CallbackQmpRobotcallRequest {
	s.ImportTime = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetCallBeginTime(v string) *CallbackQmpRobotcallRequest {
	s.CallBeginTime = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetRingTime(v int64) *CallbackQmpRobotcallRequest {
	s.RingTime = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAnswerTime(v string) *CallbackQmpRobotcallRequest {
	s.AnswerTime = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetSpeakingTime(v string) *CallbackQmpRobotcallRequest {
	s.SpeakingTime = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetSpeakingDuration(v int64) *CallbackQmpRobotcallRequest {
	s.SpeakingDuration = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetHangupTime(v string) *CallbackQmpRobotcallRequest {
	s.HangupTime = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetSpeakingTurns(v int64) *CallbackQmpRobotcallRequest {
	s.SpeakingTurns = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAgentSpeakingTime(v string) *CallbackQmpRobotcallRequest {
	s.AgentSpeakingTime = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAgentSpeakingDuration(v int64) *CallbackQmpRobotcallRequest {
	s.AgentSpeakingDuration = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetIntentTag(v string) *CallbackQmpRobotcallRequest {
	s.IntentTag = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetIntentDescription(v string) *CallbackQmpRobotcallRequest {
	s.IntentDescription = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetIndividualTag(v string) *CallbackQmpRobotcallRequest {
	s.IndividualTag = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetKeywords(v string) *CallbackQmpRobotcallRequest {
	s.Keywords = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetHungupType(v int64) *CallbackQmpRobotcallRequest {
	s.HungupType = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetSms(v int64) *CallbackQmpRobotcallRequest {
	s.Sms = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetChatRecord(v string) *CallbackQmpRobotcallRequest {
	s.ChatRecord = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetChats(v string) *CallbackQmpRobotcallRequest {
	s.Chats = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAddWx(v int64) *CallbackQmpRobotcallRequest {
	s.AddWx = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAddWxStatus(v string) *CallbackQmpRobotcallRequest {
	s.AddWxStatus = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetAnswerRecall(v int64) *CallbackQmpRobotcallRequest {
	s.AnswerRecall = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetProperties(v string) *CallbackQmpRobotcallRequest {
	s.Properties = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetBizProperties(v string) *CallbackQmpRobotcallRequest {
	s.BizProperties = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetInterceptReason(v string) *CallbackQmpRobotcallRequest {
	s.InterceptReason = &v
	return s
}

func (s *CallbackQmpRobotcallRequest) SetExtInfo(v string) *CallbackQmpRobotcallRequest {
	s.ExtInfo = &v
	return s
}

type CallbackQmpRobotcallResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s CallbackQmpRobotcallResponse) String() string {
	return tea.Prettify(s)
}

func (s CallbackQmpRobotcallResponse) GoString() string {
	return s.String()
}

func (s *CallbackQmpRobotcallResponse) SetReqMsgId(v string) *CallbackQmpRobotcallResponse {
	s.ReqMsgId = &v
	return s
}

func (s *CallbackQmpRobotcallResponse) SetResultCode(v string) *CallbackQmpRobotcallResponse {
	s.ResultCode = &v
	return s
}

func (s *CallbackQmpRobotcallResponse) SetResultMsg(v string) *CallbackQmpRobotcallResponse {
	s.ResultMsg = &v
	return s
}

type QueryQmpRobotcallDetailRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 批次号
...
func (s QueryQmpRobotcallDetailRequest) GoString() string {
	return s.String()
}

func (s *QueryQmpRobotcallDetailRequest) SetAuthToken(v string) *QueryQmpRobotcallDetailRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryQmpRobotcallDetailRequest) SetProductInstanceId(v string) *QueryQmpRobotcallDetailRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryQmpRobotcallDetailRequest) SetBizId(v string) *QueryQmpRobotcallDetailRequest {
	s.BizId = &v
	return s
}

func (s *QueryQmpRobotcallDetailRequest) SetPhoneNumber(v string) *QueryQmpRobotcallDetailRequest {
	s.PhoneNumber = &v
	return s
}

func (s *QueryQmpRobotcallDetailRequest) SetTemplateType(v string) *QueryQmpRobotcallDetailRequest {
	s.TemplateType = &v
	return s
}
...
type QueryQmpRobotcallDetailResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryQmpRobotcallDetailResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryQmpRobotcallDetailResponse) GoString() string {
	return s.String()
}

func (s *QueryQmpRobotcallDetailResponse) SetReqMsgId(v string) *QueryQmpRobotcallDetailResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryQmpRobotcallDetailResponse) SetResultCode(v string) *QueryQmpRobotcallDetailResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryQmpRobotcallDetailResponse) SetResultMsg(v string) *QueryQmpRobotcallDetailResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryQmpRobotcallDetailResponse) SetOutInfo(v string) *QueryQmpRobotcallDetailResponse {
	s.OutInfo = &v
	return s
}

func (s *QueryQmpRobotcallDetailResponse) SetCustomerOutInfo(v string) *QueryQmpRobotcallDetailResponse {
	s.CustomerOutInfo = &v
	return s
}

func (s *QueryQmpRobotcallDetailResponse) SetCallInfo(v []*AICallbackMessage) *QueryQmpRobotcallDetailResponse {
	s.CallInfo = v
	return s
}

type QueryQmpDataaccessStatisticRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 查询回执统计的任务id
...
func (s QueryQmpDataaccessStatisticRequest) GoString() string {
	return s.String()
}

func (s *QueryQmpDataaccessStatisticRequest) SetAuthToken(v string) *QueryQmpDataaccessStatisticRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryQmpDataaccessStatisticRequest) SetProductInstanceId(v string) *QueryQmpDataaccessStatisticRequest {
	s.ProductInstanceId = &v
	return s
}
...
type QueryQmpDataaccessStatisticResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryQmpDataaccessStatisticResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryQmpDataaccessStatisticResponse) GoString() string {
	return s.String()
}

func (s *QueryQmpDataaccessStatisticResponse) SetReqMsgId(v string) *QueryQmpDataaccessStatisticResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryQmpDataaccessStatisticResponse) SetResultCode(v string) *QueryQmpDataaccessStatisticResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryQmpDataaccessStatisticResponse) SetResultMsg(v string) *QueryQmpDataaccessStatisticResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryQmpDataaccessStatisticResponse) SetStatisticResult(v *StatisticResult) *QueryQmpDataaccessStatisticResponse {
	s.StatisticResult = v
	return s
}

func (s *QueryQmpDataaccessStatisticResponse) SetTaskStatus(v string) *QueryQmpDataaccessStatisticResponse {
	s.TaskStatus = &v
	return s
}

type QueryQmpRobotcallStatisticinfoRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 场景策略id
...
func (s QueryQmpRobotcallStatisticinfoRequest) GoString() string {
	return s.String()
}

func (s *QueryQmpRobotcallStatisticinfoRequest) SetAuthToken(v string) *QueryQmpRobotcallStatisticinfoRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoRequest) SetProductInstanceId(v string) *QueryQmpRobotcallStatisticinfoRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoRequest) SetSceneStrategyId(v int64) *QueryQmpRobotcallStatisticinfoRequest {
	s.SceneStrategyId = &v
	return s
}
...
type QueryQmpRobotcallStatisticinfoResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryQmpRobotcallStatisticinfoResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryQmpRobotcallStatisticinfoResponse) GoString() string {
	return s.String()
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetReqMsgId(v string) *QueryQmpRobotcallStatisticinfoResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetResultCode(v string) *QueryQmpRobotcallStatisticinfoResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetResultMsg(v string) *QueryQmpRobotcallStatisticinfoResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetTotalCount(v int64) *QueryQmpRobotcallStatisticinfoResponse {
	s.TotalCount = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetCallCount(v int64) *QueryQmpRobotcallStatisticinfoResponse {
	s.CallCount = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetCalleeCount(v int64) *QueryQmpRobotcallStatisticinfoResponse {
	s.CalleeCount = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetConnectCount(v int64) *QueryQmpRobotcallStatisticinfoResponse {
	s.ConnectCount = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetCallRate(v string) *QueryQmpRobotcallStatisticinfoResponse {
	s.CallRate = &v
	return s
}

func (s *QueryQmpRobotcallStatisticinfoResponse) SetConnectRate(v string) *QueryQmpRobotcallStatisticinfoResponse {
	s.ConnectRate = &v
	return s
}

type BatchqueryQmpTaskDetailRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 上传外呼任务返回的callId
...
func (s BatchqueryQmpTaskDetailRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryQmpTaskDetailRequest) SetAuthToken(v string) *BatchqueryQmpTaskDetailRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryQmpTaskDetailRequest) SetProductInstanceId(v string) *BatchqueryQmpTaskDetailRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryQmpTaskDetailRequest) SetBizId(v string) *BatchqueryQmpTaskDetailRequest {
	s.BizId = &v
	return s
}

func (s *BatchqueryQmpTaskDetailRequest) SetCustomerKeys(v []*string) *BatchqueryQmpTaskDetailRequest {
	s.CustomerKeys = v
	return s
}

func (s *BatchqueryQmpTaskDetailRequest) SetKeyTemplate(v string) *BatchqueryQmpTaskDetailRequest {
	s.KeyTemplate = &v
	return s
}

func (s *BatchqueryQmpTaskDetailRequest) SetSceneStrategyId(v int64) *BatchqueryQmpTaskDetailRequest {
	s.SceneStrategyId = &v
	return s
}

func (s *BatchqueryQmpTaskDetailRequest) SetCallDate(v string) *BatchqueryQmpTaskDetailRequest {
	s.CallDate = &v
	return s
}
...
type BatchqueryQmpTaskDetailResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	OutInfo *string `json:"out_info,omitempty" xml:"out_info,omitempty"`
	// 外呼记录列表
	CallInfo []*CommonRobotCallDetail `json:"call_info,omitempty" xml:"call_info,omitempty" type:"Repeated"`
}

func (s BatchqueryQmpTaskDetailResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryQmpTaskDetailResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryQmpTaskDetailResponse) SetReqMsgId(v string) *BatchqueryQmpTaskDetailResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryQmpTaskDetailResponse) SetResultCode(v string) *BatchqueryQmpTaskDetailResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryQmpTaskDetailResponse) SetResultMsg(v string) *BatchqueryQmpTaskDetailResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryQmpTaskDetailResponse) SetOutInfo(v string) *BatchqueryQmpTaskDetailResponse {
	s.OutInfo = &v
	return s
}

func (s *BatchqueryQmpTaskDetailResponse) SetCallInfo(v []*CommonRobotCallDetail) *BatchqueryQmpTaskDetailResponse {
	s.CallInfo = v
	return s
}

type QueryQmpCardsmsSupportRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// cpassAccessKey
...
func (s QueryQmpCardsmsSupportRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryQmpCardsmsSupportRequest) GoString() string {
	return s.String()
}

func (s *QueryQmpCardsmsSupportRequest) SetAuthToken(v string) *QueryQmpCardsmsSupportRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryQmpCardsmsSupportRequest) SetProductInstanceId(v string) *QueryQmpCardsmsSupportRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryQmpCardsmsSupportRequest) SetCpassAk(v string) *QueryQmpCardsmsSupportRequest {
	s.CpassAk = &v
	return s
}

func (s *QueryQmpCardsmsSupportRequest) SetIndustryTag(v string) *QueryQmpCardsmsSupportRequest {
	s.IndustryTag = &v
	return s
}

func (s *QueryQmpCardsmsSupportRequest) SetTemplateCode(v string) *QueryQmpCardsmsSupportRequest {
	s.TemplateCode = &v
	return s
}

func (s *QueryQmpCardsmsSupportRequest) SetMobiles(v string) *QueryQmpCardsmsSupportRequest {
	s.Mobiles = &v
	return s
}

type QueryQmpCardsmsSupportResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	ResultMsg *string `json:"result_msg,omitempty" xml:"result_msg,omitempty"`
	// 手机号卡片短信支持信息
	Datas *string `json:"datas,omitempty" xml:"datas,omitempty"`
}

func (s QueryQmpCardsmsSupportResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryQmpCardsmsSupportResponse) GoString() string {
	return s.String()
}

func (s *QueryQmpCardsmsSupportResponse) SetReqMsgId(v string) *QueryQmpCardsmsSupportResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryQmpCardsmsSupportResponse) SetResultCode(v string) *QueryQmpCardsmsSupportResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryQmpCardsmsSupportResponse) SetResultMsg(v string) *QueryQmpCardsmsSupportResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryQmpCardsmsSupportResponse) SetDatas(v string) *QueryQmpCardsmsSupportResponse {
	s.Datas = &v
	return s
}

type BatchqueryQmpActionplanDetailRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 场景策略id
...
func (s BatchqueryQmpActionplanDetailRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryQmpActionplanDetailRequest) SetAuthToken(v string) *BatchqueryQmpActionplanDetailRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryQmpActionplanDetailRequest) SetProductInstanceId(v string) *BatchqueryQmpActionplanDetailRequest {
	s.ProductInstanceId = &v
	return s
}
...
type BatchqueryQmpActionplanDetailResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	ResultMsg *string `json:"result_msg,omitempty" xml:"result_msg,omitempty"`
	// 触达策略详细信息
	ActionPlanDetailInfo []*ActionPlanDetailInfo `json:"action_plan_detail_info,omitempty" xml:"action_plan_detail_info,omitempty" type:"Repeated"`
}

func (s BatchqueryQmpActionplanDetailResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryQmpActionplanDetailResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryQmpActionplanDetailResponse) SetReqMsgId(v string) *BatchqueryQmpActionplanDetailResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryQmpActionplanDetailResponse) SetResultCode(v string) *BatchqueryQmpActionplanDetailResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryQmpActionplanDetailResponse) SetResultMsg(v string) *BatchqueryQmpActionplanDetailResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryQmpActionplanDetailResponse) SetActionPlanDetailInfo(v []*ActionPlanDetailInfo) *BatchqueryQmpActionplanDetailResponse {
	s.ActionPlanDetailInfo = v
	return s
}

type ApplyQmpPhonenumberstatusforsmsRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 12345
...
func (s ApplyQmpPhonenumberstatusforsmsRequest) String() string {
	return tea.Prettify(s)
}

func (s ApplyQmpPhonenumberstatusforsmsRequest) GoString() string {
	return s.String()
}

func (s *ApplyQmpPhonenumberstatusforsmsRequest) SetAuthToken(v string) *ApplyQmpPhonenumberstatusforsmsRequest {
	s.AuthToken = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsRequest) SetProductInstanceId(v string) *ApplyQmpPhonenumberstatusforsmsRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsRequest) SetCustomerKey(v string) *ApplyQmpPhonenumberstatusforsmsRequest {
	s.CustomerKey = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsRequest) SetParamTemplate(v string) *ApplyQmpPhonenumberstatusforsmsRequest {
	s.ParamTemplate = &v
	return s
}

type ApplyQmpPhonenumberstatusforsmsResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s ApplyQmpPhonenumberstatusforsmsResponse) String() string {
	return tea.Prettify(s)
}

func (s ApplyQmpPhonenumberstatusforsmsResponse) GoString() string {
	return s.String()
}

func (s *ApplyQmpPhonenumberstatusforsmsResponse) SetReqMsgId(v string) *ApplyQmpPhonenumberstatusforsmsResponse {
	s.ReqMsgId = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsResponse) SetResultCode(v string) *ApplyQmpPhonenumberstatusforsmsResponse {
	s.ResultCode = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsResponse) SetResultMsg(v string) *ApplyQmpPhonenumberstatusforsmsResponse {
	s.ResultMsg = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsResponse) SetCustomerKey(v string) *ApplyQmpPhonenumberstatusforsmsResponse {
	s.CustomerKey = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsResponse) SetStatus(v string) *ApplyQmpPhonenumberstatusforsmsResponse {
	s.Status = &v
	return s
}

func (s *ApplyQmpPhonenumberstatusforsmsResponse) SetCarrier(v string) *ApplyQmpPhonenumberstatusforsmsResponse {
	s.Carrier = &v
	return s
}

type BatchqueryQmpTenantActionplaninfoRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 渠道类型
...
func (s BatchqueryQmpTenantActionplaninfoRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryQmpTenantActionplaninfoRequest) SetAuthToken(v string) *BatchqueryQmpTenantActionplaninfoRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryQmpTenantActionplaninfoRequest) SetProductInstanceId(v string) *BatchqueryQmpTenantActionplaninfoRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryQmpTenantActionplaninfoRequest) SetContentType(v string) *BatchqueryQmpTenantActionplaninfoRequest {
	s.ContentType = &v
	return s
}

func (s *BatchqueryQmpTenantActionplaninfoRequest) SetPageNum(v int64) *BatchqueryQmpTenantActionplaninfoRequest {
	s.PageNum = &v
	return s
}
...
type BatchqueryQmpTenantActionplaninfoResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	ResultMsg *string `json:"result_msg,omitempty" xml:"result_msg,omitempty"`
	// 触达策略信息
	QueryResult []*ActionPlanDetailInfo `json:"query_result,omitempty" xml:"query_result,omitempty" type:"Repeated"`
	// 总数
	TotalCount *int64 `json:"total_count,omitempty" xml:"total_count,omitempty"`
}

func (s BatchqueryQmpTenantActionplaninfoResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryQmpTenantActionplaninfoResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryQmpTenantActionplaninfoResponse) SetReqMsgId(v string) *BatchqueryQmpTenantActionplaninfoResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryQmpTenantActionplaninfoResponse) SetResultCode(v string) *BatchqueryQmpTenantActionplaninfoResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryQmpTenantActionplaninfoResponse) SetResultMsg(v string) *BatchqueryQmpTenantActionplaninfoResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryQmpTenantActionplaninfoResponse) SetQueryResult(v []*ActionPlanDetailInfo) *BatchqueryQmpTenantActionplaninfoResponse {
	s.QueryResult = v
	return s
}

func (s *BatchqueryQmpTenantActionplaninfoResponse) SetTotalCount(v int64) *BatchqueryQmpTenantActionplaninfoResponse {
	s.TotalCount = &v
	return s
}

type QueryQmpTenantActionplaninfoRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 页码
...
func (s QueryQmpTenantActionplaninfoRequest) GoString() string {
	return s.String()
}

func (s *QueryQmpTenantActionplaninfoRequest) SetAuthToken(v string) *QueryQmpTenantActionplaninfoRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoRequest) SetProductInstanceId(v string) *QueryQmpTenantActionplaninfoRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoRequest) SetPageNum(v int64) *QueryQmpTenantActionplaninfoRequest {
	s.PageNum = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoRequest) SetPageSize(v int64) *QueryQmpTenantActionplaninfoRequest {
	s.PageSize = &v
	return s
}
...
type QueryQmpTenantActionplaninfoResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryQmpTenantActionplaninfoResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryQmpTenantActionplaninfoResponse) GoString() string {
	return s.String()
}

func (s *QueryQmpTenantActionplaninfoResponse) SetReqMsgId(v string) *QueryQmpTenantActionplaninfoResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoResponse) SetResultCode(v string) *QueryQmpTenantActionplaninfoResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoResponse) SetResultMsg(v string) *QueryQmpTenantActionplaninfoResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoResponse) SetQueryResult(v []*TenantActionPlanInfo) *QueryQmpTenantActionplaninfoResponse {
	s.QueryResult = v
	return s
}

func (s *QueryQmpTenantActionplaninfoResponse) SetPageNum(v int64) *QueryQmpTenantActionplaninfoResponse {
	s.PageNum = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoResponse) SetPageSize(v int64) *QueryQmpTenantActionplaninfoResponse {
	s.PageSize = &v
	return s
}

func (s *QueryQmpTenantActionplaninfoResponse) SetTotalCount(v int64) *QueryQmpTenantActionplaninfoResponse {
	s.TotalCount = &v
	return s
}
...
func (s *UploadUmktParamsFileResponse) SetTaskId(v int64) *UploadUmktParamsFileResponse {
	s.TaskId = &v
	return s
}
...
type QueryUmktDataaccessStatisticRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 查询回执统计的任务id
...
func (s QueryUmktDataaccessStatisticRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryUmktDataaccessStatisticRequest) GoString() string {
	return s.String()
}

func (s *QueryUmktDataaccessStatisticRequest) SetAuthToken(v string) *QueryUmktDataaccessStatisticRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryUmktDataaccessStatisticRequest) SetProductInstanceId(v string) *QueryUmktDataaccessStatisticRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryUmktDataaccessStatisticRequest) SetTaskId(v int64) *QueryUmktDataaccessStatisticRequest {
	s.TaskId = &v
	return s
}

type QueryUmktDataaccessStatisticResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryUmktDataaccessStatisticResponse) GoString() string {
	return s.String()
}

func (s *QueryUmktDataaccessStatisticResponse) SetReqMsgId(v string) *QueryUmktDataaccessStatisticResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryUmktDataaccessStatisticResponse) SetResultCode(v string) *QueryUmktDataaccessStatisticResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryUmktDataaccessStatisticResponse) SetResultMsg(v string) *QueryUmktDataaccessStatisticResponse {
	s.ResultMsg = &v
	return s
}
...
type CancelUmktDataaccessOfflinetaskRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 离线批量任务id
...
func (s CancelUmktDataaccessOfflinetaskRequest) String() string {
	return tea.Prettify(s)
}

func (s CancelUmktDataaccessOfflinetaskRequest) GoString() string {
	return s.String()
}

func (s *CancelUmktDataaccessOfflinetaskRequest) SetAuthToken(v string) *CancelUmktDataaccessOfflinetaskRequest {
	s.AuthToken = &v
	return s
}

func (s *CancelUmktDataaccessOfflinetaskRequest) SetProductInstanceId(v string) *CancelUmktDataaccessOfflinetaskRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *CancelUmktDataaccessOfflinetaskRequest) SetTaskId(v int64) *CancelUmktDataaccessOfflinetaskRequest {
	s.TaskId = &v
	return s
}

type CancelUmktDataaccessOfflinetaskResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s CancelUmktDataaccessOfflinetaskResponse) String() string {
	return tea.Prettify(s)
}

func (s CancelUmktDataaccessOfflinetaskResponse) GoString() string {
	return s.String()
}

func (s *CancelUmktDataaccessOfflinetaskResponse) SetReqMsgId(v string) *CancelUmktDataaccessOfflinetaskResponse {
	s.ReqMsgId = &v
	return s
}

func (s *CancelUmktDataaccessOfflinetaskResponse) SetResultCode(v string) *CancelUmktDataaccessOfflinetaskResponse {
	s.ResultCode = &v
	return s
}

func (s *CancelUmktDataaccessOfflinetaskResponse) SetResultMsg(v string) *CancelUmktDataaccessOfflinetaskResponse {
	s.ResultMsg = &v
	return s
}

type QueryUmktRtMarketingRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 场景策略id，决策重点
...
func (s QueryUmktRtMarketingRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryUmktRtMarketingRequest) GoString() string {
	return s.String()
}

func (s *QueryUmktRtMarketingRequest) SetAuthToken(v string) *QueryUmktRtMarketingRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryUmktRtMarketingRequest) SetProductInstanceId(v string) *QueryUmktRtMarketingRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryUmktRtMarketingRequest) SetSceneStrategyId(v int64) *QueryUmktRtMarketingRequest {
	s.SceneStrategyId = &v
	return s
}

func (s *QueryUmktRtMarketingRequest) SetQueryTemplate(v string) *QueryUmktRtMarketingRequest {
	s.QueryTemplate = &v
	return s
}

func (s *QueryUmktRtMarketingRequest) SetCustomerKey(v string) *QueryUmktRtMarketingRequest {
	s.CustomerKey = &v
	return s
}

func (s *QueryUmktRtMarketingRequest) SetBizSerialNo(v string) *QueryUmktRtMarketingRequest {
	s.BizSerialNo = &v
	return s
}

type QueryUmktRtMarketingResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	ResultMsg *string `json:"result_msg,omitempty" xml:"result_msg,omitempty"`
	// 实时单个营销结果
	QueryResult *CustomerUmktInfoModel `json:"query_result,omitempty" xml:"query_result,omitempty"`
}

func (s QueryUmktRtMarketingResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryUmktRtMarketingResponse) GoString() string {
	return s.String()
}

func (s *QueryUmktRtMarketingResponse) SetReqMsgId(v string) *QueryUmktRtMarketingResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryUmktRtMarketingResponse) SetResultCode(v string) *QueryUmktRtMarketingResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryUmktRtMarketingResponse) SetResultMsg(v string) *QueryUmktRtMarketingResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryUmktRtMarketingResponse) SetQueryResult(v *CustomerUmktInfoModel) *QueryUmktRtMarketingResponse {
	s.QueryResult = v
	return s
}

type PushUmktBackflowEventRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 回流事件id，对应租户回流事件id
...
func (s PushUmktBackflowEventRequest) String() string {
	return tea.Prettify(s)
}

func (s PushUmktBackflowEventRequest) GoString() string {
	return s.String()
}

func (s *PushUmktBackflowEventRequest) SetAuthToken(v string) *PushUmktBackflowEventRequest {
	s.AuthToken = &v
	return s
}

func (s *PushUmktBackflowEventRequest) SetProductInstanceId(v string) *PushUmktBackflowEventRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *PushUmktBackflowEventRequest) SetEventId(v int64) *PushUmktBackflowEventRequest {
	s.EventId = &v
	return s
}

func (s *PushUmktBackflowEventRequest) SetEventRecords(v []*BackflowEventRecord) *PushUmktBackflowEventRequest {
	s.EventRecords = v
	return s
}

type PushUmktBackflowEventResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s PushUmktBackflowEventResponse) String() string {
	return tea.Prettify(s)
}

func (s PushUmktBackflowEventResponse) GoString() string {
	return s.String()
}

func (s *PushUmktBackflowEventResponse) SetReqMsgId(v string) *PushUmktBackflowEventResponse {
	s.ReqMsgId = &v
	return s
}

func (s *PushUmktBackflowEventResponse) SetResultCode(v string) *PushUmktBackflowEventResponse {
	s.ResultCode = &v
	return s
}

func (s *PushUmktBackflowEventResponse) SetResultMsg(v string) *PushUmktBackflowEventResponse {
	s.ResultMsg = &v
	return s
}

type SendUmktCardsmsBatchRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// cpassAccessKey
...
func (s SendUmktCardsmsBatchRequest) GoString() string {
	return s.String()
}

func (s *SendUmktCardsmsBatchRequest) SetAuthToken(v string) *SendUmktCardsmsBatchRequest {
	s.AuthToken = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetProductInstanceId(v string) *SendUmktCardsmsBatchRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetCpassAk(v string) *SendUmktCardsmsBatchRequest {
	s.CpassAk = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetIndustryTag(v string) *SendUmktCardsmsBatchRequest {
	s.IndustryTag = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetCardTemplateCode(v string) *SendUmktCardsmsBatchRequest {
	s.CardTemplateCode = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetCardTemplateParamJson(v string) *SendUmktCardsmsBatchRequest {
	s.CardTemplateParamJson = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetPhoneNumberJson(v string) *SendUmktCardsmsBatchRequest {
	s.PhoneNumberJson = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetSignNameJson(v string) *SendUmktCardsmsBatchRequest {
	s.SignNameJson = &v
	return s
}

func (s *SendUmktCardsmsBatchRequest) SetSmsUpExtendCodeJson(v string) *SendUmktCardsmsBatchRequest {
	s.SmsUpExtendCodeJson = &v
	return s
}
...
func (s SendUmktCardsmsBatchResponse) GoString() string {
	return s.String()
}

func (s *SendUmktCardsmsBatchResponse) SetReqMsgId(v string) *SendUmktCardsmsBatchResponse {
	s.ReqMsgId = &v
	return s
}

func (s *SendUmktCardsmsBatchResponse) SetResultCode(v string) *SendUmktCardsmsBatchResponse {
	s.ResultCode = &v
	return s
}

func (s *SendUmktCardsmsBatchResponse) SetResultMsg(v string) *SendUmktCardsmsBatchResponse {
	s.ResultMsg = &v
	return s
}

func (s *SendUmktCardsmsBatchResponse) SetBizCardId(v string) *SendUmktCardsmsBatchResponse {
	s.BizCardId = &v
	return s
}

func (s *SendUmktCardsmsBatchResponse) SetMediaMobiles(v string) *SendUmktCardsmsBatchResponse {
	s.MediaMobiles = &v
	return s
}
...
type QueryUmktCardsmsSupportRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// cpassAccessKey
...
func (s QueryUmktCardsmsSupportRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryUmktCardsmsSupportRequest) GoString() string {
	return s.String()
}

func (s *QueryUmktCardsmsSupportRequest) SetAuthToken(v string) *QueryUmktCardsmsSupportRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryUmktCardsmsSupportRequest) SetProductInstanceId(v string) *QueryUmktCardsmsSupportRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryUmktCardsmsSupportRequest) SetCpassAk(v string) *QueryUmktCardsmsSupportRequest {
	s.CpassAk = &v
	return s
}

func (s *QueryUmktCardsmsSupportRequest) SetIndustryTag(v string) *QueryUmktCardsmsSupportRequest {
	s.IndustryTag = &v
	return s
}

func (s *QueryUmktCardsmsSupportRequest) SetTemplateCode(v string) *QueryUmktCardsmsSupportRequest {
	s.TemplateCode = &v
	return s
}

func (s *QueryUmktCardsmsSupportRequest) SetMobiles(v string) *QueryUmktCardsmsSupportRequest {
	s.Mobiles = &v
	return s
}

type QueryUmktCardsmsSupportResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryUmktCardsmsSupportResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryUmktCardsmsSupportResponse) GoString() string {
	return s.String()
}

func (s *QueryUmktCardsmsSupportResponse) SetReqMsgId(v string) *QueryUmktCardsmsSupportResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryUmktCardsmsSupportResponse) SetResultCode(v string) *QueryUmktCardsmsSupportResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryUmktCardsmsSupportResponse) SetResultMsg(v string) *QueryUmktCardsmsSupportResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryUmktCardsmsSupportResponse) SetDatas(v string) *QueryUmktCardsmsSupportResponse {
	s.Datas = &v
	return s
}

type SendUmktTextsmsBatchRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// cpassAccessKey
...
func (s SendUmktTextsmsBatchRequest) String() string {
	return tea.Prettify(s)
}

func (s SendUmktTextsmsBatchRequest) GoString() string {
	return s.String()
}

func (s *SendUmktTextsmsBatchRequest) SetAuthToken(v string) *SendUmktTextsmsBatchRequest {
	s.AuthToken = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetProductInstanceId(v string) *SendUmktTextsmsBatchRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetCpassAk(v string) *SendUmktTextsmsBatchRequest {
	s.CpassAk = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetIndustryTag(v string) *SendUmktTextsmsBatchRequest {
	s.IndustryTag = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetPhoneNumberJson(v string) *SendUmktTextsmsBatchRequest {
	s.PhoneNumberJson = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetSignNameJson(v string) *SendUmktTextsmsBatchRequest {
	s.SignNameJson = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetTemplateCode(v string) *SendUmktTextsmsBatchRequest {
	s.TemplateCode = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetTemplateParamJson(v string) *SendUmktTextsmsBatchRequest {
	s.TemplateParamJson = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetSmsUpExtendCodeJson(v string) *SendUmktTextsmsBatchRequest {
	s.SmsUpExtendCodeJson = &v
	return s
}

func (s *SendUmktTextsmsBatchRequest) SetOutId(v string) *SendUmktTextsmsBatchRequest {
	s.OutId = &v
	return s
}

type SendUmktTextsmsBatchResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s SendUmktTextsmsBatchResponse) String() string {
	return tea.Prettify(s)
}

func (s SendUmktTextsmsBatchResponse) GoString() string {
	return s.String()
}

func (s *SendUmktTextsmsBatchResponse) SetReqMsgId(v string) *SendUmktTextsmsBatchResponse {
	s.ReqMsgId = &v
	return s
}

func (s *SendUmktTextsmsBatchResponse) SetResultCode(v string) *SendUmktTextsmsBatchResponse {
	s.ResultCode = &v
	return s
}

func (s *SendUmktTextsmsBatchResponse) SetResultMsg(v string) *SendUmktTextsmsBatchResponse {
	s.ResultMsg = &v
	return s
}

func (s *SendUmktTextsmsBatchResponse) SetBizId(v string) *SendUmktTextsmsBatchResponse {
	s.BizId = &v
	return s
}

type SendUmktDigitalsmsBatchRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// cpassAccessKey
...
func (s SendUmktDigitalsmsBatchRequest) String() string {
	return tea.Prettify(s)
}

func (s SendUmktDigitalsmsBatchRequest) GoString() string {
	return s.String()
}

func (s *SendUmktDigitalsmsBatchRequest) SetAuthToken(v string) *SendUmktDigitalsmsBatchRequest {
	s.AuthToken = &v
	return s
}

func (s *SendUmktDigitalsmsBatchRequest) SetProductInstanceId(v string) *SendUmktDigitalsmsBatchRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *SendUmktDigitalsmsBatchRequest) SetCpassAk(v string) *SendUmktDigitalsmsBatchRequest {
	s.CpassAk = &v
	return s
}

func (s *SendUmktDigitalsmsBatchRequest) SetIndustryTag(v string) *SendUmktDigitalsmsBatchRequest {
	s.IndustryTag = &v
	return s
}

func (s *SendUmktDigitalsmsBatchRequest) SetPhoneNumbers(v string) *SendUmktDigitalsmsBatchRequest {
	s.PhoneNumbers = &v
	return s
}

func (s *SendUmktDigitalsmsBatchRequest) SetTemplateCode(v string) *SendUmktDigitalsmsBatchRequest {
	s.TemplateCode = &v
	return s
}

func (s *SendUmktDigitalsmsBatchRequest) SetTemplateParam(v string) *SendUmktDigitalsmsBatchRequest {
	s.TemplateParam = &v
	return s
}

func (s *SendUmktDigitalsmsBatchRequest) SetOutId(v string) *SendUmktDigitalsmsBatchRequest {
	s.OutId = &v
	return s
}

type SendUmktDigitalsmsBatchResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s SendUmktDigitalsmsBatchResponse) String() string {
	return tea.Prettify(s)
}

func (s SendUmktDigitalsmsBatchResponse) GoString() string {
	return s.String()
}

func (s *SendUmktDigitalsmsBatchResponse) SetReqMsgId(v string) *SendUmktDigitalsmsBatchResponse {
	s.ReqMsgId = &v
	return s
}

func (s *SendUmktDigitalsmsBatchResponse) SetResultCode(v string) *SendUmktDigitalsmsBatchResponse {
	s.ResultCode = &v
	return s
}

func (s *SendUmktDigitalsmsBatchResponse) SetResultMsg(v string) *SendUmktDigitalsmsBatchResponse {
	s.ResultMsg = &v
	return s
}

func (s *SendUmktDigitalsmsBatchResponse) SetBizId(v string) *SendUmktDigitalsmsBatchResponse {
	s.BizId = &v
	return s
}

type QueryUmktCpaassmsTemplateRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 短信类型
...
func (s QueryUmktCpaassmsTemplateRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryUmktCpaassmsTemplateRequest) GoString() string {
	return s.String()
}

func (s *QueryUmktCpaassmsTemplateRequest) SetAuthToken(v string) *QueryUmktCpaassmsTemplateRequest {
	s.AuthToken = &v
	return s
}
...
func (s *QueryUmktCpaassmsTemplateRequest) SetSmsType(v string) *QueryUmktCpaassmsTemplateRequest {
	s.SmsType = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateRequest) SetTenantIndustry(v string) *QueryUmktCpaassmsTemplateRequest {
	s.TenantIndustry = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateRequest) SetStatus(v string) *QueryUmktCpaassmsTemplateRequest {
	s.Status = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateRequest) SetPageNum(v int64) *QueryUmktCpaassmsTemplateRequest {
	s.PageNum = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateRequest) SetPageSize(v int64) *QueryUmktCpaassmsTemplateRequest {
	s.PageSize = &v
	return s
}

type QueryUmktCpaassmsTemplateResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryUmktCpaassmsTemplateResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryUmktCpaassmsTemplateResponse) GoString() string {
	return s.String()
}

func (s *QueryUmktCpaassmsTemplateResponse) SetReqMsgId(v string) *QueryUmktCpaassmsTemplateResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateResponse) SetResultCode(v string) *QueryUmktCpaassmsTemplateResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateResponse) SetResultMsg(v string) *QueryUmktCpaassmsTemplateResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateResponse) SetTotal(v int64) *QueryUmktCpaassmsTemplateResponse {
	s.Total = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateResponse) SetPageSize(v int64) *QueryUmktCpaassmsTemplateResponse {
	s.PageSize = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateResponse) SetPageNum(v int64) *QueryUmktCpaassmsTemplateResponse {
	s.PageNum = &v
	return s
}

func (s *QueryUmktCpaassmsTemplateResponse) SetCpassSmsTemplates(v []*CpaasSmsTemplate) *QueryUmktCpaassmsTemplateResponse {
	s.CpassSmsTemplates = v
	return s
}

type BatchqueryUmktRtMixedmarketingRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 场景策略id列表
	SceneStrategyIds []*int64 `json:"scene_strategy_ids,omitempty" xml:"scene_strategy_ids,omitempty" require:"true" type:"Repeated"`
	// 场景策略集合code，对标场景策略id列表，一般不可变
	SceneStrategySetCode *string `json:"scene_strategy_set_code,omitempty" xml:"scene_strategy_set_code,omitempty"`
	// 查询协议模版
	QueryTemplate *string `json:"query_template,omitempty" xml:"query_template,omitempty" require:"true"`
	// 查询的用户凭证列表
	CustomerKeys []*string `json:"customer_keys,omitempty" xml:"customer_keys,omitempty" require:"true" type:"Repeated"`
...
func (s BatchqueryUmktRtMixedmarketingRequest) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktRtMixedmarketingRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktRtMixedmarketingRequest) SetAuthToken(v string) *BatchqueryUmktRtMixedmarketingRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingRequest) SetProductInstanceId(v string) *BatchqueryUmktRtMixedmarketingRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingRequest) SetSceneStrategyIds(v []*int64) *BatchqueryUmktRtMixedmarketingRequest {
	s.SceneStrategyIds = v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingRequest) SetSceneStrategySetCode(v string) *BatchqueryUmktRtMixedmarketingRequest {
	s.SceneStrategySetCode = &v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingRequest) SetQueryTemplate(v string) *BatchqueryUmktRtMixedmarketingRequest {
	s.QueryTemplate = &v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingRequest) SetCustomerKeys(v []*string) *BatchqueryUmktRtMixedmarketingRequest {
	s.CustomerKeys = v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingRequest) SetBizSerialNo(v string) *BatchqueryUmktRtMixedmarketingRequest {
	s.BizSerialNo = &v
	return s
}

type BatchqueryUmktRtMixedmarketingResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
	...
	ResultMsg *string `json:"result_msg,omitempty" xml:"result_msg,omitempty"`
	// 查询结果
	QueryResults []*CustomerUmktInfosModel `json:"query_results,omitempty" xml:"query_results,omitempty" type:"Repeated"`
}

func (s BatchqueryUmktRtMixedmarketingResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktRtMixedmarketingResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktRtMixedmarketingResponse) SetReqMsgId(v string) *BatchqueryUmktRtMixedmarketingResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingResponse) SetResultCode(v string) *BatchqueryUmktRtMixedmarketingResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingResponse) SetResultMsg(v string) *BatchqueryUmktRtMixedmarketingResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryUmktRtMixedmarketingResponse) SetQueryResults(v []*CustomerUmktInfosModel) *BatchqueryUmktRtMixedmarketingResponse {
	s.QueryResults = v
	return s
}
...
type BatchqueryUmktRtTopnRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 场景策略id
...
func (s BatchqueryUmktRtTopnRequest) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktRtTopnRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktRtTopnRequest) SetAuthToken(v string) *BatchqueryUmktRtTopnRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryUmktRtTopnRequest) SetProductInstanceId(v string) *BatchqueryUmktRtTopnRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryUmktRtTopnRequest) SetSceneStrategyId(v int64) *BatchqueryUmktRtTopnRequest {
	s.SceneStrategyId = &v
	return s
}

func (s *BatchqueryUmktRtTopnRequest) SetQueryTemplate(v string) *BatchqueryUmktRtTopnRequest {
	s.QueryTemplate = &v
	return s
}

func (s *BatchqueryUmktRtTopnRequest) SetCustomerKeys(v []*string) *BatchqueryUmktRtTopnRequest {
	s.CustomerKeys = v
	return s
}

func (s *BatchqueryUmktRtTopnRequest) SetBizSerialNo(v string) *BatchqueryUmktRtTopnRequest {
	s.BizSerialNo = &v
	return s
}

func (s *BatchqueryUmktRtTopnRequest) SetVisitType(v string) *BatchqueryUmktRtTopnRequest {
	s.VisitType = &v
	return s
}

type BatchqueryUmktRtTopnResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s BatchqueryUmktRtTopnResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktRtTopnResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktRtTopnResponse) SetReqMsgId(v string) *BatchqueryUmktRtTopnResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryUmktRtTopnResponse) SetResultCode(v string) *BatchqueryUmktRtTopnResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryUmktRtTopnResponse) SetResultMsg(v string) *BatchqueryUmktRtTopnResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryUmktRtTopnResponse) SetSuccess(v bool) *BatchqueryUmktRtTopnResponse {
	s.Success = &v
	return s
}

func (s *BatchqueryUmktRtTopnResponse) SetQueryResult(v []*CustomerUmktInfoModel) *BatchqueryUmktRtTopnResponse {
	s.QueryResult = v
	return s
}
...
type BatchqueryUmktTenantActionplaninfoRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 渠道类型
...
func (s BatchqueryUmktTenantActionplaninfoRequest) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktTenantActionplaninfoRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktTenantActionplaninfoRequest) SetAuthToken(v string) *BatchqueryUmktTenantActionplaninfoRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoRequest) SetProductInstanceId(v string) *BatchqueryUmktTenantActionplaninfoRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoRequest) SetContentType(v string) *BatchqueryUmktTenantActionplaninfoRequest {
	s.ContentType = &v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoRequest) SetPageNum(v int64) *BatchqueryUmktTenantActionplaninfoRequest {
	s.PageNum = &v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoRequest) SetPageSize(v int64) *BatchqueryUmktTenantActionplaninfoRequest {
	s.PageSize = &v
	return s
}

type BatchqueryUmktTenantActionplaninfoResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s BatchqueryUmktTenantActionplaninfoResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktTenantActionplaninfoResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktTenantActionplaninfoResponse) SetReqMsgId(v string) *BatchqueryUmktTenantActionplaninfoResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoResponse) SetResultCode(v string) *BatchqueryUmktTenantActionplaninfoResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoResponse) SetResultMsg(v string) *BatchqueryUmktTenantActionplaninfoResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoResponse) SetQueryResult(v []*ActionPlanDetailInfo) *BatchqueryUmktTenantActionplaninfoResponse {
	s.QueryResult = v
	return s
}

func (s *BatchqueryUmktTenantActionplaninfoResponse) SetTotalCount(v int64) *BatchqueryUmktTenantActionplaninfoResponse {
	s.TotalCount = &v
	return s
}

type BatchqueryUmktRobotcallDetailRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 上传外呼任务返回的callId
	...
	SceneStrategyId *int64 `json:"scene_strategy_id,omitempty" xml:"scene_strategy_id,omitempty" require:"true"`
	// 意向标签
	IntentTags []*string `json:"intent_tags,omitempty" xml:"intent_tags,omitempty" type:"Repeated"`
	// 开始外呼时间
	CallDate *string `json:"call_date,omitempty" xml:"call_date,omitempty"`
	// 结束外呼时间
	EndCallDate *string `json:"end_call_date,omitempty" xml:"end_call_date,omitempty"`
...
func (s BatchqueryUmktRobotcallDetailRequest) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktRobotcallDetailRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetAuthToken(v string) *BatchqueryUmktRobotcallDetailRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetProductInstanceId(v string) *BatchqueryUmktRobotcallDetailRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetBizId(v string) *BatchqueryUmktRobotcallDetailRequest {
	s.BizId = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetPhoneNumbers(v []*string) *BatchqueryUmktRobotcallDetailRequest {
	s.PhoneNumbers = v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetTemplateType(v string) *BatchqueryUmktRobotcallDetailRequest {
	s.TemplateType = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetSceneStrategyId(v int64) *BatchqueryUmktRobotcallDetailRequest {
	s.SceneStrategyId = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetIntentTags(v []*string) *BatchqueryUmktRobotcallDetailRequest {
	s.IntentTags = v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetCallDate(v string) *BatchqueryUmktRobotcallDetailRequest {
	s.CallDate = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetEndCallDate(v string) *BatchqueryUmktRobotcallDetailRequest {
	s.EndCallDate = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetPageNum(v int64) *BatchqueryUmktRobotcallDetailRequest {
	s.PageNum = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailRequest) SetPageSize(v int64) *BatchqueryUmktRobotcallDetailRequest {
	s.PageSize = &v
	return s
}

type BatchqueryUmktRobotcallDetailResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s BatchqueryUmktRobotcallDetailResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktRobotcallDetailResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktRobotcallDetailResponse) SetReqMsgId(v string) *BatchqueryUmktRobotcallDetailResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailResponse) SetResultCode(v string) *BatchqueryUmktRobotcallDetailResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailResponse) SetResultMsg(v string) *BatchqueryUmktRobotcallDetailResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailResponse) SetOutInfo(v string) *BatchqueryUmktRobotcallDetailResponse {
	s.OutInfo = &v
	return s
}

func (s *BatchqueryUmktRobotcallDetailResponse) SetCallInfo(v []*CommonRobotCallDetail) *BatchqueryUmktRobotcallDetailResponse {
	s.CallInfo = v
	return s
}

type BatchqueryUmktActionplanDetailRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 场景策略id
...
func (s BatchqueryUmktActionplanDetailRequest) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktActionplanDetailRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktActionplanDetailRequest) SetAuthToken(v string) *BatchqueryUmktActionplanDetailRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryUmktActionplanDetailRequest) SetProductInstanceId(v string) *BatchqueryUmktActionplanDetailRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryUmktActionplanDetailRequest) SetSceneStrategyId(v []*int64) *BatchqueryUmktActionplanDetailRequest {
	s.SceneStrategyId = v
	return s
}

type BatchqueryUmktActionplanDetailResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s BatchqueryUmktActionplanDetailResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktActionplanDetailResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktActionplanDetailResponse) SetReqMsgId(v string) *BatchqueryUmktActionplanDetailResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryUmktActionplanDetailResponse) SetResultCode(v string) *BatchqueryUmktActionplanDetailResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryUmktActionplanDetailResponse) SetResultMsg(v string) *BatchqueryUmktActionplanDetailResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryUmktActionplanDetailResponse) SetActionPlanDetailInfo(v []*ActionPlanDetailInfo) *BatchqueryUmktActionplanDetailResponse {
	s.ActionPlanDetailInfo = v
	return s
}

type PushRiskplusUmktCommonbackflowRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 租户id
	...
	// 回流模版ID
	BackFlowTemplateId *int64 `json:"back_flow_template_id,omitempty" xml:"back_flow_template_id,omitempty" require:"true"`
	// 回流信息描述
	BackFlowDesc *string `json:"back_flow_desc,omitempty" xml:"back_flow_desc,omitempty" require:"true"`
	// 回流属性
	Properties *string `json:"properties,omitempty" xml:"properties,omitempty" require:"true"`
}

func (s PushRiskplusUmktCommonbackflowRequest) String() string {
	return tea.Prettify(s)
}

func (s PushRiskplusUmktCommonbackflowRequest) GoString() string {
	return s.String()
}

func (s *PushRiskplusUmktCommonbackflowRequest) SetAuthToken(v string) *PushRiskplusUmktCommonbackflowRequest {
	s.AuthToken = &v
	return s
}

func (s *PushRiskplusUmktCommonbackflowRequest) SetProductInstanceId(v string) *PushRiskplusUmktCommonbackflowRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *PushRiskplusUmktCommonbackflowRequest) SetTenantId(v int64) *PushRiskplusUmktCommonbackflowRequest {
	s.TenantId = &v
	return s
}

func (s *PushRiskplusUmktCommonbackflowRequest) SetBackFlowTemplateId(v int64) *PushRiskplusUmktCommonbackflowRequest {
	s.BackFlowTemplateId = &v
	return s
}

func (s *PushRiskplusUmktCommonbackflowRequest) SetBackFlowDesc(v string) *PushRiskplusUmktCommonbackflowRequest {
	s.BackFlowDesc = &v
	return s
}

func (s *PushRiskplusUmktCommonbackflowRequest) SetProperties(v string) *PushRiskplusUmktCommonbackflowRequest {
	s.Properties = &v
	return s
}

type PushRiskplusUmktCommonbackflowResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s PushRiskplusUmktCommonbackflowResponse) String() string {
	return tea.Prettify(s)
}

func (s PushRiskplusUmktCommonbackflowResponse) GoString() string {
	return s.String()
}

func (s *PushRiskplusUmktCommonbackflowResponse) SetReqMsgId(v string) *PushRiskplusUmktCommonbackflowResponse {
	s.ReqMsgId = &v
	return s
}

func (s *PushRiskplusUmktCommonbackflowResponse) SetResultCode(v string) *PushRiskplusUmktCommonbackflowResponse {
	s.ResultCode = &v
	return s
}

func (s *PushRiskplusUmktCommonbackflowResponse) SetResultMsg(v string) *PushRiskplusUmktCommonbackflowResponse {
	s.ResultMsg = &v
	return s
}

type PushUmktCommonDataRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 数据推送事件ID
...
func (s PushUmktCommonDataRequest) String() string {
	return tea.Prettify(s)
}

func (s PushUmktCommonDataRequest) GoString() string {
	return s.String()
}

func (s *PushUmktCommonDataRequest) SetAuthToken(v string) *PushUmktCommonDataRequest {
	s.AuthToken = &v
	return s
}

func (s *PushUmktCommonDataRequest) SetProductInstanceId(v string) *PushUmktCommonDataRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *PushUmktCommonDataRequest) SetEventId(v int64) *PushUmktCommonDataRequest {
	s.EventId = &v
	return s
}

func (s *PushUmktCommonDataRequest) SetProperties(v string) *PushUmktCommonDataRequest {
	s.Properties = &v
	return s
}

type PushUmktCommonDataResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s PushUmktCommonDataResponse) String() string {
	return tea.Prettify(s)
}

func (s PushUmktCommonDataResponse) GoString() string {
	return s.String()
}

func (s *PushUmktCommonDataResponse) SetReqMsgId(v string) *PushUmktCommonDataResponse {
	s.ReqMsgId = &v
	return s
}

func (s *PushUmktCommonDataResponse) SetResultCode(v string) *PushUmktCommonDataResponse {
	s.ResultCode = &v
	return s
}

func (s *PushUmktCommonDataResponse) SetResultMsg(v string) *PushUmktCommonDataResponse {
	s.ResultMsg = &v
	return s
}

type PushUmktCustomerGroupRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 事件ID
...
func (s PushUmktCustomerGroupRequest) String() string {
	return tea.Prettify(s)
}

func (s PushUmktCustomerGroupRequest) GoString() string {
	return s.String()
}

func (s *PushUmktCustomerGroupRequest) SetAuthToken(v string) *PushUmktCustomerGroupRequest {
	s.AuthToken = &v
	return s
}

func (s *PushUmktCustomerGroupRequest) SetProductInstanceId(v string) *PushUmktCustomerGroupRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *PushUmktCustomerGroupRequest) SetEventId(v string) *PushUmktCustomerGroupRequest {
	s.EventId = &v
	return s
}

func (s *PushUmktCustomerGroupRequest) SetProperties(v string) *PushUmktCustomerGroupRequest {
	s.Properties = &v
	return s
}

type PushUmktCustomerGroupResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s PushUmktCustomerGroupResponse) String() string {
	return tea.Prettify(s)
}

func (s PushUmktCustomerGroupResponse) GoString() string {
	return s.String()
}

func (s *PushUmktCustomerGroupResponse) SetReqMsgId(v string) *PushUmktCustomerGroupResponse {
	s.ReqMsgId = &v
	return s
}

func (s *PushUmktCustomerGroupResponse) SetResultCode(v string) *PushUmktCustomerGroupResponse {
	s.ResultCode = &v
	return s
}

func (s *PushUmktCustomerGroupResponse) SetResultMsg(v string) *PushUmktCustomerGroupResponse {
	s.ResultMsg = &v
	return s
}

type BatchqueryUmktTaskDetailRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 上传外呼任务返回的callId
...
func (s BatchqueryUmktTaskDetailRequest) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktTaskDetailRequest) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktTaskDetailRequest) SetAuthToken(v string) *BatchqueryUmktTaskDetailRequest {
	s.AuthToken = &v
	return s
}

func (s *BatchqueryUmktTaskDetailRequest) SetProductInstanceId(v string) *BatchqueryUmktTaskDetailRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *BatchqueryUmktTaskDetailRequest) SetBizId(v string) *BatchqueryUmktTaskDetailRequest {
	s.BizId = &v
	return s
}

func (s *BatchqueryUmktTaskDetailRequest) SetCustomerKeys(v []*string) *BatchqueryUmktTaskDetailRequest {
	s.CustomerKeys = v
	return s
}

func (s *BatchqueryUmktTaskDetailRequest) SetKeyTemplate(v string) *BatchqueryUmktTaskDetailRequest {
	s.KeyTemplate = &v
	return s
}

func (s *BatchqueryUmktTaskDetailRequest) SetSceneStrategyId(v int64) *BatchqueryUmktTaskDetailRequest {
	s.SceneStrategyId = &v
	return s
}

func (s *BatchqueryUmktTaskDetailRequest) SetCallDate(v string) *BatchqueryUmktTaskDetailRequest {
	s.CallDate = &v
	return s
}

func (s *BatchqueryUmktTaskDetailRequest) SetEndCallDate(v string) *BatchqueryUmktTaskDetailRequest {
	s.EndCallDate = &v
	return s
}

type BatchqueryUmktTaskDetailResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s BatchqueryUmktTaskDetailResponse) String() string {
	return tea.Prettify(s)
}

func (s BatchqueryUmktTaskDetailResponse) GoString() string {
	return s.String()
}

func (s *BatchqueryUmktTaskDetailResponse) SetReqMsgId(v string) *BatchqueryUmktTaskDetailResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BatchqueryUmktTaskDetailResponse) SetResultCode(v string) *BatchqueryUmktTaskDetailResponse {
	s.ResultCode = &v
	return s
}

func (s *BatchqueryUmktTaskDetailResponse) SetResultMsg(v string) *BatchqueryUmktTaskDetailResponse {
	s.ResultMsg = &v
	return s
}

func (s *BatchqueryUmktTaskDetailResponse) SetOutInfo(v string) *BatchqueryUmktTaskDetailResponse {
	s.OutInfo = &v
	return s
}

func (s *BatchqueryUmktTaskDetailResponse) SetCallInfo(v []*CommonRobotCallDetail) *BatchqueryUmktTaskDetailResponse {
	s.CallInfo = v
	return s
}
...
func (client *Client) QuerySaasSecurityPolicy(request *QuerySaasSecurityPolicyRequest) (_result *QuerySaasSecurityPolicyResponse, _err error) {
	...
	_body, _err := client.QuerySaasSecurityPolicyEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryDubbridgeCustomerCommonagreementsign(request *QueryDubbridgeCustomerCommonagreementsignRequest) (_result *QueryDubbridgeCustomerCommonagreementsignResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryDubbridgeCustomerCommonagreementsignResponse{}
	_body, _err := client.QueryDubbridgeCustomerCommonagreementsignEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryDubbridgeCustomerCommonagreementsignEx(request *QueryDubbridgeCustomerCommonagreementsignRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryDubbridgeCustomerCommonagreementsignResponse, _err error) {
	...
	_result = &QueryDubbridgeCustomerCommonagreementsignResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.dubbridge.customer.commonagreementsign.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateDubbridgeFile(request *UpdateDubbridgeFileRequest) (_result *UpdateDubbridgeFileResponse, _err error) {
	...
	_body, _err := client.UpdateDubbridgeFileEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) NotifyDubbridgeCallback(request *NotifyDubbridgeCallbackRequest) (_result *NotifyDubbridgeCallbackResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &NotifyDubbridgeCallbackResponse{}
	_body, _err := client.NotifyDubbridgeCallbackEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) NotifyDubbridgeCallbackEx(request *NotifyDubbridgeCallbackRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *NotifyDubbridgeCallbackResponse, _err error) {
	...
	_result = &NotifyDubbridgeCallbackResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.dubbridge.callback.notify"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryDubbridgeRepayResult(request *QueryDubbridgeRepayResultRequest) (_result *QueryDubbridgeRepayResultResponse, _err error) {
	...
	_body, _err := client.QueryDubbridgeRepayResultEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) SendQmpDigitalsmsBatch(request *SendQmpDigitalsmsBatchRequest) (_result *SendQmpDigitalsmsBatchResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &SendQmpDigitalsmsBatchResponse{}
	_body, _err := client.SendQmpDigitalsmsBatchEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) SendQmpDigitalsmsBatchEx(request *SendQmpDigitalsmsBatchRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *SendQmpDigitalsmsBatchResponse, _err error) {
	...
	_result = &SendQmpDigitalsmsBatchResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.digitalsms.batch.send"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CallbackQmpRobotcall(request *CallbackQmpRobotcallRequest) (_result *CallbackQmpRobotcallResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &CallbackQmpRobotcallResponse{}
	_body, _err := client.CallbackQmpRobotcallEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) CallbackQmpRobotcallEx(request *CallbackQmpRobotcallRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *CallbackQmpRobotcallResponse, _err error) {
	...
	_result = &CallbackQmpRobotcallResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.robotcall.callback"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryQmpRobotcallDetail(request *QueryQmpRobotcallDetailRequest) (_result *QueryQmpRobotcallDetailResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryQmpRobotcallDetailResponse{}
	_body, _err := client.QueryQmpRobotcallDetailEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryQmpRobotcallDetailEx(request *QueryQmpRobotcallDetailRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryQmpRobotcallDetailResponse, _err error) {
	...
	_result = &QueryQmpRobotcallDetailResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.robotcall.detail.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryQmpDataaccessStatistic(request *QueryQmpDataaccessStatisticRequest) (_result *QueryQmpDataaccessStatisticResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryQmpDataaccessStatisticResponse{}
	_body, _err := client.QueryQmpDataaccessStatisticEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryQmpDataaccessStatisticEx(request *QueryQmpDataaccessStatisticRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryQmpDataaccessStatisticResponse, _err error) {
	...
	_result = &QueryQmpDataaccessStatisticResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.dataaccess.statistic.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryQmpRobotcallStatisticinfo(request *QueryQmpRobotcallStatisticinfoRequest) (_result *QueryQmpRobotcallStatisticinfoResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryQmpRobotcallStatisticinfoResponse{}
	_body, _err := client.QueryQmpRobotcallStatisticinfoEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryQmpRobotcallStatisticinfoEx(request *QueryQmpRobotcallStatisticinfoRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryQmpRobotcallStatisticinfoResponse, _err error) {
	...
	_result = &QueryQmpRobotcallStatisticinfoResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.robotcall.statisticinfo.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) BatchqueryQmpTaskDetail(request *BatchqueryQmpTaskDetailRequest) (_result *BatchqueryQmpTaskDetailResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BatchqueryQmpTaskDetailResponse{}
	_body, _err := client.BatchqueryQmpTaskDetailEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryQmpTaskDetailEx(request *BatchqueryQmpTaskDetailRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *BatchqueryQmpTaskDetailResponse, _err error) {
	...
	_result = &BatchqueryQmpTaskDetailResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.task.detail.batchquery"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryQmpCardsmsSupport(request *QueryQmpCardsmsSupportRequest) (_result *QueryQmpCardsmsSupportResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryQmpCardsmsSupportResponse{}
	_body, _err := client.QueryQmpCardsmsSupportEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryQmpCardsmsSupportEx(request *QueryQmpCardsmsSupportRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryQmpCardsmsSupportResponse, _err error) {
	...
	_result = &QueryQmpCardsmsSupportResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.cardsms.support.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) BatchqueryQmpActionplanDetail(request *BatchqueryQmpActionplanDetailRequest) (_result *BatchqueryQmpActionplanDetailResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BatchqueryQmpActionplanDetailResponse{}
	_body, _err := client.BatchqueryQmpActionplanDetailEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryQmpActionplanDetailEx(request *BatchqueryQmpActionplanDetailRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *BatchqueryQmpActionplanDetailResponse, _err error) {
	...
	_result = &BatchqueryQmpActionplanDetailResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.actionplan.detail.batchquery"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ApplyQmpPhonenumberstatusforsms(request *ApplyQmpPhonenumberstatusforsmsRequest) (_result *ApplyQmpPhonenumberstatusforsmsResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ApplyQmpPhonenumberstatusforsmsResponse{}
	_body, _err := client.ApplyQmpPhonenumberstatusforsmsEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) ApplyQmpPhonenumberstatusforsmsEx(request *ApplyQmpPhonenumberstatusforsmsRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *ApplyQmpPhonenumberstatusforsmsResponse, _err error) {
	...
	_result = &ApplyQmpPhonenumberstatusforsmsResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.phonenumberstatusforsms.apply"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) BatchqueryQmpTenantActionplaninfo(request *BatchqueryQmpTenantActionplaninfoRequest) (_result *BatchqueryQmpTenantActionplaninfoResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BatchqueryQmpTenantActionplaninfoResponse{}
	_body, _err := client.BatchqueryQmpTenantActionplaninfoEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryQmpTenantActionplaninfoEx(request *BatchqueryQmpTenantActionplaninfoRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *BatchqueryQmpTenantActionplaninfoResponse, _err error) {
	...
	_result = &BatchqueryQmpTenantActionplaninfoResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.tenant.actionplaninfo.batchquery"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryQmpTenantActionplaninfo(request *QueryQmpTenantActionplaninfoRequest) (_result *QueryQmpTenantActionplaninfoResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryQmpTenantActionplaninfoResponse{}
	_body, _err := client.QueryQmpTenantActionplaninfoEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryQmpTenantActionplaninfoEx(request *QueryQmpTenantActionplaninfoRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryQmpTenantActionplaninfoResponse, _err error) {
	...
	_result = &QueryQmpTenantActionplaninfoResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.qmp.tenant.actionplaninfo.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryUmktDataaccessStatistic(request *QueryUmktDataaccessStatisticRequest) (_result *QueryUmktDataaccessStatisticResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryUmktDataaccessStatisticResponse{}
	_body, _err := client.QueryUmktDataaccessStatisticEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryUmktDataaccessStatisticEx(request *QueryUmktDataaccessStatisticRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryUmktDataaccessStatisticResponse, _err error) {
	...
	_result = &QueryUmktDataaccessStatisticResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.dataaccess.statistic.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CancelUmktDataaccessOfflinetask(request *CancelUmktDataaccessOfflinetaskRequest) (_result *CancelUmktDataaccessOfflinetaskResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &CancelUmktDataaccessOfflinetaskResponse{}
	_body, _err := client.CancelUmktDataaccessOfflinetaskEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) CancelUmktDataaccessOfflinetaskEx(request *CancelUmktDataaccessOfflinetaskRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *CancelUmktDataaccessOfflinetaskResponse, _err error) {
	...
	_result = &CancelUmktDataaccessOfflinetaskResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.dataaccess.offlinetask.cancel"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryUmktRtMarketing(request *QueryUmktRtMarketingRequest) (_result *QueryUmktRtMarketingResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryUmktRtMarketingResponse{}
	_body, _err := client.QueryUmktRtMarketingEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryUmktRtMarketingEx(request *QueryUmktRtMarketingRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryUmktRtMarketingResponse, _err error) {
	...
	_result = &QueryUmktRtMarketingResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.rt.marketing.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) PushUmktBackflowEvent(request *PushUmktBackflowEventRequest) (_result *PushUmktBackflowEventResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &PushUmktBackflowEventResponse{}
	_body, _err := client.PushUmktBackflowEventEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) PushUmktBackflowEventEx(request *PushUmktBackflowEventRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *PushUmktBackflowEventResponse, _err error) {
	...
	_result = &PushUmktBackflowEventResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.backflow.event.push"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) SendUmktCardsmsBatch(request *SendUmktCardsmsBatchRequest) (_result *SendUmktCardsmsBatchResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &SendUmktCardsmsBatchResponse{}
	_body, _err := client.SendUmktCardsmsBatchEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) SendUmktCardsmsBatchEx(request *SendUmktCardsmsBatchRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *SendUmktCardsmsBatchResponse, _err error) {
	...
	_result = &SendUmktCardsmsBatchResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.cardsms.batch.send"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryUmktCardsmsSupport(request *QueryUmktCardsmsSupportRequest) (_result *QueryUmktCardsmsSupportResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryUmktCardsmsSupportResponse{}
	_body, _err := client.QueryUmktCardsmsSupportEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryUmktCardsmsSupportEx(request *QueryUmktCardsmsSupportRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryUmktCardsmsSupportResponse, _err error) {
	...
	_result = &QueryUmktCardsmsSupportResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.cardsms.support.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) SendUmktTextsmsBatch(request *SendUmktTextsmsBatchRequest) (_result *SendUmktTextsmsBatchResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &SendUmktTextsmsBatchResponse{}
	_body, _err := client.SendUmktTextsmsBatchEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) SendUmktTextsmsBatchEx(request *SendUmktTextsmsBatchRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *SendUmktTextsmsBatchResponse, _err error) {
	...
	_result = &SendUmktTextsmsBatchResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.textsms.batch.send"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) SendUmktDigitalsmsBatch(request *SendUmktDigitalsmsBatchRequest) (_result *SendUmktDigitalsmsBatchResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &SendUmktDigitalsmsBatchResponse{}
	_body, _err := client.SendUmktDigitalsmsBatchEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) SendUmktDigitalsmsBatchEx(request *SendUmktDigitalsmsBatchRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *SendUmktDigitalsmsBatchResponse, _err error) {
	...
	_result = &SendUmktDigitalsmsBatchResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.digitalsms.batch.send"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) QueryUmktCpaassmsTemplate(request *QueryUmktCpaassmsTemplateRequest) (_result *QueryUmktCpaassmsTemplateResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryUmktCpaassmsTemplateResponse{}
	_body, _err := client.QueryUmktCpaassmsTemplateEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryUmktCpaassmsTemplateEx(request *QueryUmktCpaassmsTemplateRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryUmktCpaassmsTemplateResponse, _err error) {
	...
	_result = &QueryUmktCpaassmsTemplateResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.cpaassms.template.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) BatchqueryUmktRtMixedmarketing(request *BatchqueryUmktRtMixedmarketingRequest) (_result *BatchqueryUmktRtMixedmarketingResponse, _err error) {
	...
	_body, _err := client.BatchqueryUmktRtMixedmarketingEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryUmktRtTopn(request *BatchqueryUmktRtTopnRequest) (_result *BatchqueryUmktRtTopnResponse, _err error) {
	...
	_body, _err := client.BatchqueryUmktRtTopnEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryUmktTenantActionplaninfo(request *BatchqueryUmktTenantActionplaninfoRequest) (_result *BatchqueryUmktTenantActionplaninfoResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BatchqueryUmktTenantActionplaninfoResponse{}
	_body, _err := client.BatchqueryUmktTenantActionplaninfoEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryUmktTenantActionplaninfoEx(request *BatchqueryUmktTenantActionplaninfoRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *BatchqueryUmktTenantActionplaninfoResponse, _err error) {
	...
	_result = &BatchqueryUmktTenantActionplaninfoResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.tenant.actionplaninfo.batchquery"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) BatchqueryUmktRobotcallDetail(request *BatchqueryUmktRobotcallDetailRequest) (_result *BatchqueryUmktRobotcallDetailResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BatchqueryUmktRobotcallDetailResponse{}
	_body, _err := client.BatchqueryUmktRobotcallDetailEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryUmktRobotcallDetailEx(request *BatchqueryUmktRobotcallDetailRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *BatchqueryUmktRobotcallDetailResponse, _err error) {
	...
	_result = &BatchqueryUmktRobotcallDetailResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.robotcall.detail.batchquery"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) BatchqueryUmktActionplanDetail(request *BatchqueryUmktActionplanDetailRequest) (_result *BatchqueryUmktActionplanDetailResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BatchqueryUmktActionplanDetailResponse{}
	_body, _err := client.BatchqueryUmktActionplanDetailEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) BatchqueryUmktActionplanDetailEx(request *BatchqueryUmktActionplanDetailRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *BatchqueryUmktActionplanDetailResponse, _err error) {
	...
	_result = &BatchqueryUmktActionplanDetailResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.actionplan.detail.batchquery"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) PushRiskplusUmktCommonbackflow(request *PushRiskplusUmktCommonbackflowRequest) (_result *PushRiskplusUmktCommonbackflowResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &PushRiskplusUmktCommonbackflowResponse{}
	_body, _err := client.PushRiskplusUmktCommonbackflowEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) PushRiskplusUmktCommonbackflowEx(request *PushRiskplusUmktCommonbackflowRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *PushRiskplusUmktCommonbackflowResponse, _err error) {
	...
	_result = &PushRiskplusUmktCommonbackflowResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.riskplus.umkt.commonbackflow.push"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) PushUmktCommonData(request *PushUmktCommonDataRequest) (_result *PushUmktCommonDataResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &PushUmktCommonDataResponse{}
	_body, _err := client.PushUmktCommonDataEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) PushUmktCommonDataEx(request *PushUmktCommonDataRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *PushUmktCommonDataResponse, _err error) {
	...
	_result = &PushUmktCommonDataResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.common.data.push"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) PushUmktCustomerGroup(request *PushUmktCustomerGroupRequest) (_result *PushUmktCustomerGroupResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &PushUmktCustomerGroupResponse{}
	_body, _err := client.PushUmktCustomerGroupEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) PushUmktCustomerGroupEx(request *PushUmktCustomerGroupRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *PushUmktCustomerGroupResponse, _err error) {
	...
	_result = &PushUmktCustomerGroupResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.umkt.customer.group.push"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) BatchqueryUmktTaskDetail(request *BatchqueryUmktTaskDetailRequest) (_result *BatchqueryUmktTaskDetailResponse, _err error) {
	...
	_body, _err := client.BatchqueryUmktTaskDetailEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
