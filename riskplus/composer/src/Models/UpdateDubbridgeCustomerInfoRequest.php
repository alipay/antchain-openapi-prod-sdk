...
class UpdateDubbridgeCustomerInfoRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->idValidDate) {
            $res['id_valid_date'] = $this->idValidDate;
        }
     ...
     * @param array $map
     *
     * @return UpdateDubbridgeCustomerInfoRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['id_valid_date'])) {
            $model->idValidDate = $map['id_valid_date'];
        }
