...
from antchain_sdk_saastest17 import models as saas_test_17_models
...
class Client:
    ...
    def __init__(
        self, 
        config: saas_test_17_models.Config,
    ):
        """
    ...
    def service_antcloud_openapi_gateway_check(
        self,
        request: saas_test_17_models.ServiceAntcloudOpenapiGatewayCheckRequest,
    ) -> saas_test_17_models.ServiceAntcloudOpenapiGatewayCheckResponse:
        """
    ...
    def init_demo_bbp_insurance_user(
        self,
        request: saas_test_17_models.InitDemoBbpInsuranceUserRequest,
    ) -> saas_test_17_models.InitDemoBbpInsuranceUserResponse:
        """
    ...
    def query_demo_gateway_check(
        self,
        request: saas_test_17_models.QueryDemoGatewayCheckRequest,
    ) -> saas_test_17_models.QueryDemoGatewayCheckResponse:
        """
        Description: ceshi
        Summary: ss
        """
