...
class UpdateAuthTaskRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('certContent', $this->certContent, true);
        Model::validateRequired('crowdConfig', $this->crowdConfig, true);
        Model::validateRequired('draft', $this->draft, true);
        Model::validateMaxLength('taskId', $this->taskId, 20);
