...
class DeleteDidUpdatedidServiceRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
     ...
     * @param array $map
     *
     * @return DeleteDidUpdatedidServiceRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['payload'])) {
            $model->payload = DidDeleteService::fromMap($map['payload']);
        }
