...
class UpdateDidUpdatedidAuthkeyRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
     ...
     * @param array $map
     *
     * @return UpdateDidUpdatedidAuthkeyRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['payload'])) {
            $model->payload = UpdateDidAuthPayload::fromMap($map['payload']);
        }
