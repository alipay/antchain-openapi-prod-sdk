...
class QueryCreditTransferIssuebytimeRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('issueOnle', $this->issueOnle, true);
    ...
    public function toMap()
    {
        ...
        if (null !== $this->issueOnle) {
            $res['issue_onle'] = $this->issueOnle;
        }
     ...
     * @param array $map
     *
     * @return QueryCreditTransferIssuebytimeRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['issue_onle'])) {
            $model->issueOnle = $map['issue_onle'];
        }
