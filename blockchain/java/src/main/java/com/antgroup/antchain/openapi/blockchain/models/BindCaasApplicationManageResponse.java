...
public class BindCaasApplicationManageResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public BindCaasApplicationManageResponse setReqMsgId(String reqMsgId) {
    ...
    public BindCaasApplicationManageResponse setResultCode(String resultCode) {
    ...
    public BindCaasApplicationManageResponse setResultMsg(String resultMsg) {
