...
public class CreateCaasApplicationManageResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public CreateCaasApplicationManageResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateCaasApplicationManageResponse setResultCode(String resultCode) {
    ...
    public CreateCaasApplicationManageResponse setResultMsg(String resultMsg) {
