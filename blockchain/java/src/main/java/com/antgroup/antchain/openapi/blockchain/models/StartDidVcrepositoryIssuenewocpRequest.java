...
public class StartDidVcrepositoryIssuenewocpRequest extends TeaModel {
    // OAuth模式下的授权token
    ...
    public static StartDidVcrepositoryIssuenewocpRequest build(java.util.Map<String, ?> map) throws Exception {
        StartDidVcrepositoryIssuenewocpRequest self = new StartDidVcrepositoryIssuenewocpRequest();
        return TeaModel.build(map, self);
    }

    public StartDidVcrepositoryIssuenewocpRequest setAuthToken(String authToken) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setProductInstanceId(String productInstanceId) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setAuthDidList(java.util.List<String> authDidList) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setBareClaim(BareClaim bareClaim) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setExpire(Long expire) {
        this.expire = expire;
        return this;
    }
    ...
    public StartDidVcrepositoryIssuenewocpRequest setIssuer(String issuer) {
        this.issuer = issuer;
        return this;
    }
    ...
    public StartDidVcrepositoryIssuenewocpRequest setSpecifiedClaimIdType(Long specifiedClaimIdType) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setSubject(String subject) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setType(java.util.List<String> type) {
        this.type = type;
        return this;
    }
    ...
    public StartDidVcrepositoryIssuenewocpRequest setVerifiableClaimId(String verifiableClaimId) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setVerifyStatusType(String verifyStatusType) {
    ...
    public StartDidVcrepositoryIssuenewocpRequest setBizCode(String bizCode) {
