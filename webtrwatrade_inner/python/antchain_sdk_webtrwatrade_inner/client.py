...
from antchain_sdk_webtrwatrade_inner import models as webtrwatrade__inner_models
...
class Client:
    ...
    def __init__(
        self, 
        config: webtrwatrade__inner_models.Config,
    ):
        """
    ...
    def query_platform_investmentreport(
        self,
        request: webtrwatrade__inner_models.QueryPlatformInvestmentreportRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_platform_investmentreport_ex(request, headers, runtime)

    async def query_platform_investmentreport_async(
        self,
        request: webtrwatrade__inner_models.QueryPlatformInvestmentreportRequest,
    ) -> webtrwatrade__inner_models.QueryPlatformInvestmentreportResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_platform_investmentreport_ex_async(request, headers, runtime)

    def query_platform_investmentreport_ex(
        self,
        request: webtrwatrade__inner_models.QueryPlatformInvestmentreportRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            webtrwatrade__inner_models.QueryPlatformInvestmentreportResponse(),
            self.do_request('1.0', 'antdigital.webtrwatradeinner.platform.investmentreport.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_platform_investmentreport_ex_async(
        self,
        request: webtrwatrade__inner_models.QueryPlatformInvestmentreportRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
