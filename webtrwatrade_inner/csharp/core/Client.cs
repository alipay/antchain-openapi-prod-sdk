...
using AntChain.SDK.WEBTRWATRADE_INNER.Models;

namespace AntChain.SDK.WEBTRWATRADE_INNER
{
    public class Client 
    {
         ...
         * Summary: 投资者报表查询
         */
        public QueryPlatformInvestmentreportResponse QueryPlatformInvestmentreport(QueryPlatformInvestmentreportRequest request)
        {
         ...
         * Summary: 投资者报表查询
         */
        public async Task<QueryPlatformInvestmentreportResponse> QueryPlatformInvestmentreportAsync(QueryPlatformInvestmentreportRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryPlatformInvestmentreportExAsync(request, headers, runtime);
        }
         ...
         * Summary: 投资者报表查询
         */
        public QueryPlatformInvestmentreportResponse QueryPlatformInvestmentreportEx(QueryPlatformInvestmentreportRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryPlatformInvestmentreportResponse>(DoRequest("1.0", "antdigital.webtrwatradeinner.platform.investmentreport.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 投资者报表查询
         */
        public async Task<QueryPlatformInvestmentreportResponse> QueryPlatformInvestmentreportExAsync(QueryPlatformInvestmentreportRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
