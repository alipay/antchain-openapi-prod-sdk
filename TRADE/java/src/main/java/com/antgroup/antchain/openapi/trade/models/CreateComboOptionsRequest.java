...
public class CreateComboOptionsRequest extends TeaModel {
    // OAuth模式下的授权token
    ...
    public CreateComboOptionsRequest setAuthToken(String authToken) {
    ...
    public CreateComboOptionsRequest setComboVid(String comboVid) {
    ...
    public CreateComboOptionsRequest setOu(String ou) {
        this.ou = ou;
        return this;
    }
    public String getOu() {
    ...
    public CreateComboOptionsRequest setTenantId(String tenantId) {
    ...
    public CreateComboOptionsRequest setSelectedConfigs(java.util.List<SelectedConfigItem> selectedConfigs) {
    ...
    public CreateComboOptionsRequest setRequestId(String requestId) {
    ...
    public CreateComboOptionsRequest setSaleMarket(String saleMarket) {
