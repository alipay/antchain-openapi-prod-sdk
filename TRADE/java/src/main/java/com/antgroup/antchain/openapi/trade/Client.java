...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "3.19.0"),
     ...
     */
    public QueryComboOptionsResponse queryComboOptions(QueryComboOptionsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryComboOptionsEx(request, headers, runtime);
    }
     ...
     * Summary: 查询套餐内各商品的可选规格列表，返回套餐基本信息及每个商品的可选规格、售卖规则校验结果</p>
     */
    public QueryComboOptionsResponse queryComboOptionsEx(QueryComboOptionsRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.trade.combo.options.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryComboOptionsResponse());
    }
     ...
     */
    public CreatewithoptionsComboResponse createwithoptionsCombo(CreatewithoptionsComboRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.createwithoptionsComboEx(request, headers, runtime);
    }
     ...
     * Summary: 户选择完套餐规格后调用，按自选规格创建套餐订单</p>
     */
    public CreatewithoptionsComboResponse createwithoptionsComboEx(CreatewithoptionsComboRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.trade.combo.createwithoptions", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CreatewithoptionsComboResponse());
    }
     ...
     */
    public CancelComboResponse cancelCombo(CancelComboRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.cancelComboEx(request, headers, runtime);
    }
     ...
     * Summary: 取消套餐订单，仅当订单处于 INIT（初始化）或 WAIT_CONFIRM（待确认）状态时允许取消</p>
     */
    public CancelComboResponse cancelComboEx(CancelComboRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.trade.combo.cancel", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CancelComboResponse());
    }
     ...
     * Summary: 户选择完套餐规格后调用，按自选规格创建套餐订单</p>
     */
    public CreateComboOptionsResponse createComboOptions(CreateComboOptionsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.createComboOptionsEx(request, headers, runtime);
    }
     ...
     * Summary: 户选择完套餐规格后调用，按自选规格创建套餐订单</p>
     */
    public CreateComboOptionsResponse createComboOptionsEx(CreateComboOptionsRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.trade.combo.options.create", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CreateComboOptionsResponse());
    }
    ...
    public GetOrderResponse getOrder(GetOrderRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.getOrderEx(request, headers, runtime);
    }
     ...
     * Summary: 单商品订单履约状态查询</p>
     */
    public GetOrderResponse getOrderEx(GetOrderRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.trade.order.get", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new GetOrderResponse());
    }
