...
public class OfferSyncCommonBuyInfo extends TeaModel {
    // 商品列表配置 ListJson字符串
    /**
    ...
    @Validation(required = true)
    public java.util.List<String> offerAttrConstraintsListJson;
    ...
    public static OfferSyncCommonBuyInfo build(java.util.Map<String, ?> map) throws Exception {
        OfferSyncCommonBuyInfo self = new OfferSyncCommonBuyInfo();
        return TeaModel.build(map, self);
    }

    public OfferSyncCommonBuyInfo setCommonBuySaleGroupListJson(java.util.List<String> commonBuySaleGroupListJson) {
    ...
    public OfferSyncCommonBuyInfo setOfferAttrListJson(java.util.List<String> offerAttrListJson) {
    ...
    public OfferSyncCommonBuyInfo setProdOfferRegionListJson(java.util.List<String> prodOfferRegionListJson) {
    ...
    public OfferSyncCommonBuyInfo setOfferAttrGroupListJson(java.util.List<String> offerAttrGroupListJson) {
    ...
    public OfferSyncCommonBuyInfo setOfferExtendAttrListJson(java.util.List<String> offerExtendAttrListJson) {
    ...
    public OfferSyncCommonBuyInfo setOfferCommonBuyGroupListJson(java.util.List<String> offerCommonBuyGroupListJson) {
    ...
    public OfferSyncCommonBuyInfo setOfferAttrConstraintsListJson(java.util.List<String> offerAttrConstraintsListJson) {
        this.offerAttrConstraintsListJson = offerAttrConstraintsListJson;
        return this;
    }
    public java.util.List<String> getOfferAttrConstraintsListJson() {
        return this.offerAttrConstraintsListJson;
    }

    public OfferSyncCommonBuyInfo setOfferRuleGroupListJson(java.util.List<String> offerRuleGroupListJson) {
