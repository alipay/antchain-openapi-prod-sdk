...
class ALiYunAntChain extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->restStatus) {
            $res['rest_status'] = $this->restStatus;
        }
        ...
        if (null !== $this->monitorStatus) {
            $res['monitor_status'] = $this->monitorStatus;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['rest_status'])) {
            $model->restStatus = $map['rest_status'];
        }
        ...
        if (isset($map['monitor_status'])) {
            $model->monitorStatus = $map['monitor_status'];
        }
