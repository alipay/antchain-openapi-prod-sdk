...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "1.8.47"),
    ...
    /**
     * <b>description</b> :
     * <p>Description: 票税企业收入评分接口
     * Summary: 票税企业收入评分接口</p>
     */
    public QueryIncomeEvaluationResponse queryIncomeEvaluation(QueryIncomeEvaluationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryIncomeEvaluationEx(request, headers, runtime);
    }
     ...
     * Summary: 票税企业收入评分接口</p>
     */
    public QueryIncomeEvaluationResponse queryIncomeEvaluationEx(QueryIncomeEvaluationRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.tax.income.evaluation.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryIncomeEvaluationResponse());
    }
}
