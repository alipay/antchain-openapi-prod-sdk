...
namespace AntChain\Ak_96b7ac46ad0f4adea5e182931e6c7abe;
...
use AntChain\Ak_96b7ac46ad0f4adea5e182931e6c7abe\Models\ConfirmAntchainBbpContractReconciliationRequest;
use AntChain\Ak_96b7ac46ad0f4adea5e182931e6c7abe\Models\ConfirmAntchainBbpContractReconciliationResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_96b7ac46ad0f4adea5e182931e6c7abe',
                    '_prod_channel'    => 'saas',
                ];
