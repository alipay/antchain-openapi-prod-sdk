...
export class PushBlockchainTaxIcmInvoiceRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
...
export class PushBlockchainTaxIcmInvoiceResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class PushBlockchainTaxIcmInvoiceinfoRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
...
export class PushBlockchainTaxIcmInvoiceinfoResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export default class Client {
   ...
   * Summary:  区块链发票信息推送
   */
  async pushBlockchainTaxIcmInvoice(request: PushBlockchainTaxIcmInvoiceRequest): Promise<PushBlockchainTaxIcmInvoiceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.pushBlockchainTaxIcmInvoiceEx(request, headers, runtime);
  }
   ...
   * Summary:  区块链发票信息推送
   */
  async pushBlockchainTaxIcmInvoiceEx(request: PushBlockchainTaxIcmInvoiceRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<PushBlockchainTaxIcmInvoiceResponse> {
    Util.validateModel(request);
    return $tea.cast<PushBlockchainTaxIcmInvoiceResponse>(await this.doRequest("1.0", "blockchain.tax.icm.invoice.push", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new PushBlockchainTaxIcmInvoiceResponse({}));
  }
   ...
   * Summary: 标准发票推送
   */
  async pushBlockchainTaxIcmInvoiceinfo(request: PushBlockchainTaxIcmInvoiceinfoRequest): Promise<PushBlockchainTaxIcmInvoiceinfoResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.pushBlockchainTaxIcmInvoiceinfoEx(request, headers, runtime);
  }
   ...
   * Summary: 标准发票推送
   */
  async pushBlockchainTaxIcmInvoiceinfoEx(request: PushBlockchainTaxIcmInvoiceinfoRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<PushBlockchainTaxIcmInvoiceinfoResponse> {
    Util.validateModel(request);
    return $tea.cast<PushBlockchainTaxIcmInvoiceinfoResponse>(await this.doRequest("1.0", "blockchain.tax.icm.invoiceinfo.push", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new PushBlockchainTaxIcmInvoiceinfoResponse({}));
  }
