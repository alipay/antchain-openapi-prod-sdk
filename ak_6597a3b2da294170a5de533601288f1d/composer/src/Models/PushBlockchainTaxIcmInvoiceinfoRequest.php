...
namespace AntChain\Ak_6597a3b2da294170a5de533601288f1d\Models;

use AlibabaCloud\Tea\Model;

class PushBlockchainTaxIcmInvoiceinfoRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
     ...
     * @param array $map
     *
     * @return PushBlockchainTaxIcmInvoiceinfoRequest
     */
