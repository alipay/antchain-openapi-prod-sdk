...
public class Client {
     ...
     * Summary: 测试接口
     */
    public QueryDemoDemoDefaultSdkdddResponse queryDemoDemoDefaultSdkddd(QueryDemoDemoDefaultSdkdddRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 测试接口
     */
    public QueryDemoDemoDefaultSdkdddResponse queryDemoDemoDefaultSdkdddEx(QueryDemoDemoDefaultSdkdddRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "demo.demo.default.sdkddd.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDemoDemoDefaultSdkdddResponse());
    }
}
