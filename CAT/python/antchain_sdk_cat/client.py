...
class Client:
    ...
    def a_workbench_test(
        self,
        request: cat_models.AWorkbenchTestRequest,
    ) -> cat_models.AWorkbenchTestResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.a_workbench_test_ex(request, headers, runtime)

    async def a_workbench_test_async(
        self,
        request: cat_models.AWorkbenchTestRequest,
    ) -> cat_models.AWorkbenchTestResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.a_workbench_test_ex_async(request, headers, runtime)

    def a_workbench_test_ex(
        self,
        request: cat_models.AWorkbenchTestRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            cat_models.AWorkbenchTestResponse(),
            self.do_request('1.0', 'antcloud.cat.workbench.test.a', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def a_workbench_test_ex_async(
        self,
        request: cat_models.AWorkbenchTestRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            cat_models.AWorkbenchTestResponse(),
            await self.do_request_async('1.0', 'antcloud.cat.workbench.test.a', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
