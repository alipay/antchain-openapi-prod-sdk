...
class DownloadApiSwaggerRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->swaggerJsonStr) {
            $res['swagger_json_str'] = $this->swaggerJsonStr;
        }
     ...
     * @param array $map
     *
     * @return DownloadApiSwaggerRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['swagger_json_str'])) {
            $model->swaggerJsonStr = $map['swagger_json_str'];
        }
