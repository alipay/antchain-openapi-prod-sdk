...
public class ListApiResponse extends TeaModel {
    ...
    public ListApiResponse setReqMsgId(String reqMsgId) {
    ...
    public ListApiResponse setResultCode(String resultCode) {
    ...
    public ListApiResponse setResultMsg(String resultMsg) {
    ...
    public ListApiResponse setData(ApiInfoPagedListVO data) {
        this.data = data;
        return this;
    }
