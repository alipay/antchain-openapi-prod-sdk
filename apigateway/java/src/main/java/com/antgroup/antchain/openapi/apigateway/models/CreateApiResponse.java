...
public class CreateApiResponse extends TeaModel {
    ...
    public CreateApiResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateApiResponse setResultCode(String resultCode) {
    ...
    public CreateApiResponse setResultMsg(String resultMsg) {
    ...
    public CreateApiResponse setData(ApiInfoVO data) {
        this.data = data;
        return this;
    }
