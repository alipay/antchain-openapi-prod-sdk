...
public class DeleteAppRequest extends TeaModel {
    ...
    public DeleteAppRequest setProductInstanceId(String productInstanceId) {
    ...
    public DeleteAppRequest setTenantId(String tenantId) {
    ...
    public DeleteAppRequest setWorkspaceId(String workspaceId) {
