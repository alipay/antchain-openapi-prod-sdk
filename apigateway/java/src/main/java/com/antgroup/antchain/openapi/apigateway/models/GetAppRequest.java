...
public class GetAppRequest extends TeaModel {
    ...
    public GetAppRequest setProductInstanceId(String productInstanceId) {
    ...
    public GetAppRequest setTenantId(String tenantId) {
    ...
    public GetAppRequest setWorkspaceId(String workspaceId) {
    ...
    public GetAppRequest setQueryType(String queryType) {
