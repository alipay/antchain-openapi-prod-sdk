...
public class UpdateAppRequest extends TeaModel {
    ...
    public UpdateAppRequest setProductInstanceId(String productInstanceId) {
    ...
    public UpdateAppRequest setParam(AppInfoVO param) {
        this.param = param;
        return this;
    }
    ...
    public UpdateAppRequest setTenantId(String tenantId) {
    ...
    public UpdateAppRequest setWorkspaceId(String workspaceId) {
