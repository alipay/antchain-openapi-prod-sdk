...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "1.33.1"),
    ...
    /**
     * <b>description</b> :
     * <p>Description: 风险报告包月订阅页面链接获取接口
     * Summary: 风险报告包月订阅页面链接获取接口</p>
     */
    public QueryBenefithubSubscriptionlinkResponse queryBenefithubSubscriptionlink(QueryBenefithubSubscriptionlinkRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 风险报告包月订阅页面链接获取接口</p>
     */
    public QueryBenefithubSubscriptionlinkResponse queryBenefithubSubscriptionlinkEx(QueryBenefithubSubscriptionlinkRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.benefithub.subscriptionlink.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryBenefithubSubscriptionlinkResponse());
    }
    ...
    /**
     * <b>description</b> :
     * <p>Description: 天枢系统-权益购买结果通知，用户购买权益后通知到天枢系统进行业务处理，自动提交用信申请
     * Summary: 天枢系统-权益购买结果通知</p>
     */
    public NotifyDubbridgeInterestResultResponse notifyDubbridgeInterestResult(NotifyDubbridgeInterestResultRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
    ...
    /**
     * <b>description</b> :
     * <p>Description: 授信申请-定制接口
     * Summary: 授信申请-定制接口</p>
     */
    public ApplyDubbridgeCreditLxResponse applyDubbridgeCreditLx(ApplyDubbridgeCreditLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 授信申请-定制接口</p>
     */
    public ApplyDubbridgeCreditLxResponse applyDubbridgeCreditLxEx(ApplyDubbridgeCreditLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.credit.lx.apply", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApplyDubbridgeCreditLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 授信结果查询，授信通过下会返回授信单最新额度信息
     * Summary: 授信结果查询</p>
     */
    public QueryDubbridgeCreditstatusLxResponse queryDubbridgeCreditstatusLx(QueryDubbridgeCreditstatusLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 授信结果查询</p>
     */
    public QueryDubbridgeCreditstatusLxResponse queryDubbridgeCreditstatusLxEx(QueryDubbridgeCreditstatusLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.creditstatus.lx.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeCreditstatusLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 用信申请提交
     * Summary: 用信申请</p>
     */
    public ApplyDubbridgeUsecreditLxResponse applyDubbridgeUsecreditLx(ApplyDubbridgeUsecreditLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用信申请</p>
     */
    public ApplyDubbridgeUsecreditLxResponse applyDubbridgeUsecreditLxEx(ApplyDubbridgeUsecreditLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.usecredit.lx.apply", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApplyDubbridgeUsecreditLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 用信结果查询
     * Summary: 用信结果查询</p>
     */
    public QueryDubbridgeUsecreditstatusLxResponse queryDubbridgeUsecreditstatusLx(QueryDubbridgeUsecreditstatusLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用信结果查询</p>
     */
    public QueryDubbridgeUsecreditstatusLxResponse queryDubbridgeUsecreditstatusLxEx(QueryDubbridgeUsecreditstatusLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.usecreditstatus.lx.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeUsecreditstatusLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 支用放款申请
     * Summary: 支用放款申请</p>
     */
    public ApplyDubbridgeLoanLxResponse applyDubbridgeLoanLx(ApplyDubbridgeLoanLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 支用放款申请</p>
     */
    public ApplyDubbridgeLoanLxResponse applyDubbridgeLoanLxEx(ApplyDubbridgeLoanLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.loan.lx.apply", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApplyDubbridgeLoanLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 支用结果查询
     * Summary: 支用结果查询</p>
     */
    public QueryDubbridgeLoanstatusLxResponse queryDubbridgeLoanstatusLx(QueryDubbridgeLoanstatusLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 支用结果查询</p>
     */
    public QueryDubbridgeLoanstatusLxResponse queryDubbridgeLoanstatusLxEx(QueryDubbridgeLoanstatusLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.loanstatus.lx.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeLoanstatusLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 流量方生成的还款计划，通知同步至天枢及下游资金方
     * Summary: 还款计划通知</p>
     */
    public NotifyDubbridgeRepaymentplanLxResponse notifyDubbridgeRepaymentplanLx(NotifyDubbridgeRepaymentplanLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 还款计划通知</p>
     */
    public NotifyDubbridgeRepaymentplanLxResponse notifyDubbridgeRepaymentplanLxEx(NotifyDubbridgeRepaymentplanLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.repaymentplan.lx.notify", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new NotifyDubbridgeRepaymentplanLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 还款代扣申请
     * Summary: 还款代扣申请</p>
     */
    public ApplyDubbridgeRepaywithholdLxResponse applyDubbridgeRepaywithholdLx(ApplyDubbridgeRepaywithholdLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 还款代扣申请</p>
     */
    public ApplyDubbridgeRepaywithholdLxResponse applyDubbridgeRepaywithholdLxEx(ApplyDubbridgeRepaywithholdLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.repaywithhold.lx.apply", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApplyDubbridgeRepaywithholdLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 还款代扣结果查询
     * Summary: 还款代扣结果查询</p>
     */
    public QueryDubbridgeRepaywithholdLxResponse queryDubbridgeRepaywithholdLx(QueryDubbridgeRepaywithholdLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 还款代扣结果查询</p>
     */
    public QueryDubbridgeRepaywithholdLxResponse queryDubbridgeRepaywithholdLxEx(QueryDubbridgeRepaywithholdLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.repaywithhold.lx.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeRepaywithholdLxResponse());
    }
     ...
     * Summary: 实还通知</p>
     */
    public NotifyDubbridgeRepaymentLxResponse notifyDubbridgeRepaymentLx(NotifyDubbridgeRepaymentLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 实还通知</p>
     */
    public NotifyDubbridgeRepaymentLxResponse notifyDubbridgeRepaymentLxEx(NotifyDubbridgeRepaymentLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.repayment.lx.notify", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new NotifyDubbridgeRepaymentLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 实还通知结果查询
     * Summary: 实还通知结果查询</p>
     */
    public QueryDubbridgeRepaymentLxResponse queryDubbridgeRepaymentLx(QueryDubbridgeRepaymentLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 实还通知结果查询</p>
     */
    public QueryDubbridgeRepaymentLxResponse queryDubbridgeRepaymentLxEx(QueryDubbridgeRepaymentLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.repayment.lx.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeRepaymentLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 已经授信通过的用户,无需重新进行授信申请,直接查询可用额度是否充足,以及是否在有效期内
     * Summary: 额度查询接口</p>
     */
    public QueryDubbridgeCreditamtLxResponse queryDubbridgeCreditamtLx(QueryDubbridgeCreditamtLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 额度查询接口</p>
     */
    public QueryDubbridgeCreditamtLxResponse queryDubbridgeCreditamtLxEx(QueryDubbridgeCreditamtLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.creditamt.lx.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeCreditamtLxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 结清证明、代偿凭证、放款凭证获取
     * Summary: 证明类文件获取</p>
     */
    public QueryDubbridgeCertificateLxResponse queryDubbridgeCertificateLx(QueryDubbridgeCertificateLxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 证明类文件获取</p>
     */
    public QueryDubbridgeCertificateLxResponse queryDubbridgeCertificateLxEx(QueryDubbridgeCertificateLxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.certificate.lx.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeCertificateLxResponse());
    }
    ...
    /**
     * <b>description</b> :
     * <p>Description: 用户解约额度信息查询
     * Summary: 用户解约额度信息查询</p>
     */
    public QueryDubbridgePetitemResponse queryDubbridgePetitem(QueryDubbridgePetitemRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用户解约额度信息查询</p>
     */
    public QueryDubbridgePetitemResponse queryDubbridgePetitemEx(QueryDubbridgePetitemRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petitem.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgePetitemResponse());
    }
     ...
     * Summary: 用户解约</p>
     */
    public ExecDubbridgePetitemResponse execDubbridgePetitem(ExecDubbridgePetitemRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用户解约</p>
     */
    public ExecDubbridgePetitemResponse execDubbridgePetitemEx(ExecDubbridgePetitemRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petitem.exec", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ExecDubbridgePetitemResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 用户资金分账
     * Summary: 用户资金分账</p>
     */
    public PushDubbridgePetitemResponse pushDubbridgePetitem(PushDubbridgePetitemRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用户资金分账</p>
     */
    public PushDubbridgePetitemResponse pushDubbridgePetitemEx(PushDubbridgePetitemRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petitem.push", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new PushDubbridgePetitemResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 用户逾期退款
     * Summary: 用户逾期退款</p>
     */
    public RefuseDubbridgePetitemResponse refuseDubbridgePetitem(RefuseDubbridgePetitemRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用户逾期退款</p>
     */
    public RefuseDubbridgePetitemResponse refuseDubbridgePetitemEx(RefuseDubbridgePetitemRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petitem.refuse", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new RefuseDubbridgePetitemResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 电子合同签署结果同步推送
     * Summary: 电子合同签署结果同步推送</p>
     */
    public PushDubbridgeContractsignResponse pushDubbridgeContractsign(PushDubbridgeContractsignRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 电子合同签署结果同步推送</p>
     */
    public PushDubbridgeContractsignResponse pushDubbridgeContractsignEx(PushDubbridgeContractsignRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.contractsign.push", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new PushDubbridgeContractsignResponse());
    }
    ...
    /**
     * <b>description</b> :
     * <p>Description: 商户入驻风控结果查询
     * Summary: 商户入驻风控结果查询</p>
     */
    public QueryDubbridgeMerchantriskResponse queryDubbridgeMerchantrisk(QueryDubbridgeMerchantriskRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 商户入驻风控结果查询</p>
     */
    public QueryDubbridgeMerchantriskResponse queryDubbridgeMerchantriskEx(QueryDubbridgeMerchantriskRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.merchantrisk.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgeMerchantriskResponse());
    }
     ...
     * Summary: 聚合收银台申请</p>
     */
    public ApplyDubbridgePetcashierGeneralResponse applyDubbridgePetcashierGeneral(ApplyDubbridgePetcashierGeneralRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 聚合收银台申请</p>
     */
    public ApplyDubbridgePetcashierGeneralResponse applyDubbridgePetcashierGeneralEx(ApplyDubbridgePetcashierGeneralRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petcashier.general.apply", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApplyDubbridgePetcashierGeneralResponse());
    }
     ...
     * Summary: 余额查询</p>
     */
    public QueryDubbridgePetFundResponse queryDubbridgePetFund(QueryDubbridgePetFundRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 余额查询</p>
     */
    public QueryDubbridgePetFundResponse queryDubbridgePetFundEx(QueryDubbridgePetFundRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.pet.fund.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgePetFundResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 商城创建储值卡消费订单（纯储值卡余额支付）
     * Summary: 商城创建储值卡消费订单（纯储值卡余额支付）</p>
     */
    public CreateDubbridgePetmallorderResponse createDubbridgePetmallorder(CreateDubbridgePetmallorderRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 商城创建储值卡消费订单（纯储值卡余额支付）</p>
     */
    public CreateDubbridgePetmallorderResponse createDubbridgePetmallorderEx(CreateDubbridgePetmallorderRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petmallorder.create", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CreateDubbridgePetmallorderResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 商城订单状态更新
     * Summary: 商城订单状态更新</p>
     */
    public UpdateDubbridgePetmallorderResponse updateDubbridgePetmallorder(UpdateDubbridgePetmallorderRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 商城订单状态更新</p>
     */
    public UpdateDubbridgePetmallorderResponse updateDubbridgePetmallorderEx(UpdateDubbridgePetmallorderRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petmallorder.update", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new UpdateDubbridgePetmallorderResponse());
    }
     ...
     * Summary: 退款申请</p>
     */
    public ApplyDubbridgePetrefundResponse applyDubbridgePetrefund(ApplyDubbridgePetrefundRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 退款申请</p>
     */
    public ApplyDubbridgePetrefundResponse applyDubbridgePetrefundEx(ApplyDubbridgePetrefundRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petrefund.apply", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApplyDubbridgePetrefundResponse());
    }
     ...
     * Summary: 退款结果查询</p>
     */
    public QueryDubbridgePetrefundResponse queryDubbridgePetrefund(QueryDubbridgePetrefundRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 退款结果查询</p>
     */
    public QueryDubbridgePetrefundResponse queryDubbridgePetrefundEx(QueryDubbridgePetrefundRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.dubbridge.petrefund.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDubbridgePetrefundResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 分账提交，接口支持幂等
     * Summary: 分账提交，接口支持幂等</p>
     */
    public ApplyDubbridgePetmallorderTransferResponse applyDubbridgePetmallorderTransfer(ApplyDubbridgePetmallorderTransferRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
    ...
    /**
     * <b>description</b> :
     * <p>Description: rfc外呼转化数据上传接口
     * Summary: rfc外呼转化数据上传接口</p>
     */
    public UploadRfcAiboundConvertResponse uploadRfcAiboundConvert(UploadRfcAiboundConvertRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: rfc外呼转化数据上传接口</p>
     */
    public UploadRfcAiboundConvertResponse uploadRfcAiboundConvertEx(UploadRfcAiboundConvertRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        if (!com.aliyun.teautil.Common.isUnset(request.fileObject)) {
            CreateAntcloudGatewayxFileUploadRequest uploadReq = CreateAntcloudGatewayxFileUploadRequest.build(TeaConverter.buildMap(
                new TeaPair("authToken", request.authToken),
                new TeaPair("apiCode", "riskplus.rfc.aibound.convert.upload"),
                new TeaPair("fileName", request.fileObjectName)
            ));
            CreateAntcloudGatewayxFileUploadResponse uploadResp = this.createAntcloudGatewayxFileUploadEx(uploadReq, headers, runtime);
            if (!com.antgroup.antchain.openapi.antchain.util.AntchainUtils.isSuccess(uploadResp.resultCode, "ok")) {
                UploadRfcAiboundConvertResponse uploadRfcAiboundConvertResponse = UploadRfcAiboundConvertResponse.build(TeaConverter.buildMap(
                    new TeaPair("reqMsgId", uploadResp.reqMsgId),
                    new TeaPair("resultCode", uploadResp.resultCode),
                    new TeaPair("resultMsg", uploadResp.resultMsg)
                ));
    ...
    /**
     * <b>description</b> :
     * <p>Description: 贷后提供的，纾困助手支付宝流水查询接口
     * Summary: 贷后提供的，纾困助手支付宝流水查询接口</p>
     */
    public QueryCreditshieldAlipayResponse queryCreditshieldAlipay(QueryCreditshieldAlipayRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 贷后提供的，纾困助手支付宝流水查询接口</p>
     */
    public QueryCreditshieldAlipayResponse queryCreditshieldAlipayEx(QueryCreditshieldAlipayRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.creditshield.alipay.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryCreditshieldAlipayResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 合作方回调服务
     * Summary: 合作方回调服务</p>
     */
    public CallbackCreditshieldPartnerResponse callbackCreditshieldPartner(CallbackCreditshieldPartnerRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 合作方回调服务</p>
     */
    public CallbackCreditshieldPartnerResponse callbackCreditshieldPartnerEx(CallbackCreditshieldPartnerRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.creditshield.partner.callback", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CallbackCreditshieldPartnerResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 接受案件信息
     * Summary: 接受案件信息</p>
     */
    public PushCreditshieldAllocatecaseResponse pushCreditshieldAllocatecase(PushCreditshieldAllocatecaseRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.pushCreditshieldAllocatecaseEx(request, headers, runtime);
    }
     ...
     * Summary: 接受案件信息</p>
     */
    public PushCreditshieldAllocatecaseResponse pushCreditshieldAllocatecaseEx(PushCreditshieldAllocatecaseRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.creditshield.allocatecase.push", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new PushCreditshieldAllocatecaseResponse());
    }
     ...
     * Summary: 退案接口</p>
     */
    public PushCreditshieldReturncaseResponse pushCreditshieldReturncase(PushCreditshieldReturncaseRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.pushCreditshieldReturncaseEx(request, headers, runtime);
    }
     ...
     * Summary: 退案接口</p>
     */
    public PushCreditshieldReturncaseResponse pushCreditshieldReturncaseEx(PushCreditshieldReturncaseRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.creditshield.returncase.push", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new PushCreditshieldReturncaseResponse());
    }
     ...
     * Summary: 资方回调</p>
     */
    public QueryCreditshieldFundcallbackResponse queryCreditshieldFundcallback(QueryCreditshieldFundcallbackRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryCreditshieldFundcallbackEx(request, headers, runtime);
    }
     ...
     * Summary: 资方回调</p>
     */
    public QueryCreditshieldFundcallbackResponse queryCreditshieldFundcallbackEx(QueryCreditshieldFundcallbackRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.creditshield.fundcallback.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryCreditshieldFundcallbackResponse());
    }
    ...
    /**
     * <b>description</b> :
     * <p>Description: ai圈投取消圈投任务接口
     * Summary: ai圈投取消圈投任务接口</p>
     */
    public CancelUmktCampaignResponse cancelUmktCampaign(CancelUmktCampaignRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: ai圈投取消圈投任务接口</p>
     */
    public CancelUmktCampaignResponse cancelUmktCampaignEx(CancelUmktCampaignRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "riskplus.umkt.campaign.cancel", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CancelUmktCampaignResponse());
    }
