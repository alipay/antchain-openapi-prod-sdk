...
class QueryBenefithubSubscriptionlinkRequest extends Model {
    protected $_name = [
    ...
    public function validate() {
        ...
        Model::validateRequired('sceneConfig', $this->sceneConfig, true);
    }
    ...
    /**
     * @param array $map
     * @return QueryBenefithubSubscriptionlinkRequest
     */
