...
using AntChain.SDK.Ak_24b462c17fab4e6998dcceeb37c41789.Models;

namespace AntChain.SDK.Ak_24b462c17fab4e6998dcceeb37c41789
{
    public class Client 
    {
         ...
         * Summary: 测试创建
         */
        public QueryDemoTestGatewayTestResponse QueryDemoTestGatewayTest(QueryDemoTestGatewayTestRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return QueryDemoTestGatewayTestEx(request, headers, runtime);
        }
         ...
         * Summary: 测试创建
         */
        public async Task<QueryDemoTestGatewayTestResponse> QueryDemoTestGatewayTestAsync(QueryDemoTestGatewayTestRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryDemoTestGatewayTestExAsync(request, headers, runtime);
        }
         ...
         * Summary: 测试创建
         */
        public QueryDemoTestGatewayTestResponse QueryDemoTestGatewayTestEx(QueryDemoTestGatewayTestRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryDemoTestGatewayTestResponse>(DoRequest("1.0", "demo.test.gateway.test.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 测试创建
         */
        public async Task<QueryDemoTestGatewayTestResponse> QueryDemoTestGatewayTestExAsync(QueryDemoTestGatewayTestRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryDemoTestGatewayTestResponse>(await DoRequestAsync("1.0", "demo.test.gateway.test.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
