...
from antchain_sdk_ak_24b462c17fab4e6998dcceeb37c41789 import models as ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models
...
class Client:
    ...
    def __init__(
        self, 
        config: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.Config,
    ):
        """
    ...
    def bind_demo_center_ability(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.BindDemoCenterAbilityRequest,
    ) -> ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.BindDemoCenterAbilityResponse:
        """
    ...
    def query_demo_test_gateway_test(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestGatewayTestRequest,
    ) -> ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestGatewayTestResponse:
        """
        Description: 测试使用
        Summary: 测试创建
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_demo_test_gateway_test_ex(request, headers, runtime)

    async def query_demo_test_gateway_test_async(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestGatewayTestRequest,
    ) -> ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestGatewayTestResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_demo_test_gateway_test_ex_async(request, headers, runtime)

    def query_demo_test_gateway_test_ex(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestGatewayTestRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def query_demo_test_gateway_test_ex_async(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestGatewayTestRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def query_demo_test_test(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestTestRequest,
    ) -> ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestTestResponse:
        """
        Description: 的
        Summary: 下载地址创建
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_demo_test_test_ex(request, headers, runtime)

    async def query_demo_test_test_async(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestTestRequest,
    ) -> ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestTestResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_demo_test_test_ex_async(request, headers, runtime)

    def query_demo_test_test_ex(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestTestRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def query_demo_test_test_ex_async(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.QueryDemoTestTestRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def bind_demo_test_test_test(
        self,
        request: ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.BindDemoTestTestTestRequest,
    ) -> ak__24b_462c_17fab_4e_6998dcceeb_37c_41789_models.BindDemoTestTestTestResponse:
        """
        Description: testaaa
        Summary: test
        """
