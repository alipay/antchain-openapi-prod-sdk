...
package com.antgroup.antchain.openapi.ak_24b462c17fab4e6998dcceeb37c41789;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.ak_24b462c17fab4e6998dcceeb37c41789.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("_prod_code", "ak_24b462c17fab4e6998dcceeb37c41789"),
     ...
     * Summary: 测试创建
     */
    public QueryDemoTestGatewayTestResponse queryDemoTestGatewayTest(QueryDemoTestGatewayTestRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 测试创建
     */
    public QueryDemoTestGatewayTestResponse queryDemoTestGatewayTestEx(QueryDemoTestGatewayTestRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "demo.test.gateway.test.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDemoTestGatewayTestResponse());
    }
