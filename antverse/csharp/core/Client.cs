...
using AntChain.SDK.ANTVERSE.Models;

namespace AntChain.SDK.ANTVERSE
{
    public class Client 
    {
         ...
         * Summary: 交互视频获取
         */
        public GetInteractvideoResponse GetInteractvideo(GetInteractvideoRequest request)
        {
         ...
         * Summary: 交互视频获取
         */
        public async Task<GetInteractvideoResponse> GetInteractvideoAsync(GetInteractvideoRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await GetInteractvideoExAsync(request, headers, runtime);
        }
         ...
         * Summary: 交互视频获取
         */
        public GetInteractvideoResponse GetInteractvideoEx(GetInteractvideoRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetInteractvideoResponse>(DoRequest("1.0", "antchain.antverse.interactvideo.get", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 交互视频获取
         */
        public async Task<GetInteractvideoResponse> GetInteractvideoExAsync(GetInteractvideoRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
