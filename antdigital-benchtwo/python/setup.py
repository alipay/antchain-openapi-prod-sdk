...
PACKAGE = "antchain_sdk_benchtwo"
NAME = "antchain_benchtwo" or "alibabacloud-package"
DESCRIPTION = "Ant Chain BENCHTWO SDK Library for Python"
AUTHOR = "Ant Chain SDK"
