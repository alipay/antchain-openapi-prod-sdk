...
package com.antgroup.antchain.openapi.ak_82ffffda241e4bae94aada878f384539.models;
...
public class EchoDemoGatewayCheckRequest extends TeaModel {
    ...
    public EchoDemoGatewayCheckRequest setOutputDemo(DemoClass outputDemo) {
    ...
    public EchoDemoGatewayCheckRequest setOutputString(String outputString) {
    ...
    public EchoDemoGatewayCheckRequest setFileUrl(String fileUrl) {
