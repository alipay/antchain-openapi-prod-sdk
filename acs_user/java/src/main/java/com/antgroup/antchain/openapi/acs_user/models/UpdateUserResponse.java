...
public class UpdateUserResponse extends TeaModel {
    ...
    public UpdateUserResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateUserResponse setResultCode(String resultCode) {
    ...
    public UpdateUserResponse setResultMsg(String resultMsg) {
    ...
    public UpdateUserResponse setUser(ACSUserInfo user) {
        this.user = user;
        return this;
    }
