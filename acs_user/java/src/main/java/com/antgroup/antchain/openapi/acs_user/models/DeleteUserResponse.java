...
public class DeleteUserResponse extends TeaModel {
    ...
    public DeleteUserResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteUserResponse setResultCode(String resultCode) {
    ...
    public DeleteUserResponse setResultMsg(String resultMsg) {
    ...
    public DeleteUserResponse setResult(Boolean result) {
        this.result = result;
        return this;
    }
