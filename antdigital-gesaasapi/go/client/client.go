...
type CallbackAntdigitalGesaasRightsprodOperationdataRequest struct {
	// OAuth模式下的授权token
...
func (s CallbackAntdigitalGesaasRightsprodOperationdataRequest) String() string {
	return tea.Prettify(s)
}

func (s CallbackAntdigitalGesaasRightsprodOperationdataRequest) GoString() string {
	return s.String()
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetAuthToken(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.AuthToken = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetProductInstanceId(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetNotifyId(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.NotifyId = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetRightsCode(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.RightsCode = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetVoucherCode(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.VoucherCode = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetBizType(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.BizType = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetPayOrderNo(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.PayOrderNo = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetFaceAmount(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.FaceAmount = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataRequest) SetFluxAmount(v string) *CallbackAntdigitalGesaasRightsprodOperationdataRequest {
	s.FluxAmount = &v
	return s
}

type CallbackAntdigitalGesaasRightsprodOperationdataResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
...
func (s CallbackAntdigitalGesaasRightsprodOperationdataResponse) String() string {
	return tea.Prettify(s)
}

func (s CallbackAntdigitalGesaasRightsprodOperationdataResponse) GoString() string {
	return s.String()
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataResponse) SetReqMsgId(v string) *CallbackAntdigitalGesaasRightsprodOperationdataResponse {
	s.ReqMsgId = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataResponse) SetResultCode(v string) *CallbackAntdigitalGesaasRightsprodOperationdataResponse {
	s.ResultCode = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataResponse) SetResultMsg(v string) *CallbackAntdigitalGesaasRightsprodOperationdataResponse {
	s.ResultMsg = &v
	return s
}

func (s *CallbackAntdigitalGesaasRightsprodOperationdataResponse) SetResult(v string) *CallbackAntdigitalGesaasRightsprodOperationdataResponse {
	s.Result = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("GESAASAPI"),
 ...
 * Summary: 权益中心API
 */
func (client *Client) CallbackAntdigitalGesaasRightsprodOperationdata(request *CallbackAntdigitalGesaasRightsprodOperationdataRequest) (_result *CallbackAntdigitalGesaasRightsprodOperationdataResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &CallbackAntdigitalGesaasRightsprodOperationdataResponse{}
	_body, _err := client.CallbackAntdigitalGesaasRightsprodOperationdataEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 权益中心API
 */
func (client *Client) CallbackAntdigitalGesaasRightsprodOperationdataEx(request *CallbackAntdigitalGesaasRightsprodOperationdataRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *CallbackAntdigitalGesaasRightsprodOperationdataResponse, _err error) {
