...
func (s QueryRetailScoreRequest) GoString() string {
	return s.String()
}

func (s *QueryRetailScoreRequest) SetAuthToken(v string) *QueryRetailScoreRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryRetailScoreRequest) SetProductInstanceId(v string) *QueryRetailScoreRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *QueryRetailScoreRequest) SetIndustryId(v string) *QueryRetailScoreRequest {
	s.IndustryId = &v
	return s
}

func (s *QueryRetailScoreRequest) SetUserId(v string) *QueryRetailScoreRequest {
	s.UserId = &v
	return s
}

func (s *QueryRetailScoreRequest) SetUserIdType(v string) *QueryRetailScoreRequest {
	s.UserIdType = &v
	return s
}

func (s *QueryRetailScoreRequest) SetEncryptType(v string) *QueryRetailScoreRequest {
	s.EncryptType = &v
	return s
}

func (s *QueryRetailScoreRequest) SetCustomerCode(v string) *QueryRetailScoreRequest {
	s.CustomerCode = &v
	return s
}

func (s *QueryRetailScoreRequest) SetTransNo(v string) *QueryRetailScoreRequest {
	s.TransNo = &v
	return s
}

func (s *QueryRetailScoreRequest) SetUserIdHashEncrypt(v string) *QueryRetailScoreRequest {
...
func (s QueryRetailScoreResponse) GoString() string {
	return s.String()
}

func (s *QueryRetailScoreResponse) SetReqMsgId(v string) *QueryRetailScoreResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryRetailScoreResponse) SetResultCode(v string) *QueryRetailScoreResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryRetailScoreResponse) SetResultMsg(v string) *QueryRetailScoreResponse {
	s.ResultMsg = &v
	return s
}

func (s *QueryRetailScoreResponse) SetScore(v string) *QueryRetailScoreResponse {
	s.Score = &v
	return s
}
 ...
 * Summary: 蚁盾零售行业评分
 */
func (client *Client) QueryRetailScore(request *QueryRetailScoreRequest) (_result *QueryRetailScoreResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryRetailScoreResponse{}
	_body, _err := client.QueryRetailScoreEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 蚁盾零售行业评分
 */
func (client *Client) QueryRetailScoreEx(request *QueryRetailScoreRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryRetailScoreResponse, _err error) {
