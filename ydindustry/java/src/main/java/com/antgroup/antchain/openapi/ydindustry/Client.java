...
package com.antgroup.antchain.openapi.ydindustry;
...
import com.antgroup.antchain.openapi.ydindustry.models.*;
...
public class Client {
    ...
    /**
     * <b>description</b> :
     * <p>Description: 蚁盾零售行业评分
     * Summary: 蚁盾零售行业评分</p>
     */
    public QueryRetailScoreResponse queryRetailScore(QueryRetailScoreRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryRetailScoreEx(request, headers, runtime);
    }
