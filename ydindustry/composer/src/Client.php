...
class Client
{
     ...
     * Summary: 蚁盾零售行业评分.
     *
     * @param QueryRetailScoreRequest $request
     *
     * @return QueryRetailScoreResponse
     */
    public function queryRetailScore($request)
    {
     ...
     * @return QueryRetailScoreResponse
     */
    public function queryRetailScoreEx($request, $headers, $runtime)
    {
