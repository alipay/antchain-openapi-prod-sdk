...
package com.antgroup.antchain.openapi.commercialexternal;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.commercialexternal.models.*;
...
public class Client {
    ...
    public QueryTradecoreMerchantinfoResponse queryTradecoreMerchantinfoEx(QueryTradecoreMerchantinfoRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.commercialexternal.tradecore.merchantinfo.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryTradecoreMerchantinfoResponse());
    }
    ...
    public BatchqueryTradecoreSoldspecinstanceResponse batchqueryTradecoreSoldspecinstanceEx(BatchqueryTradecoreSoldspecinstanceRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.commercialexternal.tradecore.soldspecinstance.batchquery", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new BatchqueryTradecoreSoldspecinstanceResponse());
    }
}
