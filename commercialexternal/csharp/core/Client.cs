...
using AntChain.SDK.COMMERCIALEXTERNAL.Models;

namespace AntChain.SDK.COMMERCIALEXTERNAL
{
    public class Client 
    {
        ...
        public QueryTradecoreMerchantinfoResponse QueryTradecoreMerchantinfoEx(QueryTradecoreMerchantinfoRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<QueryTradecoreMerchantinfoResponse>(DoRequest("1.0", "antcloud.commercialexternal.tradecore.merchantinfo.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryTradecoreMerchantinfoResponse>(await DoRequestAsync("1.0", "antcloud.commercialexternal.tradecore.merchantinfo.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<BatchqueryTradecoreSoldspecinstanceResponse>(DoRequest("1.0", "antcloud.commercialexternal.tradecore.soldspecinstance.batchquery", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<BatchqueryTradecoreSoldspecinstanceResponse>(await DoRequestAsync("1.0", "antcloud.commercialexternal.tradecore.soldspecinstance.batchquery", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
