...
from antchain_sdk_commercialexternal import models as commercialexternal_models
...
class Client:
    ...
    def __init__(
        self, 
        config: commercialexternal_models.Config,
    ):
        """
    ...
    def query_tradecore_merchantinfo(
        self,
        request: commercialexternal_models.QueryTradecoreMerchantinfoRequest,
    ) -> commercialexternal_models.QueryTradecoreMerchantinfoResponse:
        """
    ...
    def query_tradecore_merchantinfo_ex(
        ...
        """
        UtilClient.validate_model(request)
        return commercialexternal_models.QueryTradecoreMerchantinfoResponse().from_map(
            self.do_request('1.0', 'antcloud.commercialexternal.tradecore.merchantinfo.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
    ...
    async def query_tradecore_merchantinfo_ex_async(
        ...
        UtilClient.validate_model(request)
        return commercialexternal_models.QueryTradecoreMerchantinfoResponse().from_map(
            await self.do_request_async('1.0', 'antcloud.commercialexternal.tradecore.merchantinfo.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def batchquery_tradecore_soldspecinstance(
        self,
        request: commercialexternal_models.BatchqueryTradecoreSoldspecinstanceRequest,
    ) -> commercialexternal_models.BatchqueryTradecoreSoldspecinstanceResponse:
        """
    ...
    def batchquery_tradecore_soldspecinstance_ex(
        ...
        """
        UtilClient.validate_model(request)
        return commercialexternal_models.BatchqueryTradecoreSoldspecinstanceResponse().from_map(
            self.do_request('1.0', 'antcloud.commercialexternal.tradecore.soldspecinstance.batchquery', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
    ...
    async def batchquery_tradecore_soldspecinstance_ex_async(
        ...
        UtilClient.validate_model(request)
        return commercialexternal_models.BatchqueryTradecoreSoldspecinstanceResponse().from_map(
            await self.do_request_async('1.0', 'antcloud.commercialexternal.tradecore.soldspecinstance.batchquery', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
