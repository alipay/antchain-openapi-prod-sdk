...
class BindDemoSssSsSsRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class BindDemoSssSsSsResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class QueryDemoTestTestobjectBbbRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryDemoTestTestobjectBbbResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class BindDemoSdfSssSssRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class BindDemoSdfSssSssResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class RegisterDemoTestBizeventMessageRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class RegisterDemoTestBizeventMessageResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryDemoZolozFacecompareRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryDemoZolozFacecompareResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
