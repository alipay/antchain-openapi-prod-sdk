...
class QueryAntcloudAdomAppmarketPrivacyresultRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class QueryAntcloudAdomAppmarketPrivacyresultResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class UploadAntcloudAdomAppmarketFileResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ExecAntcloudAdomAppmarketPrivacymodelRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        instance_id: str = None,
