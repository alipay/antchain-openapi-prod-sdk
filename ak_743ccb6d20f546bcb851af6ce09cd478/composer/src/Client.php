...
namespace AntChain\Ak_743ccb6d20f546bcb851af6ce09cd478;
...
class Client
{
     ...
     * Summary: 查询身份标签分数.
     *
     * @param QueryIdentityTagScoreRequest $request
     *
     * @return QueryIdentityTagScoreResponse
     */
    public function queryIdentityTagScore($request)
    {
     ...
     * @return QueryIdentityTagScoreResponse
     */
    public function queryIdentityTagScoreEx($request, $headers, $runtime)
    {
