...
class QueryAntchainBbpEnterpriseBusinessscopeRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class QueryAntchainBbpEnterpriseBusinessscopeResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
        result_msg: str = None,
        ep_business_scope: str = None,
    ):
        # 请求唯一ID，用于链路跟踪和问题排查
        ...
        # 企业经营范围
        self.ep_business_scope = ep_business_scope
    ...
    def to_map(self):
        ...
        if self.ep_business_scope is not None:
            result['ep_business_scope'] = self.ep_business_scope
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ep_business_scope') is not None:
            self.ep_business_scope = m.get('ep_business_scope')
        return self
