...
class Client:
    ...
    def query_antchain_abc_approval_test(
        self,
        request: demosdk_models.QueryAntchainAbcApprovalTestRequest,
    ) -> demosdk_models.QueryAntchainAbcApprovalTestResponse:
        """
    ...
    def api_antchain_abc_test_create(
        self,
        request: demosdk_models.ApiAntchainAbcTestCreateRequest,
    ) -> demosdk_models.ApiAntchainAbcTestCreateResponse:
        """
        Description: 测试使用api
        Summary: 测试使用api
        """
