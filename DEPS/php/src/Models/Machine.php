...
class Machine extends Model {
    ...
    public function validate() {
        ...
        Model::validateRequired('servicePackageVersion', $this->servicePackageVersion, true);
        ...
        Model::validateRequired('paasState', $this->paasState, true);
        Model::validateRequired('refTargetId', $this->refTargetId, true);
        Model::validateRequired('targetIaasId', $this->targetIaasId, true);
        Model::validateRequired('innerIp', $this->innerIp, true);
        Model::validateRequired('publicIp', $this->publicIp, true);
        Model::validateRequired('hostName', $this->hostName, true);
        Model::validateRequired('hostDomain', $this->hostDomain, true);
        Model::validateRequired('securityDomainId', $this->securityDomainId, true);
        Model::validateRequired('securityDomainCreatorId', $this->securityDomainCreatorId, true);
        Model::validateRequired('securityDomainName', $this->securityDomainName, true);
        ...
        Model::validateRequired('encodedPwd', $this->encodedPwd, true);
        Model::validateRequired('encodedSecreyKey', $this->encodedSecreyKey, true);
        Model::validateRequired('publicKey', $this->publicKey, true);
        Model::validateRequired('starManagerIp', $this->starManagerIp, true);
        Model::validateRequired('starManagerPort', $this->starManagerPort, true);
        Model::validateRequired('scriptUrl', $this->scriptUrl, true);
        Model::validateRequired('specialScriptUrl', $this->specialScriptUrl, true);
        Model::validateRequired('agentUrl', $this->agentUrl, true);
        Model::validateRequired('agentSetupUrl', $this->agentSetupUrl, true);
        Model::validateRequired('machineInitUrl', $this->machineInitUrl, true);
        Model::validateRequired('specialMachineInitUrl', $this->specialMachineInitUrl, true);
        Model::validateRequired('controlType', $this->controlType, true);
        Model::validateRequired('controlTarget', $this->controlTarget, true);
        Model::validateRequired('needInitialize', $this->needInitialize, true);
        Model::validateRequired('slbInfoList', $this->slbInfoList, true);
