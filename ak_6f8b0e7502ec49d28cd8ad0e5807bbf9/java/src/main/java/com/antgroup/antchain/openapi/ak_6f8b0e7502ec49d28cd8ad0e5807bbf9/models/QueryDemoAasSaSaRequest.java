...
public class QueryDemoAasSaSaRequest extends TeaModel {
    // OAuth模式下的授权token
    ...
    public QueryDemoAasSaSaRequest setAuthToken(String authToken) {
    ...
    public QueryDemoAasSaSaRequest setProductInstanceId(String productInstanceId) {
