...
public class QueryProjectResponse extends TeaModel {
    ...
    // 页面内容
    @NameInMap("pages")
    public java.util.List<Project> pages;
    ...
    public QueryProjectResponse setPages(java.util.List<Project> pages) {
        this.pages = pages;
        return this;
    }
    public java.util.List<Project> getPages() {
        return this.pages;
    }

    public QueryProjectResponse setTotalCount(Long totalCount) {
