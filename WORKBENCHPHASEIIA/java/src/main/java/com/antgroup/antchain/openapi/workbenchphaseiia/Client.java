...
package com.antgroup.antchain.openapi.workbenchphaseiia;
...
import com.antgroup.antchain.openapi.workbenchphaseiia.models.*;
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("_prod_code", "WORKBENCHPHASEIIA"),
    ...
    public ApiaCliCreateResponse apiaCliCreateEx(ApiaCliCreateRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        if (!com.aliyun.teautil.Common.isUnset(request.fileObject)) {
            ...
            if (!com.antgroup.antchain.openapi.antchain.util.AntchainUtils.isSuccess(uploadResp.resultCode, "ok")) {
                ApiaCliCreateResponse apiaCliCreateResponse = ApiaCliCreateResponse.build(TeaConverter.buildMap(
        ...
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.workbenchphaseiia.cli.create.apia", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApiaCliCreateResponse());
    }
