...
using AntChain.SDK.Ak_e3c3c9afe8cc46f7950be87f72fedc15.Models;

namespace AntChain.SDK.Ak_e3c3c9afe8cc46f7950be87f72fedc15
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_e3c3c9afe8cc46f7950be87f72fedc15"},
                        {"_prod_channel", "saas"},
                    };
