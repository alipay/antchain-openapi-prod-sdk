...
from antchain_sdk_ak_6a3cfc6072134ba281d01d1291482ff5 import models as ak__6a_3cfc_6072134ba_281d_01d_1291482ff_5_models
...
class Client:
    ...
    def __init__(
        self, 
        config: ak__6a_3cfc_6072134ba_281d_01d_1291482ff_5_models.Config,
    ):
        """
        ...
        while TeaCore.allow_retry(_runtime.get('retry'), _retry_times, _now):
            ...
            try:
                ...
                _request.query = {
                    ...
                    'sdk_version': '1.0.0',
                    '_prod_code': 'ak_6a3cfc6072134ba281d01d1291482ff5',
                    '_prod_channel': 'saas'
                }
    ...
    def confirm_antchain_bbp_contract_reconciliation(
        self,
        request: ak__6a_3cfc_6072134ba_281d_01d_1291482ff_5_models.ConfirmAntchainBbpContractReconciliationRequest,
    ) -> ak__6a_3cfc_6072134ba_281d_01d_1291482ff_5_models.ConfirmAntchainBbpContractReconciliationResponse:
        """
        Description: 结算单确认
        Summary: 结算单确认
        """
