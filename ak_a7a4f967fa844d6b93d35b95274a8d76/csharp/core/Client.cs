...
using AntChain.SDK.Ak_a7a4f967fa844d6b93d35b95274a8d76.Models;

namespace AntChain.SDK.Ak_a7a4f967fa844d6b93d35b95274a8d76
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_a7a4f967fa844d6b93d35b95274a8d76"},
                        {"_prod_channel", "saas"},
                    };
