...
namespace AntChain\Ak_8146025f0aa2474a88d81f508253e029;
...
class Client
{
     ...
     * Summary: 设备风险查询.
     *
     * @param QueryHksecuritytechGatewayDeviceriskFingerRequest $request
     *
     * @return QueryHksecuritytechGatewayDeviceriskFingerResponse
     */
    public function queryHksecuritytechGatewayDeviceriskFinger($request)
    {
     ...
     * @return QueryHksecuritytechGatewayDeviceriskFingerResponse
     */
    public function queryHksecuritytechGatewayDeviceriskFingerEx($request, $headers, $runtime)
    {
