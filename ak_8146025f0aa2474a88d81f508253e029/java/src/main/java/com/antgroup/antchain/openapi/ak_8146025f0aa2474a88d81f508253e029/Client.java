...
package com.antgroup.antchain.openapi.ak_8146025f0aa2474a88d81f508253e029;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.ak_8146025f0aa2474a88d81f508253e029.models.*;
...
public class Client {
     ...
     * Summary: 设备风险查询
     */
    public QueryHksecuritytechGatewayDeviceriskFingerResponse queryHksecuritytechGatewayDeviceriskFinger(QueryHksecuritytechGatewayDeviceriskFingerRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryHksecuritytechGatewayDeviceriskFingerEx(request, headers, runtime);
    }
