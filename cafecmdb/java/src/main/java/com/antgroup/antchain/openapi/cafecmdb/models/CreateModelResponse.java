...
public class CreateModelResponse extends TeaModel {
    ...
    public CreateModelResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateModelResponse setResultCode(String resultCode) {
    ...
    public CreateModelResponse setResultMsg(String resultMsg) {
    ...
    public CreateModelResponse setData(Model data) {
        this.data = data;
        return this;
    }
