...
public class DeleteItemResponse extends TeaModel {
    ...
    public DeleteItemResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteItemResponse setResultCode(String resultCode) {
    ...
    public DeleteItemResponse setResultMsg(String resultMsg) {
