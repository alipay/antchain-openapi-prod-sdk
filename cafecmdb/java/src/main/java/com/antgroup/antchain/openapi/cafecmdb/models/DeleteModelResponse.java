...
public class DeleteModelResponse extends TeaModel {
    ...
    public DeleteModelResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteModelResponse setResultCode(String resultCode) {
    ...
    public DeleteModelResponse setResultMsg(String resultMsg) {
