...
public class GetItemResponse extends TeaModel {
    ...
    public GetItemResponse setReqMsgId(String reqMsgId) {
    ...
    public GetItemResponse setResultCode(String resultCode) {
    ...
    public GetItemResponse setResultMsg(String resultMsg) {
    ...
    public GetItemResponse setData(Item data) {
        this.data = data;
        return this;
    }
    public Item getData() {
