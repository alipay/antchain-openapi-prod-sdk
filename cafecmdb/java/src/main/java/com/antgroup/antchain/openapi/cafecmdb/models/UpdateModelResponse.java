...
public class UpdateModelResponse extends TeaModel {
    ...
    public UpdateModelResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateModelResponse setResultCode(String resultCode) {
    ...
    public UpdateModelResponse setResultMsg(String resultMsg) {
    ...
    public UpdateModelResponse setData(Model data) {
        this.data = data;
        return this;
    }
