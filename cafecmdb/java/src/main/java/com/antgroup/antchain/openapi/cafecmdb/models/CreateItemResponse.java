...
public class CreateItemResponse extends TeaModel {
    ...
    public CreateItemResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateItemResponse setResultCode(String resultCode) {
    ...
    public CreateItemResponse setResultMsg(String resultMsg) {
