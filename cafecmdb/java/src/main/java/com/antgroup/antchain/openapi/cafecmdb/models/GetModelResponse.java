...
public class GetModelResponse extends TeaModel {
    ...
    public GetModelResponse setReqMsgId(String reqMsgId) {
    ...
    public GetModelResponse setResultCode(String resultCode) {
    ...
    public GetModelResponse setResultMsg(String resultMsg) {
    ...
    public GetModelResponse setData(Model data) {
        this.data = data;
        return this;
    }
