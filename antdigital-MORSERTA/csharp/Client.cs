...
namespace AntChain.SDK.MORSERTA
{
    public class Client 
    {
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: RTA广告主数据回传
        /// Summary: RTA广告主数据回传</para>
        /// </description>
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: 转化数据回传接口
        /// Summary: 转化数据回传接口</para>
        /// </description>
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: 曝光/点击数据回传接口
        /// Summary: 曝光/点击数据回传接口</para>
        /// </description>
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: 广告主通过该接口将归因后的转化数据回传给数科，数科回传至广告主
        /// Summary: 广告主通过该接口将归因后的转化数据回传给数科，数科回传至广告主</para>
        /// </description>
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: 实验效果数据拉取接口
        /// Summary: 实验效果数据拉取接口</para>
        /// </description>
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: 接收未归因的转化数据
        /// Summary: 接收未归因的转化数据</para>
        /// </description>
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: 接收客户已归因转化事件
        /// Summary: 接收客户已归因转化事件</para>
        /// </description>
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>Description: 新版转化回传接口
        /// Summary: 新版转化回传接口</para>
        /// </description>
