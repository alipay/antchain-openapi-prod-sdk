...
class QueryBacktrackScoreRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('sampleDate', $this->sampleDate, true);
    }
    ...
    public function toMap()
    {
        ...
        if (null !== $this->sampleDate) {
            $res['sample_date'] = $this->sampleDate;
        }
     ...
     * @param array $map
     *
     * @return QueryBacktrackScoreRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['sample_date'])) {
            $model->sampleDate = $map['sample_date'];
        }
