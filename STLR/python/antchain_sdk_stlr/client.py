...
class Client:
    ...
    def query_product_data(
        self,
        request: stlr_models.QueryProductDataRequest,
    ) -> stlr_models.QueryProductDataResponse:
        """
        Description: 产品产量填报检查接口
        Summary: 产品产量填报检查接口
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_product_data_ex(request, headers, runtime)

    async def query_product_data_async(
        self,
        request: stlr_models.QueryProductDataRequest,
    ) -> stlr_models.QueryProductDataResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_product_data_ex_async(request, headers, runtime)

    def query_product_data_ex(
        self,
        request: stlr_models.QueryProductDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.QueryProductDataResponse(),
            self.do_request('1.0', 'antchain.carbon.product.data.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_product_data_ex_async(
        self,
        request: stlr_models.QueryProductDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.QueryProductDataResponse(),
            await self.do_request_async('1.0', 'antchain.carbon.product.data.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def push_product_data(
        self,
        request: stlr_models.PushProductDataRequest,
    ) -> stlr_models.PushProductDataResponse:
        """
        Description: 协鑫数据直连产品产量填报接口
        Summary: 协鑫数据直连产品产量填报接口
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.push_product_data_ex(request, headers, runtime)

    async def push_product_data_async(
        self,
        request: stlr_models.PushProductDataRequest,
    ) -> stlr_models.PushProductDataResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.push_product_data_ex_async(request, headers, runtime)

    def push_product_data_ex(
        self,
        request: stlr_models.PushProductDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.PushProductDataResponse(),
            self.do_request('1.0', 'antchain.carbon.product.data.push', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def push_product_data_ex_async(
        self,
        request: stlr_models.PushProductDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.PushProductDataResponse(),
            await self.do_request_async('1.0', 'antchain.carbon.product.data.push', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def query_active_data(
        self,
        request: stlr_models.QueryActiveDataRequest,
    ) -> stlr_models.QueryActiveDataResponse:
        """
        Description: 协鑫数据直连lca活动数据项查询
        Summary: 协鑫数据直连lca活动数据项查询
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_active_data_ex(request, headers, runtime)

    async def query_active_data_async(
        self,
        request: stlr_models.QueryActiveDataRequest,
    ) -> stlr_models.QueryActiveDataResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_active_data_ex_async(request, headers, runtime)

    def query_active_data_ex(
        self,
        request: stlr_models.QueryActiveDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.QueryActiveDataResponse(),
            self.do_request('1.0', 'antchain.carbon.active.data.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_active_data_ex_async(
        self,
        request: stlr_models.QueryActiveDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.QueryActiveDataResponse(),
            await self.do_request_async('1.0', 'antchain.carbon.active.data.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def exec_active_data(
        self,
        request: stlr_models.ExecActiveDataRequest,
    ) -> stlr_models.ExecActiveDataResponse:
        """
        Description: 协鑫数据直连lca活动数据检查接口
        Summary: 协鑫数据直连lca活动数据检查接口
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.exec_active_data_ex(request, headers, runtime)

    async def exec_active_data_async(
        self,
        request: stlr_models.ExecActiveDataRequest,
    ) -> stlr_models.ExecActiveDataResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.exec_active_data_ex_async(request, headers, runtime)

    def exec_active_data_ex(
        self,
        request: stlr_models.ExecActiveDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.ExecActiveDataResponse(),
            self.do_request('1.0', 'antchain.carbon.active.data.exec', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def exec_active_data_ex_async(
        self,
        request: stlr_models.ExecActiveDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.ExecActiveDataResponse(),
            await self.do_request_async('1.0', 'antchain.carbon.active.data.exec', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def push_active_data(
        self,
        request: stlr_models.PushActiveDataRequest,
    ) -> stlr_models.PushActiveDataResponse:
        """
        Description: 协鑫数据直连lca活动数据填报
        Summary: 协鑫数据直连lca活动数据填报
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.push_active_data_ex(request, headers, runtime)

    async def push_active_data_async(
        self,
        request: stlr_models.PushActiveDataRequest,
    ) -> stlr_models.PushActiveDataResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.push_active_data_ex_async(request, headers, runtime)

    def push_active_data_ex(
        self,
        request: stlr_models.PushActiveDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            stlr_models.PushActiveDataResponse(),
            self.do_request('1.0', 'antchain.carbon.active.data.push', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def push_active_data_ex_async(
        self,
        request: stlr_models.PushActiveDataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
