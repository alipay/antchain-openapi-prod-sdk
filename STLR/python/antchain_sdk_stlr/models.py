...
class QueryProductDataRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
        item_list: List[GclProductionItem] = None,
    ):
        # OAuth模式下的授权token
        self.auth_token = auth_token
        self.product_instance_id = product_instance_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('item_list') is not None:
            for k in m.get('item_list'):
                temp_model = GclProductionItem()
                self.item_list.append(temp_model.from_map(k))
        return self


class QueryProductDataResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
        result_msg: str = None,
        success: bool = None,
        abnormal_item_list: List[GclAbnormalItem] = None,
    ):
        # 请求唯一ID，用于链路跟踪和问题排查
        self.req_msg_id = req_msg_id
        # 结果码，一般OK表示调用成功
        ...
        # 异常明细列表
        self.abnormal_item_list = abnormal_item_list

    def validate(self):
        if self.abnormal_item_list:
            for k in self.abnormal_item_list:
                if k:
                    k.validate()
    ...
    def to_map(self):
        ...
        result['abnormal_item_list'] = []
        if self.abnormal_item_list is not None:
            for k in self.abnormal_item_list:
                result['abnormal_item_list'].append(k.to_map() if k else None)
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        self.abnormal_item_list = []
        if m.get('abnormal_item_list') is not None:
            for k in m.get('abnormal_item_list'):
                temp_model = GclAbnormalItem()
                self.abnormal_item_list.append(temp_model.from_map(k))
        return self


class PushProductDataRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class PushProductDataResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryActiveDataRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
        ...
        self.input_by_process = input_by_process

    def validate(self):
        self.validate_required(self.location_name, 'location_name')
        self.validate_required(self.product_name, 'product_name')
        self.validate_required(self.specification, 'specification')
        self.validate_required(self.input_by_process, 'input_by_process')
    ...
    def to_map(self):
        ...
        if self.specification is not None:
            result['specification'] = self.specification
        if self.data_dimension is not None:
            result['data_dimension'] = self.data_dimension
        if self.input_by_process is not None:
            result['input_by_process'] = self.input_by_process
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('specification') is not None:
            self.specification = m.get('specification')
        if m.get('data_dimension') is not None:
            self.data_dimension = m.get('data_dimension')
        if m.get('input_by_process') is not None:
            self.input_by_process = m.get('input_by_process')
        return self


class QueryActiveDataResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ExecActiveDataRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
        ...
        data_dimension: str = None,
        input_by_process: bool = None,
        item_list: List[ActiveDataItem] = None,
    ):
        # OAuth模式下的授权token
        self.auth_token = auth_token
        self.product_instance_id = product_instance_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('item_list') is not None:
            for k in m.get('item_list'):
                temp_model = ActiveDataItem()
                self.item_list.append(temp_model.from_map(k))
        return self


class ExecActiveDataResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class PushActiveDataRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class PushActiveDataResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
