...
// 异常明细列表，检查通过时为空
export class GclAbnormalItem extends $tea.Model {
  // 明细编码
  /**
   * @example
   * xxxx
...
// 活动数据填报
export class ActiveDataItem extends $tea.Model {
  // 明细编码，用于异常回传和排查
  /**
   * @example
   * xxxx
   ...
   * undefined
   */
  activeDataList: MonthDataDetail[];
  // 单元过程编码
  /**
   * @example
   * xxxx
...
// 分页查询角色
export class RoleList extends $tea.Model {
  // 角色编码
  /**
   * @example
   * xxxxx
...
export class QueryProductDataRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 产品产量明细列表
  itemList: GclProductionItem[];
  static names(): { [key: string]: string } {
    return {
      authToken: 'auth_token',
      productInstanceId: 'product_instance_id',
  ...
  static types(): { [key: string]: any } {
    return {
      authToken: 'string',
      productInstanceId: 'string',
      itemList: { 'type': 'array', 'itemType': GclProductionItem },
    };
  }
...
export class QueryProductDataResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
  ...
  success?: boolean;
  // 异常明细列表
  abnormalItemList?: GclAbnormalItem[];
  static names(): { [key: string]: string } {
    return {
      reqMsgId: 'req_msg_id',
      resultCode: 'result_code',
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      resultMsg: 'string',
      success: 'boolean',
      abnormalItemList: { 'type': 'array', 'itemType': GclAbnormalItem },
    };
  }
...
export class PushProductDataRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 产品产量填报
...
export class PushProductDataResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryActiveDataRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 生产单元名称
...
export class QueryActiveDataResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class ExecActiveDataRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 生产单元名称
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      dataDimension: 'string',
      inputByProcess: 'boolean',
      itemList: { 'type': 'array', 'itemType': ActiveDataItem },
    };
  }
...
export class ExecActiveDataResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class PushActiveDataRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 生产单元名称
...
export class PushActiveDataResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class ExecEsgVerifytokenRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 碳矩阵签发的一次性凭证。
...
export class ExecEsgVerifytokenResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      resultCode: 'string',
      resultMsg: 'string',
      roleNos: { 'type': 'array', 'itemType': 'string' },
      userId: 'string',
      userName: 'string',
      nickName: 'string',
      realName: 'string',
...
export class QueryEsgListrolesRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 当前默认为1的页码
...
export class QueryEsgListrolesResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryEsgOrganizationunittreeRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // verifyToken中的企业编码
...
export class QueryEsgOrganizationunittreeResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryEsgListbyroleRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 不能为空，且必须属于当前企业
...
export class QueryEsgListbyroleResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      pageSize: 'number',
      total: 'number',
      list: { 'type': 'array', 'itemType': OperatorList },
    };
  }
...
export default class Client {
   ...
   * Summary: 产品产量填报检查接口
   */
  async queryProductData(request: QueryProductDataRequest): Promise<QueryProductDataResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryProductDataEx(request, headers, runtime);
  }
   ...
   * Summary: 产品产量填报检查接口
   */
  async queryProductDataEx(request: QueryProductDataRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryProductDataResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryProductDataResponse>(await this.doRequest("1.0", "antchain.carbon.product.data.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryProductDataResponse({}));
  }
   ...
   */
  async pushProductData(request: PushProductDataRequest): Promise<PushProductDataResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.pushProductDataEx(request, headers, runtime);
  }
   ...
   * Summary: 协鑫数据直连产品产量填报接口
   */
  async pushProductDataEx(request: PushProductDataRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<PushProductDataResponse> {
    Util.validateModel(request);
    return $tea.cast<PushProductDataResponse>(await this.doRequest("1.0", "antchain.carbon.product.data.push", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new PushProductDataResponse({}));
  }
   ...
   */
  async queryActiveData(request: QueryActiveDataRequest): Promise<QueryActiveDataResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryActiveDataEx(request, headers, runtime);
  }
   ...
   * Summary: 协鑫数据直连lca活动数据项查询
   */
  async queryActiveDataEx(request: QueryActiveDataRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryActiveDataResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryActiveDataResponse>(await this.doRequest("1.0", "antchain.carbon.active.data.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryActiveDataResponse({}));
  }
   ...
   */
  async execActiveData(request: ExecActiveDataRequest): Promise<ExecActiveDataResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.execActiveDataEx(request, headers, runtime);
  }
   ...
   * Summary: 协鑫数据直连lca活动数据检查接口
   */
  async execActiveDataEx(request: ExecActiveDataRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<ExecActiveDataResponse> {
    Util.validateModel(request);
    return $tea.cast<ExecActiveDataResponse>(await this.doRequest("1.0", "antchain.carbon.active.data.exec", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new ExecActiveDataResponse({}));
  }
   ...
   */
  async pushActiveData(request: PushActiveDataRequest): Promise<PushActiveDataResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.pushActiveDataEx(request, headers, runtime);
  }
   ...
   * Summary: 协鑫数据直连lca活动数据填报
   */
  async pushActiveDataEx(request: PushActiveDataRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<PushActiveDataResponse> {
    Util.validateModel(request);
    return $tea.cast<PushActiveDataResponse>(await this.doRequest("1.0", "antchain.carbon.active.data.push", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new PushActiveDataResponse({}));
  }
   ...
   */
  async execEsgVerifytoken(request: ExecEsgVerifytokenRequest): Promise<ExecEsgVerifytokenResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.execEsgVerifytokenEx(request, headers, runtime);
  }
   ...
   * Summary: 核验并消费一次性凭证，返回碳矩阵当前登录信息。
   */
  async execEsgVerifytokenEx(request: ExecEsgVerifytokenRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<ExecEsgVerifytokenResponse> {
    Util.validateModel(request);
    return $tea.cast<ExecEsgVerifytokenResponse>(await this.doRequest("1.0", "antchain.carbon.esg.verifytoken.exec", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new ExecEsgVerifytokenResponse({}));
  }
   ...
   */
  async queryEsgListroles(request: QueryEsgListrolesRequest): Promise<QueryEsgListrolesResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryEsgListrolesEx(request, headers, runtime);
  }
   ...
   * Summary: 当前企业已落库的全部角色
   */
  async queryEsgListrolesEx(request: QueryEsgListrolesRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryEsgListrolesResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryEsgListrolesResponse>(await this.doRequest("1.0", "antchain.carbon.esg.listroles.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryEsgListrolesResponse({}));
  }
   ...
   * Summary: 查询组织单元树
   */
  async queryEsgOrganizationunittree(request: QueryEsgOrganizationunittreeRequest): Promise<QueryEsgOrganizationunittreeResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryEsgOrganizationunittreeEx(request, headers, runtime);
  }
   ...
   * Summary: 查询组织单元树
   */
  async queryEsgOrganizationunittreeEx(request: QueryEsgOrganizationunittreeRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryEsgOrganizationunittreeResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryEsgOrganizationunittreeResponse>(await this.doRequest("1.0", "antchain.carbon.esg.organizationunittree.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryEsgOrganizationunittreeResponse({}));
  }
   ...
   * Summary: 按角色分页查询操作员
   */
  async queryEsgListbyrole(request: QueryEsgListbyroleRequest): Promise<QueryEsgListbyroleResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryEsgListbyroleEx(request, headers, runtime);
  }
