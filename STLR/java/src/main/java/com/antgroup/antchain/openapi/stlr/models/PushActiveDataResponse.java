...
public class PushActiveDataResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public PushActiveDataResponse setReqMsgId(String reqMsgId) {
    ...
    public PushActiveDataResponse setResultCode(String resultCode) {
    ...
    public PushActiveDataResponse setResultMsg(String resultMsg) {
    ...
    public PushActiveDataResponse setSuccess(Boolean success) {
    ...
    public PushActiveDataResponse setAbnormalItemList(java.util.List<GclAbnormalItem> abnormalItemList) {
