...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "2.11.15"),
    ...
    /**
     * <b>description</b> :
     * <p>Description: 产品产量填报检查接口
     * Summary: 产品产量填报检查接口</p>
     */
    public QueryProductDataResponse queryProductData(QueryProductDataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 产品产量填报检查接口</p>
     */
    public QueryProductDataResponse queryProductDataEx(QueryProductDataRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.carbon.product.data.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryProductDataResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 协鑫数据直连产品产量填报接口
     * Summary: 协鑫数据直连产品产量填报接口</p>
     */
    public PushProductDataResponse pushProductData(PushProductDataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 协鑫数据直连产品产量填报接口</p>
     */
    public PushProductDataResponse pushProductDataEx(PushProductDataRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.carbon.product.data.push", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new PushProductDataResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 协鑫数据直连lca活动数据项查询
     * Summary: 协鑫数据直连lca活动数据项查询</p>
     */
    public QueryActiveDataResponse queryActiveData(QueryActiveDataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 协鑫数据直连lca活动数据项查询</p>
     */
    public QueryActiveDataResponse queryActiveDataEx(QueryActiveDataRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.carbon.active.data.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryActiveDataResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 协鑫数据直连lca活动数据检查接口
     * Summary: 协鑫数据直连lca活动数据检查接口</p>
     */
    public ExecActiveDataResponse execActiveData(ExecActiveDataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 协鑫数据直连lca活动数据检查接口</p>
     */
    public ExecActiveDataResponse execActiveDataEx(ExecActiveDataRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.carbon.active.data.exec", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ExecActiveDataResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 协鑫数据直连lca活动数据填报
     * Summary: 协鑫数据直连lca活动数据填报</p>
     */
    public PushActiveDataResponse pushActiveData(PushActiveDataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
    ...
    /**
     * <b>description</b> :
     * <p>Description: 按用户 ID 查询指定操作员的档案信息及角色信息
     * Summary: 按用户 ID 查询指定操作员的档案信息及角色信息</p>
     */
    public QueryEsgOperatordetailResponse queryEsgOperatordetail(QueryEsgOperatordetailRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 按用户 ID 查询指定操作员的档案信息及角色信息</p>
     */
    public QueryEsgOperatordetailResponse queryEsgOperatordetailEx(QueryEsgOperatordetailRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.carbon.esg.operatordetail.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryEsgOperatordetailResponse());
    }
