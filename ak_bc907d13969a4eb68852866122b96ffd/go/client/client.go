...
func (s *AuthItagAntitagAcmRequest) SetUserid(v string) *AuthItagAntitagAcmRequest {
	s.Userid = &v
	return s
}
...
func (s *AuthItagAntitagAcmResponse) SetUserid(v string) *AuthItagAntitagAcmResponse {
	s.Userid = &v
	return s
}
