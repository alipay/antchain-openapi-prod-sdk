...
from antchain_sdk_antdigital_demosdk import models as antdigital__demosdk_models
...
class Client:
    ...
    def __init__(
        self, 
        config: antdigital__demosdk_models.Config,
    ):
        """
    ...
    def query_cc_xx(
        self,
        request: antdigital__demosdk_models.QueryCcXxRequest,
    ) -> antdigital__demosdk_models.QueryCcXxResponse:
        """
        Description: 测试
        Summary: 测试
        """
