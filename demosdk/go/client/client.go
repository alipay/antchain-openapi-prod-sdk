...
type UpdateAaaAcdRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 123
...
func (s UpdateAaaAcdRequest) String() string {
	return tea.Prettify(s)
}

func (s UpdateAaaAcdRequest) GoString() string {
	return s.String()
}

func (s *UpdateAaaAcdRequest) SetAuthToken(v string) *UpdateAaaAcdRequest {
	s.AuthToken = &v
	return s
}

func (s *UpdateAaaAcdRequest) SetProductInstanceId(v string) *UpdateAaaAcdRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *UpdateAaaAcdRequest) SetDate(v string) *UpdateAaaAcdRequest {
	s.Date = &v
	return s
}

func (s *UpdateAaaAcdRequest) SetData(v string) *UpdateAaaAcdRequest {
	s.Data = &v
	return s
}

type UpdateAaaAcdResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s UpdateAaaAcdResponse) String() string {
	return tea.Prettify(s)
}

func (s UpdateAaaAcdResponse) GoString() string {
	return s.String()
}

func (s *UpdateAaaAcdResponse) SetReqMsgId(v string) *UpdateAaaAcdResponse {
	s.ReqMsgId = &v
	return s
}

func (s *UpdateAaaAcdResponse) SetResultCode(v string) *UpdateAaaAcdResponse {
	s.ResultCode = &v
	return s
}

func (s *UpdateAaaAcdResponse) SetResultMsg(v string) *UpdateAaaAcdResponse {
	s.ResultMsg = &v
	return s
}
 ...
 * Summary: 自动化测试创建test1
 */
func (client *Client) UpdateAaaAcd(request *UpdateAaaAcdRequest) (_result *UpdateAaaAcdResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &UpdateAaaAcdResponse{}
	_body, _err := client.UpdateAaaAcdEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 自动化测试创建test1
 */
func (client *Client) UpdateAaaAcdEx(request *UpdateAaaAcdRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *UpdateAaaAcdResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	_result = &UpdateAaaAcdResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antchain.demosdk.aaa.acd.update"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
