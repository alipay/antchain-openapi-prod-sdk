...
public class ImportAbcdOneRequest extends TeaModel {
    ...
    public ImportAbcdOneRequest setTimeout(String timeout) {
    ...
    public ImportAbcdOneRequest setCount(Long count) {
        this.count = count;
        return this;
    }
    ...
    public ImportAbcdOneRequest setTime(String time) {
        this.time = time;
        return this;
    }
    ...
    public ImportAbcdOneRequest setDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public ImportAbcdOneRequest setOperator(String operator) {
