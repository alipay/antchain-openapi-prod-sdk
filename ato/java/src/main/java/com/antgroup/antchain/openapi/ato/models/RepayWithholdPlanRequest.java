...
public class RepayWithholdPlanRequest extends TeaModel {
    ...
    public RepayWithholdPlanRequest setOperation(String operation) {
    ...
    public RepayWithholdPlanRequest setCancelList(java.util.List<SingleCancelModel> cancelList) {
