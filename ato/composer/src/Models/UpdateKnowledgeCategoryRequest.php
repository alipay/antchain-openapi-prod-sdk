...
class UpdateKnowledgeCategoryRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('hasOrder', $this->hasOrder, true);
        Model::validateRequired('hasAppLink', $this->hasAppLink, true);
        Model::validateRequired('hasManual', $this->hasManual, true);
    }
     ...
     * @param array $map
     *
     * @return UpdateKnowledgeCategoryRequest
     */
