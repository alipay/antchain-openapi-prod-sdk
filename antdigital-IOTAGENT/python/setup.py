...
PACKAGE = "antchain_sdk_iotagent"
NAME = 'antchain_antdigital_iotagent' or "alibabacloud-package"
DESCRIPTION = "Ant Chain IOTAGENT SDK Library for Python"
AUTHOR = "Ant Chain SDK"
