...
class ContinuousOtaRuleResponse extends Model {
    protected $_name = [
        'ruleId' => 'rule_id',
    ...
    /**
     * @param array $map
     * @return ContinuousOtaRuleResponse
     */
    ...
    // 服务端规范化版本谓词后生成的摘要
    /**
     * @example ee76b371d0352fc0fbb17a19fdf584b2352eb8948583a620ce8ba3b238956c3c
     * @var string
     */
