...
func (client *Client) AAAEx(request *AAARequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *AAAResponse, _err error) {
	...
	_result = &AAAResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antdigital.dtaiagt.a.a.a"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
