...
use AntChain\SECURITYTECH\Models\PointSupplierInfo;

class PointOrderInfo extends Model {
    protected $_name = [
        'orderId' => 'order_id',
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['supplier_info'])){
            $model->supplierInfo = PointSupplierInfo::fromMap($map['supplier_info']);
        }
        return $model;
    }
    // 订单号（子）
