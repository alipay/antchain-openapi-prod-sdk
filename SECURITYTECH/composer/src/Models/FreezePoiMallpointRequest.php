...
use AntChain\SECURITYTECH\Models\PoiMallPointReceiverInfo;
use AntChain\SECURITYTECH\Models\PoiMallPointOrderInfo;

class FreezePoiMallpointRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return FreezePoiMallpointRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['receiver_info'])){
            $model->receiverInfo = PoiMallPointReceiverInfo::fromMap($map['receiver_info']);
        }
        if(isset($map['order_info_list'])){
            if(!empty($map['order_info_list'])){
                ...
                foreach($map['order_info_list'] as $item) {
                    $model->orderInfoList[$n++] = null !== $item ? PoiMallPointOrderInfo::fromMap($item) : $item;
                }
            }
        }
    ...
    // 收货信息
    /**
     * @var PoiMallPointReceiverInfo
     */
    public $receiverInfo;

    // 订单信息列表
    /**
     * @var PoiMallPointOrderInfo[]
     */
