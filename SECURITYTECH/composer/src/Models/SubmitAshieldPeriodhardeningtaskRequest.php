...
use AntChain\SECURITYTECH\Models\RuntimeProtectConfig;
use AntChain\SECURITYTECH\Models\ClassMethodConfig;

class SubmitAshieldPeriodhardeningtaskRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return SubmitAshieldPeriodhardeningtaskRequest
     */
