...
class AiExtraAttr extends Model
{
    ...
    {
        Model::validateRequired('timeRangeThres', $this->timeRangeThres, true);
        Model::validateRequired('abnormalValueThres', $this->abnormalValueThres, true);
        Model::validateRequired('valueRangeThres', $this->valueRangeThres, true);
        Model::validateRequired('algoScoreThres', $this->algoScoreThres, true);
    }
