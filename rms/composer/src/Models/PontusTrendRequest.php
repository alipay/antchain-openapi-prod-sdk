...
class PontusTrendRequest extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('metricTable', $this->metricTable, true);
        Model::validateRequired('siteEnv', $this->siteEnv, true);
        Model::validateRequired('viewId', $this->viewId, true);
        Model::validateRequired('periodType', $this->periodType, true);
        Model::validateRequired('extraDimNames', $this->extraDimNames, true);
        Model::validateRequired('metricFilter', $this->metricFilter, true);
        Model::validateRequired('start', $this->start, true);
        Model::validateRequired('end', $this->end, true);
        Model::validateRequired('dimConditionsList', $this->dimConditionsList, true);
        Model::validateRequired('dimExpression', $this->dimExpression, true);
        Model::validateRequired('dimExpressionList', $this->dimExpressionList, true);
    }
