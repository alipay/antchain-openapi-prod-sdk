...
class TraasWorkspaceDto extends Model
{
    // uuid
    /**
     * @example uuid
    ...
    public function toMap()
    {
        ...
        if (null !== $this->zoneUuids) {
            $res['zone_uuids'] = $this->zoneUuids;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['zone_uuids'])) {
            if (!empty($map['zone_uuids'])) {
                $model->zoneUuids = $map['zone_uuids'];
            }
        }
