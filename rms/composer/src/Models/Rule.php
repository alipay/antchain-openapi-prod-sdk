...
class Rule extends Model
{
    ...
    {
        Model::validateRequired('aiAlarmParams', $this->aiAlarmParams, true);
        Model::validateRequired('name', $this->name, true);
        Model::validateRequired('runType', $this->runType, true);
        Model::validateRequired('calTimeRange', $this->calTimeRange, true);
        Model::validateRequired('excludeDataTimeRange', $this->excludeDataTimeRange, true);
        Model::validateRequired('dimFilters', $this->dimFilters, true);
        Model::validateRequired('timeFilter', $this->timeFilter, true);
        Model::validateRequired('triggers', $this->triggers, true);
        Model::validateRequired('andor', $this->andor, true);
        Model::validateRequired('controlPlanAuto', $this->controlPlanAuto, true);
        Model::validateRequired('controlPlans', $this->controlPlans, true);
        Model::validateRequired('functionId', $this->functionId, true);
        Model::validateRequired('fromTmpRule', $this->fromTmpRule, true);
