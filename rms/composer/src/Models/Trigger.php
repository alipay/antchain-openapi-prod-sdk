...
class Trigger extends Model
{
    ...
    {
        Model::validateRequired('valueField', $this->valueField, true);
        Model::validateRequired('valueIndex', $this->valueIndex, true);
        Model::validateRequired('type', $this->type, true);
        Model::validateRequired('n', $this->n, true);
        Model::validateRequired('compare', $this->compare, true);
        Model::validateRequired('comparePercent', $this->comparePercent, true);
        Model::validateRequired('threshold', $this->threshold, true);
        Model::validateRequired('thresholdCopy', $this->thresholdCopy, true);
        Model::validateRequired('valueIsPercent', $this->valueIsPercent, true);
    }
