...
class UpdateTraasmetaWorkspaceRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->workspaceGroupUuid) {
            $res['workspace_group_uuid'] = $this->workspaceGroupUuid;
        }
     ...
     * @param array $map
     *
     * @return UpdateTraasmetaWorkspaceRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['workspace_group_uuid'])) {
            $model->workspaceGroupUuid = $map['workspace_group_uuid'];
        }
