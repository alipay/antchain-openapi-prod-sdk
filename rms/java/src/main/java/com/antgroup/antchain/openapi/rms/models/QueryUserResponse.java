...
public class QueryUserResponse extends TeaModel {
    ...
    // 用户列表
    @NameInMap("users")
    public java.util.List<MonitorUserDO> users;
    ...
    public QueryUserResponse setUsers(java.util.List<MonitorUserDO> users) {
        this.users = users;
        return this;
    }
    public java.util.List<MonitorUserDO> getUsers() {
        return this.users;
    }
