...
public class UpdateUsergroupResponse extends TeaModel {
    ...
    public UpdateUsergroupResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateUsergroupResponse setResultCode(String resultCode) {
    ...
    public UpdateUsergroupResponse setResultMsg(String resultMsg) {
