...
public class QueryAppResponse extends TeaModel {
    ...
    // 应用列表
    @NameInMap("apps")
    public java.util.List<MonitorApp> apps;
    ...
    public QueryAppResponse setApps(java.util.List<MonitorApp> apps) {
        this.apps = apps;
        return this;
    }
    public java.util.List<MonitorApp> getApps() {
        return this.apps;
    }

    public QueryAppResponse setCurrentPage(Long currentPage) {
    ...
    public QueryAppResponse setTotalCount(Long totalCount) {
