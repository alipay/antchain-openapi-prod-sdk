...
public class DeleteFolderResponse extends TeaModel {
    ...
    public DeleteFolderResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteFolderResponse setResultCode(String resultCode) {
    ...
    public DeleteFolderResponse setResultMsg(String resultMsg) {
