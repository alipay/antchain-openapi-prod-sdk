...
public class PagequeryTraasmetaAppResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public static PagequeryTraasmetaAppResponse build(java.util.Map<String, ?> map) throws Exception {
        PagequeryTraasmetaAppResponse self = new PagequeryTraasmetaAppResponse();
        return TeaModel.build(map, self);
    }

    public PagequeryTraasmetaAppResponse setReqMsgId(String reqMsgId) {
    ...
    public PagequeryTraasmetaAppResponse setApps(java.util.List<TraasAppDto> apps) {
        this.apps = apps;
        return this;
    }
