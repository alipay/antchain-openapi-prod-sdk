...
public class QueryAlarmHistoryResponse extends TeaModel {
    ...
    // 告警历史数组
    @NameInMap("alarm_historys")
    public java.util.List<AlarmHistory> alarmHistorys;
    ...
    public QueryAlarmHistoryResponse setReqMsgId(String reqMsgId) {
    ...
    public QueryAlarmHistoryResponse setAlarmHistorys(java.util.List<AlarmHistory> alarmHistorys) {
        this.alarmHistorys = alarmHistorys;
        return this;
    }
    public java.util.List<AlarmHistory> getAlarmHistorys() {
        return this.alarmHistorys;
    }
