...
public class UpdateFolderResponse extends TeaModel {
    ...
    public UpdateFolderResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateFolderResponse setResultCode(String resultCode) {
    ...
    public UpdateFolderResponse setResultMsg(String resultMsg) {
