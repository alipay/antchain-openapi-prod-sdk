...
public class DeleteUsergroupResponse extends TeaModel {
    ...
    public DeleteUsergroupResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteUsergroupResponse setResultCode(String resultCode) {
    ...
    public DeleteUsergroupResponse setResultMsg(String resultMsg) {
