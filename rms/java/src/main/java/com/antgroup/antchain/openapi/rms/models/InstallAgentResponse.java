...
public class InstallAgentResponse extends TeaModel {
    ...
    public InstallAgentResponse setReqMsgId(String reqMsgId) {
    ...
    public InstallAgentResponse setResultCode(String resultCode) {
    ...
    public InstallAgentResponse setResultMsg(String resultMsg) {
