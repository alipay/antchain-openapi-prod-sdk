...
using AntChain.SDK.Ak_f4129f4cfe97420c94afdc34f93d8e80.Models;

namespace AntChain.SDK.Ak_f4129f4cfe97420c94afdc34f93d8e80
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_f4129f4cfe97420c94afdc34f93d8e80"},
                        {"_prod_channel", "saas"},
                    };
