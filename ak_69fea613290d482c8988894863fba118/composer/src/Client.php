...
namespace AntChain\Ak_69fea613290d482c8988894863fba118;
...
use AntChain\Ak_69fea613290d482c8988894863fba118\Models\QueryDemoAbcAbcAbcRequest;
use AntChain\Ak_69fea613290d482c8988894863fba118\Models\QueryDemoAbcAbcAbcResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_69fea613290d482c8988894863fba118',
                    '_prod_channel'    => 'saas',
                ];
