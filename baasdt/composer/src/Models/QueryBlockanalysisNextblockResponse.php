...
class QueryBlockanalysisNextblockResponse extends Model
{
    // 请求唯一ID，用于链路跟踪和问题排查
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->nextBlockNumber) {
            $res['next_block_number'] = $this->nextBlockNumber;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['next_block_number'])) {
            $model->nextBlockNumber = $map['next_block_number'];
        }
