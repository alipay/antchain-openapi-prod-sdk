...
class Provision extends Model
{
    ...
    {
        Model::validateRequired('creditMax', $this->creditMax, true);
        Model::validateRequired('creditUsed', $this->creditUsed, true);
        Model::validateRequired('currency', $this->currency, true);
        Model::validateRequired('debit', $this->debit, true);
    }
