...
class Merchant extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('isAssetIssuer', $this->isAssetIssuer, true);
        Model::validateRequired('isEquityConsumer', $this->isEquityConsumer, true);
        Model::validateRequired('isEquityProvider', $this->isEquityProvider, true);
        Model::validateRequired('provision', $this->provision, true);
        Model::validateRequired('status', $this->status, true);
        Model::validateRequired('tenantId', $this->tenantId, true);
        Model::validateRequired('profitLossBalance', $this->profitLossBalance, true);
    }
