...
class OrderSplitDetailList(TeaModel):
    def __init__(
        ...
        self.split_failed_reason = split_failed_reason
    ...
    def to_map(self):
        ...
        if self.split_failed_reason is not None:
            result['split_failed_reason'] = self.split_failed_reason
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('split_failed_reason') is not None:
            self.split_failed_reason = m.get('split_failed_reason')
        return self
...
class OrderSplitInfo(TeaModel):
    def __init__(
        self,
        order_split_status: str = None,
        order_split_account_count: int = None,
        order_split_detail_list: List[OrderSplitDetailList] = None,
    ):
        # 主订单分账状态，PROCESSING-处理中,SUCCESS-成功,FAILED-失败
        self.order_split_status = order_split_status
        # 分账账号个数
        self.order_split_account_count = order_split_account_count
        # 分账账号详情，针对某一笔分账
        self.order_split_detail_list = order_split_detail_list

    def validate(self):
        self.validate_required(self.order_split_status, 'order_split_status')
        self.validate_required(self.order_split_account_count, 'order_split_account_count')
        self.validate_required(self.order_split_detail_list, 'order_split_detail_list')
        if self.order_split_detail_list:
            for k in self.order_split_detail_list:
                if k:
                    k.validate()
    ...
    def to_map(self):
        ...
        result = dict()
        if self.order_split_status is not None:
            result['order_split_status'] = self.order_split_status
        if self.order_split_account_count is not None:
            result['order_split_account_count'] = self.order_split_account_count
        result['order_split_detail_list'] = []
        if self.order_split_detail_list is not None:
            for k in self.order_split_detail_list:
                result['order_split_detail_list'].append(k.to_map() if k else None)
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('order_split_status') is not None:
            self.order_split_status = m.get('order_split_status')
        if m.get('order_split_account_count') is not None:
            self.order_split_account_count = m.get('order_split_account_count')
        self.order_split_detail_list = []
        if m.get('order_split_detail_list') is not None:
            for k in m.get('order_split_detail_list'):
                temp_model = OrderSplitDetailList()
                self.order_split_detail_list.append(temp_model.from_map(k))
        return self
...
class OrderPayInfo(TeaModel):
    def __init__(
        self,
        order_pay_status: str = None,
        order_pay_time: str = None,
        order_pay_failed_reason: str = None,
        pay_amount: int = None,
        real_pay_amount: int = None,
        real_receipt_amount: int = None,
    ):
        # 支付状态：PROCESSING-处理中,SUCCESS-成功,CLOSE-关闭,FAILED-失败
        self.order_pay_status = order_pay_status
        # 支付时间，条件返回：orderPayStatus=SUCCESS 返回
        self.order_pay_time = order_pay_time
        # 失败原因，条件返回：orderPayStatus=FAILED 返回
        self.order_pay_failed_reason = order_pay_failed_reason
        # 支付金额，单位：分，条件返回：orderPayStatus=SUCCESS 返回
        self.pay_amount = pay_amount
        # 实际支付金额，单位：分，条件返回：orderPayStatus=SUCCESS 返回
        self.real_pay_amount = real_pay_amount
        # 收款金额，单位：分，条件返回：orderPayStatus=SUCCESS 返回
        self.real_receipt_amount = real_receipt_amount

    def validate(self):
        self.validate_required(self.order_pay_status, 'order_pay_status')
    ...
    def to_map(self):
        ...
        result = dict()
        if self.order_pay_status is not None:
            result['order_pay_status'] = self.order_pay_status
        if self.order_pay_time is not None:
            result['order_pay_time'] = self.order_pay_time
        if self.order_pay_failed_reason is not None:
            result['order_pay_failed_reason'] = self.order_pay_failed_reason
        if self.pay_amount is not None:
            result['pay_amount'] = self.pay_amount
        if self.real_pay_amount is not None:
            result['real_pay_amount'] = self.real_pay_amount
        if self.real_receipt_amount is not None:
            result['real_receipt_amount'] = self.real_receipt_amount
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('order_pay_status') is not None:
            self.order_pay_status = m.get('order_pay_status')
        if m.get('order_pay_time') is not None:
            self.order_pay_time = m.get('order_pay_time')
        if m.get('order_pay_failed_reason') is not None:
            self.order_pay_failed_reason = m.get('order_pay_failed_reason')
        if m.get('pay_amount') is not None:
            self.pay_amount = m.get('pay_amount')
        if m.get('real_pay_amount') is not None:
            self.real_pay_amount = m.get('real_pay_amount')
        if m.get('real_receipt_amount') is not None:
            self.real_receipt_amount = m.get('real_receipt_amount')
        return self
...
class RefundDetailItemList(TeaModel):
    def __init__(
        self,
        amount: int = None,
        trans_out_account: str = None,
...
class PushOrderSettlementRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
    ...
    def to_map(self):
        ...
        if self.out_product_id is not None:
            result['out_product_id'] = self.out_product_id
        if self.out_order_no is not None:
            result['out_order_no'] = self.out_order_no
        if self.total_amount is not None:
            result['total_amount'] = self.total_amount
        if self.pay_product is not None:
            result['pay_product'] = self.pay_product
        if self.ext_info is not None:
            result['ext_info'] = self.ext_info
        if self.order_create_time is not None:
            result['order_create_time'] = self.order_create_time
        if self.pay_subject is not None:
            result['pay_subject'] = self.pay_subject
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('out_product_id') is not None:
            self.out_product_id = m.get('out_product_id')
        ...
        if m.get('pay_product') is not None:
            self.pay_product = m.get('pay_product')
        if m.get('ext_info') is not None:
            self.ext_info = m.get('ext_info')
        if m.get('order_create_time') is not None:
            self.order_create_time = m.get('order_create_time')
        if m.get('pay_subject') is not None:
            self.pay_subject = m.get('pay_subject')
...
class PushOrderSettlementResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class QueryOrderSettlementRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryOrderSettlementResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
        ...
        pay_subject: str = None,
        trade_no: str = None,
        order_pay_info: OrderPayInfo = None,
        order_split_info: OrderSplitInfo = None,
        pay_channel_user_id: str = None,
        pay_channel: str = None,
        pay_product: str = None,
    ):
        ...
        # 分账详情
        self.order_split_info = order_split_info
    ...
    def validate(self):
        if self.order_pay_info:
            self.order_pay_info.validate()
        if self.order_split_info:
            self.order_split_info.validate()
    ...
    def to_map(self):
        ...
        if self.order_pay_info is not None:
            result['order_pay_info'] = self.order_pay_info.to_map()
        if self.order_split_info is not None:
            result['order_split_info'] = self.order_split_info.to_map()
        if self.pay_channel_user_id is not None:
            result['pay_channel_user_id'] = self.pay_channel_user_id
        if self.pay_channel is not None:
            result['pay_channel'] = self.pay_channel
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('trade_no') is not None:
            self.trade_no = m.get('trade_no')
        if m.get('order_pay_info') is not None:
            temp_model = OrderPayInfo()
            self.order_pay_info = temp_model.from_map(m['order_pay_info'])
        if m.get('order_split_info') is not None:
            temp_model = OrderSplitInfo()
            self.order_split_info = temp_model.from_map(m['order_split_info'])
        if m.get('pay_channel_user_id') is not None:
            self.pay_channel_user_id = m.get('pay_channel_user_id')
        if m.get('pay_channel') is not None:
            self.pay_channel = m.get('pay_channel')
...
class WithdrawOrderSettlementRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class WithdrawOrderSettlementResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryOrderWithdrawRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryOrderWithdrawResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class PushOrderRefundRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class PushOrderRefundResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
        ...
        # 本次退款退分账唯一标识
        self.refund_record_no = refund_record_no
    ...
    def to_map(self):
        ...
        if self.refund_record_no is not None:
            result['refund_record_no'] = self.refund_record_no
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('refund_record_no') is not None:
            self.refund_record_no = m.get('refund_record_no')
        return self


class QueryOrderRefundRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
    ...
    def validate(self):
        self.validate_required(self.refund_record_no, 'refund_record_no')
...
class QueryOrderRefundResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
    ...
    def validate(self):
        if self.refund_detail_item_list:
            for k in self.refund_detail_item_list:
                if k:
                    k.validate()
    ...
    def to_map(self):
        ...
        result['refund_detail_item_list'] = []
        if self.refund_detail_item_list is not None:
            for k in self.refund_detail_item_list:
                result['refund_detail_item_list'].append(k.to_map() if k else None)
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        self.refund_detail_item_list = []
        if m.get('refund_detail_item_list') is not None:
            for k in m.get('refund_detail_item_list'):
                temp_model = RefundDetailItemList()
                self.refund_detail_item_list.append(temp_model.from_map(k))
        return self
