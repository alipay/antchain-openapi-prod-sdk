...
public class CallbackRightsprodOperationdataRequest extends TeaModel {
    ...
    public CallbackRightsprodOperationdataRequest setSupplyRightsCode(String supplyRightsCode) {
    ...
    public CallbackRightsprodOperationdataRequest setExtInfo(String extInfo) {
