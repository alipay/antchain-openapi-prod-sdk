...
// 分账详情
export class OrderSplitInfo extends $tea.Model {
  // 主订单分账状态，PROCESSING-处理中,SUCCESS-成功,FAILED-失败
  /**
   * @example
   * SUCCESS
   */
  orderSplitStatus: string;
  // 分账账号个数
  /**
   * @example
   * 9
   */
  orderSplitAccountCount: number;
  // 分账账号详情，针对某一笔分账
  /**
   * @example
   * undefined
   */
  orderSplitDetailList: OrderSplitDetailList[];
  static names(): { [key: string]: string } {
    return {
  ...
  static types(): { [key: string]: any } {
    return {
      orderSplitStatus: 'string',
      orderSplitAccountCount: 'number',
      orderSplitDetailList: { 'type': 'array', 'itemType': OrderSplitDetailList },
    };
  }
...
// 支付详情
export class OrderPayInfo extends $tea.Model {
...
// 退分账明细
export class RefundDetailItemList extends $tea.Model {
  // 退款退分账金额，单位为分
  /**
   * @example
   * 990
...
export class PushOrderRefundRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 外部订单号
...
export class PushOrderRefundResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryOrderRefundRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 退款退分账唯一标识
...
export class QueryOrderRefundResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export default class Client {
   ...
   * Summary: 退款退分账发起(创建)
   */
  async pushOrderRefund(request: PushOrderRefundRequest): Promise<PushOrderRefundResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.pushOrderRefundEx(request, headers, runtime);
  }
   ...
   * Summary: 退款退分账发起(创建)
   */
  async pushOrderRefundEx(request: PushOrderRefundRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<PushOrderRefundResponse> {
    Util.validateModel(request);
    return $tea.cast<PushOrderRefundResponse>(await this.doRequest("1.0", "antdigital.gesaas.order.refund.push", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new PushOrderRefundResponse({}));
  }
   ...
   * Summary: 退款退分账查询
   */
  async queryOrderRefund(request: QueryOrderRefundRequest): Promise<QueryOrderRefundResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryOrderRefundEx(request, headers, runtime);
  }
   ...
   * Summary: 退款退分账查询
   */
  async queryOrderRefundEx(request: QueryOrderRefundRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryOrderRefundResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryOrderRefundResponse>(await this.doRequest("1.0", "antdigital.gesaas.order.refund.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryOrderRefundResponse({}));
  }
  ...
  async queryRightsprodVoucherEx(request: QueryRightsprodVoucherRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryRightsprodVoucherResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryRightsprodVoucherResponse>(await this.doRequest("1.0", "antdigital.gesaas.rightsprod.voucher.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryRightsprodVoucherResponse({}));
  }
