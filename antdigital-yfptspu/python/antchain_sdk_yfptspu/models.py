...
class QueryDemoDogWorkbenchTestRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class QueryDemoDogWorkbenchTestResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class CreateDemoDogWorkbenchTestRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class CreateDemoDogWorkbenchTestResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
