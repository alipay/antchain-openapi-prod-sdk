...
namespace AntChain.SDK.BOTSG
{
    public class Client 
    {
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ImportIotagentClientResponse>(DoRequest("1.0", "antdigital.botsg.iotagent.client.import", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ImportIotagentClientResponse>(await DoRequestAsync("1.0", "antdigital.botsg.iotagent.client.import", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
