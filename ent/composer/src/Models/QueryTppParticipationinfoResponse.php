...
class QueryTppParticipationinfoResponse extends Model
{
    // 请求唯一ID，用于链路跟踪和问题排查
    /**
     * @var string
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['accumulative_revenue'])) {
            $model->accumulativeRevenue = AccumulativeRevenue::fromMap($map['accumulative_revenue']);
        }
