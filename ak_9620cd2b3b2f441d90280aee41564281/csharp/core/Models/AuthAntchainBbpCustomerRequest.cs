...
namespace AntChain.SDK.Ak_9620cd2b3b2f441d90280aee41564281.Models
{
    public class AuthAntchainBbpCustomerRequest : TeaModel {
        // OAuth模式下的授权token
        ...
        [Validation(Required=false)]
        public List<NameValuePair> ExtensionInfo { get; set; }
