...
// 测试请求类
export class TessReq extends $tea.Model {
  // 证件号
  idcard: string;
  static names(): { [key: string]: string } {
    return {
...
export default class Client {
  ...
  async queryBbbCccEx(request: QueryBbbCccRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryBbbCccResponse> {
    ...
    return $tea.cast<QueryBbbCccResponse>(await this.doRequest("1.0", "antdigital.demosdksy.bbb.ccc.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryBbbCccResponse({}));
  }
