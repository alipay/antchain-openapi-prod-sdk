...
package com.antgroup.antchain.openapi.demosdksy;
...
import com.antgroup.antchain.openapi.demosdksy.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("_prod_code", "DEMOSDKSY"),
    ...
    public QueryBbbCccResponse queryBbbCccEx(QueryBbbCccRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRequest("1.0", "antdigital.demosdksy.bbb.ccc.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryBbbCccResponse());
    }
}
