...
using AntChain.SDK.DEMOSDKSY.Models;

namespace AntChain.SDK.DEMOSDKSY
{
    public class Client 
    {
        ...
        public QueryBbbCccResponse QueryBbbCccEx(QueryBbbCccRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<QueryBbbCccResponse>(DoRequest("1.0", "antdigital.demosdksy.bbb.ccc.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryBbbCccResponse>(await DoRequestAsync("1.0", "antdigital.demosdksy.bbb.ccc.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
