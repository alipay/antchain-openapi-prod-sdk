...
func (s TessReq) String() string {
	return tea.Prettify(s)
}

func (s TessReq) GoString() string {
	return s.String()
}

func (s *TessReq) SetIdcard(v string) *TessReq {
	s.Idcard = &v
	return s
}
...
type QueryBbbCccRequest struct {
	...
	// fd
	Tes *string `json:"tes,omitempty" xml:"tes,omitempty"`
	// 测试
	TestReq *TessReq `json:"test_req,omitempty" xml:"test_req,omitempty" require:"true"`
}
...
func (s *QueryBbbCccRequest) SetTes(v string) *QueryBbbCccRequest {
	s.Tes = &v
	return s
}

func (s *QueryBbbCccRequest) SetTestReq(v *TessReq) *QueryBbbCccRequest {
	s.TestReq = v
	return s
}
...
func (s *QueryBbbCccResponse) SetTest(v string) *QueryBbbCccResponse {
	s.Test = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("DEMOSDKSY"),
...
func (client *Client) QueryBbbCccEx(request *QueryBbbCccRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryBbbCccResponse, _err error) {
	...
	_result = &QueryBbbCccResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antdigital.demosdksy.bbb.ccc.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
