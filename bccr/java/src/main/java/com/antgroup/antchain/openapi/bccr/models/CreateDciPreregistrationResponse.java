...
public class CreateDciPreregistrationResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public CreateDciPreregistrationResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateDciPreregistrationResponse setResultCode(String resultCode) {
    ...
    public CreateDciPreregistrationResponse setResultMsg(String resultMsg) {
    ...
    public CreateDciPreregistrationResponse setDciContentId(String dciContentId) {
