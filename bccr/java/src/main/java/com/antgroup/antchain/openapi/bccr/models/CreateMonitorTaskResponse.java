...
public class CreateMonitorTaskResponse extends TeaModel {
    ...
    public CreateMonitorTaskResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateMonitorTaskResponse setResultCode(String resultCode) {
    ...
    public CreateMonitorTaskResponse setResultMsg(String resultMsg) {
    ...
    public CreateMonitorTaskResponse setMonitorTaskId(String monitorTaskId) {
