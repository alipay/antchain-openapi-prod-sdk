...
class ConfirmExchangeRequest extends Model {
    protected $_name = [
        'chainId' => 'chain_id',
    ...
    /**
     * @description 附言。实际数据结构根据商品类型和描述输入，可参考https://tech.antfin.com/docs/2/163896
     * @example 确认接单
     * @var string
     */
    public $memo;
