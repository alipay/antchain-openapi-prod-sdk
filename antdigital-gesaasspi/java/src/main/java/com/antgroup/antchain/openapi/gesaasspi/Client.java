...
package com.antgroup.antchain.openapi.gesaasspi;
...
import com.antgroup.antchain.openapi.gesaasspi.models.*;
...
public class Client {
     ...
     */
    public CallbackAntdigitalGesaasspiRightsprodStatusResponse callbackAntdigitalGesaasspiRightsprodStatus(CallbackAntdigitalGesaasspiRightsprodStatusRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 权益中心券状态变更回调通知</p>
     */
    public CallbackAntdigitalGesaasspiRightsprodStatusResponse callbackAntdigitalGesaasspiRightsprodStatusEx(CallbackAntdigitalGesaasspiRightsprodStatusRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antdigital.gesaasspi.rightsprod.status.callback", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CallbackAntdigitalGesaasspiRightsprodStatusResponse());
    }
     ...
     * Summary: 券操作回调通知</p>
     */
    public CallbackAntdigitalGesaasspiRightsprodOperationResponse callbackAntdigitalGesaasspiRightsprodOperation(CallbackAntdigitalGesaasspiRightsprodOperationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     */
    public PushAntdigitalGesaasspiRightsprodGrantrightsResponse pushAntdigitalGesaasspiRightsprodGrantrights(PushAntdigitalGesaasspiRightsprodGrantrightsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 权益供应商权益发放spi</p>
     */
    public PushAntdigitalGesaasspiRightsprodGrantrightsResponse pushAntdigitalGesaasspiRightsprodGrantrightsEx(PushAntdigitalGesaasspiRightsprodGrantrightsRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antdigital.gesaasspi.rightsprod.grantrights.push", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new PushAntdigitalGesaasspiRightsprodGrantrightsResponse());
    }
