...
using AntChain.SDK.Ak_bcd56548adce45febea214a77c845293.Models;

namespace AntChain.SDK.Ak_bcd56548adce45febea214a77c845293
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_bcd56548adce45febea214a77c845293"},
                        {"_prod_channel", "saas"},
                    };
