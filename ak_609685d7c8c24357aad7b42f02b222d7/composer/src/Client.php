...
namespace AntChain\Ak_609685d7c8c24357aad7b42f02b222d7;
...
use AntChain\Ak_609685d7c8c24357aad7b42f02b222d7\Models\BindDemoAaaBbbCccRequest;
use AntChain\Ak_609685d7c8c24357aad7b42f02b222d7\Models\BindDemoAaaBbbCccResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_609685d7c8c24357aad7b42f02b222d7',
                    '_prod_channel'    => 'saas',
                ];
