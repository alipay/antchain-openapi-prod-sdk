...
func (s *PayTradeRequest) SetMerchantUserId(v string) *PayTradeRequest {
	s.MerchantUserId = &v
	return s
}

func (s *PayTradeRequest) SetTransCurrency(v string) *PayTradeRequest {
	s.TransCurrency = &v
	return s
}

func (s *PayTradeRequest) SetBuyerId(v string) *PayTradeRequest {
	s.BuyerId = &v
	return s
}
