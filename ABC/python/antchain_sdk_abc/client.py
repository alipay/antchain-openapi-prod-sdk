...
class Client:
    ...
    def query_alltest_one(
        self,
        request: abc_models.QueryAlltestOneRequest,
    ) -> abc_models.QueryAlltestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_alltest_one_ex(request, headers, runtime)

    async def query_alltest_one_async(
        self,
        request: abc_models.QueryAlltestOneRequest,
    ) -> abc_models.QueryAlltestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_alltest_one_ex_async(request, headers, runtime)

    def query_alltest_one_ex(
        self,
        request: abc_models.QueryAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.QueryAlltestOneResponse(),
            self.do_request('1.0', 'antchain.abc.alltest.one.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_alltest_one_ex_async(
        self,
        request: abc_models.QueryAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.QueryAlltestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.alltest.one.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def import_alltest_one(
        self,
        request: abc_models.ImportAlltestOneRequest,
    ) -> abc_models.ImportAlltestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.import_alltest_one_ex(request, headers, runtime)

    async def import_alltest_one_async(
        self,
        request: abc_models.ImportAlltestOneRequest,
    ) -> abc_models.ImportAlltestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.import_alltest_one_ex_async(request, headers, runtime)

    def import_alltest_one_ex(
        self,
        request: abc_models.ImportAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.ImportAlltestOneResponse(),
            self.do_request('1.0', 'antchain.abc.alltest.one.import', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def import_alltest_one_ex_async(
        self,
        request: abc_models.ImportAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.ImportAlltestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.alltest.one.import', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def stabilize_alltest_one(
        self,
        request: abc_models.StabilizeAlltestOneRequest,
    ) -> abc_models.StabilizeAlltestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.stabilize_alltest_one_ex(request, headers, runtime)

    async def stabilize_alltest_one_async(
        self,
        request: abc_models.StabilizeAlltestOneRequest,
    ) -> abc_models.StabilizeAlltestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.stabilize_alltest_one_ex_async(request, headers, runtime)

    def stabilize_alltest_one_ex(
        self,
        request: abc_models.StabilizeAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.StabilizeAlltestOneResponse(),
            self.do_request('1.0', 'antchain.abc.alltest.one.stabilize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def stabilize_alltest_one_ex_async(
        self,
        request: abc_models.StabilizeAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.StabilizeAlltestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.alltest.one.stabilize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def unstabilize_alltest_one(
        self,
        request: abc_models.UnstabilizeAlltestOneRequest,
    ) -> abc_models.UnstabilizeAlltestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.unstabilize_alltest_one_ex(request, headers, runtime)

    async def unstabilize_alltest_one_async(
        self,
        request: abc_models.UnstabilizeAlltestOneRequest,
    ) -> abc_models.UnstabilizeAlltestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.unstabilize_alltest_one_ex_async(request, headers, runtime)

    def unstabilize_alltest_one_ex(
        self,
        request: abc_models.UnstabilizeAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.UnstabilizeAlltestOneResponse(),
            self.do_request('1.0', 'antchain.abc.alltest.one.unstabilize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def unstabilize_alltest_one_ex_async(
        self,
        request: abc_models.UnstabilizeAlltestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.UnstabilizeAlltestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.alltest.one.unstabilize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def query_alltest_two(
        self,
        request: abc_models.QueryAlltestTwoRequest,
    ) -> abc_models.QueryAlltestTwoResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_alltest_two_ex(request, headers, runtime)

    async def query_alltest_two_async(
        self,
        request: abc_models.QueryAlltestTwoRequest,
    ) -> abc_models.QueryAlltestTwoResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_alltest_two_ex_async(request, headers, runtime)

    def query_alltest_two_ex(
        self,
        request: abc_models.QueryAlltestTwoRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.QueryAlltestTwoResponse(),
            self.do_request('1.0', 'antchain.abc.alltest.two.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_alltest_two_ex_async(
        self,
        request: abc_models.QueryAlltestTwoRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.QueryAlltestTwoResponse(),
            await self.do_request_async('1.0', 'antchain.abc.alltest.two.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
    ...
    def ccc_aaa_bbb(
        self,
        request: abc_models.CccAaaBbbRequest,
    ) -> abc_models.CccAaaBbbResponse:
        """
        Description: aaa
        Summary: aaa
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.ccc_aaa_bbb_ex(request, headers, runtime)

    async def ccc_aaa_bbb_async(
        self,
        request: abc_models.CccAaaBbbRequest,
    ) -> abc_models.CccAaaBbbResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.ccc_aaa_bbb_ex_async(request, headers, runtime)
    ...
    def ccc_aaa_bbb_ex(
        ...
        return TeaCore.from_map(
            abc_models.CccAaaBbbResponse(),
            self.do_request('1.0', 'antchain.abc.aaa.bbb.ccc', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def ccc_aaa_bbb_ex_async(
        self,
        request: abc_models.CccAaaBbbRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.CccAaaBbbResponse(),
            await self.do_request_async('1.0', 'antchain.abc.aaa.bbb.ccc', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
    ...
    def azxd_azsx(
        self,
        request: abc_models.AzxdAzsxRequest,
    ) -> abc_models.AzxdAzsxResponse:
        """
        Description: 1
        Summary: 1
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.azxd_azsx_ex(request, headers, runtime)

    async def azxd_azsx_async(
        self,
        request: abc_models.AzxdAzsxRequest,
    ) -> abc_models.AzxdAzsxResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.azxd_azsx_ex_async(request, headers, runtime)
    ...
    def azxd_azsx_ex(
        ...
        return TeaCore.from_map(
            abc_models.AzxdAzsxResponse(),
            self.do_request('1.0', 'antchain.abc.azsx.azxd', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def azxd_azsx_ex_async(
        self,
        request: abc_models.AzxdAzsxRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.AzxdAzsxResponse(),
            await self.do_request_async('1.0', 'antchain.abc.azsx.azxd', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def query_test_one(
        self,
        request: abc_models.QueryTestOneRequest,
    ) -> abc_models.QueryTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_test_one_ex(request, headers, runtime)

    async def query_test_one_async(
        self,
        request: abc_models.QueryTestOneRequest,
    ) -> abc_models.QueryTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_test_one_ex_async(request, headers, runtime)

    def query_test_one_ex(
        self,
        request: abc_models.QueryTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.QueryTestOneResponse(),
            self.do_request('1.0', 'antchain.abc.test.one.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_test_one_ex_async(
        self,
        request: abc_models.QueryTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.QueryTestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.test.one.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def import_test_one(
        self,
        request: abc_models.ImportTestOneRequest,
    ) -> abc_models.ImportTestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.import_test_one_ex(request, headers, runtime)

    async def import_test_one_async(
        self,
        request: abc_models.ImportTestOneRequest,
    ) -> abc_models.ImportTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.import_test_one_ex_async(request, headers, runtime)

    def import_test_one_ex(
        self,
        request: abc_models.ImportTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.ImportTestOneResponse(),
            self.do_request('1.0', 'antchain.abc.test.one.import', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def import_test_one_ex_async(
        self,
        request: abc_models.ImportTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.ImportTestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.test.one.import', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def stabilize_test_one(
        self,
        request: abc_models.StabilizeTestOneRequest,
    ) -> abc_models.StabilizeTestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.stabilize_test_one_ex(request, headers, runtime)

    async def stabilize_test_one_async(
        self,
        request: abc_models.StabilizeTestOneRequest,
    ) -> abc_models.StabilizeTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.stabilize_test_one_ex_async(request, headers, runtime)

    def stabilize_test_one_ex(
        self,
        request: abc_models.StabilizeTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.StabilizeTestOneResponse(),
            self.do_request('1.0', 'antchain.abc.test.one.stabilize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def stabilize_test_one_ex_async(
        self,
        request: abc_models.StabilizeTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.StabilizeTestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.test.one.stabilize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def capture_test_one(
        self,
        request: abc_models.CaptureTestOneRequest,
    ) -> abc_models.CaptureTestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.capture_test_one_ex(request, headers, runtime)

    async def capture_test_one_async(
        self,
        request: abc_models.CaptureTestOneRequest,
    ) -> abc_models.CaptureTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.capture_test_one_ex_async(request, headers, runtime)

    def capture_test_one_ex(
        self,
        request: abc_models.CaptureTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.CaptureTestOneResponse(),
            self.do_request('1.0', 'antchain.abc.test.one.capture', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def capture_test_one_ex_async(
        self,
        request: abc_models.CaptureTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.CaptureTestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.test.one.capture', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def match_test_one(
        self,
        request: abc_models.MatchTestOneRequest,
    ) -> abc_models.MatchTestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.match_test_one_ex(request, headers, runtime)

    async def match_test_one_async(
        self,
        request: abc_models.MatchTestOneRequest,
    ) -> abc_models.MatchTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.match_test_one_ex_async(request, headers, runtime)

    def match_test_one_ex(
        self,
        request: abc_models.MatchTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.MatchTestOneResponse(),
            self.do_request('1.0', 'antchain.abc.test.one.match', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def match_test_one_ex_async(
        self,
        request: abc_models.MatchTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.MatchTestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.test.one.match', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def operate_test_one(
        self,
        request: abc_models.OperateTestOneRequest,
    ) -> abc_models.OperateTestOneResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.operate_test_one_ex(request, headers, runtime)

    async def operate_test_one_async(
        self,
        request: abc_models.OperateTestOneRequest,
    ) -> abc_models.OperateTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.operate_test_one_ex_async(request, headers, runtime)

    def operate_test_one_ex(
        self,
        request: abc_models.OperateTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.OperateTestOneResponse(),
            self.do_request('1.0', 'antchain.abc.test.one.operate', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def operate_test_one_ex_async(
        self,
        request: abc_models.OperateTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.OperateTestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.test.one.operate', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def time_test_one(
        self,
        request: abc_models.TimeTestOneRequest,
    ) -> abc_models.TimeTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.time_test_one_ex(request, headers, runtime)

    async def time_test_one_async(
        self,
        request: abc_models.TimeTestOneRequest,
    ) -> abc_models.TimeTestOneResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.time_test_one_ex_async(request, headers, runtime)

    def time_test_one_ex(
        self,
        request: abc_models.TimeTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.TimeTestOneResponse(),
            self.do_request('1.0', 'antchain.abc.test.one.time', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def time_test_one_ex_async(
        self,
        request: abc_models.TimeTestOneRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.TimeTestOneResponse(),
            await self.do_request_async('1.0', 'antchain.abc.test.one.time', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
    ...
    def reset_one_limit(
        self,
        request: abc_models.ResetOneLimitRequest,
    ) -> abc_models.ResetOneLimitResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.reset_one_limit_ex(request, headers, runtime)

    async def reset_one_limit_async(
        self,
        request: abc_models.ResetOneLimitRequest,
    ) -> abc_models.ResetOneLimitResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.reset_one_limit_ex_async(request, headers, runtime)

    def reset_one_limit_ex(
        self,
        request: abc_models.ResetOneLimitRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.ResetOneLimitResponse(),
            self.do_request('1.0', 'antchain.abc.one.limit.reset', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def reset_one_limit_ex_async(
        self,
        request: abc_models.ResetOneLimitRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.ResetOneLimitResponse(),
            await self.do_request_async('1.0', 'antchain.abc.one.limit.reset', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def withdraw_one_limit(
        self,
        request: abc_models.WithdrawOneLimitRequest,
    ) -> abc_models.WithdrawOneLimitResponse:
        """
        Description: 个人工作台二期预发测试
        Summary: 个人工作台二期预发测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.withdraw_one_limit_ex(request, headers, runtime)

    async def withdraw_one_limit_async(
        self,
        request: abc_models.WithdrawOneLimitRequest,
    ) -> abc_models.WithdrawOneLimitResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.withdraw_one_limit_ex_async(request, headers, runtime)

    def withdraw_one_limit_ex(
        self,
        request: abc_models.WithdrawOneLimitRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.WithdrawOneLimitResponse(),
            self.do_request('1.0', 'antchain.abc.one.limit.withdraw', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def withdraw_one_limit_ex_async(
        self,
        request: abc_models.WithdrawOneLimitRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            abc_models.WithdrawOneLimitResponse(),
            await self.do_request_async('1.0', 'antchain.abc.one.limit.withdraw', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
