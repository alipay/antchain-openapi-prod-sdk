...
class BatchqueryscoreAntdigitalMdpRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class BatchqueryscoreAntdigitalMdpResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class QuerybyappidAntdigitalMdpRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QuerybyappidAntdigitalMdpResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
