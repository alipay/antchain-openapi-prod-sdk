...
namespace AntChain.SDK.BXPT_NEW
{
    public class Client 
    {
         ...
         */
        public ExecMultimodalDataprodResponse ExecMultimodalDataprod(ExecMultimodalDataprodRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return ExecMultimodalDataprodEx(request, headers, runtime);
        }
         ...
         * Summary: 提供多模态的数据产品执行
         */
        public async Task<ExecMultimodalDataprodResponse> ExecMultimodalDataprodAsync(ExecMultimodalDataprodRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await ExecMultimodalDataprodExAsync(request, headers, runtime);
        }
         ...
         * Summary: 提供多模态的数据产品执行
         */
        public ExecMultimodalDataprodResponse ExecMultimodalDataprodEx(ExecMultimodalDataprodRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.FileObject))
            {
                ...
                {
                    ExecMultimodalDataprodResponse execMultimodalDataprodResponse = new ExecMultimodalDataprodResponse
                    {
            ...
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ExecMultimodalDataprodResponse>(DoRequest("1.0", "antcloud.bxptnew.multimodal.dataprod.exec", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 提供多模态的数据产品执行
         */
        public async Task<ExecMultimodalDataprodResponse> ExecMultimodalDataprodExAsync(ExecMultimodalDataprodRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.FileObject))
            {
                CreateAntcloudGatewayxFileUploadRequest uploadReq = new CreateAntcloudGatewayxFileUploadRequest
            ...
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ExecMultimodalDataprodResponse>(await DoRequestAsync("1.0", "antcloud.bxptnew.multimodal.dataprod.exec", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 数据产品执行结果通知
         */
        public NotifyMultimodalDataprodResponse NotifyMultimodalDataprod(NotifyMultimodalDataprodRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return NotifyMultimodalDataprodEx(request, headers, runtime);
        }
         ...
         * Summary: 数据产品执行结果通知
         */
        public async Task<NotifyMultimodalDataprodResponse> NotifyMultimodalDataprodAsync(NotifyMultimodalDataprodRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await NotifyMultimodalDataprodExAsync(request, headers, runtime);
        }
         ...
         * Summary: 数据产品执行结果通知
         */
        public NotifyMultimodalDataprodResponse NotifyMultimodalDataprodEx(NotifyMultimodalDataprodRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<NotifyMultimodalDataprodResponse>(DoRequest("1.0", "antcloud.bxptnew.multimodal.dataprod.notify", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 数据产品执行结果通知
         */
        public async Task<NotifyMultimodalDataprodResponse> NotifyMultimodalDataprodExAsync(NotifyMultimodalDataprodRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
