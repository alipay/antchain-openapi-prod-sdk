...
from antchain_sdk_saastest6 import models as saas_test_6_models
...
class Client:
    ...
    def __init__(
        self, 
        config: saas_test_6_models.Config,
    ):
        """
    ...
    def echo_demo_gateway_check(
        self,
        request: saas_test_6_models.EchoDemoGatewayCheckRequest,
    ) -> saas_test_6_models.EchoDemoGatewayCheckResponse:
        """
    ...
    def echo_demo_gateway_check_ex(
        ...
        if not UtilClient.is_unset(request.file_object):
            upload_req = saas_test_6_models.CreateAntcloudGatewayxFileUploadRequest(
            ...
            if not AntchainUtils.is_success(upload_resp.result_code, 'ok'):
                echo_demo_gateway_check_response = saas_test_6_models.EchoDemoGatewayCheckResponse(
    ...
    def create_antcloud_openapi_apiservice_group(
        self,
        request: saas_test_6_models.CreateAntcloudOpenapiApiserviceGroupRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.create_antcloud_openapi_apiservice_group_ex(request, headers, runtime)

    async def create_antcloud_openapi_apiservice_group_async(
        self,
        request: saas_test_6_models.CreateAntcloudOpenapiApiserviceGroupRequest,
    ) -> saas_test_6_models.CreateAntcloudOpenapiApiserviceGroupResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.create_antcloud_openapi_apiservice_group_ex_async(request, headers, runtime)

    def create_antcloud_openapi_apiservice_group_ex(
        self,
        request: saas_test_6_models.CreateAntcloudOpenapiApiserviceGroupRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def create_antcloud_openapi_apiservice_group_ex_async(
        self,
        request: saas_test_6_models.CreateAntcloudOpenapiApiserviceGroupRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def create_antcloud_gatewayx_file_upload(
        self,
        request: saas_test_6_models.CreateAntcloudGatewayxFileUploadRequest,
    ) -> saas_test_6_models.CreateAntcloudGatewayxFileUploadResponse:
        """
