...
using AntChain.SDK.SaasTest6.Models;

namespace AntChain.SDK.SaasTest6
{
    public class Client 
    {
         ...
         * Summary: 创建分组
         */
        public CreateAntcloudOpenapiApiserviceGroupResponse CreateAntcloudOpenapiApiserviceGroup(CreateAntcloudOpenapiApiserviceGroupRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
         ...
         * Summary: 创建分组
         */
        public async Task<CreateAntcloudOpenapiApiserviceGroupResponse> CreateAntcloudOpenapiApiserviceGroupAsync(CreateAntcloudOpenapiApiserviceGroupRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await CreateAntcloudOpenapiApiserviceGroupExAsync(request, headers, runtime);
        }
         ...
         * Summary: 创建分组
         */
        public CreateAntcloudOpenapiApiserviceGroupResponse CreateAntcloudOpenapiApiserviceGroupEx(CreateAntcloudOpenapiApiserviceGroupRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateAntcloudOpenapiApiserviceGroupResponse>(DoRequest("1.0", "antcloud.openapi.apiservice.group.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 创建分组
         */
        public async Task<CreateAntcloudOpenapiApiserviceGroupResponse> CreateAntcloudOpenapiApiserviceGroupExAsync(CreateAntcloudOpenapiApiserviceGroupRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateAntcloudOpenapiApiserviceGroupResponse>(await DoRequestAsync("1.0", "antcloud.openapi.apiservice.group.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
