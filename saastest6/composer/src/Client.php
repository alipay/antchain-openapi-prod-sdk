...
use AntChain\SaasTest6\Models\CreateAntcloudGatewayxFileUploadRequest;
use AntChain\SaasTest6\Models\CreateAntcloudGatewayxFileUploadResponse;
use AntChain\SaasTest6\Models\CreateAntcloudOpenapiApiserviceGroupRequest;
...
class Client
{
     ...
     * Summary: 创建分组.
     *
     * @param CreateAntcloudOpenapiApiserviceGroupRequest $request
     *
     * @return CreateAntcloudOpenapiApiserviceGroupResponse
     */
    public function createAntcloudOpenapiApiserviceGroup($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];

        return $this->createAntcloudOpenapiApiserviceGroupEx($request, $headers, $runtime);
    }
     ...
     * @return CreateAntcloudOpenapiApiserviceGroupResponse
     */
    public function createAntcloudOpenapiApiserviceGroupEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);
