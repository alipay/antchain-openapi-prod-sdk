...
type UpdateNftPropertyRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
	// 用户id标识
	...
	UpdateInfo *string `json:"update_info,omitempty" xml:"update_info,omitempty" require:"true"`
}

func (s UpdateNftPropertyRequest) String() string {
	return tea.Prettify(s)
}

func (s UpdateNftPropertyRequest) GoString() string {
	return s.String()
}

func (s *UpdateNftPropertyRequest) SetAuthToken(v string) *UpdateNftPropertyRequest {
	s.AuthToken = &v
	return s
}

func (s *UpdateNftPropertyRequest) SetProductInstanceId(v string) *UpdateNftPropertyRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *UpdateNftPropertyRequest) SetIdNo(v string) *UpdateNftPropertyRequest {
	s.IdNo = &v
	return s
}

func (s *UpdateNftPropertyRequest) SetIdType(v string) *UpdateNftPropertyRequest {
	s.IdType = &v
	return s
}

func (s *UpdateNftPropertyRequest) SetNftId(v string) *UpdateNftPropertyRequest {
	s.NftId = &v
	return s
}

func (s *UpdateNftPropertyRequest) SetSource(v string) *UpdateNftPropertyRequest {
	s.Source = &v
	return s
}

func (s *UpdateNftPropertyRequest) SetUpdateInfo(v string) *UpdateNftPropertyRequest {
	s.UpdateInfo = &v
	return s
}

type UpdateNftPropertyResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s UpdateNftPropertyResponse) String() string {
	return tea.Prettify(s)
}

func (s UpdateNftPropertyResponse) GoString() string {
	return s.String()
}

func (s *UpdateNftPropertyResponse) SetReqMsgId(v string) *UpdateNftPropertyResponse {
	s.ReqMsgId = &v
	return s
}

func (s *UpdateNftPropertyResponse) SetResultCode(v string) *UpdateNftPropertyResponse {
	s.ResultCode = &v
	return s
}

func (s *UpdateNftPropertyResponse) SetResultMsg(v string) *UpdateNftPropertyResponse {
	s.ResultMsg = &v
	return s
}
 ...
 * Summary: 资产属性更新
 */
func (client *Client) UpdateNftProperty(request *UpdateNftPropertyRequest) (_result *UpdateNftPropertyResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &UpdateNftPropertyResponse{}
	_body, _err := client.UpdateNftPropertyEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 资产属性更新
 */
func (client *Client) UpdateNftPropertyEx(request *UpdateNftPropertyRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *UpdateNftPropertyResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	_result = &UpdateNftPropertyResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antchain.nftx.nft.property.update"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
