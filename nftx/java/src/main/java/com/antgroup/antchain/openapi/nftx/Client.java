...
public class Client {
     ...
     * Summary: 外部订单数据同步
     */
    public SyncOrderDataResponse syncOrderData(SyncOrderDataRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 外部订单数据同步
     */
    public SyncOrderDataResponse syncOrderDataEx(SyncOrderDataRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.nftx.order.data.sync", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new SyncOrderDataResponse());
    }
     ...
     * Summary: 查询实物定制图片
     */
    public QueryResourceImageResponse queryResourceImage(QueryResourceImageRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 查询实物定制图片
     */
    public QueryResourceImageResponse queryResourceImageEx(QueryResourceImageRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.nftx.resource.image.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryResourceImageResponse());
    }
     ...
     * Summary: 用户收货信息存档
     */
    public ImportResourceConsigneeinfoResponse importResourceConsigneeinfo(ImportResourceConsigneeinfoRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
