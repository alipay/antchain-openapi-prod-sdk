...
func (s *ExecAntcloudBxptnewDataproductRequest) SetProductType(v string) *ExecAntcloudBxptnewDataproductRequest {
	s.ProductType = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("ak_2329128e7da44c10a48ad4b13121ee91"),
