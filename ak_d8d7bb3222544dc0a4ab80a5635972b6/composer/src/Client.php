...
namespace AntChain\Ak_d8d7bb3222544dc0a4ab80a5635972b6;
...
use AntChain\Ak_d8d7bb3222544dc0a4ab80a5635972b6\Models\ConfirmAntchainBbpContractReconciliationRequest;
use AntChain\Ak_d8d7bb3222544dc0a4ab80a5635972b6\Models\ConfirmAntchainBbpContractReconciliationResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_d8d7bb3222544dc0a4ab80a5635972b6',
                    '_prod_channel'    => 'saas',
                ];
