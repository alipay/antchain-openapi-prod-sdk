...
using AntChain.SDK.Ak_f2ba648e36a44708ab93a511f45f8a19.Models;

namespace AntChain.SDK.Ak_f2ba648e36a44708ab93a511f45f8a19
{
    public class Client 
    {
         ...
         * Summary: 123
         */
        public BindDemoQweQweResponse BindDemoQweQwe(BindDemoQweQweRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return BindDemoQweQweEx(request, headers, runtime);
        }
         ...
         * Summary: 123
         */
        public async Task<BindDemoQweQweResponse> BindDemoQweQweAsync(BindDemoQweQweRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await BindDemoQweQweExAsync(request, headers, runtime);
        }
         ...
         * Summary: 123
         */
        public BindDemoQweQweResponse BindDemoQweQweEx(BindDemoQweQweRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<BindDemoQweQweResponse>(DoRequest("1.0", "demo.qwe.qwe.bind", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 123
         */
        public async Task<BindDemoQweQweResponse> BindDemoQweQweExAsync(BindDemoQweQweRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<BindDemoQweQweResponse>(await DoRequestAsync("1.0", "demo.qwe.qwe.bind", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
