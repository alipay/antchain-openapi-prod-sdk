...
class StrategyUploadResult extends Model
{
    ...
    {
        Model::validateRequired('ruleMetaId', $this->ruleMetaId, true);
        Model::validateRequired('sceneId', $this->sceneId, true);
        Model::validateRequired('tenantSceneId', $this->tenantSceneId, true);
        Model::validateRequired('decisionRuleId', $this->decisionRuleId, true);
