...
PACKAGE = "antchain_sdk_unicontact"
NAME = "antchain_unicontact" or "alibabacloud-package"
DESCRIPTION = "Ant Chain UNICONTACT SDK Library for Python"
AUTHOR = "Ant Chain SDK"
