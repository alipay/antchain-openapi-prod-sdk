...
class UpdateMsDdcsAttributeRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->newAttributeName) {
            $res['new_attribute_name'] = $this->newAttributeName;
        }
     ...
     * @param array $map
     *
     * @return UpdateMsDdcsAttributeRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['new_attribute_name'])) {
            $model->newAttributeName = $map['new_attribute_name'];
        }
