...
class SaveDataConversionRequest extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('attributeType', $this->attributeType, true);
    }
    ...
    public function toMap()
    {
        ...
        if (null !== $this->attributeType) {
            $res['attribute_type'] = $this->attributeType;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['attribute_type'])) {
            $model->attributeType = $map['attribute_type'];
        }
