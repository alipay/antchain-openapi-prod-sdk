...
package com.antgroup.antchain.openapi.morserta;
...
import com.antgroup.antchain.openapi.morserta.models.*;
...
public class Client {
    ...
    /**
     * <b>description</b> :
     * <p>Description: 新版转化回传接口
     * Summary: 新版转化回传接口</p>
     */
    public SaveDataConversionResponse saveDataConversion(SaveDataConversionRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 新版转化回传接口</p>
     */
    public SaveDataConversionResponse saveDataConversionEx(SaveDataConversionRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.morserta.data.conversion.save", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new SaveDataConversionResponse());
    }
}
