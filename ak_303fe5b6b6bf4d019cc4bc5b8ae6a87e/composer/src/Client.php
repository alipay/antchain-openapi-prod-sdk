...
namespace AntChain\Ak_303fe5b6b6bf4d019cc4bc5b8ae6a87e;
...
use AntChain\Ak_303fe5b6b6bf4d019cc4bc5b8ae6a87e\Models\QueryDemoAbcAbcAbcRequest;
use AntChain\Ak_303fe5b6b6bf4d019cc4bc5b8ae6a87e\Models\QueryDemoAbcAbcAbcResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_303fe5b6b6bf4d019cc4bc5b8ae6a87e',
                    '_prod_channel'    => 'saas',
                ];
