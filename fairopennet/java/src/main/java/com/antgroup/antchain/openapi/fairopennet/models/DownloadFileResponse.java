...
public class DownloadFileResponse extends TeaModel {
    ...
    public DownloadFileResponse setReqMsgId(String reqMsgId) {
    ...
    public DownloadFileResponse setResultCode(String resultCode) {
    ...
    public DownloadFileResponse setResultMsg(String resultMsg) {
