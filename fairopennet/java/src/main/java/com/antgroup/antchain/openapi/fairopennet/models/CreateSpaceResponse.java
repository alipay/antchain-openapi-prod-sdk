...
public class CreateSpaceResponse extends TeaModel {
    ...
    public CreateSpaceResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateSpaceResponse setResultCode(String resultCode) {
    ...
    public CreateSpaceResponse setResultMsg(String resultMsg) {
