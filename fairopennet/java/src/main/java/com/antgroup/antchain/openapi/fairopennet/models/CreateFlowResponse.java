...
public class CreateFlowResponse extends TeaModel {
    ...
    public CreateFlowResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateFlowResponse setResultCode(String resultCode) {
    ...
    public CreateFlowResponse setResultMsg(String resultMsg) {
