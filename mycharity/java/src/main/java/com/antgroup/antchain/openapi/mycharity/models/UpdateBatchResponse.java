...
public class UpdateBatchResponse extends TeaModel {
    ...
    public UpdateBatchResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateBatchResponse setResultCode(String resultCode) {
    ...
    public UpdateBatchResponse setResultMsg(String resultMsg) {
