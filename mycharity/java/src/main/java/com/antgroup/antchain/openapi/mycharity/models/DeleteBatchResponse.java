...
public class DeleteBatchResponse extends TeaModel {
    ...
    public DeleteBatchResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteBatchResponse setResultCode(String resultCode) {
    ...
    public DeleteBatchResponse setResultMsg(String resultMsg) {
