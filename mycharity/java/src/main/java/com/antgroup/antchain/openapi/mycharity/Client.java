...
public class Client {
     ...
     */
    public BatchqueryActivityrecordResponse batchqueryActivityrecord(BatchqueryActivityrecordRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用户活动徽章捐赠记录查询
     */
    public BatchqueryActivityrecordResponse batchqueryActivityrecordEx(BatchqueryActivityrecordRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.mycharity.activityrecord.batchquery", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new BatchqueryActivityrecordResponse());
    }
     ...
     * Summary: 用户活动徽章详情
     */
    public DetailUserbadgeResponse detailUserbadge(DetailUserbadgeRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 用户活动徽章详情
     */
    public DetailUserbadgeResponse detailUserbadgeEx(DetailUserbadgeRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.mycharity.userbadge.detail", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new DetailUserbadgeResponse());
    }
}
