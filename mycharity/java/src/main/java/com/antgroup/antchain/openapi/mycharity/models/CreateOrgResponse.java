...
public class CreateOrgResponse extends TeaModel {
    ...
    public CreateOrgResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateOrgResponse setResultCode(String resultCode) {
    ...
    public CreateOrgResponse setResultMsg(String resultMsg) {
