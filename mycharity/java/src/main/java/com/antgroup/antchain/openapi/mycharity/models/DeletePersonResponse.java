...
public class DeletePersonResponse extends TeaModel {
    ...
    public DeletePersonResponse setReqMsgId(String reqMsgId) {
    ...
    public DeletePersonResponse setResultCode(String resultCode) {
    ...
    public DeletePersonResponse setResultMsg(String resultMsg) {
