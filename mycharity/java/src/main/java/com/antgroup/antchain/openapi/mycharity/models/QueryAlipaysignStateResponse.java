...
public class QueryAlipaysignStateResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public QueryAlipaysignStateResponse setReqMsgId(String reqMsgId) {
    ...
    public QueryAlipaysignStateResponse setResultCode(String resultCode) {
    ...
    public QueryAlipaysignStateResponse setResultMsg(String resultMsg) {
