...
public class UpdateRecordResponse extends TeaModel {
    ...
    public UpdateRecordResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateRecordResponse setResultCode(String resultCode) {
    ...
    public UpdateRecordResponse setResultMsg(String resultMsg) {
