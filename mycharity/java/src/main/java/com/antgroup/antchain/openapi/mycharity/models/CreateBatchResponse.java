...
public class CreateBatchResponse extends TeaModel {
    ...
    public CreateBatchResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateBatchResponse setResultCode(String resultCode) {
    ...
    public CreateBatchResponse setResultMsg(String resultMsg) {
