...
from antchain_sdk_marketingagent import models as marketingagent_models
...
class Client:
    ...
    def __init__(
        self, 
        config: marketingagent_models.Config,
    ):
        """
    ...
    def send_message(
        self,
        request: marketingagent_models.SendMessageRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.send_message_ex(request, headers, runtime)
    ...
    async def send_message_async(
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.send_message_ex_async(request, headers, runtime)
    ...
    def send_message_ex(
        ...
        return TeaCore.from_map(
            marketingagent_models.SendMessageResponse(),
            self.do_request('1.0', 'antcloud.marketingagent.message.send', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def send_message_ex_async(
        self,
        request: marketingagent_models.SendMessageRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            marketingagent_models.SendMessageResponse(),
            await self.do_request_async('1.0', 'antcloud.marketingagent.message.send', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def get_task(
        self,
        request: marketingagent_models.GetTaskRequest,
    ...
    def get_task_ex(
        ...
        return TeaCore.from_map(
            marketingagent_models.GetTaskResponse(),
            self.do_request('1.0', 'antcloud.marketingagent.task.get', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
