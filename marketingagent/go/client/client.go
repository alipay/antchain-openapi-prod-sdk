...
type SendMessageRequest struct {
	...
	Request *Message `json:"request,omitempty" xml:"request,omitempty" require:"true"`
	// tenant
...
func (s *SendMessageRequest) SetAuthToken(v string) *SendMessageRequest {
	s.AuthToken = &v
	return s
}

func (s *SendMessageRequest) SetRequest(v *Message) *SendMessageRequest {
	s.Request = v
	return s
}

func (s *SendMessageRequest) SetTenant(v string) *SendMessageRequest {
	s.Tenant = &v
	return s
}
...
type SendMessageResponse struct {
	...
	// Message is one unit of communication between client and server.
	Msg *Message `json:"msg,omitempty" xml:"msg,omitempty"`
}
...
func (s *SendMessageResponse) SetReqMsgId(v string) *SendMessageResponse {
	s.ReqMsgId = &v
	return s
}

func (s *SendMessageResponse) SetResultCode(v string) *SendMessageResponse {
	s.ResultCode = &v
	return s
}

func (s *SendMessageResponse) SetResultMsg(v string) *SendMessageResponse {
	s.ResultMsg = &v
	return s
}

func (s *SendMessageResponse) SetTask(v *Task) *SendMessageResponse {
	s.Task = v
	return s
}

func (s *SendMessageResponse) SetMsg(v *Message) *SendMessageResponse {
	s.Msg = v
	return s
}
...
func (s *GetTaskResponse) SetTask(v *Task) *GetTaskResponse {
	s.Task = v
	return s
}

type GetComsumeJdRequest struct {
	// OAuth模式下的授权token
	AuthToken *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	// 项目ID
...
func (s GetComsumeJdRequest) String() string {
	return tea.Prettify(s)
}

func (s GetComsumeJdRequest) GoString() string {
	return s.String()
}

func (s *GetComsumeJdRequest) SetAuthToken(v string) *GetComsumeJdRequest {
	s.AuthToken = &v
	return s
}

func (s *GetComsumeJdRequest) SetProjectId(v string) *GetComsumeJdRequest {
	s.ProjectId = &v
	return s
}

func (s *GetComsumeJdRequest) SetUserId(v string) *GetComsumeJdRequest {
	s.UserId = &v
	return s
}

func (s *GetComsumeJdRequest) SetCouponId(v string) *GetComsumeJdRequest {
	s.CouponId = &v
	return s
}

func (s *GetComsumeJdRequest) SetPrizeStatus(v string) *GetComsumeJdRequest {
	s.PrizeStatus = &v
	return s
}

func (s *GetComsumeJdRequest) SetConsumeTime(v string) *GetComsumeJdRequest {
	s.ConsumeTime = &v
	return s
}

func (s *GetComsumeJdRequest) SetWriteOffType(v int64) *GetComsumeJdRequest {
	s.WriteOffType = &v
	return s
}

func (s *GetComsumeJdRequest) SetBankFlowNo(v string) *GetComsumeJdRequest {
	s.BankFlowNo = &v
	return s
}

func (s *GetComsumeJdRequest) SetTransactionId(v string) *GetComsumeJdRequest {
	s.TransactionId = &v
	return s
}

func (s *GetComsumeJdRequest) SetTradeAmount(v int64) *GetComsumeJdRequest {
	s.TradeAmount = &v
	return s
}

func (s *GetComsumeJdRequest) SetMerchantNo(v string) *GetComsumeJdRequest {
	s.MerchantNo = &v
	return s
}

type GetComsumeJdResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s GetComsumeJdResponse) String() string {
	return tea.Prettify(s)
}

func (s GetComsumeJdResponse) GoString() string {
	return s.String()
}

func (s *GetComsumeJdResponse) SetReqMsgId(v string) *GetComsumeJdResponse {
	s.ReqMsgId = &v
	return s
}

func (s *GetComsumeJdResponse) SetResultCode(v string) *GetComsumeJdResponse {
	s.ResultCode = &v
	return s
}

func (s *GetComsumeJdResponse) SetResultMsg(v string) *GetComsumeJdResponse {
	s.ResultMsg = &v
	return s
}

func (s *GetComsumeJdResponse) SetCode(v string) *GetComsumeJdResponse {
	s.Code = &v
	return s
}

func (s *GetComsumeJdResponse) SetMessage(v string) *GetComsumeJdResponse {
	s.Message = &v
	return s
}
...
func (client *Client) SendMessage(request *SendMessageRequest) (_result *SendMessageResponse, _err error) {
	...
	_body, _err := client.SendMessageEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) SendMessageEx(request *SendMessageRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *SendMessageResponse, _err error) {
	...
	_result = &SendMessageResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antcloud.marketingagent.message.send"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) GetTaskEx(request *GetTaskRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *GetTaskResponse, _err error) {
	...
	_result = &GetTaskResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antcloud.marketingagent.task.get"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
 ...
 * Summary: 京东微信核销数据回调
 */
func (client *Client) GetComsumeJd(request *GetComsumeJdRequest) (_result *GetComsumeJdResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &GetComsumeJdResponse{}
	_body, _err := client.GetComsumeJdEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 京东微信核销数据回调
 */
func (client *Client) GetComsumeJdEx(request *GetComsumeJdRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *GetComsumeJdResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
