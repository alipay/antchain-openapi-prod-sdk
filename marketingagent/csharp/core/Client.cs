...
using AntChain.SDK.MARKETINGAGENT.Models;

namespace AntChain.SDK.MARKETINGAGENT
{
    public class Client 
    {
        ...
        public async Task<SendMessageResponse> SendMessageAsync(SendMessageRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await SendMessageExAsync(request, headers, runtime);
        }
         ...
         * Summary: message:send
         */
        public SendMessageResponse SendMessageEx(SendMessageRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendMessageResponse>(DoRequest("1.0", "antcloud.marketingagent.message.send", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: message:send
         */
        public async Task<SendMessageResponse> SendMessageExAsync(SendMessageRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendMessageResponse>(await DoRequestAsync("1.0", "antcloud.marketingagent.message.send", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetTaskResponse>(DoRequest("1.0", "antcloud.marketingagent.task.get", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
