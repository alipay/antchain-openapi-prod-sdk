...
class Asset extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('assetExtInfo', $this->assetExtInfo, true);
        ...
        Model::validateRequired('issueAccountBalance', $this->issueAccountBalance, true);
        Model::validateRequired('overdueRecoveryAccountBalance', $this->overdueRecoveryAccountBalance, true);
        Model::validateRequired('receivePaymentAccountBalance', $this->receivePaymentAccountBalance, true);
        Model::validateRequired('relayAccountBalance', $this->relayAccountBalance, true);
        Model::validateRequired('status', $this->status, true);
        Model::validateRequired('tenantId', $this->tenantId, true);
        Model::validateRequired('totalIssueBalance', $this->totalIssueBalance, true);
    }
