...
class SaveJointconstraintRecordRequest extends Model {
    ...
    public function validate() {
        ...
        Model::validatePattern('paidTime', $this->paidTime, '\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}[Z]');
        Model::validatePattern('paymentDeadline', $this->paymentDeadline, '\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}[Z]');
    }
