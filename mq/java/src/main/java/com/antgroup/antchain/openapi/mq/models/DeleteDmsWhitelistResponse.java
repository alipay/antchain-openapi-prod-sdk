...
public class DeleteDmsWhitelistResponse extends TeaModel {
    ...
    public DeleteDmsWhitelistResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteDmsWhitelistResponse setResultCode(String resultCode) {
    ...
    public DeleteDmsWhitelistResponse setResultMsg(String resultMsg) {
