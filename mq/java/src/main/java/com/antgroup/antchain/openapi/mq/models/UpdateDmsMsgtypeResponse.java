...
public class UpdateDmsMsgtypeResponse extends TeaModel {
    ...
    public UpdateDmsMsgtypeResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateDmsMsgtypeResponse setResultCode(String resultCode) {
    ...
    public UpdateDmsMsgtypeResponse setResultMsg(String resultMsg) {
