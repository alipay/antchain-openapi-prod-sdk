...
public class BatchdeleteDmsMsgResponse extends TeaModel {
    ...
    public BatchdeleteDmsMsgResponse setReqMsgId(String reqMsgId) {
    ...
    public BatchdeleteDmsMsgResponse setResultCode(String resultCode) {
    ...
    public BatchdeleteDmsMsgResponse setResultMsg(String resultMsg) {
