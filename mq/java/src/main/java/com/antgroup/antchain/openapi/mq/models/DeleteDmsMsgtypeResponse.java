...
public class DeleteDmsMsgtypeResponse extends TeaModel {
    ...
    public DeleteDmsMsgtypeResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteDmsMsgtypeResponse setResultCode(String resultCode) {
    ...
    public DeleteDmsMsgtypeResponse setResultMsg(String resultMsg) {
