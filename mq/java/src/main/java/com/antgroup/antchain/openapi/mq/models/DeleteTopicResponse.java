...
public class DeleteTopicResponse extends TeaModel {
    ...
    public DeleteTopicResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteTopicResponse setResultCode(String resultCode) {
    ...
    public DeleteTopicResponse setResultMsg(String resultMsg) {
