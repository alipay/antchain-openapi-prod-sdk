...
public class DeleteDmsMsgResponse extends TeaModel {
    ...
    public DeleteDmsMsgResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteDmsMsgResponse setResultCode(String resultCode) {
    ...
    public DeleteDmsMsgResponse setResultMsg(String resultMsg) {
