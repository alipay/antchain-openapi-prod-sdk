...
class QuerySofamqConnectorjobpartitionstatusResponse extends Model
{
    // 请求唯一ID，用于链路跟踪和问题排查
    /**
     * @var string
    ...
    // 分区分页状态
    /**
     * @var ConnectorJobPartitionStatusPageResult
     */
    public $data;
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['data'])) {
            $model->data = ConnectorJobPartitionStatusPageResult::fromMap($map['data']);
        }
