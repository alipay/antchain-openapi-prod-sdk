...
class QuerySofamqConnectorplansingletonResponse extends Model
{
    // 请求唯一ID，用于链路跟踪和问题排查
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->jobInstance) {
            $res['job_instance'] = null !== $this->jobInstance ? $this->jobInstance->toMap() : null;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['job_instance'])) {
            $model->jobInstance = JobRecordDTO::fromMap($map['job_instance']);
        }
