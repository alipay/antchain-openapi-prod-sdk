...
public class SubmitAntchainAtoFrontSignRequest extends TeaModel {
    ...
    public SubmitAntchainAtoFrontSignRequest setUserOpenId(String userOpenId) {
    ...
    public SubmitAntchainAtoFrontSignRequest setMerchantAppId(String merchantAppId) {
    ...
    public SubmitAntchainAtoFrontSignRequest setUserType(String userType) {
    ...
    public SubmitAntchainAtoFrontSignRequest setUserOrgIdNumber(String userOrgIdNumber) {
    ...
    public SubmitAntchainAtoFrontSignRequest setUserOrgIdType(String userOrgIdType) {
    ...
    public SubmitAntchainAtoFrontSignRequest setUserOrgName(String userOrgName) {
    ...
    public SubmitAntchainAtoFrontSignRequest setWithholdSignScene(String withholdSignScene) {
