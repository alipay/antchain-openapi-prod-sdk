...
public class SubmitAntchainAtoSignFlowRequest extends TeaModel {
    ...
    public SubmitAntchainAtoSignFlowRequest setUserOpenId(String userOpenId) {
    ...
    public SubmitAntchainAtoSignFlowRequest setMerchantAppId(String merchantAppId) {
    ...
    public SubmitAntchainAtoSignFlowRequest setSealType(String sealType) {
    ...
    public SubmitAntchainAtoSignFlowRequest setWithholdSignScene(String withholdSignScene) {
