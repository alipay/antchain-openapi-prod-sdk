...
class TransferCutpaymentsubRevenueRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('transAmount', $this->transAmount, true);
     ...
     * @param array $map
     *
     * @return TransferCutpaymentsubRevenueRequest
     */
