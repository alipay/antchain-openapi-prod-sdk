...
class QueryEducationBackgroundResponse extends Model
{
    // 请求唯一ID，用于链路跟踪和问题排查
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->educationInfo) {
            $res['education_info'] = $this->educationInfo;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['education_info'])) {
            $model->educationInfo = $map['education_info'];
        }
