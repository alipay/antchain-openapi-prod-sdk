...
public class QueryBankLivenessResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public static QueryBankLivenessResponse build(java.util.Map<String, ?> map) throws Exception {
        QueryBankLivenessResponse self = new QueryBankLivenessResponse();
        return TeaModel.build(map, self);
    }

    public QueryBankLivenessResponse setReqMsgId(String reqMsgId) {
