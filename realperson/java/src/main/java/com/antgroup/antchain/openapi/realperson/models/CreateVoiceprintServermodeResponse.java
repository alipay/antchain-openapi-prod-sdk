...
public class CreateVoiceprintServermodeResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public static CreateVoiceprintServermodeResponse build(java.util.Map<String, ?> map) throws Exception {
        CreateVoiceprintServermodeResponse self = new CreateVoiceprintServermodeResponse();
        return TeaModel.build(map, self);
    }

    public CreateVoiceprintServermodeResponse setReqMsgId(String reqMsgId) {
