...
public class Client {
     ...
     * Summary: 查询售后中心项目信息
     */
    public QueryCustomResponse queryCustomEx(QueryCustomRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
     ...
     * Summary: 提交到aone
     */
    public SaveAoneResponse saveAoneEx(SaveAoneRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
     ...
     * Summary: 查询aone详情
     */
    public QueryAoneResponse queryAoneEx(QueryAoneRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
