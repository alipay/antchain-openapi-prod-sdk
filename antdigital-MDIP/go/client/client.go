...
type CallbackRiskplusMdipFileRequest struct {
	// OAuth模式下的授权token
...
func (s CallbackRiskplusMdipFileRequest) GoString() string {
	return s.String()
}

func (s *CallbackRiskplusMdipFileRequest) SetAuthToken(v string) *CallbackRiskplusMdipFileRequest {
	s.AuthToken = &v
	return s
}

func (s *CallbackRiskplusMdipFileRequest) SetProductInstanceId(v string) *CallbackRiskplusMdipFileRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *CallbackRiskplusMdipFileRequest) SetFileObject(v io.Reader) *CallbackRiskplusMdipFileRequest {
	s.FileObject = v
	return s
}

func (s *CallbackRiskplusMdipFileRequest) SetFileObjectName(v string) *CallbackRiskplusMdipFileRequest {
	s.FileObjectName = &v
	return s
}

func (s *CallbackRiskplusMdipFileRequest) SetFileId(v string) *CallbackRiskplusMdipFileRequest {
	s.FileId = &v
	return s
}

func (s *CallbackRiskplusMdipFileRequest) SetServiceCode(v string) *CallbackRiskplusMdipFileRequest {
	s.ServiceCode = &v
	return s
}

func (s *CallbackRiskplusMdipFileRequest) SetCaller(v string) *CallbackRiskplusMdipFileRequest {
	s.Caller = &v
	return s
}
...
type CallbackRiskplusMdipFileResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
...
func (s CallbackRiskplusMdipFileResponse) String() string {
	return tea.Prettify(s)
}

func (s CallbackRiskplusMdipFileResponse) GoString() string {
	return s.String()
}

func (s *CallbackRiskplusMdipFileResponse) SetReqMsgId(v string) *CallbackRiskplusMdipFileResponse {
	s.ReqMsgId = &v
	return s
}

func (s *CallbackRiskplusMdipFileResponse) SetResultCode(v string) *CallbackRiskplusMdipFileResponse {
	s.ResultCode = &v
	return s
}

func (s *CallbackRiskplusMdipFileResponse) SetResultMsg(v string) *CallbackRiskplusMdipFileResponse {
	s.ResultMsg = &v
	return s
}
...
//
// Summary: 支持异步回传文件
func (client *Client) CallbackRiskplusMdipFile(request *CallbackRiskplusMdipFileRequest) (_result *CallbackRiskplusMdipFileResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &CallbackRiskplusMdipFileResponse{}
	_body, _err := client.CallbackRiskplusMdipFileEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
//
// Summary: 支持异步回传文件
func (client *Client) CallbackRiskplusMdipFileEx(request *CallbackRiskplusMdipFileRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *CallbackRiskplusMdipFileResponse, _err error) {
	if !tea.BoolValue(util.IsUnset(request.FileObject)) {
		uploadReq := &CreateAntcloudGatewayxFileUploadRequest{
			AuthToken: request.AuthToken,
			ApiCode:   tea.String("riskplus.mdip.file.callback"),
		...
		if !tea.BoolValue(antchainutil.IsSuccess(uploadResp.ResultCode, tea.String("ok"))) {
			callbackRiskplusMdipFileResponse := &CallbackRiskplusMdipFileResponse{
	...
	_result = &CallbackRiskplusMdipFileResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("riskplus.mdip.file.callback"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
