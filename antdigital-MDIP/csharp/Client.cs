...
using AntChain.SDK.MDIP.Models;

namespace AntChain.SDK.MDIP
{
    public class Client 
    {
        ...
        /// </description>
        public CallbackRiskplusMdipFileResponse CallbackRiskplusMdipFile(CallbackRiskplusMdipFileRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return CallbackRiskplusMdipFileEx(request, headers, runtime);
        }
        ...
        /// Summary: 支持异步回传文件</para>
        /// </description>
        public async Task<CallbackRiskplusMdipFileResponse> CallbackRiskplusMdipFileAsync(CallbackRiskplusMdipFileRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await CallbackRiskplusMdipFileExAsync(request, headers, runtime);
        }
        ...
        /// Summary: 支持异步回传文件</para>
        /// </description>
        public CallbackRiskplusMdipFileResponse CallbackRiskplusMdipFileEx(CallbackRiskplusMdipFileRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.FileObject))
            {
                ...
                {
                    CallbackRiskplusMdipFileResponse callbackRiskplusMdipFileResponse = new CallbackRiskplusMdipFileResponse
                    {
            ...
            return TeaModel.ToObject<CallbackRiskplusMdipFileResponse>(DoRequest("1.0", "riskplus.mdip.file.callback", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        /// Summary: 支持异步回传文件</para>
        /// </description>
        public async Task<CallbackRiskplusMdipFileResponse> CallbackRiskplusMdipFileExAsync(CallbackRiskplusMdipFileRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.FileObject))
            {
                CreateAntcloudGatewayxFileUploadRequest uploadReq = new CreateAntcloudGatewayxFileUploadRequest
            ...
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CallbackRiskplusMdipFileResponse>(await DoRequestAsync("1.0", "riskplus.mdip.file.callback", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
