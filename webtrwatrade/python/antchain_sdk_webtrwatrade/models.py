...
class OperationLogVO(TeaModel):
    ...
    def to_map(self):
        ...
        if self.gmt_modified is not None:
            result['gmt_modified'] = self.gmt_modified
        if self.modifie_by is not None:
            result['modifie_by'] = self.modifie_by
        if self.user_id is not None:
            result['user_id'] = self.user_id
        if self.user_address is not None:
            result['user_address'] = self.user_address
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('gmt_modified') is not None:
            self.gmt_modified = m.get('gmt_modified')
        if m.get('modifie_by') is not None:
            self.modifie_by = m.get('modifie_by')
        if m.get('user_id') is not None:
            self.user_id = m.get('user_id')
        if m.get('user_address') is not None:
            self.user_address = m.get('user_address')
...
class ListIssuerProjectRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class ListIssuerProjectResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ListDistributorProjectRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class ListDistributorProjectResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ListIssuerAlloperationlogRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
        ...
        self.login_accout = login_accout
        # 开始时间 (时间戳)
        self.start_time_mills = start_time_mills
        # 结束时间 (时间戳)
        self.end_time_mills = end_time_mills
    ...
    def to_map(self):
        ...
        if self.login_accout is not None:
            result['login_accout'] = self.login_accout
        if self.start_time_mills is not None:
            result['start_time_mills'] = self.start_time_mills
        if self.end_time_mills is not None:
            result['end_time_mills'] = self.end_time_mills
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('login_accout') is not None:
            self.login_accout = m.get('login_accout')
        if m.get('start_time_mills') is not None:
            self.start_time_mills = m.get('start_time_mills')
        if m.get('end_time_mills') is not None:
            self.end_time_mills = m.get('end_time_mills')
...
class ListIssuerAlloperationlogResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ListDistributorAlloperationlogRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class ListDistributorAlloperationlogResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class UpdateIssuerPriceRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class UpdateIssuerPriceResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ListIssuerSubuserRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class ListIssuerSubuserResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ListDistributorSubuserRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class ListDistributorSubuserResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
