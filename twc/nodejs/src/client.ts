...
export class CreateContractEncrypteduserRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
...
export class CreateContractEncrypteduserResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class SetContractTenantkeyRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 被通信秘钥加密后的解密密钥字符串。
...
export class SetContractTenantkeyResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class GetContractEncryptedfileuploadurlRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 包含后缀的文件全名, 合同.pdf
...
export class GetContractEncryptedfileuploadurlResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class CreateContractTaskRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 任务类型枚举值
...
export class CreateContractTaskResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryContractTaskRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 创建任务时，返回的任务id
...
export class QueryContractTaskResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class ExecContractPayRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 合同流程id
...
export class ExecContractPayResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class UnbindContractPayRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
...
export class UnbindContractPayResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryContractComplainRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 投诉单号
...
export class QueryContractComplainResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
  ...
  static types(): { [key: string]: any } {
    return {
      ...
      phoneNo: 'string',
      tradeAmount: 'string',
      replyDetailInfos: { 'type': 'array', 'itemType': ReplayDetailInfo },
    };
  }
...
export class SendContractComplainfeedbackRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 支付宝侧投诉单号
...
export class SendContractComplainfeedbackResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class UploadContractComplainimageRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
...
export class UploadContractComplainimageResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryJusticeRightsRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 案件维权记录编号
...
export class QueryJusticeRightsResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class UpdateJusticeRightsRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 案件维权记录编号
...
export class UpdateJusticeRightsResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class NotifyJusticeRightspaymentRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 案件维权记录编号
...
export class NotifyJusticeRightspaymentResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class CreateTrafficTraceidRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 业务场景码
...
export class CreateTrafficTraceidResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class UploadTrafficOperatelogRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
...
export class UploadTrafficOperatelogResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export default class Client {
   ...
   * Summary: 创建平台方用户加密版
   */
  async createContractEncrypteduser(request: CreateContractEncrypteduserRequest): Promise<CreateContractEncrypteduserResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.createContractEncrypteduserEx(request, headers, runtime);
  }
   ...
   * Summary: 创建平台方用户加密版
   */
  async createContractEncrypteduserEx(request: CreateContractEncrypteduserRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<CreateContractEncrypteduserResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateContractEncrypteduserResponse>(await this.doRequest("1.0", "twc.notary.contract.encrypteduser.create", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new CreateContractEncrypteduserResponse({}));
  }
   ...
   * Summary: 用户密钥设置接口
   */
  async setContractTenantkey(request: SetContractTenantkeyRequest): Promise<SetContractTenantkeyResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.setContractTenantkeyEx(request, headers, runtime);
  }
   ...
   * Summary: 用户密钥设置接口
   */
  async setContractTenantkeyEx(request: SetContractTenantkeyRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<SetContractTenantkeyResponse> {
    Util.validateModel(request);
    return $tea.cast<SetContractTenantkeyResponse>(await this.doRequest("1.0", "twc.notary.contract.tenantkey.set", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new SetContractTenantkeyResponse({}));
  }
   ...
   * Summary: 获取加密文件上传链接
   */
  async getContractEncryptedfileuploadurl(request: GetContractEncryptedfileuploadurlRequest): Promise<GetContractEncryptedfileuploadurlResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.getContractEncryptedfileuploadurlEx(request, headers, runtime);
  }
   ...
   * Summary: 获取加密文件上传链接
   */
  async getContractEncryptedfileuploadurlEx(request: GetContractEncryptedfileuploadurlRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<GetContractEncryptedfileuploadurlResponse> {
    Util.validateModel(request);
    return $tea.cast<GetContractEncryptedfileuploadurlResponse>(await this.doRequest("1.0", "twc.notary.contract.encryptedfileuploadurl.get", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new GetContractEncryptedfileuploadurlResponse({}));
  }
   ...
   * Summary: 创建任务接口
   */
  async createContractTask(request: CreateContractTaskRequest): Promise<CreateContractTaskResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.createContractTaskEx(request, headers, runtime);
  }
   ...
   * Summary: 创建任务接口
   */
  async createContractTaskEx(request: CreateContractTaskRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<CreateContractTaskResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateContractTaskResponse>(await this.doRequest("1.0", "twc.notary.contract.task.create", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new CreateContractTaskResponse({}));
  }
   ...
   * Summary: 任务查询
   */
  async queryContractTask(request: QueryContractTaskRequest): Promise<QueryContractTaskResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryContractTaskEx(request, headers, runtime);
  }
   ...
   * Summary: 任务查询
   */
  async queryContractTaskEx(request: QueryContractTaskRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryContractTaskResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryContractTaskResponse>(await this.doRequest("1.0", "twc.notary.contract.task.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryContractTaskResponse({}));
  }
   ...
   * Summary: 合同代扣触发接口
   */
  async execContractPay(request: ExecContractPayRequest): Promise<ExecContractPayResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.execContractPayEx(request, headers, runtime);
  }
   ...
   * Summary: 合同代扣触发接口
   */
  async execContractPayEx(request: ExecContractPayRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<ExecContractPayResponse> {
    Util.validateModel(request);
    return $tea.cast<ExecContractPayResponse>(await this.doRequest("1.0", "twc.notary.contract.pay.exec", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new ExecContractPayResponse({}));
  }
   ...
   * Summary: 代扣强制解约
   */
  async unbindContractPay(request: UnbindContractPayRequest): Promise<UnbindContractPayResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.unbindContractPayEx(request, headers, runtime);
  }
   ...
   * Summary: 代扣强制解约
   */
  async unbindContractPayEx(request: UnbindContractPayRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<UnbindContractPayResponse> {
    Util.validateModel(request);
    return $tea.cast<UnbindContractPayResponse>(await this.doRequest("1.0", "twc.notary.contract.pay.unbind", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new UnbindContractPayResponse({}));
  }
   ...
   * Summary: 投诉数据查询
   */
  async queryContractComplain(request: QueryContractComplainRequest): Promise<QueryContractComplainResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryContractComplainEx(request, headers, runtime);
  }
   ...
   * Summary: 投诉数据查询
   */
  async queryContractComplainEx(request: QueryContractComplainRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryContractComplainResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryContractComplainResponse>(await this.doRequest("1.0", "twc.notary.contract.complain.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryContractComplainResponse({}));
  }
   ...
   * Summary: 投诉反馈
   */
  async sendContractComplainfeedback(request: SendContractComplainfeedbackRequest): Promise<SendContractComplainfeedbackResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.sendContractComplainfeedbackEx(request, headers, runtime);
  }
   ...
   * Summary: 投诉反馈
   */
  async sendContractComplainfeedbackEx(request: SendContractComplainfeedbackRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<SendContractComplainfeedbackResponse> {
    Util.validateModel(request);
    return $tea.cast<SendContractComplainfeedbackResponse>(await this.doRequest("1.0", "twc.notary.contract.complainfeedback.send", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new SendContractComplainfeedbackResponse({}));
  }
   ...
   * Summary: 商户上传处理图片
   */
  async uploadContractComplainimage(request: UploadContractComplainimageRequest): Promise<UploadContractComplainimageResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.uploadContractComplainimageEx(request, headers, runtime);
  }
   ...
   */
  async queryJusticeRights(request: QueryJusticeRightsRequest): Promise<QueryJusticeRightsResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryJusticeRightsEx(request, headers, runtime);
  }
   ...
   * Summary: isv机构-案件要素查询
   */
  async queryJusticeRightsEx(request: QueryJusticeRightsRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryJusticeRightsResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryJusticeRightsResponse>(await this.doRequest("1.0", "twc.notary.justice.rights.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryJusticeRightsResponse({}));
  }
   ...
   */
  async updateJusticeRights(request: UpdateJusticeRightsRequest): Promise<UpdateJusticeRightsResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.updateJusticeRightsEx(request, headers, runtime);
  }
   ...
   * Summary: isv机构-维权状态更新
   */
  async updateJusticeRightsEx(request: UpdateJusticeRightsRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<UpdateJusticeRightsResponse> {
    Util.validateModel(request);
    return $tea.cast<UpdateJusticeRightsResponse>(await this.doRequest("1.0", "twc.notary.justice.rights.update", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new UpdateJusticeRightsResponse({}));
  }
   ...
   */
  async notifyJusticeRightspayment(request: NotifyJusticeRightspaymentRequest): Promise<NotifyJusticeRightspaymentResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.notifyJusticeRightspaymentEx(request, headers, runtime);
  }
   ...
   * Summary: isv机构-案件缴费通知接口
   */
  async notifyJusticeRightspaymentEx(request: NotifyJusticeRightspaymentRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<NotifyJusticeRightspaymentResponse> {
    Util.validateModel(request);
    return $tea.cast<NotifyJusticeRightspaymentResponse>(await this.doRequest("1.0", "twc.notary.justice.rightspayment.notify", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new NotifyJusticeRightspaymentResponse({}));
  }
   ...
   * Summary: traceId创建接口
   */
  async createTrafficTraceid(request: CreateTrafficTraceidRequest): Promise<CreateTrafficTraceidResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.createTrafficTraceidEx(request, headers, runtime);
  }
   ...
   * Summary: traceId创建接口
   */
  async createTrafficTraceidEx(request: CreateTrafficTraceidRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<CreateTrafficTraceidResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateTrafficTraceidResponse>(await this.doRequest("1.0", "twc.notary.traffic.traceid.create", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new CreateTrafficTraceidResponse({}));
  }
   ...
   * Summary: 操作行为日志传入
   */
  async uploadTrafficOperatelog(request: UploadTrafficOperatelogRequest): Promise<UploadTrafficOperatelogResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.uploadTrafficOperatelogEx(request, headers, runtime);
  }
