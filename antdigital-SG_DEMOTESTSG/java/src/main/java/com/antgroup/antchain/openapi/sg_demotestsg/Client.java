...
package com.antgroup.antchain.openapi.sg_demotestsg;
...
import com.antgroup.antchain.openapi.sg_demotestsg.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("_prod_code", "SG_DEMOTESTSG"),
    ...
    public QueryUserResponse queryUserEx(QueryUserRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRequest("1.0", "antdigital.sgdemotestsg.user.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryUserResponse());
    }
}
