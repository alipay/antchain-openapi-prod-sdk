...
using AntChain.SDK.AICLAIM.Models;

namespace AntChain.SDK.AICLAIM
{
    public class Client 
    {
         ...
         * Summary: 理赔材料照片分类
         */
        public ExecImageClassificationResponse ExecImageClassification(ExecImageClassificationRequest request)
        {
         ...
         * Summary: 理赔材料照片分类
         */
        public async Task<ExecImageClassificationResponse> ExecImageClassificationAsync(ExecImageClassificationRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await ExecImageClassificationExAsync(request, headers, runtime);
        }
         ...
         * Summary: 理赔材料照片分类
         */
        public ExecImageClassificationResponse ExecImageClassificationEx(ExecImageClassificationRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.FileObject))
            {
                ...
                {
                    ExecImageClassificationResponse execImageClassificationResponse = new ExecImageClassificationResponse
                    {
            ...
            return TeaModel.ToObject<ExecImageClassificationResponse>(DoRequest("1.0", "antdigital.aiclaim.image.classification.exec", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 理赔材料照片分类
         */
        public async Task<ExecImageClassificationResponse> ExecImageClassificationExAsync(ExecImageClassificationRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.FileObject))
            {
                CreateAntcloudGatewayxFileUploadRequest uploadReq = new CreateAntcloudGatewayxFileUploadRequest
