...
from antchain_sdk_aiclaim import models as aiclaim_models
...
class Client:
    ...
    def exec_image_classification(
        self,
        request: aiclaim_models.ExecImageClassificationRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.exec_image_classification_ex(request, headers, runtime)

    async def exec_image_classification_async(
        self,
        request: aiclaim_models.ExecImageClassificationRequest,
    ) -> aiclaim_models.ExecImageClassificationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.exec_image_classification_ex_async(request, headers, runtime)

    def exec_image_classification_ex(
        self,
        request: aiclaim_models.ExecImageClassificationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        if not UtilClient.is_unset(request.file_object):
            upload_req = aiclaim_models.CreateAntcloudGatewayxFileUploadRequest(
                ...
                api_code='antdigital.aiclaim.image.classification.exec',
                file_name=request.file_object_name
            )
            upload_resp = self.create_antcloud_gatewayx_file_upload_ex(upload_req, headers, runtime)
            if not AntchainUtils.is_success(upload_resp.result_code, 'ok'):
                exec_image_classification_response = aiclaim_models.ExecImageClassificationResponse(
                    req_msg_id=upload_resp.req_msg_id,
                    result_code=upload_resp.result_code,
                    result_msg=upload_resp.result_msg
                )
                return exec_image_classification_response
        ...
        return TeaCore.from_map(
            aiclaim_models.ExecImageClassificationResponse(),
            self.do_request('1.0', 'antdigital.aiclaim.image.classification.exec', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def exec_image_classification_ex_async(
        self,
        request: aiclaim_models.ExecImageClassificationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def create_antcloud_gatewayx_file_upload(
        self,
        request: aiclaim_models.CreateAntcloudGatewayxFileUploadRequest,
    ) -> aiclaim_models.CreateAntcloudGatewayxFileUploadResponse:
        """
