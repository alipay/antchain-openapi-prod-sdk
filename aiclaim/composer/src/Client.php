...
use AntChain\AICLAIM\Models\CreateAntcloudGatewayxFileUploadRequest;
...
class Client
{
     ...
     * Summary: 理赔材料照片分类.
     *
     * @param ExecImageClassificationRequest $request
     *
     * @return ExecImageClassificationResponse
     */
    public function execImageClassification($request)
    {
     ...
     * @return ExecImageClassificationResponse
     */
    public function execImageClassificationEx($request, $headers, $runtime)
    {
        if (!Utils::isUnset($request->fileObject)) {
            ...
            if (!UtilClient::isSuccess($uploadResp->resultCode, 'ok')) {
                return new ExecImageClassificationResponse([
