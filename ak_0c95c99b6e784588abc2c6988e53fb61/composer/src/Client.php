...
namespace AntChain\Ak_0c95c99b6e784588abc2c6988e53fb61;
...
use AntChain\Ak_0c95c99b6e784588abc2c6988e53fb61\Models\ConfirmAntchainBbpContractReconciliationRequest;
use AntChain\Ak_0c95c99b6e784588abc2c6988e53fb61\Models\ConfirmAntchainBbpContractReconciliationResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_0c95c99b6e784588abc2c6988e53fb61',
                    '_prod_channel'    => 'saas',
                ];
