...
from antchain_sdk_gesaas_spi import models as gesaas__spi_models
...
class Client:
    ...
    def __init__(
        self, 
        config: gesaas__spi_models.Config,
    ):
        """
    ...
    def callback_gesaas_order(
        self,
        request: gesaas__spi_models.CallbackGesaasOrderRequest,
    ) -> gesaas__spi_models.CallbackGesaasOrderResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.callback_gesaas_order_ex(request, headers, runtime)

    async def callback_gesaas_order_async(
        self,
        request: gesaas__spi_models.CallbackGesaasOrderRequest,
    ) -> gesaas__spi_models.CallbackGesaasOrderResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.callback_gesaas_order_ex_async(request, headers, runtime)

    def callback_gesaas_order_ex(
        self,
        request: gesaas__spi_models.CallbackGesaasOrderRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            gesaas__spi_models.CallbackGesaasOrderResponse(),
            self.do_request('1.0', 'antdigital.gesaasspi.gesaas.order.callback', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def callback_gesaas_order_ex_async(
        self,
        request: gesaas__spi_models.CallbackGesaasOrderRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            gesaas__spi_models.CallbackGesaasOrderResponse(),
            await self.do_request_async('1.0', 'antdigital.gesaasspi.gesaas.order.callback', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def push_rightsprod_voucher(
        self,
        request: gesaas__spi_models.PushRightsprodVoucherRequest,
    ) -> gesaas__spi_models.PushRightsprodVoucherResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.push_rightsprod_voucher_ex(request, headers, runtime)

    async def push_rightsprod_voucher_async(
        self,
        request: gesaas__spi_models.PushRightsprodVoucherRequest,
    ) -> gesaas__spi_models.PushRightsprodVoucherResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.push_rightsprod_voucher_ex_async(request, headers, runtime)

    def push_rightsprod_voucher_ex(
        self,
        request: gesaas__spi_models.PushRightsprodVoucherRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            gesaas__spi_models.PushRightsprodVoucherResponse(),
            self.do_request('1.0', 'antdigital.gesaasspi.rightsprod.voucher.push', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def push_rightsprod_voucher_ex_async(
        self,
        request: gesaas__spi_models.PushRightsprodVoucherRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            gesaas__spi_models.PushRightsprodVoucherResponse(),
            await self.do_request_async('1.0', 'antdigital.gesaasspi.rightsprod.voucher.push', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def callback_rightsprod_status(
        self,
        request: gesaas__spi_models.CallbackRightsprodStatusRequest,
    ) -> gesaas__spi_models.CallbackRightsprodStatusResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.callback_rightsprod_status_ex(request, headers, runtime)

    async def callback_rightsprod_status_async(
        self,
        request: gesaas__spi_models.CallbackRightsprodStatusRequest,
    ) -> gesaas__spi_models.CallbackRightsprodStatusResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.callback_rightsprod_status_ex_async(request, headers, runtime)

    def callback_rightsprod_status_ex(
        self,
        request: gesaas__spi_models.CallbackRightsprodStatusRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def callback_rightsprod_status_ex_async(
        self,
        request: gesaas__spi_models.CallbackRightsprodStatusRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def callback_rightsprod_operation(
        self,
        request: gesaas__spi_models.CallbackRightsprodOperationRequest,
    ) -> gesaas__spi_models.CallbackRightsprodOperationResponse:
        """
        Description: 券操作回调通知
        Summary: 券操作回调通知
        """
    ...
    def push_rightsprod_grantrights(
        self,
        request: gesaas__spi_models.PushRightsprodGrantrightsRequest,
    ) -> gesaas__spi_models.PushRightsprodGrantrightsResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.push_rightsprod_grantrights_ex(request, headers, runtime)

    async def push_rightsprod_grantrights_async(
        self,
        request: gesaas__spi_models.PushRightsprodGrantrightsRequest,
    ) -> gesaas__spi_models.PushRightsprodGrantrightsResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.push_rightsprod_grantrights_ex_async(request, headers, runtime)

    def push_rightsprod_grantrights_ex(
        self,
        request: gesaas__spi_models.PushRightsprodGrantrightsRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def push_rightsprod_grantrights_ex_async(
        self,
        request: gesaas__spi_models.PushRightsprodGrantrightsRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def query_rightsprod_config(
        self,
        request: gesaas__spi_models.QueryRightsprodConfigRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_rightsprod_config_ex(request, headers, runtime)

    async def query_rightsprod_config_async(
        self,
        request: gesaas__spi_models.QueryRightsprodConfigRequest,
    ) -> gesaas__spi_models.QueryRightsprodConfigResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_rightsprod_config_ex_async(request, headers, runtime)

    def query_rightsprod_config_ex(
        self,
        request: gesaas__spi_models.QueryRightsprodConfigRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            gesaas__spi_models.QueryRightsprodConfigResponse(),
            self.do_request('1.0', 'antdigital.gesaasspi.rightsprod.config.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_rightsprod_config_ex_async(
        self,
        request: gesaas__spi_models.QueryRightsprodConfigRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
