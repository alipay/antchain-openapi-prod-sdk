...
use AntChain\GESAAS_SPI\Models\CallbackGesaasOrderRequest;
use AntChain\GESAAS_SPI\Models\CallbackGesaasOrderResponse;
...
class Client {
     ...
     * @param CallbackGesaasOrderRequest $request
     * @return CallbackGesaasOrderResponse
     */
    public function callbackGesaasOrder($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return CallbackGesaasOrderResponse
     */
    public function callbackGesaasOrderEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return CallbackGesaasOrderResponse::fromMap($this->doRequest("1.0", "antdigital.gesaasspi.gesaas.order.callback", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }
     ...
     * @param QueryRightsprodConfigRequest $request
     * @return QueryRightsprodConfigResponse
     */
    public function queryRightsprodConfig($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
