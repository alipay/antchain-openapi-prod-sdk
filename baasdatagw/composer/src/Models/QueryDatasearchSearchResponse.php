...
class QueryDatasearchSearchResponse extends Model
{
    // 请求唯一ID，用于链路跟踪和问题排查
    /**
     * @var string
    ...
    // 检索的结果
    /**
     * @var DataSearchResultResponseLog[]
     */
    public $logs;
    protected $_name = [
        'reqMsgId'   => 'req_msg_id',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['context'])) {
            $model->context = DataSearchRequest::fromMap($map['context']);
        }
        if (isset($map['logs'])) {
            if (!empty($map['logs'])) {
                $model->logs = [];
                ...
                foreach ($map['logs'] as $item) {
                    $model->logs[$n++] = null !== $item ? DataSearchResultResponseLog::fromMap($item) : $item;
                }
            }
        }
