...
export default class Client {
  ...
  async syncAssetelementProjectEx(request: SyncAssetelementProjectRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<SyncAssetelementProjectResponse> {
    Util.validateModel(request);
    return $tea.cast<SyncAssetelementProjectResponse>(await this.doRequest("1.0", "antdigital.bothk.assetelement.project.sync", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new SyncAssetelementProjectResponse({}));
  }
  ...
  async updateDeviceInfobydeviceEx(request: UpdateDeviceInfobydeviceRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<UpdateDeviceInfobydeviceResponse> {
    Util.validateModel(request);
    return $tea.cast<UpdateDeviceInfobydeviceResponse>(await this.doRequest("1.0", "antdigital.bothk.device.infobydevice.update", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new UpdateDeviceInfobydeviceResponse({}));
  }
