...
use AntChain\BOTHK\Models\CreateDistributedeviceBydeviceidmulRequest;
use AntChain\BOTHK\Models\CreateDistributedeviceBydeviceidmulResponse;
use AntChain\BOTHK\Models\CreateDistributedeviceBydevicemulRequest;
use AntChain\BOTHK\Models\CreateDistributedeviceBydevicemulResponse;
use AntChain\BOTHK\Models\GetDeviceBydeviceidRequest;
...
class Client
{
    ...
    public function createDistributedeviceBydeviceidmulEx($request, $headers, $runtime)
    {
        ...
        return CreateDistributedeviceBydeviceidmulResponse::fromMap($this->doRequest('1.0', 'antdigital.bothk.distributedevice.bydeviceidmul.create', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
    ...
    public function createDistributedeviceBydevicemulEx($request, $headers, $runtime)
    {
        ...
        return CreateDistributedeviceBydevicemulResponse::fromMap($this->doRequest('1.0', 'antdigital.bothk.distributedevice.bydevicemul.create', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
    ...
    public function sendEventDataEx($request, $headers, $runtime)
    {
        ...
        return SendEventDataResponse::fromMap($this->doRequest('1.0', 'antdigital.bothk.event.data.send', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
