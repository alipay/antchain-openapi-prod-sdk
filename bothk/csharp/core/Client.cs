...
using AntChain.SDK.BOTHK.Models;

namespace AntChain.SDK.BOTHK
{
    public class Client 
    {
        ...
        public CreateDistributedeviceBydeviceidmulResponse CreateDistributedeviceBydeviceidmulEx(CreateDistributedeviceBydeviceidmulRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<CreateDistributedeviceBydeviceidmulResponse>(DoRequest("1.0", "antdigital.bothk.distributedevice.bydeviceidmul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateDistributedeviceBydeviceidmulResponse>(await DoRequestAsync("1.0", "antdigital.bothk.distributedevice.bydeviceidmul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateDistributedeviceBydevicemulResponse>(DoRequest("1.0", "antdigital.bothk.distributedevice.bydevicemul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateDistributedeviceBydevicemulResponse>(await DoRequestAsync("1.0", "antdigital.bothk.distributedevice.bydevicemul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendEventDataResponse>(DoRequest("1.0", "antdigital.bothk.event.data.send", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendEventDataResponse>(await DoRequestAsync("1.0", "antdigital.bothk.event.data.send", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetDeviceBydeviceidResponse>(DoRequest("1.0", "antdigital.bothk.device.bydeviceid.get", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<UpdateDeviceInfobydeviceResponse>(DoRequest("1.0", "antdigital.bothk.device.infobydevice.update", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<UpdateDeviceInfobydeviceResponse>(await DoRequestAsync("1.0", "antdigital.bothk.device.infobydevice.update", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
