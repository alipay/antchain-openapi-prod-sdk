...
public class QueryTestTestTestRequest extends TeaModel {
    ...
    public QueryTestTestTestRequest setTimeout(String timeout) {
    ...
    public QueryTestTestTestRequest setFileObject(java.io.InputStream fileObject) {
    ...
    public QueryTestTestTestRequest setFileObjectName(String fileObjectName) {
    ...
    public QueryTestTestTestRequest setFileId(String fileId) {
        this.fileId = fileId;
        return this;
    }
