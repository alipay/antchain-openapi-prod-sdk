...
public class UpdateProductResponse extends TeaModel {
    ...
    public UpdateProductResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateProductResponse setResultCode(String resultCode) {
    ...
    public UpdateProductResponse setResultMsg(String resultMsg) {
