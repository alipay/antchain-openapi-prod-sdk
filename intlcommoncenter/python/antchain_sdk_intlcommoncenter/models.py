...
class UpdateOfferMeterRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
        offer_code: str = None,
        meter_access_status: str = None,
    ):
        # OAuth模式下的授权token
        self.auth_token = auth_token
        self.product_instance_id = product_instance_id
        ...
        self.meter_access_status = meter_access_status

    def validate(self):
        self.validate_required(self.offer_code, 'offer_code')
        self.validate_required(self.meter_access_status, 'meter_access_status')
    ...
    def to_map(self):
        ...
        if self.meter_access_status is not None:
            result['meter_access_status'] = self.meter_access_status
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meter_access_status') is not None:
            self.meter_access_status = m.get('meter_access_status')
        return self


class UpdateOfferMeterResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
