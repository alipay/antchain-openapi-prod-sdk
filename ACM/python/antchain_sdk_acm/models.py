...
class QueryUserProjectRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        user_id: str = None,
...
class QueryUserProjectResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class UpdateTenantCountryRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        tenant_id: str = None,
...
class UpdateTenantCountryResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryTenantProjectRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        tenant_id: str = None,
...
class QueryTenantProjectResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class UpdateTenantProjectRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        user_id: str = None,
...
class UpdateTenantProjectResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class UpdateProjectStatusRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        user_id: str = None,
...
class UpdateProjectStatusResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryProjectMemberRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        user_id: str = None,
...
class QueryProjectMemberResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryProjectUserRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        user_id: str = None,
...
class QueryProjectUserResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class GetOperatorResponse(TeaModel):
    def __init__(
        ...
        self.operater_type = operater_type
        # 关联账号id
    ...
    def to_map(self):
        ...
        if self.operater_type is not None:
            result['operater_type'] = self.operater_type
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operater_type') is not None:
            self.operater_type = m.get('operater_type')
...
class GetMasterTenantResponse(TeaModel):
    ...
    def to_map(self):
        ...
        if self.certified is not None:
            result['certified'] = self.certified
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('firm_name') is not None:
            self.firm_name = m.get('firm_name')
        if m.get('certified') is not None:
            self.certified = m.get('certified')
        return self
...
class CreateUserTokenRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        login_name: str = None,
...
class CreateUserTokenResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class RefreshUserTokenRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        token: str = None,
...
class RefreshUserTokenResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class DeleteTrustloginTokenRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        source_system: str = None,
...
class DeleteTrustloginTokenResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class CreateAlipayTenantRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        cert_no: str = None,
...
class CreateAlipayTenantResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
