...
public class RemoveProjectMemberResponse extends TeaModel {
    ...
    public RemoveProjectMemberResponse setReqMsgId(String reqMsgId) {
    ...
    public RemoveProjectMemberResponse setResultCode(String resultCode) {
    ...
    public RemoveProjectMemberResponse setResultMsg(String resultMsg) {
