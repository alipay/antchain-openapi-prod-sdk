...
public class AddProjectMemberResponse extends TeaModel {
    ...
    public AddProjectMemberResponse setReqMsgId(String reqMsgId) {
    ...
    public AddProjectMemberResponse setResultCode(String resultCode) {
    ...
    public AddProjectMemberResponse setResultMsg(String resultMsg) {
