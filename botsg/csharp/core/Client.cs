...
using AntChain.SDK.BOTSG.Models;

namespace AntChain.SDK.BOTSG
{
    public class Client 
    {
        ...
        public SyncAssetelementProjectResponse SyncAssetelementProjectEx(SyncAssetelementProjectRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<SyncAssetelementProjectResponse>(DoRequest("1.0", "antdigital.botsg.assetelement.project.sync", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SyncAssetelementProjectResponse>(await DoRequestAsync("1.0", "antdigital.botsg.assetelement.project.sync", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetDeviceBydeviceidResponse>(DoRequest("1.0", "antdigital.botsg.device.bydeviceid.get", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetDeviceBydeviceidResponse>(await DoRequestAsync("1.0", "antdigital.botsg.device.bydeviceid.get", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateDistributedeviceBydeviceidmulResponse>(DoRequest("1.0", "antdigital.botsg.distributedevice.bydeviceidmul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateDistributedeviceBydeviceidmulResponse>(await DoRequestAsync("1.0", "antdigital.botsg.distributedevice.bydeviceidmul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateDistributedeviceBydevicemulResponse>(DoRequest("1.0", "antdigital.botsg.distributedevice.bydevicemul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateDistributedeviceBydevicemulResponse>(await DoRequestAsync("1.0", "antdigital.botsg.distributedevice.bydevicemul.create", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendEventDataResponse>(DoRequest("1.0", "antdigital.botsg.event.data.send", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendEventDataResponse>(await DoRequestAsync("1.0", "antdigital.botsg.event.data.send", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
