...
public class DeleteWarehouseResponse extends TeaModel {
    ...
    public DeleteWarehouseResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteWarehouseResponse setResultCode(String resultCode) {
    ...
    public DeleteWarehouseResponse setResultMsg(String resultMsg) {
