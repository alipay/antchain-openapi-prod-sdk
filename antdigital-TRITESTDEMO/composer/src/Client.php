...
use AntChain\TRITESTDEMO\Models\TestAntchainDemosdkHttpApiRequest;
use AntChain\TRITESTDEMO\Models\TestAntchainDemosdkHttpApiResponse;
...
use AntChain\TRITESTDEMO\Models\QueryCreateApiaRequest;
use AntChain\TRITESTDEMO\Models\QueryCreateApiaResponse;
use AntChain\TRITESTDEMO\Models\TestTriApiRequest;
use AntChain\TRITESTDEMO\Models\TestTriApiResponse;
...
class Client {
     ...
     * Description: 测试
     * Summary: 测试
     * @param TestAntchainDemosdkHttpApiRequest $request
     * @return TestAntchainDemosdkHttpApiResponse
     */
    public function testAntchainDemosdkHttpApi($request){
     ...
     * @return TestAntchainDemosdkHttpApiResponse
     */
    public function testAntchainDemosdkHttpApiEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return TestAntchainDemosdkHttpApiResponse::fromMap($this->doRequest("1.0", "antchain.demosdk.http.api.test", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }
     ...
     * Description: 测试
     * Summary: 测试
     * @param QueryCreateApiaRequest $request
     * @return QueryCreateApiaResponse
     */
    public function queryCreateApia($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryCreateApiaResponse
     */
    public function queryCreateApiaEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryCreateApiaResponse::fromMap($this->doRequest("1.0", "antcloud.tritestdemo.create.apia.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 测试
     * Summary: 测试
     * @param TestTriApiRequest $request
     * @return TestTriApiResponse
     */
    public function testTriApi($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return TestTriApiResponse
     */
    public function testTriApiEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return TestTriApiResponse::fromMap($this->doRequest("1.0", "antcloud.tritestdemo.tri.api.test", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }
}
