...
use AntChain\AGORAX\Models\CrowdNodeTypeEnum;

class CrowdNodeDTO extends Model {
    protected $_name = [
        'nodeId' => 'node_id',
        'nodeType' => 'node_type',
        'exclude' => 'exclude',
    ...
    public function toMap() {
        ...
        if (null !== $this->nodeType) {
            $res['node_type'] = null !== $this->nodeType ? $this->nodeType->toMap() : null;
        }
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['node_type'])){
            $model->nodeType = CrowdNodeTypeEnum::fromMap($map['node_type']);
        }
