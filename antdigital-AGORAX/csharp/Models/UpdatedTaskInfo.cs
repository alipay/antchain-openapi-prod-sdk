...
{
    // 更新后的任务信息
    public class UpdatedTaskInfo : TeaModel {
        // 任务标题(同一个租户不能重复)
        /// <summary>
        /// <b>Example:</b>
        /// <para>普通任务修改</para>
        ...
        /// <summary>
        /// <b>Example:</b>
        /// <para><a href="https://pro.wenjuan.com/t/a1">https://pro.wenjuan.com/t/a1</a></para>
        /// </summary>
        ...
        [Validation(Required=false)]
        public string VerifyOmment { get; set; }
