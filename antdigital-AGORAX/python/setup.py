...
PACKAGE = "antchain_sdk_agorax"
NAME = 'antchain_antdigital_agorax' or "alibabacloud-package"
DESCRIPTION = "Ant Chain AGORAX SDK Library for Python"
AUTHOR = "Ant Chain SDK"
