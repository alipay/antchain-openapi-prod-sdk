...
class Client:
    ...
    def query_logs_new(
        self,
        request: intellicar_models.QueryLogsNewRequest,
    ) -> intellicar_models.QueryLogsNewResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_logs_new_ex(request, headers, runtime)

    async def query_logs_new_async(
        self,
        request: intellicar_models.QueryLogsNewRequest,
    ) -> intellicar_models.QueryLogsNewResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_logs_new_ex_async(request, headers, runtime)

    def query_logs_new_ex(
        self,
        request: intellicar_models.QueryLogsNewRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            intellicar_models.QueryLogsNewResponse(),
            self.do_request('1.0', 'antdigital.intellicar.logs.new.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_logs_new_ex_async(
        self,
        request: intellicar_models.QueryLogsNewRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            intellicar_models.QueryLogsNewResponse(),
            await self.do_request_async('1.0', 'antdigital.intellicar.logs.new.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def exec_logs_new(
        self,
        request: intellicar_models.ExecLogsNewRequest,
    ) -> intellicar_models.ExecLogsNewResponse:
        """
        Description: 日志改造测试
        Summary: 日志改造测试
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.exec_logs_new_ex(request, headers, runtime)

    async def exec_logs_new_async(
        self,
        request: intellicar_models.ExecLogsNewRequest,
    ) -> intellicar_models.ExecLogsNewResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.exec_logs_new_ex_async(request, headers, runtime)

    def exec_logs_new_ex(
        self,
        request: intellicar_models.ExecLogsNewRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            intellicar_models.ExecLogsNewResponse(),
            self.do_request('1.0', 'antdigital.intellicar.logs.new.exec', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def exec_logs_new_ex_async(
        self,
        request: intellicar_models.ExecLogsNewRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            intellicar_models.ExecLogsNewResponse(),
            await self.do_request_async('1.0', 'antdigital.intellicar.logs.new.exec', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )
