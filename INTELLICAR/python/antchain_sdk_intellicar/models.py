...
class DeviceBean(TeaModel):
    ...
    def validate(self):
        self.validate_required(self.device_id_type, 'device_id_type')
    ...
    def to_map(self):
        ...
        if self.device_id_type is not None:
            result['device_id_type'] = self.device_id_type
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('device_id_type') is not None:
            self.device_id_type = m.get('device_id_type')
...
class TagBean(TeaModel):
    ...
    def to_map(self):
        ...
        if self.tname is not None:
            result['tname'] = self.tname
        if self.tvname is not None:
            result['tvname'] = self.tvname
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('tname') is not None:
            self.tname = m.get('tname')
        if m.get('tvname') is not None:
            self.tvname = m.get('tvname')
        return self
...
class UsedCarInfo(TeaModel):
    ...
    def validate(self):
        ...
        self.validate_required(self.pid, 'pid')
        self.validate_required(self.specid, 'specid')
...
class RegisterCdsqScratchesRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
    ...
    def validate(self):
        ...
        self.validate_required(self.car_no, 'car_no')
        self.validate_required(self.address, 'address')
        self.validate_required(self.scene_code, 'scene_code')
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('car_no') is not None:
            self.car_no = m.get('car_no')
        if m.get('address') is not None:
            self.address = m.get('address')
        if m.get('scene_code') is not None:
            self.scene_code = m.get('scene_code')
...
class RegisterCdsqScratchesResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryCdsqScratchesRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryCdsqScratchesResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
        ...
        self.response_msg = response_msg
        # 电子保单 url 地址
        self.return_pdf_value = return_pdf_value
        # 保单服务号
        self.policy_no = policy_no
    ...
    def to_map(self):
        ...
        if self.response_msg is not None:
            result['response_msg'] = self.response_msg
        if self.return_pdf_value is not None:
            result['return_pdf_value'] = self.return_pdf_value
        if self.policy_no is not None:
            result['policy_no'] = self.policy_no
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('response_msg') is not None:
            self.response_msg = m.get('response_msg')
        if m.get('return_pdf_value') is not None:
            self.return_pdf_value = m.get('return_pdf_value')
        if m.get('policy_no') is not None:
            self.policy_no = m.get('policy_no')
...
class DeleteCdsqScratchesRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class DeleteCdsqScratchesResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class CallbackCdsqScratchesRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class CallbackCdsqScratchesResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class SaveCdsqScratchesRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class SaveCdsqScratchesResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryCarVinRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryCarVinResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class RegisterTagChanganRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class RegisterTagChanganResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryTagChanganRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryTagChanganResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class QueryLogsNewRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class QueryLogsNewResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class ExecLogsNewRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class ExecLogsNewResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
