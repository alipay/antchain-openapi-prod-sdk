...
use AntChain\INTELLICAR\Models\CyUserInfo;
use AntChain\INTELLICAR\Models\CarInfo;

class RegisterCarownerCyRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return RegisterCarownerCyRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['user_info'])){
            $model->userInfo = CyUserInfo::fromMap($map['user_info']);
        }
