...
use AntChain\INTELLICAR\Models\CarOwnerUserInfo;
use AntChain\INTELLICAR\Models\CarInfo;

class RegisterCarownerRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return RegisterCarownerRequest
     */
