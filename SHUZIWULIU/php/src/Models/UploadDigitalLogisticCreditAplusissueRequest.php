...
use AntChain\SHUZIWULIU\Models\IssueApplyInfoPlus;

class UploadDigitalLogisticCreditAplusissueRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return UploadDigitalLogisticCreditAplusissueRequest
     */
