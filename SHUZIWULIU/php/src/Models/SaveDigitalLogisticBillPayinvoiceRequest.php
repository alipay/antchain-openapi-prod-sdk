...
use AntChain\SHUZIWULIU\Models\PayBillInvoiceParam;
use AntChain\SHUZIWULIU\Models\PayTariffInvoiceParam;

class SaveDigitalLogisticBillPayinvoiceRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return SaveDigitalLogisticBillPayinvoiceRequest
     */
