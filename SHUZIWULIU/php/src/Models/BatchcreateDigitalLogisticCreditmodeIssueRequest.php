...
use AntChain\SHUZIWULIU\Models\IssueApplyInfo;

class BatchcreateDigitalLogisticCreditmodeIssueRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return BatchcreateDigitalLogisticCreditmodeIssueRequest
     */
