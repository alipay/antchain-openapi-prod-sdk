...
use AntChain\SHUZIWULIU\Models\ContainerGoodsParam;

class SaveDigitalLogisticBizContainerRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return SaveDigitalLogisticBizContainerRequest
     */
