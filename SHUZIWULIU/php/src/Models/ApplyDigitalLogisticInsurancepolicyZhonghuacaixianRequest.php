...
class ApplyDigitalLogisticInsurancepolicyZhonghuacaixianRequest extends Model {
    protected $_name = [
    ...
    public function validate() {
        ...
        Model::validatePattern('identifyPeriodStart', $this->identifyPeriodStart, '\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}[Z]');
    ...
    /**
     * @param array $map
     * @return ApplyDigitalLogisticInsurancepolicyZhonghuacaixianRequest
     */
