...
use AntChain\SHUZIWULIU\Models\MasterBlBookingParam;
use AntChain\SHUZIWULIU\Models\MasterBlContainerParam;
use AntChain\SHUZIWULIU\Models\MasterBlGoodsParam;

class SaveDigitalLogisticBizMasterblRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return SaveDigitalLogisticBizMasterblRequest
     */
