...
use AntChain\SHUZIWULIU\Models\CargoAmount;
use AntChain\SHUZIWULIU\Models\PayAmount;
use AntChain\SHUZIWULIU\Models\WaybillAmount;

class UpdateDigitalLogisticCargowaybillBillRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return UpdateDigitalLogisticCargowaybillBillRequest
     */
