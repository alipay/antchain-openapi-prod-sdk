...
public class QueryFavorStocksRequest extends TeaModel {
    // OAuth模式下的授权token
    ...
    public static QueryFavorStocksRequest build(java.util.Map<String, ?> map) throws Exception {
        QueryFavorStocksRequest self = new QueryFavorStocksRequest();
        return TeaModel.build(map, self);
    }

    public QueryFavorStocksRequest setAuthToken(String authToken) {
    ...
    public QueryFavorStocksRequest setProductInstanceId(String productInstanceId) {
    ...
    public QueryFavorStocksRequest setOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public QueryFavorStocksRequest setLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public QueryFavorStocksRequest setStockCreatorMchid(String stockCreatorMchid) {
    ...
    public QueryFavorStocksRequest setCreateStartTime(String createStartTime) {
    ...
    public QueryFavorStocksRequest setCreateEndTime(String createEndTime) {
    ...
    public QueryFavorStocksRequest setStatus(String status) {
        this.status = status;
        return this;
    }
