...
public class PaymentCancelResult extends TeaModel {
    // 外部业务平台原始交易号
    ...
    public static PaymentCancelResult build(java.util.Map<String, ?> map) throws Exception {
        PaymentCancelResult self = new PaymentCancelResult();
        return TeaModel.build(map, self);
    }

    public PaymentCancelResult setOutOrderId(String outOrderId) {
    ...
    public PaymentCancelResult setFundMode(String fundMode) {
    ...
    public PaymentCancelResult setOrderState(String orderState) {
    ...
    public PaymentCancelResult setAvailableAmount(Long availableAmount) {
    ...
    public PaymentCancelResult setAvailableCurrency(String availableCurrency) {
    ...
    public PaymentCancelResult setState(String state) {
        this.state = state;
        return this;
    }
    ...
    public PaymentCancelResult setOutRequestId(String outRequestId) {
    ...
    public PaymentCancelResult setSubCode(String subCode) {
    ...
    public PaymentCancelResult setSubMsg(String subMsg) {
        this.subMsg = subMsg;
        return this;
    }
