...
use AntChain\BAASPLUS\Models\DidDocServicesInfo;

class CreateBaasPlusDidCorporatedidagentRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return CreateBaasPlusDidCorporatedidagentRequest
     */
