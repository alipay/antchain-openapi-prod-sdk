...
class CreateTwcNotaryNotarizationBillRequest extends Model {
    protected $_name = [
    ...
    public function validate() {
        Model::validatePattern('eNotarizationValidDate', $this->eNotarizationValidDate, '\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}[Z]');
    }
    ...
    /**
     * @param array $map
     * @return CreateTwcNotaryNotarizationBillRequest
     */
