...
class CreateLeaseOrderRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    {
        Model::validateRequired('alipayOrderAmount', $this->alipayOrderAmount, true);
        Model::validateRequired('alipayOrderNo', $this->alipayOrderNo, true);
        Model::validateRequired('alipayOrderTotalAmount', $this->alipayOrderTotalAmount, true);
        Model::validateRequired('depositWaiveAmount', $this->depositWaiveAmount, true);
        Model::validateRequired('itemName', $this->itemName, true);
        Model::validateRequired('itemPrice', $this->itemPrice, true);
        Model::validateRequired('itemType', $this->itemType, true);
        Model::validateRequired('merchantAlipayAccount', $this->merchantAlipayAccount, true);
        Model::validateRequired('merchantAlipayId', $this->merchantAlipayId, true);
        Model::validateRequired('merchantName', $this->merchantName, true);
        Model::validateRequired('tenancyTermEnd', $this->tenancyTermEnd, true);
        Model::validateRequired('tenancyTermStart', $this->tenancyTermStart, true);
     ...
     * @param array $map
     *
     * @return CreateLeaseOrderRequest
     */
