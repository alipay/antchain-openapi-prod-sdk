...
use AntChain\TWC\Models\ContractEHandSignFieldApplication;

class CreateContractEhandsignfieldRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return CreateContractEhandsignfieldRequest
     */
        ...
        if(isset($map['sign_fields'])){
            if(!empty($map['sign_fields'])){
                ...
                foreach($map['sign_fields'] as $item) {
                    $model->signFields[$n++] = null !== $item ? ContractEHandSignFieldApplication::fromMap($item) : $item;
                }
            }
        }
        return $model;
    ...
    // 签署区列表数据
    /**
     * @var ContractEHandSignFieldApplication[]
     */
    public $signFields;
