...
use AntChain\TWC\Models\QueryContractSignauthRequest;
use AntChain\TWC\Models\QueryContractSignauthResponse;
...
use AntChain\TWC\Models\DeleteAccountEsignRequest;
use AntChain\TWC\Models\DeleteAccountEsignResponse;
use AntChain\TWC\Models\QueryContractCompanyfourmetacheckRequest;
use AntChain\TWC\Models\QueryContractCompanyfourmetacheckResponse;
...
class Client {
     ...
     * @param DeleteAccountEsignRequest $request
     * @return DeleteAccountEsignResponse
     */
    public function deleteAccountEsign($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return DeleteAccountEsignResponse
     */
    public function deleteAccountEsignEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return DeleteAccountEsignResponse::fromMap($this->doRequest("1.0", "twc.notary.account.esign.delete", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }

    /**
     * Description: 合同模板四要素校验
     * Summary: 合同模板四要素校验
     * @param QueryContractCompanyfourmetacheckRequest $request
     * @return QueryContractCompanyfourmetacheckResponse
     */
    public function queryContractCompanyfourmetacheck($request){
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryContractCompanyfourmetacheckResponse
     */
    public function queryContractCompanyfourmetacheckEx($request, $headers, $runtime){
        Utils::validateModel($request);
        return QueryContractCompanyfourmetacheckResponse::fromMap($this->doRequest("1.0", "twc.notary.contract.companyfourmetacheck.query", "HTTPS", "POST", "/gateway.do", Tea::merge($request), $headers, $runtime));
    }
}
