...
type NotaryCheckResult struct {
	...
	// 存证时间
	NotaryTime *string `json:"notary_time,omitempty" xml:"notary_time,omitempty" require:"true" pattern:"\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}[Z]"`
	// 存证类型
...
func (s *KeywordsPosition) SetPosX(v int64) *KeywordsPosition {
	s.PosX = &v
	return s
}

func (s *KeywordsPosition) SetPosY(v int64) *KeywordsPosition {
	s.PosY = &v
	return s
}
...
type CreateContractRegisterzftRequest struct {
	...
	// 申请时间
	ApplyTime *string `json:"apply_time,omitempty" xml:"apply_time,omitempty" require:"true" pattern:"\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}[Z]"`
...
type QueryContractWordspositionResponse struct {
	...
	FileId *string `json:"file_id,omitempty" xml:"file_id,omitempty"`
	// 关键字位置列表
	Data *KeywordsPosition `json:"data,omitempty" xml:"data,omitempty"`
}
...
type SaveJointconstraintRecordRequest struct {
	...
	//
	//
	PaymentDeadline *string `json:"payment_deadline,omitempty" xml:"payment_deadline,omitempty" require:"true" pattern:"\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}[Z]"`
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"sdk_version":      tea.String("1.4.131"),
			}
