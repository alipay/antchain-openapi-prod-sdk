...
using AntChain.SDK.Ak_0865f558338744bd8da4fcade32586f9.Models;

namespace AntChain.SDK.Ak_0865f558338744bd8da4fcade32586f9
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_0865f558338744bd8da4fcade32586f9"},
                        {"_prod_channel", "saas"},
                    };
