...
public class DeleteDatabaseResponse extends TeaModel {
    ...
    public DeleteDatabaseResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteDatabaseResponse setResultCode(String resultCode) {
    ...
    public DeleteDatabaseResponse setResultMsg(String resultMsg) {
