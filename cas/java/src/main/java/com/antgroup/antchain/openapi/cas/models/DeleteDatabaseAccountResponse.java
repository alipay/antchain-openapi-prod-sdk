...
public class DeleteDatabaseAccountResponse extends TeaModel {
    ...
    public DeleteDatabaseAccountResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteDatabaseAccountResponse setResultCode(String resultCode) {
    ...
    public DeleteDatabaseAccountResponse setResultMsg(String resultMsg) {
