...
public class DeleteVpcResponse extends TeaModel {
    ...
    public DeleteVpcResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteVpcResponse setResultCode(String resultCode) {
    ...
    public DeleteVpcResponse setResultMsg(String resultMsg) {
