...
public class UpdateQuotaResponse extends TeaModel {
    ...
    public UpdateQuotaResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateQuotaResponse setResultCode(String resultCode) {
    ...
    public UpdateQuotaResponse setResultMsg(String resultMsg) {
