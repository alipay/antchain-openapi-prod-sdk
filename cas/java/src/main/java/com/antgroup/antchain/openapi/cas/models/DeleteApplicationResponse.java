...
public class DeleteApplicationResponse extends TeaModel {
    ...
    public DeleteApplicationResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteApplicationResponse setResultCode(String resultCode) {
    ...
    public DeleteApplicationResponse setResultMsg(String resultMsg) {
