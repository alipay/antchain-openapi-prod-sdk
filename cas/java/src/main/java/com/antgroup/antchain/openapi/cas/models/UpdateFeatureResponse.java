...
public class UpdateFeatureResponse extends TeaModel {
    ...
    public UpdateFeatureResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateFeatureResponse setResultCode(String resultCode) {
    ...
    public UpdateFeatureResponse setResultMsg(String resultMsg) {
