...
public class ReleaseDatabaseResponse extends TeaModel {
    ...
    public ReleaseDatabaseResponse setReqMsgId(String reqMsgId) {
    ...
    public ReleaseDatabaseResponse setResultCode(String resultCode) {
    ...
    public ReleaseDatabaseResponse setResultMsg(String resultMsg) {
