...
class ExecAntdigitalAiclaimImageExtractionRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class ExecAntdigitalAiclaimImageExtractionResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
    ...
    def to_map(self):
        ...
        if self.key_fields is not None:
            result['key_fields'] = self.key_fields
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('key_fields') is not None:
            self.key_fields = m.get('key_fields')
        return self
