...
public class CancelOrderResponse extends TeaModel {
    ...
    public CancelOrderResponse setReqMsgId(String reqMsgId) {
    ...
    public CancelOrderResponse setResultMsg(String resultMsg) {
    ...
    public CancelOrderResponse setResult(Boolean result) {
        this.result = result;
        return this;
    }
