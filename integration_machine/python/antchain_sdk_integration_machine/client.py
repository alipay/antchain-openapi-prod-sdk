...
from antchain_sdk_integration_machine import models as integration__machine_models
...
class Client:
    ...
    def __init__(
        self, 
        config: integration__machine_models.Config,
    ):
        """
    ...
    def query_healthinfo(
        self,
        request: integration__machine_models.QueryHealthinfoRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_healthinfo_ex(request, headers, runtime)

    async def query_healthinfo_async(
        self,
        request: integration__machine_models.QueryHealthinfoRequest,
    ) -> integration__machine_models.QueryHealthinfoResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_healthinfo_ex_async(request, headers, runtime)

    def query_healthinfo_ex(
        self,
        request: integration__machine_models.QueryHealthinfoRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def query_healthinfo_ex_async(
        self,
        request: integration__machine_models.QueryHealthinfoRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def push_healthinfolog(
        self,
        request: integration__machine_models.PushHealthinfologRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.push_healthinfolog_ex(request, headers, runtime)

    async def push_healthinfolog_async(
        self,
        request: integration__machine_models.PushHealthinfologRequest,
    ) -> integration__machine_models.PushHealthinfologResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.push_healthinfolog_ex_async(request, headers, runtime)

    def push_healthinfolog_ex(
        self,
        request: integration__machine_models.PushHealthinfologRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def push_healthinfolog_ex_async(
        self,
        request: integration__machine_models.PushHealthinfologRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def get_healthinfo(
        self,
        request: integration__machine_models.GetHealthinfoRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.get_healthinfo_ex(request, headers, runtime)

    async def get_healthinfo_async(
        self,
        request: integration__machine_models.GetHealthinfoRequest,
    ) -> integration__machine_models.GetHealthinfoResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.get_healthinfo_ex_async(request, headers, runtime)

    def get_healthinfo_ex(
        self,
        request: integration__machine_models.GetHealthinfoRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def get_healthinfo_ex_async(
        self,
        request: integration__machine_models.GetHealthinfoRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
