...
package com.antgroup.antchain.openapi.integration_machine;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.integration_machine.models.*;
...
public class Client {
     ...
     * Summary: 查询防疫健康信息
     */
    public QueryHealthinfoResponse queryHealthinfo(QueryHealthinfoRequest request) throws Exception {
     ...
     * Summary: 查询防疫健康信息
     */
    public QueryHealthinfoResponse queryHealthinfoEx(QueryHealthinfoRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.antim.healthinfo.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryHealthinfoResponse());
    }
     ...
     * Summary: 上报通行记录
     */
    public PushHealthinfologResponse pushHealthinfolog(PushHealthinfologRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 上报通行记录
     */
    public PushHealthinfologResponse pushHealthinfologEx(PushHealthinfologRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.antim.healthinfolog.push", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new PushHealthinfologResponse());
    }
     ...
     */
    public GetHealthinfoResponse getHealthinfo(GetHealthinfoRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 通行记录查询
     */
    public QueryHealthinfologResponse queryHealthinfolog(QueryHealthinfologRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 设备实时通行统计查询
     */
    public QueryDevicestatisticsResponse queryDevicestatisticsEx(QueryDevicestatisticsRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.antim.devicestatistics.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryDevicestatisticsResponse());
    }
}
