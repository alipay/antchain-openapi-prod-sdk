...
public class SyncFundSplittingRequest extends TeaModel {
    ...
    public static SyncFundSplittingRequest build(java.util.Map<String, ?> map) throws Exception {
        SyncFundSplittingRequest self = new SyncFundSplittingRequest();
        return TeaModel.build(map, self);
    }

    public SyncFundSplittingRequest setAuthToken(String authToken) {
    ...
    public SyncFundSplittingRequest setProductInstanceId(String productInstanceId) {
    ...
    public SyncFundSplittingRequest setFundNo(String fundNo) {
        this.fundNo = fundNo;
        return this;
    }
    ...
    public SyncFundSplittingRequest setOrderId(String orderId) {
    ...
    public SyncFundSplittingRequest setMerchantTenantId(String merchantTenantId) {
    ...
    public SyncFundSplittingRequest setTermNum(Long termNum) {
    ...
    public SyncFundSplittingRequest setDeductionTime(String deductionTime) {
    ...
    public SyncFundSplittingRequest setDeductionAmount(Long deductionAmount) {
    ...
    public SyncFundSplittingRequest setMerchantSplitAmount(Long merchantSplitAmount) {
    ...
    public SyncFundSplittingRequest setFundSplitAmount(Long fundSplitAmount) {
    ...
    public SyncFundSplittingRequest setOtherSplitInfo(String otherSplitInfo) {
