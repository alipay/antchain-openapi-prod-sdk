...
public class GetSignFlowResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public GetSignFlowResponse setReqMsgId(String reqMsgId) {
    ...
    public GetSignFlowResponse setResultCode(String resultCode) {
    ...
    public GetSignFlowResponse setResultMsg(String resultMsg) {
    ...
    public GetSignFlowResponse setSignNo(String signNo) {
        this.signNo = signNo;
        return this;
    }
    ...
    public GetSignFlowResponse setOrderId(String orderId) {
    ...
    public GetSignFlowResponse setAccountId(String accountId) {
    ...
    public GetSignFlowResponse setStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public GetSignFlowResponse setFlowId(String flowId) {
        this.flowId = flowId;
        return this;
    }
    ...
    public GetSignFlowResponse setDocList(String docList) {
    ...
    public GetSignFlowResponse setBusinessScene(String businessScene) {
    ...
    public GetSignFlowResponse setAlipayUserId(String alipayUserId) {
