...
package com.antgroup.antchain.openapi.hk_securitytech;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.hk_securitytech.models.*;
...
public class Client {
     ...
     * Summary: EaglePromo
     */
    public QueryEaglepromoMarketingriskResponse queryEaglepromoMarketingrisk(QueryEaglepromoMarketingriskRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
    ...
    public SubmitAshieldPeriodhardeningtaskResponse submitAshieldPeriodhardeningtaskEx(SubmitAshieldPeriodhardeningtaskRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "hksecuritytech.gateway.ashield.periodhardeningtask.submit", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new SubmitAshieldPeriodhardeningtaskResponse());
    }
}
