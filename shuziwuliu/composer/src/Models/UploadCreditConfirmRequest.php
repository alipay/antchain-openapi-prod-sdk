...
class UploadCreditConfirmRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('confirmNo', $this->confirmNo, true);
        ...
        Model::validateRequired('protocolPdfId', $this->protocolPdfId, true);
     ...
     * @param array $map
     *
     * @return UploadCreditConfirmRequest
     */
