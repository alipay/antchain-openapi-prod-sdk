...
class CreateTransportWaybillRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('carBadgeColor', $this->carBadgeColor, true);
        Model::validateRequired('carBadgeNo', $this->carBadgeNo, true);
        Model::validateRequired('consignorDid', $this->consignorDid, true);
        Model::validateRequired('createTime', $this->createTime, true);
        Model::validateRequired('driverDid', $this->driverDid, true);
        Model::validateRequired('endAddress', $this->endAddress, true);
        Model::validateRequired('endDetailedAddress', $this->endDetailedAddress, true);
        Model::validateRequired('startAddress', $this->startAddress, true);
        Model::validateRequired('startDetailedAddress', $this->startDetailedAddress, true);
     ...
     * @param array $map
     *
     * @return CreateTransportWaybillRequest
     */
