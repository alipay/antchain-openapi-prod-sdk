...
class VerifyBillReceiptbillorderRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('receiptTariffCode', $this->receiptTariffCode, true);
        Model::validateRequired('verifyReceiptTariffCode', $this->verifyReceiptTariffCode, true);
    }
     ...
     * @param array $map
     *
     * @return VerifyBillReceiptbillorderRequest
     */
