...
class PfCreditQuotaInfo extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('creditEnd', $this->creditEnd, true);
        Model::validateRequired('creditStart', $this->creditStart, true);
        Model::validateRequired('quotaNo', $this->quotaNo, true);
        Model::validateRequired('remainingQuota', $this->remainingQuota, true);
        Model::validateRequired('remark', $this->remark, true);
        Model::validateRequired('status', $this->status, true);
        Model::validateRequired('totalQuota', $this->totalQuota, true);
        Model::validateRequired('updateTime', $this->updateTime, true);
        Model::validateRequired('totalPledgeQuota', $this->totalPledgeQuota, true);
        Model::validateRequired('remainPledgeQuota', $this->remainPledgeQuota, true);
    }
