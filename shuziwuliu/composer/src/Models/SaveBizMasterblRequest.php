...
class SaveBizMasterblRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
        ...
        if (isset($map['bl_booking_params'])) {
            if (!empty($map['bl_booking_params'])) {
                ...
                foreach ($map['bl_booking_params'] as $item) {
                    $model->blBookingParams[$n++] = null !== $item ? MasterBlBookingParam::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['container_params'])) {
            if (!empty($map['container_params'])) {
                ...
                foreach ($map['container_params'] as $item) {
                    $model->containerParams[$n++] = null !== $item ? MasterBlContainerParam::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['goods_params'])) {
            if (!empty($map['goods_params'])) {
                ...
                foreach ($map['goods_params'] as $item) {
                    $model->goodsParams[$n++] = null !== $item ? MasterBlGoodsParam::fromMap($item) : $item;
                }
            }
        }
