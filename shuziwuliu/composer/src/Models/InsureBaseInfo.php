...
class InsureBaseInfo extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('tbrEmail', $this->tbrEmail, true);
        ...
        Model::validatePattern('idenrifyPeriodStart', $this->idenrifyPeriodStart, '\\d{4}[-]\\d{1,2}[-]\\d{1,2}[T]\\d{2}:\\d{2}:\\d{2}([Z]|([\\.]\\d{1,9})?[\\+]\\d{2}[\\:]?\\d{2})');
