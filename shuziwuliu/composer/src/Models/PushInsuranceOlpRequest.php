...
class PushInsuranceOlpRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('insureDate', $this->insureDate, true);
        Model::validateRequired('platformConsumerCode', $this->platformConsumerCode, true);
        Model::validateRequired('platformConsumerName', $this->platformConsumerName, true);
        Model::validateRequired('polNo', $this->polNo, true);
        Model::validateRequired('polStatus', $this->polStatus, true);
     ...
     * @param array $map
     *
     * @return PushInsuranceOlpRequest
     */
