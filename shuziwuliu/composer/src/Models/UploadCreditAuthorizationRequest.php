...
class UploadCreditAuthorizationRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    {
        Model::validateRequired('consignorCertNo', $this->consignorCertNo, true);
        Model::validateRequired('consignorDid', $this->consignorDid, true);
        Model::validateRequired('consignorName', $this->consignorName, true);
        Model::validateRequired('consignorPlatformAccount', $this->consignorPlatformAccount, true);
        Model::validateRequired('expireDate', $this->expireDate, true);
        Model::validateRequired('groupPlatformDid', $this->groupPlatformDid, true);
        Model::validateRequired('hasAuthorizationClause', $this->hasAuthorizationClause, true);
        Model::validateRequired('platformCertNo', $this->platformCertNo, true);
        Model::validateRequired('platformDid', $this->platformDid, true);
        Model::validateRequired('platformName', $this->platformName, true);
        Model::validateRequired('protocolImgId', $this->protocolImgId, true);
        Model::validateRequired('protocolName', $this->protocolName, true);
     ...
     * @param array $map
     *
     * @return UploadCreditAuthorizationRequest
     */
