...
class NotifyInsuranceReportresultRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('channelSimpleCode', $this->channelSimpleCode, true);
        ...
        Model::validateMaxLength('channelSimpleCode', $this->channelSimpleCode, 16);
    ...
    public function toMap()
    {
        ...
        if (null !== $this->channelSimpleCode) {
            $res['channel_simple_code'] = $this->channelSimpleCode;
        }
     ...
     * @param array $map
     *
     * @return NotifyInsuranceReportresultRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['channel_simple_code'])) {
            $model->channelSimpleCode = $map['channel_simple_code'];
        }
