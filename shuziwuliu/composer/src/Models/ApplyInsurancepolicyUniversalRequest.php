...
class ApplyInsurancepolicyUniversalRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('bbrType', $this->bbrType, true);
        Model::validateRequired('cargoQuantity', $this->cargoQuantity, true);
        Model::validateRequired('cargoQuantityUnit', $this->cargoQuantityUnit, true);
        ...
        Model::validateRequired('driverTel', $this->driverTel, true);
        ...
        Model::validateRequired('printInvoice', $this->printInvoice, true);
        ...
        Model::validateRequired('tbrType', $this->tbrType, true);
     ...
     * @param array $map
     *
     * @return ApplyInsurancepolicyUniversalRequest
     */
