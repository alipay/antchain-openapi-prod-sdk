...
class ApplyInsurancePiprereportRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
     ...
     * @var string
     */
    public $judgmentFinishTime;

    // 判责是否成立
    /**
     * @var bool
     */
    public $judgmentIsTenable;
    ...
    public function validate()
    {
        ...
        Model::validateRequired('complaintTime', $this->complaintTime, true);
    ...
    public function toMap()
    {
        ...
        if (null !== $this->complaintTime) {
            $res['complaint_time'] = $this->complaintTime;
        }
        if (null !== $this->judgmentTime) {
            $res['judgment_time'] = $this->judgmentTime;
        }
        if (null !== $this->judgmentFinishTime) {
            $res['judgment_finish_time'] = $this->judgmentFinishTime;
        }
        if (null !== $this->judgmentIsTenable) {
            $res['judgment_is_tenable'] = $this->judgmentIsTenable;
        }
     ...
     * @param array $map
     *
     * @return ApplyInsurancePiprereportRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['complaint_time'])) {
            $model->complaintTime = $map['complaint_time'];
        }
        if (isset($map['judgment_time'])) {
            $model->judgmentTime = $map['judgment_time'];
        }
        if (isset($map['judgment_finish_time'])) {
            $model->judgmentFinishTime = $map['judgment_finish_time'];
        }
        if (isset($map['judgment_is_tenable'])) {
            $model->judgmentIsTenable = $map['judgment_is_tenable'];
        }
