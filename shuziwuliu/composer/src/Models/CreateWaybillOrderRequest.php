...
class CreateWaybillOrderRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->cargoOrders) {
            $res['cargo_orders'] = $this->cargoOrders;
        }
     ...
     * @param array $map
     *
     * @return CreateWaybillOrderRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['cargo_orders'])) {
            if (!empty($map['cargo_orders'])) {
                $model->cargoOrders = $map['cargo_orders'];
            }
        }
