...
namespace AntChain\Ak_c5b091f0690e45b8885768dd84d78dc9;
...
use AntChain\Ak_c5b091f0690e45b8885768dd84d78dc9\Models\ConfirmAntchainBbpContractReconciliationRequest;
use AntChain\Ak_c5b091f0690e45b8885768dd84d78dc9\Models\ConfirmAntchainBbpContractReconciliationResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_c5b091f0690e45b8885768dd84d78dc9',
                    '_prod_channel'    => 'saas',
                ];
