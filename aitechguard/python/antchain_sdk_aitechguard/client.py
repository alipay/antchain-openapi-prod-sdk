...
class Client:
    ...
    def check_aicoguardrails_ask(
        self,
        request: aitechguard_models.CheckAicoguardrailsAskRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.check_aicoguardrails_ask_ex(request, headers, runtime)

    async def check_aicoguardrails_ask_async(
        self,
        request: aitechguard_models.CheckAicoguardrailsAskRequest,
    ) -> aitechguard_models.CheckAicoguardrailsAskResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.check_aicoguardrails_ask_ex_async(request, headers, runtime)

    def check_aicoguardrails_ask_ex(
        self,
        request: aitechguard_models.CheckAicoguardrailsAskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def check_aicoguardrails_ask_ex_async(
        self,
        request: aitechguard_models.CheckAicoguardrailsAskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
