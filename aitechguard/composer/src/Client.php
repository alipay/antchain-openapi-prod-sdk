...
namespace AntChain\AITECHGUARD;
...
class Client
{
     ...
     * Summary: 提问检测服务接口.
     *
     * @param CheckAicoguardrailsAskRequest $request
     *
     * @return CheckAicoguardrailsAskResponse
     */
    public function checkAicoguardrailsAsk($request)
    {
     ...
     * @return CheckAicoguardrailsAskResponse
     */
    public function checkAicoguardrailsAskEx($request, $headers, $runtime)
    {
