...
PACKAGE = "antchain_sdk_aiosproduct"
NAME = 'antchain_antdigital_aiosproduct' or "alibabacloud-package"
DESCRIPTION = "Ant Chain AIOSPRODUCT SDK Library for Python"
AUTHOR = "Ant Chain SDK"
