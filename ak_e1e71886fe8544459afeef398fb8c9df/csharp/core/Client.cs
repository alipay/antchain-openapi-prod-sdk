...
using AntChain.SDK.Ak_e1e71886fe8544459afeef398fb8c9df.Models;

namespace AntChain.SDK.Ak_e1e71886fe8544459afeef398fb8c9df
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_e1e71886fe8544459afeef398fb8c9df"},
                        {"_prod_channel", "saas"},
                    };
