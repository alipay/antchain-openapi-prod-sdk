...
type ImportAntchainDemosdkCreateTestRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
}

func (s ImportAntchainDemosdkCreateTestRequest) String() string {
	return tea.Prettify(s)
}

func (s ImportAntchainDemosdkCreateTestRequest) GoString() string {
	return s.String()
}

func (s *ImportAntchainDemosdkCreateTestRequest) SetAuthToken(v string) *ImportAntchainDemosdkCreateTestRequest {
	s.AuthToken = &v
	return s
}

func (s *ImportAntchainDemosdkCreateTestRequest) SetProductInstanceId(v string) *ImportAntchainDemosdkCreateTestRequest {
	s.ProductInstanceId = &v
	return s
}

type ImportAntchainDemosdkCreateTestResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
...
func (s ImportAntchainDemosdkCreateTestResponse) String() string {
	return tea.Prettify(s)
}

func (s ImportAntchainDemosdkCreateTestResponse) GoString() string {
	return s.String()
}

func (s *ImportAntchainDemosdkCreateTestResponse) SetReqMsgId(v string) *ImportAntchainDemosdkCreateTestResponse {
	s.ReqMsgId = &v
	return s
}

func (s *ImportAntchainDemosdkCreateTestResponse) SetResultCode(v string) *ImportAntchainDemosdkCreateTestResponse {
	s.ResultCode = &v
	return s
}

func (s *ImportAntchainDemosdkCreateTestResponse) SetResultMsg(v string) *ImportAntchainDemosdkCreateTestResponse {
	s.ResultMsg = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("BENCHONE"),
 ...
 */
func (client *Client) ImportAntchainDemosdkCreateTest(request *ImportAntchainDemosdkCreateTestRequest) (_result *ImportAntchainDemosdkCreateTestResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ImportAntchainDemosdkCreateTestResponse{}
	_body, _err := client.ImportAntchainDemosdkCreateTestEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 用于个人工作台二期测试使用
 */
func (client *Client) ImportAntchainDemosdkCreateTestEx(request *ImportAntchainDemosdkCreateTestRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *ImportAntchainDemosdkCreateTestResponse, _err error) {
