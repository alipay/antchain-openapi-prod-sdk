...
using AntChain.SDK.Ak_a050edd0f07344eabd879166e7187ce5.Models;

namespace AntChain.SDK.Ak_a050edd0f07344eabd879166e7187ce5
{
    public class Client 
    {
         ...
         * Summary: 外呼收单接口
         */
        public ImportAntchainAioOutboundPhoneResponse ImportAntchainAioOutboundPhone(ImportAntchainAioOutboundPhoneRequest request)
        {
         ...
         * Summary: 外呼收单接口
         */
        public async Task<ImportAntchainAioOutboundPhoneResponse> ImportAntchainAioOutboundPhoneAsync(ImportAntchainAioOutboundPhoneRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await ImportAntchainAioOutboundPhoneExAsync(request, headers, runtime);
        }
         ...
         * Summary: 外呼收单接口
         */
        public ImportAntchainAioOutboundPhoneResponse ImportAntchainAioOutboundPhoneEx(ImportAntchainAioOutboundPhoneRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ImportAntchainAioOutboundPhoneResponse>(DoRequest("1.0", "antchain.aio.outbound.phone.import", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 外呼收单接口
         */
        public async Task<ImportAntchainAioOutboundPhoneResponse> ImportAntchainAioOutboundPhoneExAsync(ImportAntchainAioOutboundPhoneRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
