...
namespace AntChain\Ak_a050edd0f07344eabd879166e7187ce5;
...
class Client
{
     ...
     * Summary: 外呼收单接口.
     *
     * @param ImportAntchainAioOutboundPhoneRequest $request
     *
     * @return ImportAntchainAioOutboundPhoneResponse
     */
    public function importAntchainAioOutboundPhone($request)
    {
     ...
     * @return ImportAntchainAioOutboundPhoneResponse
     */
    public function importAntchainAioOutboundPhoneEx($request, $headers, $runtime)
    {
