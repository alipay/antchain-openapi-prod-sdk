...
public class UpdateProjectResponse extends TeaModel {
    ...
    public UpdateProjectResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateProjectResponse setResultCode(String resultCode) {
    ...
    public UpdateProjectResponse setResultMsg(String resultMsg) {
    ...
    public UpdateProjectResponse setResult(Boolean result) {
        this.result = result;
        return this;
    }
