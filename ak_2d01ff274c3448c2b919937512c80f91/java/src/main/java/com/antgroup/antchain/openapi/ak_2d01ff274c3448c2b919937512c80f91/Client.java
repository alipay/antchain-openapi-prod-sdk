...
package com.antgroup.antchain.openapi.ak_2d01ff274c3448c2b919937512c80f91;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.ak_2d01ff274c3448c2b919937512c80f91.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("_prod_code", "ak_2d01ff274c3448c2b919937512c80f91"),
     ...
     * Summary: huanyu
     */
    public BindAntcloudCatHuanyuResponse bindAntcloudCatHuanyu(BindAntcloudCatHuanyuRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: huanyu
     */
    public BindAntcloudCatHuanyuResponse bindAntcloudCatHuanyuEx(BindAntcloudCatHuanyuRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.cat.huanyu.bind", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new BindAntcloudCatHuanyuResponse());
    }
