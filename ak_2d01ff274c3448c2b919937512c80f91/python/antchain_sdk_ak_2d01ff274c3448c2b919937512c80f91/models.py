...
class GetAntcloudCatAgeRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        id: str = None,
...
class GetAntcloudCatAgeResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class BindAntcloudCatHuanyuRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        operator: str = None,
...
class BindAntcloudCatHuanyuResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
