...
type BindAntcloudCatHuanyuRequest struct {
	// OAuth模式下的授权token
	AuthToken *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	// huanyu
...
func (s BindAntcloudCatHuanyuRequest) String() string {
	return tea.Prettify(s)
}

func (s BindAntcloudCatHuanyuRequest) GoString() string {
	return s.String()
}

func (s *BindAntcloudCatHuanyuRequest) SetAuthToken(v string) *BindAntcloudCatHuanyuRequest {
	s.AuthToken = &v
	return s
}

func (s *BindAntcloudCatHuanyuRequest) SetOperator(v string) *BindAntcloudCatHuanyuRequest {
	s.Operator = &v
	return s
}

type BindAntcloudCatHuanyuResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s BindAntcloudCatHuanyuResponse) String() string {
	return tea.Prettify(s)
}

func (s BindAntcloudCatHuanyuResponse) GoString() string {
	return s.String()
}

func (s *BindAntcloudCatHuanyuResponse) SetReqMsgId(v string) *BindAntcloudCatHuanyuResponse {
	s.ReqMsgId = &v
	return s
}

func (s *BindAntcloudCatHuanyuResponse) SetResultCode(v string) *BindAntcloudCatHuanyuResponse {
	s.ResultCode = &v
	return s
}

func (s *BindAntcloudCatHuanyuResponse) SetResultMsg(v string) *BindAntcloudCatHuanyuResponse {
	s.ResultMsg = &v
	return s
}

func (s *BindAntcloudCatHuanyuResponse) SetYunyou(v string) *BindAntcloudCatHuanyuResponse {
	s.Yunyou = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("ak_2d01ff274c3448c2b919937512c80f91"),
 ...
 * Summary: huanyu
 */
func (client *Client) BindAntcloudCatHuanyu(request *BindAntcloudCatHuanyuRequest) (_result *BindAntcloudCatHuanyuResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BindAntcloudCatHuanyuResponse{}
	_body, _err := client.BindAntcloudCatHuanyuEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: huanyu
 */
func (client *Client) BindAntcloudCatHuanyuEx(request *BindAntcloudCatHuanyuRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *BindAntcloudCatHuanyuResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
