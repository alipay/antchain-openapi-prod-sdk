...
package com.antgroup.antchain.openapi.ak_1fef8815252948ebb01da07898dd0fb2;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.ak_1fef8815252948ebb01da07898dd0fb2.models.*;
...
public class Client {
     ...
     */
    public GetAntchainBbpContractRuleResponse getAntchainBbpContractRule(GetAntchainBbpContractRuleRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 外包薪资规则合约查询接口
     */
    public GetAntchainBbpContractRuleResponse getAntchainBbpContractRuleEx(GetAntchainBbpContractRuleRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antchain.bbp.contract.rule.get", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new GetAntchainBbpContractRuleResponse());
    }
