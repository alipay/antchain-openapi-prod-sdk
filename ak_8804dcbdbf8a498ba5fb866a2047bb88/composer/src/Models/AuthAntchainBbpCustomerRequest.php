...
namespace AntChain\Ak_8804dcbdbf8a498ba5fb866a2047bb88\Models;

use AlibabaCloud\Tea\Model;

class AuthAntchainBbpCustomerRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
     ...
     * @param array $map
     *
     * @return AuthAntchainBbpCustomerRequest
     */
        ...
        if (isset($map['extension_info'])) {
            if (!empty($map['extension_info'])) {
                ...
                foreach ($map['extension_info'] as $item) {
                    $model->extensionInfo[$n++] = null !== $item ? NameValuePair::fromMap($item) : $item;
                }
            }
        }
