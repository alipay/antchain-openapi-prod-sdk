...
namespace AntChain\Ak_b9d7cdbb39114f839ab11fae673ebb6c;
...
use AntChain\Ak_b9d7cdbb39114f839ab11fae673ebb6c\Models\UpdateDemoCjtestCjRequest;
use AntChain\Ak_b9d7cdbb39114f839ab11fae673ebb6c\Models\UpdateDemoCjtestCjResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.3',
                    '_prod_code'       => 'ak_b9d7cdbb39114f839ab11fae673ebb6c',
                    '_prod_channel'    => 'saas',
                ];
