...
public class Client {
     ...
     * Summary: 外部发券</p>
     */
    public SendPartnerCouponResponse sendPartnerCoupon(SendPartnerCouponRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.sendPartnerCouponEx(request, headers, runtime);
    }
     ...
     * Summary: 外部发券</p>
     */
    public SendPartnerCouponResponse sendPartnerCouponEx(SendPartnerCouponRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.marketing.partner.coupon.send", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new SendPartnerCouponResponse());
    }
     ...
     * Summary: 外部客户查询券余量</p>
     */
    public QueryPartnerCouponstockResponse queryPartnerCouponstock(QueryPartnerCouponstockRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryPartnerCouponstockEx(request, headers, runtime);
    }
     ...
     * Summary: 外部客户查询券余量</p>
     */
    public QueryPartnerCouponstockResponse queryPartnerCouponstockEx(QueryPartnerCouponstockRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.marketing.partner.couponstock.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryPartnerCouponstockResponse());
    }
     ...
     */
    public QueryPartnerCouponResponse queryPartnerCoupon(QueryPartnerCouponRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryPartnerCouponEx(request, headers, runtime);
    }
     ...
     * Summary: 查询指定租户指定产品列表可用优惠券</p>
     */
    public QueryPartnerCouponResponse queryPartnerCouponEx(QueryPartnerCouponRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.marketing.partner.coupon.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryPartnerCouponResponse());
    }
     ...
     */
    public ListPartnerCoupontemplateResponse listPartnerCoupontemplate(ListPartnerCoupontemplateRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.listPartnerCoupontemplateEx(request, headers, runtime);
    }
     ...
     * Summary: 用于查询可用的优惠券模板信息</p>
     */
    public ListPartnerCoupontemplateResponse listPartnerCoupontemplateEx(ListPartnerCoupontemplateRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.marketing.partner.coupontemplate.list", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ListPartnerCoupontemplateResponse());
    }
    ...
    /**
     * <b>description</b> :
     * <p>Description: 根据内容库id和目录id查询子目录
     * Summary: 根据内容库id和目录id查询子目录</p>
     */
    ...
    /**
     * <b>description</b> :
     * <p>Description: 优惠券查询(只查询可用优惠券，提供给收银台使用)
     * Summary: 查询所有可用优惠券列表</p>
     */
