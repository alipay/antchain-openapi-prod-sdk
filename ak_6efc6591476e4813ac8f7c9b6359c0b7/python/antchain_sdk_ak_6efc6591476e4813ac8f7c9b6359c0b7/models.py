...
class QueryDemoAaaaFffDdRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
    ...
    def validate(self):
        self.validate_required(self.xxx, 'xxx')
        self.validate_required(self.yyy, 'yyy')
...
class QueryDemoAaaaFffDdResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
...
class CheckSaasSecurityInfosecOpencheckservicecheckRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        product_instance_id: str = None,
...
class CheckSaasSecurityInfosecOpencheckservicecheckResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
