...
public class QueryGuardAskRequest extends TeaModel {
    ...
    public KeyValuePair businessProperties;
    ...
    public QueryGuardAskRequest setBusinessProperties(KeyValuePair businessProperties) {
        this.businessProperties = businessProperties;
        return this;
    }
    public KeyValuePair getBusinessProperties() {
