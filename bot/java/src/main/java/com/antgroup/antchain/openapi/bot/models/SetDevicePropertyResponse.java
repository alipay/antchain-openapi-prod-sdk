...
public class SetDevicePropertyResponse extends TeaModel {
    ...
    public SetDevicePropertyResponse setReqMsgId(String reqMsgId) {
    ...
    public SetDevicePropertyResponse setResultCode(String resultCode) {
    ...
    public SetDevicePropertyResponse setResultMsg(String resultMsg) {
