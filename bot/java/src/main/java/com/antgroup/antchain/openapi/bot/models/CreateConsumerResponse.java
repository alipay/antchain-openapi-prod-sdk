...
public class CreateConsumerResponse extends TeaModel {
    ...
    public CreateConsumerResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateConsumerResponse setResultCode(String resultCode) {
    ...
    public CreateConsumerResponse setResultMsg(String resultMsg) {
