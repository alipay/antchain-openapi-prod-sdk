...
public class SyncLabelTransferResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public SyncLabelTransferResponse setReqMsgId(String reqMsgId) {
    ...
    public SyncLabelTransferResponse setResultCode(String resultCode) {
    ...
    public SyncLabelTransferResponse setResultMsg(String resultMsg) {
