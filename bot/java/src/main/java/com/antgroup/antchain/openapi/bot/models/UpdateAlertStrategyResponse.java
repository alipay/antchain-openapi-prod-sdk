...
public class UpdateAlertStrategyResponse extends TeaModel {
    ...
    public UpdateAlertStrategyResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateAlertStrategyResponse setResultCode(String resultCode) {
    ...
    public UpdateAlertStrategyResponse setResultMsg(String resultMsg) {
