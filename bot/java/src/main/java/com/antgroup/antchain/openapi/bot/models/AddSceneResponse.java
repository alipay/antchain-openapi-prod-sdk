...
public class AddSceneResponse extends TeaModel {
    ...
    public AddSceneResponse setReqMsgId(String reqMsgId) {
    ...
    public AddSceneResponse setResultCode(String resultCode) {
    ...
    public AddSceneResponse setResultMsg(String resultMsg) {
