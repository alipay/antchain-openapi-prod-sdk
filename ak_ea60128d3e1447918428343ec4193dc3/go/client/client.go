...
type QueryDemoComShareLiuRequest struct {
	// OAuth模式下的授权token
	AuthToken         *string `json:"auth_token,omitempty" xml:"auth_token,omitempty"`
	ProductInstanceId *string `json:"product_instance_id,omitempty" xml:"product_instance_id,omitempty"`
}

func (s QueryDemoComShareLiuRequest) String() string {
	return tea.Prettify(s)
}

func (s QueryDemoComShareLiuRequest) GoString() string {
	return s.String()
}

func (s *QueryDemoComShareLiuRequest) SetAuthToken(v string) *QueryDemoComShareLiuRequest {
	s.AuthToken = &v
	return s
}

func (s *QueryDemoComShareLiuRequest) SetProductInstanceId(v string) *QueryDemoComShareLiuRequest {
	s.ProductInstanceId = &v
	return s
}

type QueryDemoComShareLiuResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
	ReqMsgId *string `json:"req_msg_id,omitempty" xml:"req_msg_id,omitempty"`
	// 结果码，一般OK表示调用成功
	ResultCode *string `json:"result_code,omitempty" xml:"result_code,omitempty"`
...
func (s QueryDemoComShareLiuResponse) String() string {
	return tea.Prettify(s)
}

func (s QueryDemoComShareLiuResponse) GoString() string {
	return s.String()
}

func (s *QueryDemoComShareLiuResponse) SetReqMsgId(v string) *QueryDemoComShareLiuResponse {
	s.ReqMsgId = &v
	return s
}

func (s *QueryDemoComShareLiuResponse) SetResultCode(v string) *QueryDemoComShareLiuResponse {
	s.ResultCode = &v
	return s
}

func (s *QueryDemoComShareLiuResponse) SetResultMsg(v string) *QueryDemoComShareLiuResponse {
	s.ResultMsg = &v
	return s
}
 ...
 * Summary: api简介
 */
func (client *Client) QueryDemoComShareLiu(request *QueryDemoComShareLiuRequest) (_result *QueryDemoComShareLiuResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &QueryDemoComShareLiuResponse{}
	_body, _err := client.QueryDemoComShareLiuEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: api简介
 */
func (client *Client) QueryDemoComShareLiuEx(request *QueryDemoComShareLiuRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryDemoComShareLiuResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	_result = &QueryDemoComShareLiuResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("demo.com.share.liu.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
