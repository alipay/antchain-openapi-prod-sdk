...
public class UpdateServiceResponse extends TeaModel {
    ...
    public UpdateServiceResponse setReqMsgId(String reqMsgId) {
    ...
    public UpdateServiceResponse setResultCode(String resultCode) {
    ...
    public UpdateServiceResponse setResultMsg(String resultMsg) {
