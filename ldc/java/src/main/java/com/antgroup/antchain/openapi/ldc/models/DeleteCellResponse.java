...
public class DeleteCellResponse extends TeaModel {
    ...
    public DeleteCellResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteCellResponse setResultCode(String resultCode) {
    ...
    public DeleteCellResponse setResultMsg(String resultMsg) {
