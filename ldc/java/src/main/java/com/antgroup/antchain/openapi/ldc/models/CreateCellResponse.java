...
public class CreateCellResponse extends TeaModel {
    ...
    public CreateCellResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateCellResponse setResultCode(String resultCode) {
    ...
    public CreateCellResponse setResultMsg(String resultMsg) {
