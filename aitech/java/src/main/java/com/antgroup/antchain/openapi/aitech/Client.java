...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "1.1.62"),
    ...
    /**
     * <b>description</b> :
     * <p>Description: 天鉴图片检测功能saas版本
     * Summary: 天鉴图片检测功能saas</p>
     */
    public QuerySecurityImageResponse querySecurityImage(QuerySecurityImageRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 天鉴图片检测功能saas</p>
     */
    public QuerySecurityImageResponse querySecurityImageEx(QuerySecurityImageRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "aitech.comm.security.image.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QuerySecurityImageResponse());
    }
}
