...
class QuerySecurityPolicyRequest(TeaModel):
    ...
    def to_map(self):
        ...
        if self.expect_product_codes is not None:
            result['expect_product_codes'] = self.expect_product_codes
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('expect_product_codes') is not None:
            self.expect_product_codes = m.get('expect_product_codes')
