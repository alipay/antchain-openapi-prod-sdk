...
using AntChain.SDK.INS_RISK.Models;

namespace AntChain.SDK.INS_RISK
{
    public class Client 
    {
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QuerySecurityPolicyResponse>(DoRequest("1.0", "antdigital.insrisk.security.policy.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QuerySecurityPolicyResponse>(await DoRequestAsync("1.0", "antdigital.insrisk.security.policy.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
