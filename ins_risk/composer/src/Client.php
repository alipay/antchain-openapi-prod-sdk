...
class Client
{
    ...
    public function querySecurityPolicyEx($request, $headers, $runtime)
    {
        ...
        return QuerySecurityPolicyResponse::fromMap($this->doRequest('1.0', 'antdigital.insrisk.security.policy.query', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
}
