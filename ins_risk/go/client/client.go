...
func (s *QuerySecurityPolicyRequest) SetBusinessCode(v string) *QuerySecurityPolicyRequest {
	s.BusinessCode = &v
	return s
}
...
func (s *QuerySecurityPolicyRequest) SetParams(v string) *QuerySecurityPolicyRequest {
	s.Params = &v
	return s
}
...
func (s *QuerySecurityPolicyResponse) SetBizResult(v string) *QuerySecurityPolicyResponse {
	s.BizResult = &v
	return s
}
...
func (client *Client) QuerySecurityPolicyEx(request *QuerySecurityPolicyRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QuerySecurityPolicyResponse, _err error) {
	...
	_result = &QuerySecurityPolicyResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antdigital.insrisk.security.policy.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
