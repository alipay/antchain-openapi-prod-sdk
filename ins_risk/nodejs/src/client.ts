...
export default class Client {
  ...
  async querySecurityPolicyEx(request: QuerySecurityPolicyRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QuerySecurityPolicyResponse> {
    Util.validateModel(request);
    return $tea.cast<QuerySecurityPolicyResponse>(await this.doRequest("1.0", "antdigital.insrisk.security.policy.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QuerySecurityPolicyResponse({}));
  }
