...
package com.antgroup.antchain.openapi.creativerender;
...
import com.antgroup.antchain.openapi.creativerender.models.*;
...
public class Client {
    ...
    /**
     * <b>description</b> :
     * <p>Description: 创意素材中心chat生图接口
     * Summary: 创意素材中心chat生图接口</p>
     */
    public ExecAntcloudMarketingagentChatCreativeResponse execAntcloudMarketingagentChatCreative(ExecAntcloudMarketingagentChatCreativeRequest request) throws Exception {
     ...
     * Summary: 创意素材中心chat生图接口</p>
     */
    public ExecAntcloudMarketingagentChatCreativeResponse execAntcloudMarketingagentChatCreativeEx(ExecAntcloudMarketingagentChatCreativeRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.marketingagent.chat.creative.exec", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ExecAntcloudMarketingagentChatCreativeResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 创意素材chat接口
     * Summary: 创意素材chat接口</p>
     */
    public ExecAntcloudMarketingagentCreativeChatResponse execAntcloudMarketingagentCreativeChat(ExecAntcloudMarketingagentCreativeChatRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
