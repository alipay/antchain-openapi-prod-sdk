...
PACKAGE = "antchain_sdk_creativerender"
NAME = 'antchain_antdigital_creativerender' or "alibabacloud-package"
DESCRIPTION = "Ant Chain CREATIVERENDER SDK Library for Python"
AUTHOR = "Ant Chain SDK"
