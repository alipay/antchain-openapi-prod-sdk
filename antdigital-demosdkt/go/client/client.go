...
type ImportAntchainDemosdkRoleRequest struct {
	// OAuth模式下的授权token
...
func (s ImportAntchainDemosdkRoleRequest) String() string {
	return tea.Prettify(s)
}

func (s ImportAntchainDemosdkRoleRequest) GoString() string {
	return s.String()
}

func (s *ImportAntchainDemosdkRoleRequest) SetAuthToken(v string) *ImportAntchainDemosdkRoleRequest {
	s.AuthToken = &v
	return s
}

func (s *ImportAntchainDemosdkRoleRequest) SetProductInstanceId(v string) *ImportAntchainDemosdkRoleRequest {
	s.ProductInstanceId = &v
	return s
}

func (s *ImportAntchainDemosdkRoleRequest) SetTest(v string) *ImportAntchainDemosdkRoleRequest {
	s.Test = &v
	return s
}

type ImportAntchainDemosdkRoleResponse struct {
	// 请求唯一ID，用于链路跟踪和问题排查
...
func (s ImportAntchainDemosdkRoleResponse) String() string {
	return tea.Prettify(s)
}

func (s ImportAntchainDemosdkRoleResponse) GoString() string {
	return s.String()
}

func (s *ImportAntchainDemosdkRoleResponse) SetReqMsgId(v string) *ImportAntchainDemosdkRoleResponse {
	s.ReqMsgId = &v
	return s
}

func (s *ImportAntchainDemosdkRoleResponse) SetResultCode(v string) *ImportAntchainDemosdkRoleResponse {
	s.ResultCode = &v
	return s
}

func (s *ImportAntchainDemosdkRoleResponse) SetResultMsg(v string) *ImportAntchainDemosdkRoleResponse {
	s.ResultMsg = &v
	return s
}

func (s *ImportAntchainDemosdkRoleResponse) SetIdcard(v string) *ImportAntchainDemosdkRoleResponse {
	s.Idcard = &v
	return s
}
	...
	for _retryTimes := 0; tea.BoolValue(tea.AllowRetry(_runtime["retry"], tea.Int(_retryTimes))); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]*string{
				...
				"_prod_code":       tea.String("DEMOSDKT"),
 ...
 * Summary: 测试
 */
func (client *Client) ImportAntchainDemosdkRole(request *ImportAntchainDemosdkRoleRequest) (_result *ImportAntchainDemosdkRoleResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ImportAntchainDemosdkRoleResponse{}
	_body, _err := client.ImportAntchainDemosdkRoleEx(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
 ...
 * Summary: 测试
 */
func (client *Client) ImportAntchainDemosdkRoleEx(request *ImportAntchainDemosdkRoleRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *ImportAntchainDemosdkRoleResponse, _err error) {
