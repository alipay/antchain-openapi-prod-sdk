...
class SubmitInquiryRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('inquirePlatform', $this->inquirePlatform, true);
        ...
        Model::validateRequired('inquirer', $this->inquirer, true);
    }
