...
PACKAGE = "antchain_sdk_insurance_saas"
NAME = "antchain_insurance_saas" or "alibabacloud-package"
DESCRIPTION = "Ant Chain INSURANCE_SAAS SDK Library for Python"
AUTHOR = "Ant Chain SDK"
...
setup(
    ...
    url=URL,
    keywords=["antchain","insurance","saas"],
