...
public class CreateProductResponse extends TeaModel {
    ...
    public CreateProductResponse setReqMsgId(String reqMsgId) {
    ...
    public CreateProductResponse setResultCode(String resultCode) {
    ...
    public CreateProductResponse setResultMsg(String resultMsg) {
