...
public class DeleteProductResponse extends TeaModel {
    ...
    public DeleteProductResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteProductResponse setResultCode(String resultCode) {
    ...
    public DeleteProductResponse setResultMsg(String resultMsg) {
