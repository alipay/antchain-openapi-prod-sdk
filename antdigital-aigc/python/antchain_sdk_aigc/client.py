...
from antchain_sdk_aigc import models as aigc_models
...
class Client:
    ...
    def push_video_createtask(
        self,
        request: aigc_models.PushVideoCreatetaskRequest,
    ) -> aigc_models.PushVideoCreatetaskResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.push_video_createtask_ex(request, headers, runtime)

    async def push_video_createtask_async(
        self,
        request: aigc_models.PushVideoCreatetaskRequest,
    ) -> aigc_models.PushVideoCreatetaskResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.push_video_createtask_ex_async(request, headers, runtime)

    def push_video_createtask_ex(
        self,
        request: aigc_models.PushVideoCreatetaskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            aigc_models.PushVideoCreatetaskResponse(),
            self.do_request('1.0', 'antdigital.aigc.video.createtask.push', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def push_video_createtask_ex_async(
        self,
        request: aigc_models.PushVideoCreatetaskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            aigc_models.PushVideoCreatetaskResponse(),
            await self.do_request_async('1.0', 'antdigital.aigc.video.createtask.push', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def query_video_querytask(
        self,
        request: aigc_models.QueryVideoQuerytaskRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_video_querytask_ex(request, headers, runtime)

    async def query_video_querytask_async(
        self,
        request: aigc_models.QueryVideoQuerytaskRequest,
    ) -> aigc_models.QueryVideoQuerytaskResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_video_querytask_ex_async(request, headers, runtime)

    def query_video_querytask_ex(
        self,
        request: aigc_models.QueryVideoQuerytaskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            aigc_models.QueryVideoQuerytaskResponse(),
            self.do_request('1.0', 'antdigital.aigc.video.querytask.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_video_querytask_ex_async(
        self,
        request: aigc_models.QueryVideoQuerytaskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
