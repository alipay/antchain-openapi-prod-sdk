...
class Client
{
     ...
     *
     * @param PushVideoCreatetaskRequest $request
     *
     * @return PushVideoCreatetaskResponse
     */
    public function pushVideoCreatetask($request)
    {
     ...
     * @return PushVideoCreatetaskResponse
     */
    public function pushVideoCreatetaskEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return PushVideoCreatetaskResponse::fromMap($this->doRequest('1.0', 'antdigital.aigc.video.createtask.push', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: AIGC视频任务查询.
     *
     * @param QueryVideoQuerytaskRequest $request
     *
     * @return QueryVideoQuerytaskResponse
     */
    public function queryVideoQuerytask($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryVideoQuerytaskResponse
     */
    public function queryVideoQuerytaskEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);
