...
using AntChain.SDK.AIGC.Models;

namespace AntChain.SDK.AIGC
{
    public class Client 
    {
         ...
         */
        public PushVideoCreatetaskResponse PushVideoCreatetask(PushVideoCreatetaskRequest request)
        {
         ...
         * Summary: 创建aigc视频生成任务
         */
        public async Task<PushVideoCreatetaskResponse> PushVideoCreatetaskAsync(PushVideoCreatetaskRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await PushVideoCreatetaskExAsync(request, headers, runtime);
        }
         ...
         * Summary: 创建aigc视频生成任务
         */
        public PushVideoCreatetaskResponse PushVideoCreatetaskEx(PushVideoCreatetaskRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<PushVideoCreatetaskResponse>(DoRequest("1.0", "antdigital.aigc.video.createtask.push", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 创建aigc视频生成任务
         */
        public async Task<PushVideoCreatetaskResponse> PushVideoCreatetaskExAsync(PushVideoCreatetaskRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<PushVideoCreatetaskResponse>(await DoRequestAsync("1.0", "antdigital.aigc.video.createtask.push", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: AIGC视频任务查询
         */
        public QueryVideoQuerytaskResponse QueryVideoQuerytask(QueryVideoQuerytaskRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
         ...
         * Summary: AIGC视频任务查询
         */
        public async Task<QueryVideoQuerytaskResponse> QueryVideoQuerytaskAsync(QueryVideoQuerytaskRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryVideoQuerytaskExAsync(request, headers, runtime);
        }
         ...
         * Summary: AIGC视频任务查询
         */
        public QueryVideoQuerytaskResponse QueryVideoQuerytaskEx(QueryVideoQuerytaskRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryVideoQuerytaskResponse>(DoRequest("1.0", "antdigital.aigc.video.querytask.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: AIGC视频任务查询
         */
        public async Task<QueryVideoQuerytaskResponse> QueryVideoQuerytaskExAsync(QueryVideoQuerytaskRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
