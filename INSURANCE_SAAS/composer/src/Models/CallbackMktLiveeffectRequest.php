...
class CallbackMktLiveeffectRequest extends Model {
    ...
    public function toMap() {
        ...
        if (null !== $this->marketingChannel) {
            $res['marketing_channel'] = $this->marketingChannel;
        }
        if (null !== $this->rtaTraceId) {
            $res['rta_trace_id'] = $this->rtaTraceId;
        }
        if (null !== $this->rtaExpId) {
            $res['rta_exp_id'] = $this->rtaExpId;
        }
        if (null !== $this->rtbTraceId) {
            $res['rtb_trace_id'] = $this->rtbTraceId;
        }
        return $res;
    }
    /**
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['marketing_channel'])){
            $model->marketingChannel = $map['marketing_channel'];
        }
        if(isset($map['rta_trace_id'])){
            $model->rtaTraceId = $map['rta_trace_id'];
        }
        if(isset($map['rta_exp_id'])){
            $model->rtaExpId = $map['rta_exp_id'];
        }
        if(isset($map['rtb_trace_id'])){
            $model->rtbTraceId = $map['rtb_trace_id'];
        }
        return $model;
    }
    // OAuth模式下的授权token
