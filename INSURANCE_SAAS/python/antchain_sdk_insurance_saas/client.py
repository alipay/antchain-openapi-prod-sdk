...
class Client:
    ...
    def callback_mkt_monitordata(
        self,
        request: insurance__saas_models.CallbackMktMonitordataRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.callback_mkt_monitordata_ex(request, headers, runtime)

    async def callback_mkt_monitordata_async(
        self,
        request: insurance__saas_models.CallbackMktMonitordataRequest,
    ) -> insurance__saas_models.CallbackMktMonitordataResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.callback_mkt_monitordata_ex_async(request, headers, runtime)

    def callback_mkt_monitordata_ex(
        self,
        request: insurance__saas_models.CallbackMktMonitordataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            insurance__saas_models.CallbackMktMonitordataResponse(),
            self.do_request('1.0', 'antcloud.insurance.mkt.monitordata.callback', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def callback_mkt_monitordata_ex_async(
        self,
        request: insurance__saas_models.CallbackMktMonitordataRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def notify_autoinsurance_event(
        self,
        request: insurance__saas_models.NotifyAutoinsuranceEventRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.notify_autoinsurance_event_ex(request, headers, runtime)

    async def notify_autoinsurance_event_async(
        self,
        request: insurance__saas_models.NotifyAutoinsuranceEventRequest,
    ) -> insurance__saas_models.NotifyAutoinsuranceEventResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.notify_autoinsurance_event_ex_async(request, headers, runtime)

    def notify_autoinsurance_event_ex(
        self,
        request: insurance__saas_models.NotifyAutoinsuranceEventRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            insurance__saas_models.NotifyAutoinsuranceEventResponse(),
            self.do_request('1.0', 'antcloud.insurance.autoinsurance.event.notify', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def notify_autoinsurance_event_ex_async(
        self,
        request: insurance__saas_models.NotifyAutoinsuranceEventRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
