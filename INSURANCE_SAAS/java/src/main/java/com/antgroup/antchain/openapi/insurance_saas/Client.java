...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "1.12.54"),
    ...
    /**
     * <b>description</b> :
     * <p>Description: 保险营销效果回传接口——媒体
     * Summary: 保险营销效果回传接口——媒体</p>
     */
    public CallbackMktLiveeffectResponse callbackMktLiveeffect(CallbackMktLiveeffectRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
    ...
    /**
     * <b>description</b> :
     * <p>Description: 保司营销监测数据回传
     * Summary: 保司营销监测数据回传</p>
     */
    public CallbackMktMonitordataResponse callbackMktMonitordata(CallbackMktMonitordataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 保司营销监测数据回传</p>
     */
    public CallbackMktMonitordataResponse callbackMktMonitordataEx(CallbackMktMonitordataRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.insurance.mkt.monitordata.callback", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CallbackMktMonitordataResponse());
    }
     ...
     * Summary: 理想蚂蚁保项目</p>
     */
    public NotifyEmbedoemautoinsuranceEventResponse notifyEmbedoemautoinsuranceEvent(NotifyEmbedoemautoinsuranceEventRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 理想蚂蚁保项目</p>
     */
    public NotifyEmbedoemautoinsuranceEventResponse notifyEmbedoemautoinsuranceEventEx(NotifyEmbedoemautoinsuranceEventRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.insurance.embedoemautoinsurance.event.notify", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new NotifyEmbedoemautoinsuranceEventResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 媒体点击统计数据回传
     * Summary: 媒体点击统计数据回传</p>
     */
    public CallbackMktMediastatisticaldataResponse callbackMktMediastatisticaldata(CallbackMktMediastatisticaldataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 媒体点击统计数据回传</p>
     */
    public CallbackMktMediastatisticaldataResponse callbackMktMediastatisticaldataEx(CallbackMktMediastatisticaldataRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.insurance.mkt.mediastatisticaldata.callback", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CallbackMktMediastatisticaldataResponse());
    }
     ...
     */
    public CallbackMktEffectsimpleResponse callbackMktEffectsimple(CallbackMktEffectsimpleRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
    ...
    /**
     * <b>description</b> :
     * <p>Description: 车险线索查询
     * Summary: 车险线索查询</p>
     */
    public QueryLeadMarketResponse queryLeadMarket(QueryLeadMarketRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 车险线索查询</p>
     */
    public QueryLeadMarketResponse queryLeadMarketEx(QueryLeadMarketRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.insurance.lead.market.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryLeadMarketResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 理想车险事件通知
     * Summary: 理想车险事件通知</p>
     */
    public NotifyAutoinsuranceEventResponse notifyAutoinsuranceEvent(NotifyAutoinsuranceEventRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 理想车险事件通知</p>
     */
    public NotifyAutoinsuranceEventResponse notifyAutoinsuranceEventEx(NotifyAutoinsuranceEventRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "antcloud.insurance.autoinsurance.event.notify", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new NotifyAutoinsuranceEventResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 保险营销文件上传，营销链路中涉及到文件上传，均可使用本接口，根据上传的数据类型做区分
     * Summary: 保险营销文件上传，营销链路中涉及到文件上传，均可使用本接口，根据上传的数据类型做区分</p>
     */
    public UploadMktFileResponse uploadMktFile(UploadMktFileRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 保险营销文件上传，营销链路中涉及到文件上传，均可使用本接口，根据上传的数据类型做区分</p>
     */
    public UploadMktFileResponse uploadMktFileEx(UploadMktFileRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        if (!com.aliyun.teautil.Common.isUnset(request.fileObject)) {
            CreateAntcloudGatewayxFileUploadRequest uploadReq = CreateAntcloudGatewayxFileUploadRequest.build(TeaConverter.buildMap(
                new TeaPair("authToken", request.authToken),
                new TeaPair("apiCode", "antcloud.insurance.mkt.file.upload"),
                new TeaPair("fileName", request.fileObjectName)
            ));
            CreateAntcloudGatewayxFileUploadResponse uploadResp = this.createAntcloudGatewayxFileUploadEx(uploadReq, headers, runtime);
            if (!com.antgroup.antchain.openapi.antchain.util.AntchainUtils.isSuccess(uploadResp.resultCode, "ok")) {
                UploadMktFileResponse uploadMktFileResponse = UploadMktFileResponse.build(TeaConverter.buildMap(
