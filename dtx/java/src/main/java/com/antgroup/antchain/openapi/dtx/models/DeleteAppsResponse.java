...
public class DeleteAppsResponse extends TeaModel {
    ...
    public DeleteAppsResponse setReqMsgId(String reqMsgId) {
    ...
    public DeleteAppsResponse setResultCode(String resultCode) {
    ...
    public DeleteAppsResponse setResultMsg(String resultMsg) {
