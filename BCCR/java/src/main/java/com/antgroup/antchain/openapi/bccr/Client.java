...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.query = TeaConverter.buildMap(
                    ...
                    new TeaPair("sdk_version", "1.21.1"),
    ...
    /**
     * <b>description</b> :
     * <p>Description: DCI发证之后，用户可以上传发出的证书来版权核验真伪
     * Summary: DCI发证之后，用户可以上传发出的证书来版权核验真伪</p>
     */
    public VerifyDciCertResponse verifyDciCert(VerifyDciCertRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.verifyDciCertEx(request, headers, runtime);
    }
     ...
     * Summary: DCI发证之后，用户可以上传发出的证书来版权核验真伪</p>
     */
    public VerifyDciCertResponse verifyDciCertEx(VerifyDciCertRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.dci.cert.verify", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new VerifyDciCertResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 查询DCI凭证核验结果
     * Summary: 查询DCI凭证核验结果</p>
     */
    public ResultDciCertResponse resultDciCert(ResultDciCertRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.resultDciCertEx(request, headers, runtime);
    }
     ...
     * Summary: 查询DCI凭证核验结果</p>
     */
    public ResultDciCertResponse resultDciCertEx(ResultDciCertRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.dci.cert.result", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ResultDciCertResponse());
    }
     ...
     */
    public QueryapplyformCopyrightregistrationDigitalregistrationResponse queryapplyformCopyrightregistrationDigitalregistration(QueryapplyformCopyrightregistrationDigitalregistrationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryapplyformCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
    }
     ...
     * Summary: 版权登记-数登申请-查询数登申请表</p>
     */
    public QueryapplyformCopyrightregistrationDigitalregistrationResponse queryapplyformCopyrightregistrationDigitalregistrationEx(QueryapplyformCopyrightregistrationDigitalregistrationRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.queryapplyform", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryapplyformCopyrightregistrationDigitalregistrationResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 查询当前数登申请是否支持静默签授权
     * Summary: 查询当前数登申请是否支持静默签授权</p>
     */
    public QueryautosealauthCopyrightregistrationDigitalregistrationResponse queryautosealauthCopyrightregistrationDigitalregistration(QueryautosealauthCopyrightregistrationDigitalregistrationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryautosealauthCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
    }
     ...
     * Summary: 查询当前数登申请是否支持静默签授权</p>
     */
    public QueryautosealauthCopyrightregistrationDigitalregistrationResponse queryautosealauthCopyrightregistrationDigitalregistrationEx(QueryautosealauthCopyrightregistrationDigitalregistrationRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.queryautosealauth", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryautosealauthCopyrightregistrationDigitalregistrationResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 创建数登申请表签署流程
     * Summary: 创建数登申请表签署流程</p>
     */
    public CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse createapplyformsealflowCopyrightregistrationDigitalregistration(CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.createapplyformsealflowCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
    }
    ...
    public CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse createapplyformsealflowCopyrightregistrationDigitalregistrationEx(CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.createapplyformsealflow", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 获取签署链接
     * Summary: 获取签署链接</p>
     */
    public QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse queryapplyformsealurlCopyrightregistrationDigitalregistration(QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryapplyformsealurlCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
    }
    ...
    public QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse queryapplyformsealurlCopyrightregistrationDigitalregistrationEx(QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.queryapplyformsealurl", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 完成数登表签署
     * Summary: 完成数登表签署</p>
     */
    public CompleteapplyformsealCopyrightregistrationDigitalregistrationResponse completeapplyformsealCopyrightregistrationDigitalregistration(CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.completeapplyformsealCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
    }
     ...
     * Summary: 数登初审</p>
     */
    public SubmitDigregPreliminaryreviewResponse submitDigregPreliminaryreview(SubmitDigregPreliminaryreviewRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 数登初审</p>
     */
    public SubmitDigregPreliminaryreviewResponse submitDigregPreliminaryreviewEx(SubmitDigregPreliminaryreviewRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.digreg.preliminaryreview.submit", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new SubmitDigregPreliminaryreviewResponse());
    }
     ...
     * Summary: 数登复审</p>
     */
    public SubmitDigregReviewResponse submitDigregReview(SubmitDigregReviewRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 数登复审</p>
     */
    public SubmitDigregReviewResponse submitDigregReviewEx(SubmitDigregReviewRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.digreg.review.submit", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new SubmitDigregReviewResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 提交DCI凭证核验接口
     * Summary: 提交DCI凭证核验接口</p>
     */
    public VerifyDciCertificateResponse verifyDciCertificate(VerifyDciCertificateRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.verifyDciCertificateEx(request, headers, runtime);
    }
     ...
     * Summary: 提交DCI凭证核验接口</p>
     */
    public VerifyDciCertificateResponse verifyDciCertificateEx(VerifyDciCertificateRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "blockchain.bccr.dci.certificate.verify", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new VerifyDciCertificateResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 查询DCI凭证核验结果接口
     * Summary: 查询DCI凭证核验结果接口</p>
     */
    public QueryDciCertificateresultResponse queryDciCertificateresult(QueryDciCertificateresultRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryDciCertificateresultEx(request, headers, runtime);
    }
