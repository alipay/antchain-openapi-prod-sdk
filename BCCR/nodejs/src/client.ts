...
export class VerifyDciCertRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
...
export class VerifyDciCertResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class ResultDciCertRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // DCI证书凭证核验ID
...
export class ResultDciCertResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryapplyformCopyrightregistrationDigitalregistrationRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 数登ID
...
export class QueryapplyformCopyrightregistrationDigitalregistrationResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryautosealauthCopyrightregistrationDigitalregistrationRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 数登申请ID
...
export class QueryautosealauthCopyrightregistrationDigitalregistrationResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 数登申请ID
...
export class CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 数登申请ID
...
export class QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 数登申请ID
...
export class CompleteapplyformsealCopyrightregistrationDigitalregistrationResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class VerifyDciCertificateRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // 文件ID（支持PDF/图片）
...
export class VerifyDciCertificateResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export class QueryDciCertificateresultRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
  productInstanceId?: string;
  // DCI证书核验ID
...
export class QueryDciCertificateresultResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export default class Client {
   ...
   */
  async verifyDciCert(request: VerifyDciCertRequest): Promise<VerifyDciCertResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.verifyDciCertEx(request, headers, runtime);
  }
   ...
   * Summary: DCI发证之后，用户可以上传发出的证书来版权核验真伪
   */
  async verifyDciCertEx(request: VerifyDciCertRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<VerifyDciCertResponse> {
    Util.validateModel(request);
    return $tea.cast<VerifyDciCertResponse>(await this.doRequest("1.0", "blockchain.bccr.dci.cert.verify", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new VerifyDciCertResponse({}));
  }
   ...
   * Summary: 查询DCI凭证核验结果
   */
  async resultDciCert(request: ResultDciCertRequest): Promise<ResultDciCertResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.resultDciCertEx(request, headers, runtime);
  }
   ...
   * Summary: 查询DCI凭证核验结果
   */
  async resultDciCertEx(request: ResultDciCertRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<ResultDciCertResponse> {
    Util.validateModel(request);
    return $tea.cast<ResultDciCertResponse>(await this.doRequest("1.0", "blockchain.bccr.dci.cert.result", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new ResultDciCertResponse({}));
  }
   ...
   */
  async queryapplyformCopyrightregistrationDigitalregistration(request: QueryapplyformCopyrightregistrationDigitalregistrationRequest): Promise<QueryapplyformCopyrightregistrationDigitalregistrationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryapplyformCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
  }
   ...
   * Summary: 版权登记-数登申请-查询数登申请表
   */
  async queryapplyformCopyrightregistrationDigitalregistrationEx(request: QueryapplyformCopyrightregistrationDigitalregistrationRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryapplyformCopyrightregistrationDigitalregistrationResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryapplyformCopyrightregistrationDigitalregistrationResponse>(await this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.queryapplyform", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryapplyformCopyrightregistrationDigitalregistrationResponse({}));
  }
   ...
   */
  async queryautosealauthCopyrightregistrationDigitalregistration(request: QueryautosealauthCopyrightregistrationDigitalregistrationRequest): Promise<QueryautosealauthCopyrightregistrationDigitalregistrationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryautosealauthCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
  }
   ...
   * Summary: 查询当前数登申请是否支持静默签授权
   */
  async queryautosealauthCopyrightregistrationDigitalregistrationEx(request: QueryautosealauthCopyrightregistrationDigitalregistrationRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryautosealauthCopyrightregistrationDigitalregistrationResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryautosealauthCopyrightregistrationDigitalregistrationResponse>(await this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.queryautosealauth", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryautosealauthCopyrightregistrationDigitalregistrationResponse({}));
  }
   ...
   * Summary: 创建数登申请表签署流程
   */
  async createapplyformsealflowCopyrightregistrationDigitalregistration(request: CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest): Promise<CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.createapplyformsealflowCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
  }
   ...
   * Summary: 创建数登申请表签署流程
   */
  async createapplyformsealflowCopyrightregistrationDigitalregistrationEx(request: CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse>(await this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.createapplyformsealflow", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse({}));
  }
   ...
   * Summary: 获取签署链接
   */
  async queryapplyformsealurlCopyrightregistrationDigitalregistration(request: QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest): Promise<QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryapplyformsealurlCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
  }
   ...
   * Summary: 获取签署链接
   */
  async queryapplyformsealurlCopyrightregistrationDigitalregistrationEx(request: QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse>(await this.doRequest("1.0", "blockchain.bccr.copyrightregistration.digitalregistration.queryapplyformsealurl", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse({}));
  }
   ...
   * Summary: 完成数登表签署
   */
  async completeapplyformsealCopyrightregistrationDigitalregistration(request: CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest): Promise<CompleteapplyformsealCopyrightregistrationDigitalregistrationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.completeapplyformsealCopyrightregistrationDigitalregistrationEx(request, headers, runtime);
  }
   ...
   * Summary: 提交DCI凭证核验接口
   */
  async verifyDciCertificate(request: VerifyDciCertificateRequest): Promise<VerifyDciCertificateResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.verifyDciCertificateEx(request, headers, runtime);
  }
   ...
   * Summary: 提交DCI凭证核验接口
   */
  async verifyDciCertificateEx(request: VerifyDciCertificateRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<VerifyDciCertificateResponse> {
    Util.validateModel(request);
    return $tea.cast<VerifyDciCertificateResponse>(await this.doRequest("1.0", "blockchain.bccr.dci.certificate.verify", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new VerifyDciCertificateResponse({}));
  }
   ...
   */
  async queryDciCertificateresult(request: QueryDciCertificateresultRequest): Promise<QueryDciCertificateresultResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryDciCertificateresultEx(request, headers, runtime);
  }
