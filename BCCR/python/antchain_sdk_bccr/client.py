...
class Client:
    ...
    def verify_dci_cert(
        self,
        request: bccr_models.VerifyDciCertRequest,
    ) -> bccr_models.VerifyDciCertResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.verify_dci_cert_ex(request, headers, runtime)

    async def verify_dci_cert_async(
        self,
        request: bccr_models.VerifyDciCertRequest,
    ) -> bccr_models.VerifyDciCertResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.verify_dci_cert_ex_async(request, headers, runtime)

    def verify_dci_cert_ex(
        self,
        request: bccr_models.VerifyDciCertRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.VerifyDciCertResponse(),
            self.do_request('1.0', 'blockchain.bccr.dci.cert.verify', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def verify_dci_cert_ex_async(
        self,
        request: bccr_models.VerifyDciCertRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.VerifyDciCertResponse(),
            await self.do_request_async('1.0', 'blockchain.bccr.dci.cert.verify', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def result_dci_cert(
        self,
        request: bccr_models.ResultDciCertRequest,
    ) -> bccr_models.ResultDciCertResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.result_dci_cert_ex(request, headers, runtime)

    async def result_dci_cert_async(
        self,
        request: bccr_models.ResultDciCertRequest,
    ) -> bccr_models.ResultDciCertResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.result_dci_cert_ex_async(request, headers, runtime)

    def result_dci_cert_ex(
        self,
        request: bccr_models.ResultDciCertRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.ResultDciCertResponse(),
            self.do_request('1.0', 'blockchain.bccr.dci.cert.result', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def result_dci_cert_ex_async(
        self,
        request: bccr_models.ResultDciCertRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.ResultDciCertResponse(),
            await self.do_request_async('1.0', 'blockchain.bccr.dci.cert.result', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def queryapplyform_copyrightregistration_digitalregistration(
        self,
        request: bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.queryapplyform_copyrightregistration_digitalregistration_ex(request, headers, runtime)

    async def queryapplyform_copyrightregistration_digitalregistration_async(
        self,
        request: bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.queryapplyform_copyrightregistration_digitalregistration_ex_async(request, headers, runtime)

    def queryapplyform_copyrightregistration_digitalregistration_ex(
        self,
        request: bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationResponse(),
            self.do_request('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.queryapplyform', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def queryapplyform_copyrightregistration_digitalregistration_ex_async(
        self,
        request: bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.QueryapplyformCopyrightregistrationDigitalregistrationResponse(),
            await self.do_request_async('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.queryapplyform', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def queryautosealauth_copyrightregistration_digitalregistration(
        self,
        request: bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.queryautosealauth_copyrightregistration_digitalregistration_ex(request, headers, runtime)

    async def queryautosealauth_copyrightregistration_digitalregistration_async(
        self,
        request: bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.queryautosealauth_copyrightregistration_digitalregistration_ex_async(request, headers, runtime)

    def queryautosealauth_copyrightregistration_digitalregistration_ex(
        self,
        request: bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationResponse(),
            self.do_request('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.queryautosealauth', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def queryautosealauth_copyrightregistration_digitalregistration_ex_async(
        self,
        request: bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.QueryautosealauthCopyrightregistrationDigitalregistrationResponse(),
            await self.do_request_async('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.queryautosealauth', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def createapplyformsealflow_copyrightregistration_digitalregistration(
        self,
        request: bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.createapplyformsealflow_copyrightregistration_digitalregistration_ex(request, headers, runtime)

    async def createapplyformsealflow_copyrightregistration_digitalregistration_async(
        self,
        request: bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.createapplyformsealflow_copyrightregistration_digitalregistration_ex_async(request, headers, runtime)

    def createapplyformsealflow_copyrightregistration_digitalregistration_ex(
        self,
        request: bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse(),
            self.do_request('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.createapplyformsealflow', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def createapplyformsealflow_copyrightregistration_digitalregistration_ex_async(
        self,
        request: bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.CreateapplyformsealflowCopyrightregistrationDigitalregistrationResponse(),
            await self.do_request_async('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.createapplyformsealflow', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def queryapplyformsealurl_copyrightregistration_digitalregistration(
        self,
        request: bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse:
        """
        Description: 获取签署链接
        Summary: 获取签署链接
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.queryapplyformsealurl_copyrightregistration_digitalregistration_ex(request, headers, runtime)

    async def queryapplyformsealurl_copyrightregistration_digitalregistration_async(
        self,
        request: bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.queryapplyformsealurl_copyrightregistration_digitalregistration_ex_async(request, headers, runtime)

    def queryapplyformsealurl_copyrightregistration_digitalregistration_ex(
        self,
        request: bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse(),
            self.do_request('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.queryapplyformsealurl', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def queryapplyformsealurl_copyrightregistration_digitalregistration_ex_async(
        self,
        request: bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.QueryapplyformsealurlCopyrightregistrationDigitalregistrationResponse(),
            await self.do_request_async('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.queryapplyformsealurl', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def completeapplyformseal_copyrightregistration_digitalregistration(
        self,
        request: bccr_models.CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.completeapplyformseal_copyrightregistration_digitalregistration_ex(request, headers, runtime)

    async def completeapplyformseal_copyrightregistration_digitalregistration_async(
        self,
        request: bccr_models.CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest,
    ) -> bccr_models.CompleteapplyformsealCopyrightregistrationDigitalregistrationResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.completeapplyformseal_copyrightregistration_digitalregistration_ex_async(request, headers, runtime)

    def completeapplyformseal_copyrightregistration_digitalregistration_ex(
        self,
        request: bccr_models.CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.CompleteapplyformsealCopyrightregistrationDigitalregistrationResponse(),
            self.do_request('1.0', 'blockchain.bccr.copyrightregistration.digitalregistration.completeapplyformseal', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def completeapplyformseal_copyrightregistration_digitalregistration_ex_async(
        self,
        request: bccr_models.CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    def verify_dci_certificate(
        self,
        request: bccr_models.VerifyDciCertificateRequest,
    ) -> bccr_models.VerifyDciCertificateResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.verify_dci_certificate_ex(request, headers, runtime)

    async def verify_dci_certificate_async(
        self,
        request: bccr_models.VerifyDciCertificateRequest,
    ) -> bccr_models.VerifyDciCertificateResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.verify_dci_certificate_ex_async(request, headers, runtime)

    def verify_dci_certificate_ex(
        self,
        request: bccr_models.VerifyDciCertificateRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.VerifyDciCertificateResponse(),
            self.do_request('1.0', 'blockchain.bccr.dci.certificate.verify', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def verify_dci_certificate_ex_async(
        self,
        request: bccr_models.VerifyDciCertificateRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.VerifyDciCertificateResponse(),
            await self.do_request_async('1.0', 'blockchain.bccr.dci.certificate.verify', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def query_dci_certificateresult(
        self,
        request: bccr_models.QueryDciCertificateresultRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_dci_certificateresult_ex(request, headers, runtime)

    async def query_dci_certificateresult_async(
        self,
        request: bccr_models.QueryDciCertificateresultRequest,
    ) -> bccr_models.QueryDciCertificateresultResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_dci_certificateresult_ex_async(request, headers, runtime)

    def query_dci_certificateresult_ex(
        self,
        request: bccr_models.QueryDciCertificateresultRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            bccr_models.QueryDciCertificateresultResponse(),
            self.do_request('1.0', 'blockchain.bccr.dci.certificateresult.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_dci_certificateresult_ex_async(
        self,
        request: bccr_models.QueryDciCertificateresultRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
