...
class QueryautosealauthCopyrightregistrationDigitalregistrationRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return QueryautosealauthCopyrightregistrationDigitalregistrationRequest
     */
