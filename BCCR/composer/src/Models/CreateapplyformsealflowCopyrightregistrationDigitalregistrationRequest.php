...
class CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return CreateapplyformsealflowCopyrightregistrationDigitalregistrationRequest
     */
