...
class CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return CompleteapplyformsealCopyrightregistrationDigitalregistrationRequest
     */
