...
class QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return QueryapplyformsealurlCopyrightregistrationDigitalregistrationRequest
     */
