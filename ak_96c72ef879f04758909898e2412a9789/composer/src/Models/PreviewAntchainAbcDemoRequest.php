...
class PreviewAntchainAbcDemoRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateMaximum('inputNumber', $this->inputNumber, 10000);
        Model::validateMinimum('inputNumber', $this->inputNumber, 10);
     ...
     * @param array $map
     *
     * @return PreviewAntchainAbcDemoRequest
     */
