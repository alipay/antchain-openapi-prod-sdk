...
using AntChain.SDK.INTELLIDOCTOR.Models;

namespace AntChain.SDK.INTELLIDOCTOR
{
    public class Client 
    {
        ...
        public QueryKnowledgeagentSseResponse QueryKnowledgeagentSse(QueryKnowledgeagentSseRequest request)
        {
            ...
            return QueryKnowledgeagentSseEx(request, headers, runtime);
        }
        ...
        public async Task<QueryKnowledgeagentSseResponse> QueryKnowledgeagentSseAsync(QueryKnowledgeagentSseRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryKnowledgeagentSseExAsync(request, headers, runtime);
        }
        ...
        public QueryKnowledgeagentSseResponse QueryKnowledgeagentSseEx(QueryKnowledgeagentSseRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<QueryKnowledgeagentSseResponse>(DoRequest("1.0", "antdigital.intellidoctor.knowledgeagent.sse.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryKnowledgeagentSseResponse>(await DoRequestAsync("1.0", "antdigital.intellidoctor.knowledgeagent.sse.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
