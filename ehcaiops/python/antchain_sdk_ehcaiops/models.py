...
class ImportCloudLogRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        bus_code: str = None,
    ...
    def validate(self):
        self.validate_required(self.bus_code, 'bus_code')
        self.validate_required(self.scene_code, 'scene_code')
        self.validate_required(self.log_message, 'log_message')
    ...
    def to_map(self):
        ...
        if self.bus_code is not None:
            result['bus_code'] = self.bus_code
        if self.scene_code is not None:
            result['scene_code'] = self.scene_code
        if self.log_message is not None:
            result['log_message'] = self.log_message
        if self.batch_import is not None:
            result['batch_import'] = self.batch_import
        if self.element_separator is not None:
            result['element_separator'] = self.element_separator
        if self.line_separator is not None:
            result['line_separator'] = self.line_separator
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('bus_code') is not None:
            self.bus_code = m.get('bus_code')
        if m.get('scene_code') is not None:
            self.scene_code = m.get('scene_code')
        if m.get('log_message') is not None:
            self.log_message = m.get('log_message')
        if m.get('batch_import') is not None:
            self.batch_import = m.get('batch_import')
        if m.get('element_separator') is not None:
            self.element_separator = m.get('element_separator')
        if m.get('line_separator') is not None:
            self.line_separator = m.get('line_separator')
        return self


class ImportCloudLogResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class UploadLogFileRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
    ...
    def validate(self):
        ...
        self.validate_required(self.bus_code, 'bus_code')
        self.validate_required(self.scene_code, 'scene_code')
        self.validate_required(self.element_separator, 'element_separator')
...
class UploadLogFileResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
