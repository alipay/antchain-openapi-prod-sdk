...
namespace AntChain\Ak_c9451c6c245a4916872e1ef807fb9aed;
...
use AntChain\Ak_c9451c6c245a4916872e1ef807fb9aed\Models\StatusDemoGatewayCheckRequest;
use AntChain\Ak_c9451c6c245a4916872e1ef807fb9aed\Models\StatusDemoGatewayCheckResponse;
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->query    = [
                    ...
                    'sdk_version'      => '1.0.0',
                    '_prod_code'       => 'ak_c9451c6c245a4916872e1ef807fb9aed',
                    '_prod_channel'    => 'saas',
                ];
