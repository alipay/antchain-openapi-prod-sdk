...
class QueryAntcloudBxptnewDatapromotionDecisionRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
...
class QueryAntcloudBxptnewDatapromotionDecisionResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
...
class PushAntcloudBxptnewDatapromotionTrafficRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
        insurer_code: str = None,
...
class PushAntcloudBxptnewDatapromotionTrafficResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
        result_code: str = None,
