...
public class HoldassetAntdigitalWebtrwatradeFundchannelTxnRequest extends TeaModel {
    // OAuth模式下的授权token
    ...
    public HoldassetAntdigitalWebtrwatradeFundchannelTxnRequest setAuthToken(String authToken) {
    ...
    public HoldassetAntdigitalWebtrwatradeFundchannelTxnRequest setProductInstanceId(String productInstanceId) {
