...
export class QueryAntdigitalDtaiagtMarketRichdetailRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
...
export class QueryAntdigitalDtaiagtMarketRichdetailResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export default class Client {
   ...
   * Summary: 通用市场列表查询
   */
  async queryAntdigitalDtaiagtMarketRichdetail(request: QueryAntdigitalDtaiagtMarketRichdetailRequest): Promise<QueryAntdigitalDtaiagtMarketRichdetailResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryAntdigitalDtaiagtMarketRichdetailEx(request, headers, runtime);
  }
   ...
   * Summary: 通用市场列表查询
   */
  async queryAntdigitalDtaiagtMarketRichdetailEx(request: QueryAntdigitalDtaiagtMarketRichdetailRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryAntdigitalDtaiagtMarketRichdetailResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryAntdigitalDtaiagtMarketRichdetailResponse>(await this.doRequest("1.0", "antdigital.dtaiagt.market.richdetail.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryAntdigitalDtaiagtMarketRichdetailResponse({}));
  }
