...
class EducationInfo extends Model
{
    ...
    {
        Model::validateRequired('project211', $this->project211, true);
        Model::validateRequired('project985', $this->project985, true);
        Model::validateRequired('doubleFirstClass', $this->doubleFirstClass, true);
        Model::validateRequired('major', $this->major, true);
        Model::validateRequired('educationLevel', $this->educationLevel, true);
        Model::validateRequired('graduationDate', $this->graduationDate, true);
        Model::validateRequired('educationType', $this->educationType, true);
    }
