...
PACKAGE = "antchain_sdk_intellicar"
NAME = "antchain_intellicar" or "alibabacloud-package"
DESCRIPTION = "Ant Chain INTELLICAR SDK Library for Python"
AUTHOR = "Ant Chain SDK"
