...
public class QueryRuleResponse extends TeaModel {
    ...
    public QueryRuleResponse setReqMsgId(String reqMsgId) {
    ...
    public QueryRuleResponse setResultCode(String resultCode) {
    ...
    public QueryRuleResponse setResultMsg(String resultMsg) {
