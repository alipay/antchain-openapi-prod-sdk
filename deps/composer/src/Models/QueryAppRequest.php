...
class QueryAppRequest extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->noneAppGroup) {
            $res['none_app_group'] = $this->noneAppGroup;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['none_app_group'])) {
            $model->noneAppGroup = $map['none_app_group'];
        }
