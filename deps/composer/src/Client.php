...
use AntChain\Deps\Models\AllCmdtemplateRequest;
use AntChain\Deps\Models\AllCmdtemplateResponse;
use AntChain\Deps\Models\ApplyPlanRequest;
use AntChain\Deps\Models\ApplyPlanResponse;
...
use AntChain\Deps\Models\BindCmdtemplateRequest;
use AntChain\Deps\Models\BindCmdtemplateResponse;
use AntChain\Deps\Models\BindCustomflowtemplateRequest;
use AntChain\Deps\Models\BindCustomflowtemplateResponse;
...
use AntChain\Deps\Models\CreateCmdtemplateRequest;
use AntChain\Deps\Models\CreateCmdtemplateResponse;
use AntChain\Deps\Models\CreateCmdtemplateVersionRequest;
use AntChain\Deps\Models\CreateCmdtemplateVersionResponse;
...
use AntChain\Deps\Models\CreateCustomflowtemplateRequest;
use AntChain\Deps\Models\CreateCustomflowtemplateResponse;
...
use AntChain\Deps\Models\DeleteCmdtemplateRequest;
use AntChain\Deps\Models\DeleteCmdtemplateResponse;
...
use AntChain\Deps\Models\DeleteCustomflowtemplateRequest;
use AntChain\Deps\Models\DeleteCustomflowtemplateResponse;
...
use AntChain\Deps\Models\GetCustomflowtemplateRequest;
use AntChain\Deps\Models\GetCustomflowtemplateResponse;
...
use AntChain\Deps\Models\GetOptestRequest;
use AntChain\Deps\Models\GetOptestResponse;
...
use AntChain\Deps\Models\QueryCmdtemplateBindRequest;
use AntChain\Deps\Models\QueryCmdtemplateBindResponse;
use AntChain\Deps\Models\QueryCmdtemplateRequest;
use AntChain\Deps\Models\QueryCmdtemplateResponse;
use AntChain\Deps\Models\QueryCmdtemplateVersionsRequest;
use AntChain\Deps\Models\QueryCmdtemplateVersionsResponse;
...
use AntChain\Deps\Models\QueryCustomflowtemplateBindRequest;
use AntChain\Deps\Models\QueryCustomflowtemplateBindResponse;
use AntChain\Deps\Models\QueryCustomflowtemplateRequest;
use AntChain\Deps\Models\QueryCustomflowtemplateResponse;
use AntChain\Deps\Models\QueryCustomflowtemplateSummaryRequest;
use AntChain\Deps\Models\QueryCustomflowtemplateSummaryResponse;
...
use AntChain\Deps\Models\UpdateCmdtemplateRequest;
use AntChain\Deps\Models\UpdateCmdtemplateResponse;
...
use AntChain\Deps\Models\UpdateCustomflowtemplateRequest;
use AntChain\Deps\Models\UpdateCustomflowtemplateResponse;
...
class Client
{
     ...
     * Summary: 部署单提交审批申请.
     *
     * @param ApplyPlanRequest $request
     *
     * @return ApplyPlanResponse
     */
    public function applyPlan($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return ApplyPlanResponse
     */
    public function applyPlanEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return ApplyPlanResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.plan.apply', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     *
     * @param GetOptestRequest $request
     *
     * @return GetOptestResponse
     */
    public function getOptest($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return GetOptestResponse
     */
    public function getOptestEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return GetOptestResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.optest.get', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 查询流程模版概要
     *
     * @param QueryCustomflowtemplateSummaryRequest $request
     *
     * @return QueryCustomflowtemplateSummaryResponse
     */
    public function queryCustomflowtemplateSummary($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryCustomflowtemplateSummaryResponse
     */
    public function queryCustomflowtemplateSummaryEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return QueryCustomflowtemplateSummaryResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.summary.query', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 创建指令模板
     *
     * @param CreateCmdtemplateRequest $request
     *
     * @return CreateCmdtemplateResponse
     */
    public function createCmdtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return CreateCmdtemplateResponse
     */
    public function createCmdtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return CreateCmdtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.create', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 删除指令模板
     *
     * @param DeleteCmdtemplateRequest $request
     *
     * @return DeleteCmdtemplateResponse
     */
    public function deleteCmdtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return DeleteCmdtemplateResponse
     */
    public function deleteCmdtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return DeleteCmdtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.delete', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 更新指令模板
     *
     * @param UpdateCmdtemplateRequest $request
     *
     * @return UpdateCmdtemplateResponse
     */
    public function updateCmdtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return UpdateCmdtemplateResponse
     */
    public function updateCmdtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return UpdateCmdtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.update', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 指令模板授权.
     *
     * @param BindCmdtemplateRequest $request
     *
     * @return BindCmdtemplateResponse
     */
    public function bindCmdtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return BindCmdtemplateResponse
     */
    public function bindCmdtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return BindCmdtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.bind', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 查询流程模板
     *
     * @param QueryCustomflowtemplateRequest $request
     *
     * @return QueryCustomflowtemplateResponse
     */
    public function queryCustomflowtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryCustomflowtemplateResponse
     */
    public function queryCustomflowtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return QueryCustomflowtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.query', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 查询流程模板详情.
     *
     * @param GetCustomflowtemplateRequest $request
     *
     * @return GetCustomflowtemplateResponse
     */
    public function getCustomflowtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return GetCustomflowtemplateResponse
     */
    public function getCustomflowtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return GetCustomflowtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.get', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 创建流程模板
     *
     * @param CreateCustomflowtemplateRequest $request
     *
     * @return CreateCustomflowtemplateResponse
     */
    public function createCustomflowtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return CreateCustomflowtemplateResponse
     */
    public function createCustomflowtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return CreateCustomflowtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.create', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 编辑流程模板
     *
     * @param UpdateCustomflowtemplateRequest $request
     *
     * @return UpdateCustomflowtemplateResponse
     */
    public function updateCustomflowtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return UpdateCustomflowtemplateResponse
     */
    public function updateCustomflowtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return UpdateCustomflowtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.update', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 删除流程模板
     *
     * @param DeleteCustomflowtemplateRequest $request
     *
     * @return DeleteCustomflowtemplateResponse
     */
    public function deleteCustomflowtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return DeleteCustomflowtemplateResponse
     */
    public function deleteCustomflowtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return DeleteCustomflowtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.delete', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 流程模板授权.
     *
     * @param BindCustomflowtemplateRequest $request
     *
     * @return BindCustomflowtemplateResponse
     */
    public function bindCustomflowtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return BindCustomflowtemplateResponse
     */
    public function bindCustomflowtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return BindCustomflowtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.bind', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 流程模板授权查询.
     *
     * @param QueryCustomflowtemplateBindRequest $request
     *
     * @return QueryCustomflowtemplateBindResponse
     */
    public function queryCustomflowtemplateBind($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryCustomflowtemplateBindResponse
     */
    public function queryCustomflowtemplateBindEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return QueryCustomflowtemplateBindResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.customflowtemplate.bind.query', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 指令模板授权查询.
     *
     * @param QueryCmdtemplateBindRequest $request
     *
     * @return QueryCmdtemplateBindResponse
     */
    public function queryCmdtemplateBind($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryCmdtemplateBindResponse
     */
    public function queryCmdtemplateBindEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return QueryCmdtemplateBindResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.bind.query', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 指令模板版本查询.
     *
     * @param QueryCmdtemplateVersionsRequest $request
     *
     * @return QueryCmdtemplateVersionsResponse
     */
    public function queryCmdtemplateVersions($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return QueryCmdtemplateVersionsResponse
     */
    public function queryCmdtemplateVersionsEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return QueryCmdtemplateVersionsResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.versions.query', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 指令模板版本创建.
     *
     * @param CreateCmdtemplateVersionRequest $request
     *
     * @return CreateCmdtemplateVersionResponse
     */
    public function createCmdtemplateVersion($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return CreateCmdtemplateVersionResponse
     */
    public function createCmdtemplateVersionEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return CreateCmdtemplateVersionResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.version.create', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
     ...
     * Summary: 指令模板分页查询.
     *
     * @param AllCmdtemplateRequest $request
     *
     * @return AllCmdtemplateResponse
     */
    public function allCmdtemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @return AllCmdtemplateResponse
     */
    public function allCmdtemplateEx($request, $headers, $runtime)
    {
        Utils::validateModel($request);

        return AllCmdtemplateResponse::fromMap($this->doRequest('1.0', 'antcloud.deps.cmdtemplate.all', 'HTTPS', 'POST', '/gateway.do', Tea::merge($request), $headers, $runtime));
    }
