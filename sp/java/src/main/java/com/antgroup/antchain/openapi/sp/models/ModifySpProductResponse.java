...
public class ModifySpProductResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public ModifySpProductResponse setReqMsgId(String reqMsgId) {
    ...
    public ModifySpProductResponse setResultCode(String resultCode) {
    ...
    public ModifySpProductResponse setResultMsg(String resultMsg) {
