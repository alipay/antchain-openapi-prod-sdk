...
class FaceFaceauthInitializeResponse extends Model
{
    // 请求唯一ID，用于链路跟踪和问题排查
    /**
     * @var string
    ...
    public function validate()
    {
        ...
        Model::validateRequired('resultCodeSub', $this->resultCodeSub, true);
        Model::validateRequired('resultMsgSub', $this->resultMsgSub, true);
