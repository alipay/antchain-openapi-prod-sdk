...
namespace AntChain\Ak_55afdde95cc7448bad87a98d904c1f44;
...
class Client
{
     ...
     * Summary: 数字人交互接口.
     *
     * @param QueryUniversalsaasDigitalhumanRobotRequest $request
     *
     * @return QueryUniversalsaasDigitalhumanRobotResponse
     */
    public function queryUniversalsaasDigitalhumanRobot($request)
    {
     ...
     * @return QueryUniversalsaasDigitalhumanRobotResponse
     */
    public function queryUniversalsaasDigitalhumanRobotEx($request, $headers, $runtime)
    {
