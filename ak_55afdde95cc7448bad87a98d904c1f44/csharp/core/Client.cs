...
using AntChain.SDK.Ak_55afdde95cc7448bad87a98d904c1f44.Models;

namespace AntChain.SDK.Ak_55afdde95cc7448bad87a98d904c1f44
{
    public class Client 
    {
         ...
         * Summary: 数字人交互接口
         */
        public QueryUniversalsaasDigitalhumanRobotResponse QueryUniversalsaasDigitalhumanRobot(QueryUniversalsaasDigitalhumanRobotRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return QueryUniversalsaasDigitalhumanRobotEx(request, headers, runtime);
        }
         ...
         * Summary: 数字人交互接口
         */
        public async Task<QueryUniversalsaasDigitalhumanRobotResponse> QueryUniversalsaasDigitalhumanRobotAsync(QueryUniversalsaasDigitalhumanRobotRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await QueryUniversalsaasDigitalhumanRobotExAsync(request, headers, runtime);
        }
         ...
         * Summary: 数字人交互接口
         */
        public QueryUniversalsaasDigitalhumanRobotResponse QueryUniversalsaasDigitalhumanRobotEx(QueryUniversalsaasDigitalhumanRobotRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryUniversalsaasDigitalhumanRobotResponse>(DoRequest("1.0", "universalsaas.digitalhuman.robot.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
         ...
         * Summary: 数字人交互接口
         */
        public async Task<QueryUniversalsaasDigitalhumanRobotResponse> QueryUniversalsaasDigitalhumanRobotExAsync(QueryUniversalsaasDigitalhumanRobotRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
