...
export class QueryUniversalsaasDigitalhumanRobotRequest extends $tea.Model {
  // OAuth模式下的授权token
  authToken?: string;
...
export class QueryUniversalsaasDigitalhumanRobotResponse extends $tea.Model {
  // 请求唯一ID，用于链路跟踪和问题排查
  reqMsgId?: string;
  // 结果码，一般OK表示调用成功
  resultCode?: string;
...
export default class Client {
   ...
   * Summary: 数字人交互接口
   */
  async queryUniversalsaasDigitalhumanRobot(request: QueryUniversalsaasDigitalhumanRobotRequest): Promise<QueryUniversalsaasDigitalhumanRobotResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    let headers : {[key: string ]: string} = { };
    return await this.queryUniversalsaasDigitalhumanRobotEx(request, headers, runtime);
  }
