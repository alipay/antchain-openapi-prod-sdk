...
package com.antgroup.antchain.openapi.ak_55afdde95cc7448bad87a98d904c1f44;

import com.aliyun.tea.*;
import com.antgroup.antchain.openapi.ak_55afdde95cc7448bad87a98d904c1f44.models.*;
...
public class Client {
     ...
     * Summary: 数字人交互接口
     */
    public QueryUniversalsaasDigitalhumanRobotResponse queryUniversalsaasDigitalhumanRobot(QueryUniversalsaasDigitalhumanRobotRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryUniversalsaasDigitalhumanRobotEx(request, headers, runtime);
    }
