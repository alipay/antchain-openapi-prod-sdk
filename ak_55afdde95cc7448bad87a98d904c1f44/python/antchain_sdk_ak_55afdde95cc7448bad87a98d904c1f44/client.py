...
from antchain_sdk_ak_55afdde95cc7448bad87a98d904c1f44 import models as ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models
...
class Client:
    ...
    def __init__(
        self, 
        config: ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models.Config,
    ):
        """
    ...
    def query_universalsaas_digitalhuman_robot(
        self,
        request: ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models.QueryUniversalsaasDigitalhumanRobotRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_universalsaas_digitalhuman_robot_ex(request, headers, runtime)

    async def query_universalsaas_digitalhuman_robot_async(
        self,
        request: ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models.QueryUniversalsaasDigitalhumanRobotRequest,
    ) -> ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models.QueryUniversalsaasDigitalhumanRobotResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_universalsaas_digitalhuman_robot_ex_async(request, headers, runtime)

    def query_universalsaas_digitalhuman_robot_ex(
        self,
        request: ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models.QueryUniversalsaasDigitalhumanRobotRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models.QueryUniversalsaasDigitalhumanRobotResponse(),
            self.do_request('1.0', 'universalsaas.digitalhuman.robot.query', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def query_universalsaas_digitalhuman_robot_ex_async(
        self,
        request: ak__55afdde_95cc_7448bad_87a_98d_904c_1f_44_models.QueryUniversalsaasDigitalhumanRobotRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
