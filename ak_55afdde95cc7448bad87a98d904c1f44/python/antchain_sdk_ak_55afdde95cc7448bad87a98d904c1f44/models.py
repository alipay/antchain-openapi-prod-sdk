...
class QueryUniversalsaasDigitalhumanRobotRequest(TeaModel):
    def __init__(
        self,
        auth_token: str = None,
    ...
    def validate(self):
        self.validate_required(self.target_method, 'target_method')
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('target_method') is not None:
            self.target_method = m.get('target_method')
        if m.get('tenant_code') is not None:
            self.tenant_code = m.get('tenant_code')
        if m.get('method_params') is not None:
            self.method_params = m.get('method_params')
        return self


class QueryUniversalsaasDigitalhumanRobotResponse(TeaModel):
    def __init__(
        self,
        req_msg_id: str = None,
