...
using AntChain.SDK.Ak_50eaf604cdf649e99d6b6d4d6525a52f.Models;

namespace AntChain.SDK.Ak_50eaf604cdf649e99d6b6d4d6525a52f
{
    public class Client 
    {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    request_.Query = new Dictionary<string, string>
                    {
                        ...
                        {"sdk_version", "1.0.0"},
                        {"_prod_code", "ak_50eaf604cdf649e99d6b6d4d6525a52f"},
                        {"_prod_channel", "saas"},
                    };
