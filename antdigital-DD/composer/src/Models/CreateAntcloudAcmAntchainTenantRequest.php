...
class CreateAntcloudAcmAntchainTenantRequest extends Model {
    protected $_name = [
    ...
    public function toMap() {
        ...
        if (null !== $this->registerArea) {
            $res['register_area'] = $this->registerArea;
        }
        return $res;
    }
    /**
     * @param array $map
     * @return CreateAntcloudAcmAntchainTenantRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['register_area'])){
            $model->registerArea = $map['register_area'];
        }
        return $model;
    }
    // OAuth模式下的授权token
