...
class OfferSyncCommonBuyInfo extends Model {
    protected $_name = [
    ...
    public function validate() {
        ...
        Model::validateRequired('offerAttrConstraintsListJson', $this->offerAttrConstraintsListJson, true);
    ...
    public function toMap() {
        ...
        if (null !== $this->offerAttrConstraintsListJson) {
            $res['offer_attr_constraints_list_json'] = $this->offerAttrConstraintsListJson;
        }
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['offer_attr_constraints_list_json'])){
            if(!empty($map['offer_attr_constraints_list_json'])){
                $model->offerAttrConstraintsListJson = $map['offer_attr_constraints_list_json'];
            }
        }
     ...
     * @var string[]
     */
    public $offerAttrConstraintsListJson;
