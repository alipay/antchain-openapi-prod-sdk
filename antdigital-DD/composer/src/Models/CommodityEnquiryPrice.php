...
class CommodityEnquiryPrice extends Model {
    ...
    public function toMap() {
        ...
        if (null !== $this->payAmountBeforeGst) {
            $res['pay_amount_before_gst'] = $this->payAmountBeforeGst;
        }
        if (null !== $this->payAmountOfGst) {
            $res['pay_amount_of_gst'] = $this->payAmountOfGst;
        }
        return $res;
    }
    /**
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['pay_amount_before_gst'])){
            $model->payAmountBeforeGst = $map['pay_amount_before_gst'];
        }
        if(isset($map['pay_amount_of_gst'])){
            $model->payAmountOfGst = $map['pay_amount_of_gst'];
        }
        return $model;
    }
    // 商品主数据编码
