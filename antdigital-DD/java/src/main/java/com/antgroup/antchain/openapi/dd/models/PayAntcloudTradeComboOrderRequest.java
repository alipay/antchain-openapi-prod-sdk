...
public class PayAntcloudTradeComboOrderRequest extends TeaModel {
    // OAuth模式下的授权token
    ...
    public PayAntcloudTradeComboOrderRequest setAuthToken(String authToken) {
    ...
    public PayAntcloudTradeComboOrderRequest setComboOrderId(String comboOrderId) {
    ...
    public PayAntcloudTradeComboOrderRequest setPayChannel(String payChannel) {
    ...
    public PayAntcloudTradeComboOrderRequest setPayMode(String payMode) {
    ...
    public PayAntcloudTradeComboOrderRequest setPayReturnUrl(String payReturnUrl) {
