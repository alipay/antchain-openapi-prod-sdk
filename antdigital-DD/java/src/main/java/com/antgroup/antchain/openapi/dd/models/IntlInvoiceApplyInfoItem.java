...
public class IntlInvoiceApplyInfoItem extends TeaModel {
    ...
    public IntlInvoiceApplyInfoItem setInvoiceType(String invoiceType) {
    ...
    public IntlInvoiceApplyInfoItem setApplyType(String applyType) {
    ...
    public IntlInvoiceApplyInfoItem setElcFileMap(String elcFileMap) {
        this.elcFileMap = elcFileMap;
        return this;
    }
    public String getElcFileMap() {
        return this.elcFileMap;
    }
