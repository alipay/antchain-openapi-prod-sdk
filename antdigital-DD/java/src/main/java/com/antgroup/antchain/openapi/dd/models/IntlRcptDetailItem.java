...
public class IntlRcptDetailItem extends TeaModel {
    ...
    @Validation(required = true)
    public String rcptContractAmtExclTax;
    ...
    @Validation(required = true)
    public String reptInvedAmtExclTax;
    ...
    @Validation(required = true)
    public String rcptContractRemainAmtExclTax;
    ...
    public IntlRcptDetailItem setRcptContractAmtExclTax(String rcptContractAmtExclTax) {
        this.rcptContractAmtExclTax = rcptContractAmtExclTax;
        return this;
    }
    public String getRcptContractAmtExclTax() {
        return this.rcptContractAmtExclTax;
    }

    public IntlRcptDetailItem setReptInvedAmtExclTax(String reptInvedAmtExclTax) {
        this.reptInvedAmtExclTax = reptInvedAmtExclTax;
        return this;
    }
    public String getReptInvedAmtExclTax() {
        return this.reptInvedAmtExclTax;
    }

    public IntlRcptDetailItem setRcptContractRemainAmtExclTax(String rcptContractRemainAmtExclTax) {
        this.rcptContractRemainAmtExclTax = rcptContractRemainAmtExclTax;
        return this;
    }
    public String getRcptContractRemainAmtExclTax() {
        return this.rcptContractRemainAmtExclTax;
    }
