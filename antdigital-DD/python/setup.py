...
PACKAGE = "antchain_sdk_dd"
NAME = 'antchain_antdigital_dd' or "alibabacloud-package"
DESCRIPTION = "Ant Chain DD SDK Library for Python"
AUTHOR = "Ant Chain SDK"
