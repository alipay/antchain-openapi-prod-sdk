...
from antchain_sdk_corlab import models as corlab_models
...
class Client:
    ...
    def recognize_model(
        self,
        request: corlab_models.RecognizeModelRequest,
    ) -> corlab_models.RecognizeModelResponse:
        """
        Description: 单次模型预测
        Summary: 模型预测
        """
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.recognize_model_ex(request, headers, runtime)

    async def recognize_model_async(
        self,
        request: corlab_models.RecognizeModelRequest,
    ) -> corlab_models.RecognizeModelResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.recognize_model_ex_async(request, headers, runtime)

    def recognize_model_ex(
        self,
        request: corlab_models.RecognizeModelRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            corlab_models.RecognizeModelResponse(),
            self.do_request('1.0', 'antdigital.corlab.model.recognize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def recognize_model_ex_async(
        self,
        request: corlab_models.RecognizeModelRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            corlab_models.RecognizeModelResponse(),
            await self.do_request_async('1.0', 'antdigital.corlab.model.recognize', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    def add_model_task(
        self,
        request: corlab_models.AddModelTaskRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.add_model_task_ex(request, headers, runtime)

    async def add_model_task_async(
        self,
        request: corlab_models.AddModelTaskRequest,
    ) -> corlab_models.AddModelTaskResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.add_model_task_ex_async(request, headers, runtime)

    def add_model_task_ex(
        self,
        request: corlab_models.AddModelTaskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            corlab_models.AddModelTaskResponse(),
            self.do_request('1.0', 'antdigital.corlab.model.task.add', 'HTTPS', 'POST', f'/gateway.do', TeaCore.to_map(request), headers, runtime)
        )

    async def add_model_task_ex_async(
        self,
        request: corlab_models.AddModelTaskRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
