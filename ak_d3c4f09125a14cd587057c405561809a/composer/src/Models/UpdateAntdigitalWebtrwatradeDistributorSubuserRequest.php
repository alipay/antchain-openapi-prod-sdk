...
class UpdateAntdigitalWebtrwatradeDistributorSubuserRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
    ...
    public function toMap()
    {
        ...
        if (null !== $this->loginAccountSwitch) {
            $res['login_account_switch'] = $this->loginAccountSwitch;
        }
        if (null !== $this->name) {
            $res['name'] = $this->name;
        }
     ...
     * @param array $map
     *
     * @return UpdateAntdigitalWebtrwatradeDistributorSubuserRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['login_account_switch'])) {
            $model->loginAccountSwitch = $map['login_account_switch'];
        }
        if (isset($map['name'])) {
            $model->name = $map['name'];
        }
