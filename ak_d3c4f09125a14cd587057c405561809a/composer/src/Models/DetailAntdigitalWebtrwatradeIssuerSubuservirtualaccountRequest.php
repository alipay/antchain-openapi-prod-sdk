...
class DetailAntdigitalWebtrwatradeIssuerSubuservirtualaccountRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
     ...
     * @param array $map
     *
     * @return DetailAntdigitalWebtrwatradeIssuerSubuservirtualaccountRequest
     */
