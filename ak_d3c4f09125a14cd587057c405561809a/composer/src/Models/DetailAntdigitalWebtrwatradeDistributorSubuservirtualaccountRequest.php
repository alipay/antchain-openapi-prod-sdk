...
class DetailAntdigitalWebtrwatradeDistributorSubuservirtualaccountRequest extends Model
{
    // OAuth模式下的授权token
    /**
     * @var string
     ...
     * @var string
     */
    public $virtualAccountLoginName;

    // 虚拟子账号登录名类型(EMAIL)
    /**
     * @var string
     */
    public $virtualAccountLoginAccountType;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->virtualAccountLoginName) {
            $res['virtual_account_login_name'] = $this->virtualAccountLoginName;
        }
        if (null !== $this->virtualAccountLoginAccountType) {
            $res['virtual_account_login_account_type'] = $this->virtualAccountLoginAccountType;
        }
     ...
     * @param array $map
     *
     * @return DetailAntdigitalWebtrwatradeDistributorSubuservirtualaccountRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['virtual_account_login_name'])) {
            $model->virtualAccountLoginName = $map['virtual_account_login_name'];
        }
        if (isset($map['virtual_account_login_account_type'])) {
            $model->virtualAccountLoginAccountType = $map['virtual_account_login_account_type'];
        }
