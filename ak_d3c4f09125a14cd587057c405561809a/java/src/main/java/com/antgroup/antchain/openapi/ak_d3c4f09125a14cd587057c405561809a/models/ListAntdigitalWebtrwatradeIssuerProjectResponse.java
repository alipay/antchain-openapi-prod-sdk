...
public class ListAntdigitalWebtrwatradeIssuerProjectResponse extends TeaModel {
    // 请求唯一ID，用于链路跟踪和问题排查
    ...
    public ListAntdigitalWebtrwatradeIssuerProjectResponse setReqMsgId(String reqMsgId) {
    ...
    public ListAntdigitalWebtrwatradeIssuerProjectResponse setResultCode(String resultCode) {
    ...
    public ListAntdigitalWebtrwatradeIssuerProjectResponse setResultMsg(String resultMsg) {
