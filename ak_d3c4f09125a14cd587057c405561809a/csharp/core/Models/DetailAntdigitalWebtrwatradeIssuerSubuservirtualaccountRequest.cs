...
{
    public class DetailAntdigitalWebtrwatradeIssuerSubuservirtualaccountRequest : TeaModel {
        // OAuth模式下的授权token
        ...
        [Validation(Required=false)]
        public string VirtualAccountLoginName { get; set; }

        // 虚拟子账号登录名类型(EMAIL)
        [NameInMap("virtual_account_login_account_type")]
        [Validation(Required=false)]
        public string VirtualAccountLoginAccountType { get; set; }
