...
public class UnbindUserResponse extends TeaModel {
    ...
    public UnbindUserResponse setReqMsgId(String reqMsgId) {
    ...
    public UnbindUserResponse setResultCode(String resultCode) {
    ...
    public UnbindUserResponse setResultMsg(String resultMsg) {
