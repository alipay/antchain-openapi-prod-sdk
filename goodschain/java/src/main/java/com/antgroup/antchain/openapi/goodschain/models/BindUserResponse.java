...
public class BindUserResponse extends TeaModel {
    ...
    public BindUserResponse setReqMsgId(String reqMsgId) {
    ...
    public BindUserResponse setResultCode(String resultCode) {
    ...
    public BindUserResponse setResultMsg(String resultMsg) {
