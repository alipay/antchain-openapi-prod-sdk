...
PACKAGE = "antchain_sdk_goodschain"
NAME = "antchain_goodschain" or "alibabacloud-package"
DESCRIPTION = "Ant Chain GOODSCHAIN SDK Library for Python"
AUTHOR = "Ant Chain SDK"
