...
type QueryGatewayRequest struct {
	...
	// 接口返回耗时，单位是ms
	TimeLimit *int64 `json:"time_limit,omitempty" xml:"time_limit,omitempty" require:"true"`
}
...
func (s *QueryGatewayRequest) SetTimeLimit(v int64) *QueryGatewayRequest {
	s.TimeLimit = &v
	return s
}
...
func (client *Client) QueryGatewayEx(request *QueryGatewayRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *QueryGatewayResponse, _err error) {
	...
	_result = &QueryGatewayResponse{}
	_body, _err := client.DoRequest(tea.String("1.0"), tea.String("antchain.loadtestmock.gateway.query"), tea.String("HTTPS"), tea.String("POST"), tea.String("/gateway.do"), tea.ToMap(request), headers, runtime)
	if _err != nil {
		return _result, _err
	}
