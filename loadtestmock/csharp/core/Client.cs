...
using AntChain.SDK.LOADTESTMOCK.Models;

namespace AntChain.SDK.LOADTESTMOCK
{
    public class Client 
    {
        ...
        public QueryGatewayResponse QueryGatewayEx(QueryGatewayRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<QueryGatewayResponse>(DoRequest("1.0", "antchain.loadtestmock.gateway.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryGatewayResponse>(await DoRequestAsync("1.0", "antchain.loadtestmock.gateway.query", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
