...
export default class Client {
  ...
  async queryGatewayEx(request: QueryGatewayRequest, headers: {[key: string ]: string}, runtime: $Util.RuntimeOptions): Promise<QueryGatewayResponse> {
    ...
    return $tea.cast<QueryGatewayResponse>(await this.doRequest("1.0", "antchain.loadtestmock.gateway.query", "HTTPS", "POST", `/gateway.do`, $tea.toMap(request), headers, runtime), new QueryGatewayResponse({}));
  }
