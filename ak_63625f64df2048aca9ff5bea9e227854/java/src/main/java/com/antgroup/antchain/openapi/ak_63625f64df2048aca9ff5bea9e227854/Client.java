...
package com.antgroup.antchain.openapi.ak_63625f64df2048aca9ff5bea9e227854;
...
import com.antgroup.antchain.openapi.ak_63625f64df2048aca9ff5bea9e227854.models.*;
...
public class Client {
    ...
    public CheckDemoAicoguardcoreAicoguardrailsQuestionResponse checkDemoAicoguardcoreAicoguardrailsQuestionEx(CheckDemoAicoguardcoreAicoguardrailsQuestionRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRequest("1.0", "demo.aicoguardcore.aicoguardrails.question.check", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new CheckDemoAicoguardcoreAicoguardrailsQuestionResponse());
    }
