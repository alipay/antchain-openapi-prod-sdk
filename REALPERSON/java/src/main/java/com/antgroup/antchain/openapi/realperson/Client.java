...
public class Client {
     ...
     * Summary: 文件上传接口</p>
     */
    public UploadFileResponse uploadFileEx(UploadFileRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        if (!com.aliyun.teautil.Common.isUnset(request.fileObject)) {
            CreateAntcloudGatewayxFileUploadRequest uploadReq = CreateAntcloudGatewayxFileUploadRequest.build(TeaConverter.buildMap(
                new TeaPair("authToken", request.authToken),
                new TeaPair("apiCode", "di.realperson.file.upload"),
                new TeaPair("fileName", request.fileObjectName)
            ));
            CreateAntcloudGatewayxFileUploadResponse uploadResp = this.createAntcloudGatewayxFileUploadEx(uploadReq, headers, runtime);
            if (!com.antgroup.antchain.openapi.antchain.util.AntchainUtils.isSuccess(uploadResp.resultCode, "ok")) {
        ...
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "di.realperson.file.upload", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new UploadFileResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 用户身份核验
     * Summary: 用户身份核验</p>
     */
    public QueryRiderQualificationResponse queryRiderQualification(QueryRiderQualificationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
    ...
    /**
     * <b>description</b> :
     * <p>Description: 运营商二次放号增强版扩展接口
     * Summary: 运营商二次放号增强版扩展接口</p>
     */
    public QueryThreemetaPhonereuseproxResponse queryThreemetaPhonereuseprox(QueryThreemetaPhonereuseproxRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryThreemetaPhonereuseproxEx(request, headers, runtime);
    }
     ...
     * Summary: 运营商二次放号增强版扩展接口</p>
     */
    public QueryThreemetaPhonereuseproxResponse queryThreemetaPhonereuseproxEx(QueryThreemetaPhonereuseproxRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "di.realperson.threemeta.phonereuseprox.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryThreemetaPhonereuseproxResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 运营商二次放号扩展接口
     * Summary: 运营商二次放号扩展接口</p>
     */
    public QueryThreemetaPhonereusexResponse queryThreemetaPhonereusex(QueryThreemetaPhonereusexRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryThreemetaPhonereusexEx(request, headers, runtime);
    }
     ...
     * Summary: 运营商二次放号扩展接口</p>
     */
    public QueryThreemetaPhonereusexResponse queryThreemetaPhonereusexEx(QueryThreemetaPhonereusexRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "di.realperson.threemeta.phonereusex.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryThreemetaPhonereusexResponse());
    }
    ...
    /**
     * <b>description</b> :
     * <p>Description: 意愿认证服务端查询
     * Summary: 意愿认证服务端查询</p>
     */
    public QueryServerWillauthResponse queryServerWillauth(QueryServerWillauthRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryServerWillauthEx(request, headers, runtime);
    }
     ...
     * Summary: 意愿认证服务端查询</p>
     */
    public QueryServerWillauthResponse queryServerWillauthEx(QueryServerWillauthRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "di.realperson.server.willauth.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryServerWillauthResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 意愿认证服务端材料查询
     * Summary: 意愿认证服务端材料查询</p>
     */
    public QueryServerWillauthmaterialResponse queryServerWillauthmaterial(QueryServerWillauthmaterialRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.queryServerWillauthmaterialEx(request, headers, runtime);
    }
     ...
     * Summary: 意愿认证服务端材料查询</p>
     */
    public QueryServerWillauthmaterialResponse queryServerWillauthmaterialEx(QueryServerWillauthmaterialRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "di.realperson.server.willauthmaterial.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryServerWillauthmaterialResponse());
    }
    ...
    /**
     * <b>description</b> :
     * <p>Description: 卡状态 y 标回流
     * Summary: 卡状态 y 标回流</p>
     */
    public ApplyExtYdataResponse applyExtYdata(ApplyExtYdataRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 卡状态 y 标回流</p>
     */
    public ApplyExtYdataResponse applyExtYdataEx(ApplyExtYdataRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "di.realperson.ext.ydata.apply", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new ApplyExtYdataResponse());
    }

    /**
     * <b>description</b> :
     * <p>Description: 个人运营商二次放号专业版
     * Summary: 个人运营商二次放号专业版</p>
     */
    public QueryThreemetaPhonereuseproResponse queryThreemetaPhonereusepro(QueryThreemetaPhonereuseproRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * Summary: 个人运营商二次放号专业版</p>
     */
    public QueryThreemetaPhonereuseproResponse queryThreemetaPhonereuseproEx(QueryThreemetaPhonereuseproRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("1.0", "di.realperson.threemeta.phonereusepro.query", "HTTPS", "POST", "/gateway.do", TeaModel.buildMap(request), headers, runtime), new QueryThreemetaPhonereuseproResponse());
    }
