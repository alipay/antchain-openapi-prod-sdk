...
using AntChain.SDK.MDP.Models;

namespace AntChain.SDK.MDP
{
    public class Client 
    {
        ...
        public async Task<GetuserscoreResponse> GetuserscoreAsync(GetuserscoreRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await GetuserscoreExAsync(request, headers, runtime);
        }
        ...
        public GetuserscoreResponse GetuserscoreEx(GetuserscoreRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<GetuserscoreResponse>(DoRequest("1.0", "antdigital.mdp.getuserscore", "HTTPS", "POST", "/gateway.do", request.ToMap(), headers, runtime));
        }
