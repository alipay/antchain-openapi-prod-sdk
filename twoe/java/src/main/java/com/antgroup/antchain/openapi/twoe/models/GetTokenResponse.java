...
public class GetTokenResponse extends TeaModel {
    ...
    public GetTokenResponse setReqMsgId(String reqMsgId) {
    ...
    public GetTokenResponse setResultCode(String resultCode) {
    ...
    public GetTokenResponse setResultMsg(String resultMsg) {
    ...
    public GetTokenResponse setAuthToken(String authToken) {
