...
from antchain_sdk_risknet import models as risknet_models
...
class Client:
    ...
    def query_general(
        self,
        request: risknet_models.QueryGeneralRequest,
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.query_general_ex(request, headers, runtime)

    async def query_general_async(
        self,
        request: risknet_models.QueryGeneralRequest,
    ) -> risknet_models.QueryGeneralResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.query_general_ex_async(request, headers, runtime)

    def query_general_ex(
        self,
        request: risknet_models.QueryGeneralRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def query_general_ex_async(
        self,
        request: risknet_models.QueryGeneralRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
